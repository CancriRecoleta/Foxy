...
import com.github.foxy.common.util.ThreadLocalMemoryBuffer;
...
public class SaveLoadSystem3 {
    ...
    public static int lin2z(int i) {//y,z,x
        ...
        int y = (i>>10)&0x1F;
        int z = (i>>5)&0x1F;
        return BitOps.expand(x,0b1001001001001)|BitOps.expand(y,0b10010010010010)|BitOps.expand(z,0b100100100100100);

        //zyxzyxzyxzyxzyx
    }

    public static int z2lin(int i) {
        int x = BitOps.compress(i, 0b1001001001001);
        int y = BitOps.compress(i, 0b10010010010010);
        int z = BitOps.compress(i, 0b100100100100100);
        return x|(y<<10)|(z<<5);
    }
