...
import com.github.foxy.client.core.rendering.post.FullscreenBlit;
    ...
    protected void finish(Viewport<?> viewport, int sourceFrameBuffer, int srcWidth, int srcHeight) {
        ...
        if (this.useEnvFog) {
            ...
            if (Math.abs(end-start)>1) {
                ...
                glUniform4f(4, invEndFogDelta, startDelta, com.github.foxy.common.util.BitOps.clamp(endDistance*invEndFogDelta+startDelta, 0, 1),0);//
