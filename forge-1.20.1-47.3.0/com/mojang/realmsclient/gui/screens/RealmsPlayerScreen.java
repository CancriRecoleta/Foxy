...
public class RealmsPlayerScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        }).bounds($$0, row(1), this.columnWidth + 10, 20).build());
        this.removeButton = (Button)this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.invites.remove.tooltip"), (p_278866_) -> {
            this.uninvite(this.playerIndex);
        }).bounds($$0, row(7), this.columnWidth + 10, 20).build());
        this.opdeopButton = (Button)this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.invites.ops.tooltip"), (p_278869_) -> {
        ...
        }).bounds($$0, row(9), this.columnWidth + 10, 20).build());
        this.addRenderableWidget(Button.builder(CommonComponents.GUI_BACK, (p_89122_) -> {
            this.backButtonClicked();
        }).bounds($$0 + this.columnWidth / 2 + 2, row(12), this.columnWidth / 2 + 10 - 2, 20).build());
    ...
    void op(int p_89193_) {
        ...
        String $$2 = ((PlayerInfo)this.serverData.players.get(p_89193_)).getUuid();
    ...
    void deop(int p_89195_) {
        RealmsClient $$1 = RealmsClient.create();
        String $$2 = ((PlayerInfo)this.serverData.players.get(p_89195_)).getUuid();
    ...
    private void updateOps(Ops p_89108_) {
        ...
        while(var2.hasNext()) {
            PlayerInfo $$1 = (PlayerInfo)var2.next();
            $$1.setOperator(p_89108_.ops.contains($$1.getName()));
        }
    ...
    void uninvite(int p_89197_) {
        ...
        if (p_89197_ >= 0 && p_89197_ < this.serverData.players.size()) {
            PlayerInfo $$1 = (PlayerInfo)this.serverData.players.get(p_89197_);
            RealmsConfirmScreen $$2 = new RealmsConfirmScreen((p_278868_) -> {
                if (p_278868_) {
                    RealmsClient $$2 = RealmsClient.create();

                    try {
                        $$2.uninvite(this.serverData.id, $$1.getUuid());
                    } catch (RealmsServiceException var5) {
    ...
    public void render(GuiGraphics p_281762_, int p_282648_, int p_282676_, float p_281822_) {
        ...
        p_281762_.drawCenteredString(this.font, (Component)this.title, this.width / 2, 17, 16777215);
        int $$4 = row(12) + 20;
        p_281762_.setColor(0.25F, 0.25F, 0.25F, 1.0F);
        p_281762_.blit(OPTIONS_BACKGROUND, 0, $$4, 0.0F, 0.0F, this.width, this.height - $$4, 32, 32);
        ...
        p_281762_.drawString(this.font, (Component)Component.translatable("mco.configure.world.invited.number", $$5), this.column1X, row(0), 10526880, false);
    ...
    class InvitedObjectSelectionList extends RealmsObjectSelectionList<Entry> {
        ...
        public void updateButtons() {
            if (RealmsPlayerScreen.this.playerIndex != -1) {
                ((Entry)this.getEntry(RealmsPlayerScreen.this.playerIndex)).updateButtons();
            }
        ...
        public void setSelected(@Nullable Entry p_89246_) {
    ...
    private class Entry extends ObjectSelectionList.Entry<Entry> {
        ...
        public Entry(PlayerInfo p_89204_) {
            ...
            int $$2 = RealmsPlayerScreen.this.invitedObjectSelectionList.getRowRight() - 16 - 9;
            int $$3 = RealmsPlayerScreen.this.invitedObjectSelectionList.getRowTop($$1) + 1;
            this.removeButton = new ImageButton($$2, $$3, 8, 7, 0, 0, 7, RealmsPlayerScreen.CROSS_ICON_LOCATION, 8, 14, (p_279099_) -> {
            ...
            $$2 += 11;
            this.makeOpButton = new ImageButton($$2, $$3, 8, 7, 0, 0, 7, RealmsPlayerScreen.USER_ICON_LOCATION, 8, 14, (p_279435_) -> {
            ...
            this.removeOpButton = new ImageButton($$2, $$3, 8, 7, 0, 0, 7, RealmsPlayerScreen.OP_ICON_LOCATION, 8, 14, (p_279383_) -> {
        ...
        public void render(GuiGraphics p_282985_, int p_281343_, int p_283042_, int p_282863_, int p_281381_, int p_282692_, int p_283240_, int p_282706_, boolean p_283067_, float p_282230_) {
            ...
            p_282985_.drawString(RealmsPlayerScreen.this.font, this.playerInfo.getName(), RealmsPlayerScreen.this.column1X + 3 + 12, p_283042_ + 1, $$12, false);
