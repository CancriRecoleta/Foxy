...
public enum OctahedralGroup implements StringRepresentable {
    ...
    private static final OctahedralGroup[][] cayleyTable = (OctahedralGroup[][])Util.make(new OctahedralGroup[values().length][values().length], (p_56533_) -> {
        Map<Pair<SymmetricGroup3, BooleanList>, OctahedralGroup> $$1 = (Map)Arrays.stream(values()).collect(Collectors.toMap((p_174952_) -> {
        ...
        for(int var4 = 0; var4 < var3; ++var4) {
            OctahedralGroup $$2 = var2[var4];
            OctahedralGroup[] var6 = values();
            int var7 = var6.length;

            for(int var8 = 0; var8 < var7; ++var8) {
                OctahedralGroup $$3 = var6[var8];
    ...
    private static final OctahedralGroup[] inverseTable = (OctahedralGroup[])Arrays.stream(values()).map((p_56536_) -> {
        return (OctahedralGroup)Arrays.stream(values()).filter((p_174947_) -> {
    ...
    public Direction rotate(Direction p_56529_) {
        if (this.rotatedDirections == null) {
            ...
            Direction.Axis[] $$1 = net.minecraft.core.Direction.Axis.values();
