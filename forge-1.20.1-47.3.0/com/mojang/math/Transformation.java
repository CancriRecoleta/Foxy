...
public final class Transformation implements IForgeTransformation {
    ...
    static {
        EXTENDED_CODEC = Codec.either(CODEC, ExtraCodecs.MATRIX4F.xmap(Transformation::new, Transformation::getMatrix)).xmap((p_269605_) -> {
            return (Transformation)p_269605_.map((p_269601_) -> {
                return p_269601_;
            }, (p_269602_) -> {
                return p_269602_;
            });
