...
public class DefaultVertexFormat {
    ...
    static {
        ELEMENT_POSITION = new VertexFormatElement(0, Type.FLOAT, Usage.POSITION, 3);
        ELEMENT_COLOR = new VertexFormatElement(0, Type.UBYTE, Usage.COLOR, 4);
        ELEMENT_UV0 = new VertexFormatElement(0, Type.FLOAT, Usage.UV, 2);
        ELEMENT_UV1 = new VertexFormatElement(1, Type.SHORT, Usage.UV, 2);
        ELEMENT_UV2 = new VertexFormatElement(2, Type.SHORT, Usage.UV, 2);
        ELEMENT_NORMAL = new VertexFormatElement(0, Type.BYTE, Usage.NORMAL, 3);
        ELEMENT_PADDING = new VertexFormatElement(0, Type.BYTE, Usage.PADDING, 1);
