...
public class VertexFormat {
    ...
    public VertexFormat(ImmutableMap<String, VertexFormatElement> p_166910_) {
        ...
        for(UnmodifiableIterator var3 = p_166910_.values().iterator(); var3.hasNext(); i += vertexformatelement.getByteSize()) {
    ...
    public VertexBuffer getImmediateDrawVertexBuffer() {
        ...
        if (vertexbuffer == null) {
            this.immediateDrawVertexBuffer = vertexbuffer = new VertexBuffer(Usage.DYNAMIC);
        }
    ...
    public boolean hasPosition() {
        return this.elements.stream().anyMatch((e) -> {
            return e.getUsage() == com.mojang.blaze3d.vertex.VertexFormatElement.Usage.POSITION;
        });
    }

    public boolean hasNormal() {
        return this.elements.stream().anyMatch((e) -> {
            return e.getUsage() == com.mojang.blaze3d.vertex.VertexFormatElement.Usage.NORMAL;
        });
    }

    public boolean hasColor() {
        return this.elements.stream().anyMatch((e) -> {
            return e.getUsage() == com.mojang.blaze3d.vertex.VertexFormatElement.Usage.COLOR;
        });
    }

    public boolean hasUV(int which) {
        return this.elements.stream().anyMatch((e) -> {
            return e.getUsage() == com.mojang.blaze3d.vertex.VertexFormatElement.Usage.UV && e.getIndex() == which;
        });
    }
