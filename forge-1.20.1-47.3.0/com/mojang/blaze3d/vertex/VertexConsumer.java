...
public interface VertexConsumer extends IForgeVertexConsumer {
    ...
    default VertexConsumer color(int p_193480_) {
        return this.color(ARGB32.red(p_193480_), ARGB32.green(p_193480_), ARGB32.blue(p_193480_), ARGB32.alpha(p_193480_));
    }
    ...
    default void putBulkData(PoseStack.Pose p_85996_, BakedQuad p_85997_, float[] p_85998_, float p_85999_, float p_86000_, float p_86001_, int[] p_86002_, int p_86003_, boolean p_86004_) {
        this.putBulkData(p_85996_, p_85997_, p_85998_, p_85999_, p_86000_, p_86001_, 1.0F, p_86002_, p_86003_, p_86004_);
    }
    ...
    default void putBulkData(PoseStack.Pose p_85996_, BakedQuad p_85997_, float[] p_85998_, float p_85999_, float p_86000_, float p_86001_, float alpha, int[] p_86002_, int p_86003_, boolean p_86004_) {
        ...
        int[] var10000 = new int[]{p_86002_[0], p_86002_[1], p_86002_[2], p_86002_[3]};
        ...
        try {
            ...
            for(int k = 0; k < j; ++k) {
                ...
                if (p_86004_) {
                    ...
                    f4 = f9 * afloat[k] * p_86000_;
                    f5 = f10 * afloat[k] * p_86001_;
                } else {
