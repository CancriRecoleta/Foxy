...
public class VertexMultiConsumer {
    ...
    public static VertexConsumer create(VertexConsumer p_86169_, VertexConsumer p_86170_) {
        return new Double(p_86169_, p_86170_);
    }

    public static VertexConsumer create(VertexConsumer... p_167064_) {
        return new Multiple(p_167064_);
    }
    ...
    private static class Multiple implements VertexConsumer {
        ...
        public Multiple(VertexConsumer[] p_167073_) {
            for(int $$1 = 0; $$1 < p_167073_.length; ++$$1) {
                for(int $$2 = $$1 + 1; $$2 < p_167073_.length; ++$$2) {
                    if (p_167073_[$$1] == p_167073_[$$2]) {
                        throw new IllegalArgumentException("Duplicate delegates");
                    }
                }
            }
