...
public class VertexBuffer implements AutoCloseable {
    ...
    public VertexBuffer(Usage p_286252_) {
    ...
    public void upload(BufferBuilder.RenderedBuffer p_231222_) {
        if (!this.isInvalid()) {
            ...
            try {
                ...
                this.format = this.uploadVertexBuffer($$1, p_231222_.vertexBuffer());
                this.sequentialIndices = this.uploadIndexBuffer($$1, p_231222_.indexBuffer());
    ...
    private RenderSystem.AutoStorageIndexBuffer uploadIndexBuffer(BufferBuilder.DrawState p_231224_, ByteBuffer p_231225_) {
        if (!p_231224_.sequentialIndex()) {
            ...
            if ($$2 != this.sequentialIndices || !$$2.hasStorage(p_231224_.indexCount())) {
    ...
    private void _drawWithShader(Matrix4f p_253705_, Matrix4f p_253737_, ShaderInstance p_166879_) {
        ...
        if (p_166879_.LINE_WIDTH != null && (this.mode == Mode.LINES || this.mode == Mode.LINE_STRIP)) {
