...
public class InputConstants {
    ...
    public static Key getKey(int p_84828_, int p_84829_) {
        return p_84828_ == -1 ? com.mojang.blaze3d.platform.InputConstants.Type.SCANCODE.getOrCreate(p_84829_) : com.mojang.blaze3d.platform.InputConstants.Type.KEYSYM.getOrCreate(p_84828_);
    }

    public static Key getKey(String p_84852_) {
        if (com.mojang.blaze3d.platform.InputConstants.Key.NAME_MAP.containsKey(p_84852_)) {
            return (Key)com.mojang.blaze3d.platform.InputConstants.Key.NAME_MAP.get(p_84852_);
        } else {
            Type[] var1 = com.mojang.blaze3d.platform.InputConstants.Type.values();
            int var2 = var1.length;

            for(int var3 = 0; var3 < var2; ++var3) {
                Type $$1 = var1[var3];
                if (p_84852_.startsWith($$1.defaultPrefix)) {
                    String $$2 = p_84852_.substring($$1.defaultPrefix.length() + 1);
    ...
    static {
        ...
        UNKNOWN = com.mojang.blaze3d.platform.InputConstants.Type.KEYSYM.getOrCreate(-1);
    }
    ...
    public static enum Type {
        ...
        private static void addKey(Type p_84900_, String p_84901_, int p_84902_) {
            Key $$3 = new Key(p_84901_, p_84900_, p_84902_);
            p_84900_.map.put(p_84902_, $$3);
        }

        private Type(String p_84893_, BiFunction p_84894_) {
            this.defaultPrefix = p_84893_;
            this.displayTextSupplier = p_84894_;
        }

        public Key getOrCreate(int p_84896_) {
            return (Key)this.map.computeIfAbsent(p_84896_, (p_84907_) -> {
                int $$1 = p_84907_;
                if (this == MOUSE) {
                    ++$$1;
                }
                ...
                return new Key($$2, this, p_84907_);
            });
        }
    ...
    public static final class Key {
        ...
        Key(String p_84860_, Type p_84861_, int p_84862_) {
            this.name = p_84860_;
            this.type = p_84861_;
            this.value = p_84862_;
            this.displayName = new LazyLoadedValue(() -> {
                return (Component)p_84861_.displayTextSupplier.apply(p_84862_, p_84860_);
            });
