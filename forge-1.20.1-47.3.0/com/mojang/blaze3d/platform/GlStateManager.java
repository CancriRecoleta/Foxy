...
public class GlStateManager {
    ...
    public static void glShaderSource(int p_157117_, List<String> p_157118_) {
        ...
        Iterator var3 = p_157118_.iterator();
    ...
    public static void _texParameter(int p_84161_, int p_84162_, float p_84163_) {
        ...
        if (p_84161_ == 33985) {
            lastBrightnessX = (float)p_84162_;
    ...
    public static void _viewport(int p_84431_, int p_84432_, int p_84433_, int p_84434_) {
        RenderSystem.assertOnRenderThreadOrInit();
        com.mojang.blaze3d.platform.GlStateManager.Viewport.INSTANCE.x = p_84431_;
        com.mojang.blaze3d.platform.GlStateManager.Viewport.INSTANCE.y = p_84432_;
        com.mojang.blaze3d.platform.GlStateManager.Viewport.INSTANCE.width = p_84433_;
        com.mojang.blaze3d.platform.GlStateManager.Viewport.INSTANCE.height = p_84434_;
    ...
    static {
        ON_LINUX = Util.getPlatform() == OS.LINUX;
        ...
        TEXTURES = (TextureState[])IntStream.range(0, 12).mapToObj((p_157120_) -> {
            return new TextureState();
        }).toArray((p_157122_) -> {
            return new TextureState[p_157122_];
        });
