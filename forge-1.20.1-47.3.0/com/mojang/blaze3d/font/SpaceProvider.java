...
public class SpaceProvider implements GlyphProvider {
    ...
    public GlyphInfo getGlyph(int p_231105_) {
        return (GlyphInfo)this.glyphs.get(p_231105_);
    }
    ...
    public static record Definition(Map<Integer, Float> advances) implements GlyphProviderDefinition {
        public static final MapCodec<Definition> CODEC = RecordCodecBuilder.mapCodec((p_286766_) -> {
            return p_286766_.group(Codec.unboundedMap(ExtraCodecs.CODEPOINT, Codec.FLOAT).fieldOf("advances").forGetter(Definition::advances)).apply(p_286766_, Definition::new);
        });
        ...
        public Either<GlyphProviderDefinition.Loader, GlyphProviderDefinition.Reference> unpack() {
            GlyphProviderDefinition.Loader $$0 = (p_286243_) -> {
