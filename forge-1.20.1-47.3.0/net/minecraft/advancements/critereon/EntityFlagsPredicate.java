...
public class EntityFlagsPredicate {
    ...
    public static EntityFlagsPredicate fromJson(@Nullable JsonElement p_33699_) {
        if (p_33699_ != null && !p_33699_.isJsonNull()) {
            JsonObject $$1 = GsonHelper.convertToJsonObject(p_33699_, "entity flags");
    ...
    public static class Builder {
        ...
        public Builder setOnFire(@Nullable Boolean p_33715_) {
            this.isOnFire = p_33715_;
            return this;
        }

        public Builder setCrouching(@Nullable Boolean p_150058_) {
            this.isCrouching = p_150058_;
            return this;
        }

        public Builder setSprinting(@Nullable Boolean p_150060_) {
            this.isSprinting = p_150060_;
            return this;
        }

        public Builder setSwimming(@Nullable Boolean p_150062_) {
            this.isSwimming = p_150062_;
            return this;
        }

        public Builder setIsBaby(@Nullable Boolean p_33718_) {
