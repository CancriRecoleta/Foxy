...
public class FilledBucketTrigger extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    public TriggerInstance createInstance(JsonObject p_286783_, ContextAwarePredicate p_286776_, DeserializationContext p_286812_) {
        ItemPredicate $$3 = ItemPredicate.fromJson(p_286783_.get("item"));
        return new TriggerInstance(p_286776_, $$3);
    }
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public static TriggerInstance filledBucket(ItemPredicate p_38794_) {
            return new TriggerInstance(ContextAwarePredicate.ANY, p_38794_);
        }
        ...
        public JsonObject serializeToJson(SerializationContext p_38796_) {
            JsonObject $$1 = super.serializeToJson(p_38796_);
