...
public class ClientboundSetPlayerTeamPacket implements Packet<ClientGamePacketListener> {
    ...
    public static ClientboundSetPlayerTeamPacket createAddOrModifyPacket(PlayerTeam p_179333_, boolean p_179334_) {
        return new ClientboundSetPlayerTeamPacket(p_179333_.getName(), p_179334_ ? 0 : 2, Optional.of(new Parameters(p_179333_)), (Collection)(p_179334_ ? p_179333_.getPlayers() : ImmutableList.of()));
    }
    ...
    public static ClientboundSetPlayerTeamPacket createPlayerPacket(PlayerTeam p_179329_, String p_179330_, Action p_179331_) {
        return new ClientboundSetPlayerTeamPacket(p_179329_.getName(), p_179331_ == net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket.Action.ADD ? 3 : 4, Optional.empty(), ImmutableList.of(p_179330_));
    }
    ...
    public ClientboundSetPlayerTeamPacket(FriendlyByteBuf p_179323_) {
        ...
        if (shouldHaveParameters(this.method)) {
            this.parameters = Optional.of(new Parameters(p_179323_));
        } else {
    ...
    public Action getPlayerAction() {
        switch (this.method) {
            case 0:
            case 3:
                return net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket.Action.ADD;
            case 1:
            case 2:
            default:
                return null;
            case 4:
                return net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket.Action.REMOVE;
        }
    }
    ...
    public Action getTeamAction() {
        switch (this.method) {
            case 0 -> return net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket.Action.ADD;
            case 1 -> return net.minecraft.network.protocol.game.ClientboundSetPlayerTeamPacket.Action.REMOVE;
            default -> return null;
        }
    }
    ...
    public static class Parameters {
        ...
        public Parameters(FriendlyByteBuf p_179362_) {
            ...
            this.color = (ChatFormatting)p_179362_.readEnum(ChatFormatting.class);
