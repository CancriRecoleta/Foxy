...
public class ClientboundAwardStatsPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundAwardStatsPacket(FriendlyByteBuf p_178592_) {
        this.stats = (Object2IntMap)p_178592_.readMap(Object2IntOpenHashMap::new, (p_258209_) -> {
            StatType<?> $$2 = (StatType)p_258209_.readById(BuiltInRegistries.STAT_TYPE);
            return readStatCap(p_178592_, $$2);
