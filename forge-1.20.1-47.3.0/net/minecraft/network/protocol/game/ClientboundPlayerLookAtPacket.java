...
public class ClientboundPlayerLookAtPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundPlayerLookAtPacket(EntityAnchorArgument.Anchor p_132782_, Entity p_132783_, EntityAnchorArgument.Anchor p_132784_) {
        ...
        Vec3 $$3 = p_132784_.apply(p_132783_);
        this.x = $$3.x;
        this.y = $$3.y;
        this.z = $$3.z;
        this.atEntity = true;
    ...
    public ClientboundPlayerLookAtPacket(FriendlyByteBuf p_179146_) {
        this.fromAnchor = (EntityAnchorArgument.Anchor)p_179146_.readEnum(EntityAnchorArgument.Anchor.class);
        ...
        if (this.atEntity) {
            ...
            this.toAnchor = (EntityAnchorArgument.Anchor)p_179146_.readEnum(EntityAnchorArgument.Anchor.class);
        } else {
            this.entity = 0;
            this.toAnchor = null;
        }
    ...
    public Vec3 getPosition(Level p_132786_) {
        if (this.atEntity) {
            Entity $$1 = p_132786_.getEntity(this.entity);
