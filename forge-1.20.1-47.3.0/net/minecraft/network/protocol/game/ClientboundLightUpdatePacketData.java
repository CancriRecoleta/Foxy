...
public class ClientboundLightUpdatePacketData {
    ...
    public ClientboundLightUpdatePacketData(ChunkPos p_285385_, LevelLightEngine p_285143_, @Nullable BitSet p_285253_, @Nullable BitSet p_285051_) {
        ...
        for(int $$4 = 0; $$4 < p_285143_.getLightSectionCount(); ++$$4) {
            if (p_285253_ == null || p_285253_.get($$4)) {
                this.prepareSectionData(p_285385_, p_285143_, LightLayer.SKY, $$4, this.skyYMask, this.emptySkyYMask, this.skyUpdates);
            }

            if (p_285051_ == null || p_285051_.get($$4)) {
                this.prepareSectionData(p_285385_, p_285143_, LightLayer.BLOCK, $$4, this.blockYMask, this.emptyBlockYMask, this.blockUpdates);
            }
        }
    ...
    private void prepareSectionData(ChunkPos p_195742_, LevelLightEngine p_195743_, LightLayer p_195744_, int p_195745_, BitSet p_195746_, BitSet p_195747_, List<byte[]> p_195748_) {
        DataLayer $$7 = p_195743_.getLayerListener(p_195744_).getDataLayerData(SectionPos.of(p_195742_, p_195743_.getMinLightSection() + p_195745_));
        if ($$7 != null) {
            if ($$7.isEmpty()) {
                p_195747_.set(p_195745_);
            } else {
                p_195746_.set(p_195745_);
                p_195748_.add($$7.copy().getData());
            }
        }
