...
public class ServerboundSetStructureBlockPacket implements Packet<ServerGamePacketListener> {
    ...
    public ServerboundSetStructureBlockPacket(FriendlyByteBuf p_179786_) {
        ...
        this.updateType = (StructureBlockEntity.UpdateType)p_179786_.readEnum(StructureBlockEntity.UpdateType.class);
        this.mode = (StructureMode)p_179786_.readEnum(StructureMode.class);
        ...
        this.mirror = (Mirror)p_179786_.readEnum(Mirror.class);
        this.rotation = (Rotation)p_179786_.readEnum(Rotation.class);
        this.data = p_179786_.readUtf(128);
        this.integrity = Mth.clamp(p_179786_.readFloat(), 0.0F, 1.0F);
        this.seed = p_179786_.readVarLong();
        int $$3 = p_179786_.readByte();
