...
public class ClientboundBossEventPacket implements Packet<ClientGamePacketListener> {
    ...
    static final Operation REMOVE_OPERATION = new Operation() {
        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.REMOVE;
        }
    ...
    public ClientboundBossEventPacket(FriendlyByteBuf p_178638_) {
        ...
        OperationType $$1 = (OperationType)p_178638_.readEnum(OperationType.class);
        this.operation = (Operation)$$1.reader.apply(p_178638_);
    }

    public static ClientboundBossEventPacket createAddPacket(BossEvent p_178640_) {
        return new ClientboundBossEventPacket(p_178640_.getId(), new AddOperation(p_178640_));
    }
    ...
    public static ClientboundBossEventPacket createUpdateProgressPacket(BossEvent p_178650_) {
        return new ClientboundBossEventPacket(p_178650_.getId(), new UpdateProgressOperation(p_178650_.getProgress()));
    }

    public static ClientboundBossEventPacket createUpdateNamePacket(BossEvent p_178652_) {
        return new ClientboundBossEventPacket(p_178652_.getId(), new UpdateNameOperation(p_178652_.getName()));
    }

    public static ClientboundBossEventPacket createUpdateStylePacket(BossEvent p_178654_) {
        return new ClientboundBossEventPacket(p_178654_.getId(), new UpdateStyleOperation(p_178654_.getColor(), p_178654_.getOverlay()));
    }

    public static ClientboundBossEventPacket createUpdatePropertiesPacket(BossEvent p_178656_) {
        return new ClientboundBossEventPacket(p_178656_.getId(), new UpdatePropertiesOperation(p_178656_.shouldDarkenScreen(), p_178656_.shouldPlayBossMusic(), p_178656_.shouldCreateWorldFog()));
    }
    ...
    public void dispatch(Handler p_178644_) {
    ...
    private static enum OperationType {
        ...
        private OperationType(Function p_178716_) {
    ...
    private static class AddOperation implements Operation {
        ...
        private AddOperation(FriendlyByteBuf p_178674_) {
            ...
            this.color = (BossEvent.BossBarColor)p_178674_.readEnum(BossEvent.BossBarColor.class);
            this.overlay = (BossEvent.BossBarOverlay)p_178674_.readEnum(BossEvent.BossBarOverlay.class);
            int $$1 = p_178674_.readUnsignedByte();
        ...
        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.ADD;
        }

        public void dispatch(UUID p_178677_, Handler p_178678_) {
    ...
    static class UpdateProgressOperation implements Operation {
        ...
        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.UPDATE_PROGRESS;
        }

        public void dispatch(UUID p_178741_, Handler p_178742_) {
    ...
    private static class UpdateNameOperation implements Operation {
        ...
        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.UPDATE_NAME;
        }

        public void dispatch(UUID p_178730_, Handler p_178731_) {
    ...
    static class UpdateStyleOperation implements Operation {
        ...
        private UpdateStyleOperation(FriendlyByteBuf p_178766_) {
            this.color = (BossEvent.BossBarColor)p_178766_.readEnum(BossEvent.BossBarColor.class);
            this.overlay = (BossEvent.BossBarOverlay)p_178766_.readEnum(BossEvent.BossBarOverlay.class);
        }

        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.UPDATE_STYLE;
        }

        public void dispatch(UUID p_178769_, Handler p_178770_) {
    ...
    private static class UpdatePropertiesOperation implements Operation {
        ...
        private UpdatePropertiesOperation(FriendlyByteBuf p_178749_) {
            int $$1 = p_178749_.readUnsignedByte();
            this.darkenScreen = ($$1 & 1) > 0;
            this.playMusic = ($$1 & 2) > 0;
            this.createWorldFog = ($$1 & 4) > 0;
        }
        ...
        public OperationType getType() {
            return net.minecraft.network.protocol.game.ClientboundBossEventPacket.OperationType.UPDATE_PROPERTIES;
        }

        public void dispatch(UUID p_178756_, Handler p_178757_) {
