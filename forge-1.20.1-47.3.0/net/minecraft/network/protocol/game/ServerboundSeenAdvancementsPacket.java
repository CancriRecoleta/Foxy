...
public class ServerboundSeenAdvancementsPacket implements Packet<ServerGamePacketListener> {
    ...
    public static ServerboundSeenAdvancementsPacket openedTab(Advancement p_134443_) {
        return new ServerboundSeenAdvancementsPacket(net.minecraft.network.protocol.game.ServerboundSeenAdvancementsPacket.Action.OPENED_TAB, p_134443_.getId());
    }

    public static ServerboundSeenAdvancementsPacket closedScreen() {
        return new ServerboundSeenAdvancementsPacket(net.minecraft.network.protocol.game.ServerboundSeenAdvancementsPacket.Action.CLOSED_SCREEN, (ResourceLocation)null);
    }

    public ServerboundSeenAdvancementsPacket(FriendlyByteBuf p_179744_) {
        this.action = (Action)p_179744_.readEnum(Action.class);
