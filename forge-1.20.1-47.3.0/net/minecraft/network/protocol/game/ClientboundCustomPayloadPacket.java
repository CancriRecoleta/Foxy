...
public class ClientboundCustomPayloadPacket implements Packet<ClientGamePacketListener>, ICustomPacket<ClientboundCustomPayloadPacket> {
    ...
    public void write(FriendlyByteBuf p_132044_) {
        ...
        p_132044_.writeBytes(this.data.slice());
    }
