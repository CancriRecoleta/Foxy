...
public class TranslatableContents implements ComponentContents {
    ...
    private void decomposeTemplate(String p_237516_, Consumer<FormattedText> p_237517_) {
        ...
        try {
            ...
            for(j = 0; matcher.find(j); j = l) {
                ...
                String s4;
                if (k > j) {
                    s4 = p_237516_.substring(j, k);
                    if (s4.indexOf(37) != -1) {
                        throw new IllegalArgumentException();
                    }

                    p_237517_.accept(FormattedText.of(s4));
                }
            ...
            if (j == 0) {
                j = TextComponentMessageFormatHandler.handle(this, p_237517_, this.args, p_237516_);
            }
            ...
            IllegalArgumentException illegalargumentexception = var12;
    ...
    public <T> Optional<T> visit(FormattedText.StyledContentConsumer<T> p_237521_, Style p_237522_) {
        ...
        do {
            ...
            optional = formattedtext.visit(p_237521_, p_237522_);
    ...
    public <T> Optional<T> visit(FormattedText.ContentConsumer<T> p_237519_) {
        ...
        do {
            ...
            optional = formattedtext.visit(p_237519_);
        } while(!optional.isPresent());
