...
public class SynchedEntityData {
    ...
    public <T> void define(EntityDataAccessor<T> p_135373_, T p_135374_) {
        ...
        if (i > 254) {
            ...
            EntityDataSerializer var10002 = p_135373_.getSerializer();
    ...
    private <T> DataItem<T> getItem(EntityDataAccessor<T> p_135380_) {
        ...
        try {
            ...
            crashreportcategory.setDetail("Data ID", (Object)p_135380_);
    ...
    public void assignValues(List<DataValue<?>> p_135357_) {
        ...
        try {
            Iterator var2 = p_135357_.iterator();
    ...
    public static class DataItem<T> {
        ...
        public DataValue<T> value() {
            return net.minecraft.network.syncher.SynchedEntityData.DataValue.create(this.accessor, this.value);
        }
    }
    ...
    public static record DataValue<T>(int id, EntityDataSerializer<T> serializer, T value) {
        ...
        public static <T> DataValue<T> create(EntityDataAccessor<T> p_254543_, T p_254138_) {
            ...
            return new DataValue(p_254543_.getId(), entitydataserializer, entitydataserializer.copy(p_254138_));
        }
        ...
        public static DataValue<?> read(FriendlyByteBuf p_254314_, int p_254356_) {
        ...
        private static <T> DataValue<T> read(FriendlyByteBuf p_254224_, int p_253899_, EntityDataSerializer<T> p_254222_) {
            return new DataValue(p_253899_, p_254222_, p_254222_.read(p_254224_));
        }
