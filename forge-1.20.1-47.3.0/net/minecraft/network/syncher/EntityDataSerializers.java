...
public class EntityDataSerializers {
    ...
    public static EntityDataSerializer<?> getSerializer(int p_135049_) {
        return ForgeHooks.getSerializer(p_135049_, SERIALIZERS);
    }

    public static int getSerializedId(EntityDataSerializer<?> p_135053_) {
        return ForgeHooks.getSerializerId(p_135053_, SERIALIZERS);
    }
    ...
    static {
        ...
        PARTICLE = new EntityDataSerializer.ForValueType<ParticleOptions>() {
            ...
            public ParticleOptions read(FriendlyByteBuf p_238139_) {
                return this.readParticle(p_238139_, (ParticleType)p_238139_.readById(BuiltInRegistries.PARTICLE_TYPE));
            }
        ...
        VILLAGER_DATA = new EntityDataSerializer.ForValueType<VillagerData>() {
            ...
            public VillagerData read(FriendlyByteBuf p_238156_) {
                return new VillagerData((VillagerType)p_238156_.readById(BuiltInRegistries.VILLAGER_TYPE), (VillagerProfession)p_238156_.readById(BuiltInRegistries.VILLAGER_PROFESSION), p_238156_.readVarInt());
            }
        };
