...
public enum ConnectionProtocol implements BundlerInfo.Provider {
    ...
    private ConnectionProtocol(int p_129580_, ProtocolBuilder p_129581_) {
        this.id = p_129580_;
        this.flows = p_129581_.flows;
    }

    public int getPacketId(PacketFlow p_265671_, Packet<?> p_265442_) {
        return ((PacketSet)this.flows.get(p_265671_)).getId(p_265442_.getClass());
    }

    public BundlerInfo getBundlerInfo(PacketFlow p_265790_) {
        return ((PacketSet)this.flows.get(p_265790_)).bundlerInfo();
    }
    ...
    public Int2ObjectMap<Class<? extends Packet<?>>> getPacketsByIds(PacketFlow p_195621_) {
        ...
        PacketSet<?> $$2 = (PacketSet)this.flows.get(p_195621_);
        if ($$2 == null) {
            return Int2ObjectMaps.emptyMap();
        } else {
            $$2.classToId.forEach((p_195611_, p_195612_) -> {
                $$1.put(p_195612_, p_195611_);
            });
            return $$1;
        }
    }
    ...
    public Packet<?> createPacket(PacketFlow p_178322_, int p_178323_, FriendlyByteBuf p_178324_) {
        return ((PacketSet)this.flows.get(p_178322_)).createPacket(p_178323_, p_178324_);
    }
    ...
    static {
        ...
        for(int var2 = 0; var2 < var1; ++var2) {
            ConnectionProtocol $$0 = var0[var2];
            int $$1 = $$0.getId();
            if ($$1 < -1 || $$1 > 2) {
            ...
            LOOKUP[$$1 - -1] = $$0;
            $$0.flows.forEach((p_264719_, p_264720_) -> {
    ...
    static class ProtocolBuilder {
        ...
        public <T extends PacketListener> ProtocolBuilder addFlow(PacketFlow p_129626_, PacketSet<T> p_129627_) {
    ...
    private static class PacketSet<T extends PacketListener> {
        ...
        final Object2IntMap<Class<? extends Packet<T>>> classToId = (Object2IntMap)Util.make(new Object2IntOpenHashMap(), (p_129613_) -> {
        ...
        public <P extends Packet<T>> PacketSet<T> addPacket(Class<P> p_178331_, Function<FriendlyByteBuf, P> p_178332_) {
            int $$2 = this.idToDeserializer.size();
            int $$3 = this.classToId.put(p_178331_, $$2);
            if ($$3 != -1) {
                String $$4 = "Packet " + p_178331_ + " is already registered to ID " + $$3;
        ...
        public <P extends BundlePacket<T>> PacketSet<T> withBundlePacket(Class<P> p_265034_, Function<Iterable<Packet<T>>, P> p_265591_) {
            if (this.bundlerInfo != BundlerInfo.EMPTY) {
                ...
                this.bundlerInfo = BundlerInfo.createForPacket(p_265034_, p_265591_, $$2);
        ...
        public Packet<?> createPacket(int p_178328_, FriendlyByteBuf p_178329_) {
            Function<FriendlyByteBuf, ? extends Packet<T>> $$2 = (Function)this.idToDeserializer.get(p_178328_);
            return $$2 != null ? (Packet)$$2.apply(p_178329_) : null;
        }

        public void listAllPackets(Consumer<Class<? extends Packet<?>>> p_265213_) {
            this.classToId.keySet().stream().filter((p_264721_) -> {
                return p_264721_ != BundleDelimiterPacket.class;
            }).forEach(p_265213_);
