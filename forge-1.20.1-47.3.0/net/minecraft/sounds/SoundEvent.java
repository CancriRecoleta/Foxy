...
public class SoundEvent {
    ...
    private static SoundEvent create(ResourceLocation p_263406_, Optional<Float> p_263346_) {
        return (SoundEvent)p_263346_.map((p_263360_) -> {
    ...
    public static SoundEvent readFromNetwork(FriendlyByteBuf p_263371_) {
        ResourceLocation $$1 = p_263371_.readResourceLocation();
        Optional<Float> $$2 = p_263371_.readOptional(FriendlyByteBuf::readFloat);
        return create($$1, $$2);
    }
