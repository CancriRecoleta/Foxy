...
public class SoundEvents {
    ...
    private static Holder<SoundEvent> register(ResourceLocation p_263323_, ResourceLocation p_263411_, float p_263385_) {
        return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, (ResourceLocation)p_263323_, SoundEvent.createFixedRangeEvent(p_263411_, p_263385_));
    }
    ...
    private static SoundEvent register(ResourceLocation p_263388_, ResourceLocation p_263340_) {
        return (SoundEvent)Registry.register(BuiltInRegistries.SOUND_EVENT, (ResourceLocation)p_263388_, SoundEvent.createVariableRangeEvent(p_263340_));
    }

    private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation p_263362_, ResourceLocation p_263424_) {
        return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, (ResourceLocation)p_263362_, SoundEvent.createVariableRangeEvent(p_263424_));
    }
