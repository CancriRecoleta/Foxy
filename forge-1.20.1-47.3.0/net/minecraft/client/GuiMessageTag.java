...
public record GuiMessageTag(int indicatorColor, @Nullable Icon icon, @Nullable Component text, @Nullable String logTag) {
    ...
    public static GuiMessageTag chatModified(String p_242878_) {
        ...
        Component $$2 = Component.empty().append(CHAT_MODIFIED_TEXT).append(CommonComponents.NEW_LINE).append((Component)$$1);
        return new GuiMessageTag(6316128, net.minecraft.client.GuiMessageTag.Icon.CHAT_MODIFIED, $$2, "Modified");
    }
