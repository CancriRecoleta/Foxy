...
public class SpectatorPage {
    ...
    public SpectatorMenuItem getItem(int p_101852_) {
        return p_101852_ >= 0 && p_101852_ < this.items.size() ? (SpectatorMenuItem)MoreObjects.firstNonNull((SpectatorMenuItem)this.items.get(p_101852_), SpectatorMenu.EMPTY_SLOT) : SpectatorMenu.EMPTY_SLOT;
    }
