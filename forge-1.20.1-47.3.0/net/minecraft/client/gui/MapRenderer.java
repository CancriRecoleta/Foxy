...
public class MapRenderer implements AutoCloseable {
    ...
    private MapInstance getOrCreateMapInstance(int p_168779_, MapItemSavedData p_168780_) {
        return (MapInstance)this.maps.compute(p_168779_, (p_182563_, p_182564_) -> {
            if (p_182564_ == null) {
                return new MapInstance(p_182563_, p_168780_);
            } else {
    ...
    class MapInstance implements AutoCloseable {
        ...
        void draw(PoseStack p_93292_, MultiBufferSource p_93293_, boolean p_93294_, int p_93295_) {
            ...
            while(true) {
                ...
                } while(p_93294_ && !mapdecoration.renderOnFrame());
                ...
                if (mapdecoration.render(k)) {
                    ...
                    if (mapdecoration.getName() != null) {
                        ...
                        float f6 = (float)font.width((FormattedText)component);
                        ...
                        font.drawInBatch((Component)component, 0.0F, 0.0F, -1, false, p_93292_.last().pose(), p_93293_, DisplayMode.NORMAL, Integer.MIN_VALUE, p_93295_);
                        p_93292_.popPose();
                    }
