...
public class GuiGraphics implements IForgeGuiGraphics {
    ...
    public void fill(RenderType p_286711_, int p_286234_, int p_286444_, int p_286244_, int p_286411_, int p_286671_, int p_286599_) {
        ...
        float f3 = (float)ARGB32.alpha(p_286599_) / 255.0F;
        float f = (float)ARGB32.red(p_286599_) / 255.0F;
        float f1 = (float)ARGB32.green(p_286599_) / 255.0F;
        float f2 = (float)ARGB32.blue(p_286599_) / 255.0F;
    ...
    private void fillGradient(VertexConsumer p_286862_, int p_283414_, int p_281397_, int p_283587_, int p_281521_, int p_283505_, int p_283131_, int p_282949_) {
        float f = (float)ARGB32.alpha(p_283131_) / 255.0F;
        float f1 = (float)ARGB32.red(p_283131_) / 255.0F;
        float f2 = (float)ARGB32.green(p_283131_) / 255.0F;
        float f3 = (float)ARGB32.blue(p_283131_) / 255.0F;
        float f4 = (float)ARGB32.alpha(p_282949_) / 255.0F;
        float f5 = (float)ARGB32.red(p_282949_) / 255.0F;
        float f6 = (float)ARGB32.green(p_282949_) / 255.0F;
        float f7 = (float)ARGB32.blue(p_282949_) / 255.0F;
        Matrix4f matrix4f = this.pose.last().pose();
    ...
    public int drawString(Font p_283343_, @Nullable String p_281896_, float p_283569_, float p_283418_, int p_281560_, boolean p_282130_) {
        if (p_281896_ == null) {
            ...
            int i = p_283343_.drawInBatch(p_281896_, p_283569_, p_283418_, p_281560_, p_282130_, this.pose.last().pose(), this.bufferSource, DisplayMode.NORMAL, 0, 15728880, p_283343_.isBidirectional());
            this.flushIfUnmanaged();
            return i;
        }
    }
    ...
    public int drawString(Font p_282636_, FormattedCharSequence p_281596_, float p_281586_, float p_282816_, int p_281743_, boolean p_282394_) {
        int i = p_282636_.drawInBatch((FormattedCharSequence)p_281596_, p_281586_, p_282816_, p_281743_, p_282394_, this.pose.last().pose(), this.bufferSource, DisplayMode.NORMAL, 0, 15728880);
        this.flushIfUnmanaged();
        return i;
    }
    ...
    public void drawWordWrap(Font p_281494_, FormattedText p_283463_, int p_282183_, int p_283250_, int p_282564_, int p_282629_) {
        for(Iterator var7 = p_281494_.split(p_283463_, p_282564_).iterator(); var7.hasNext(); p_283250_ += 9) {
    ...
    public void blitRepeating(ResourceLocation p_283059_, int p_283575_, int p_283192_, int p_281790_, int p_283642_, int p_282691_, int p_281912_, int p_281728_, int p_282324_) {
        this.blitRepeating(p_283059_, p_283575_, p_283192_, p_281790_, p_283642_, p_282691_, p_281912_, p_281728_, p_282324_, 256, 256);
    }
    ...
    public void blitRepeating(ResourceLocation p_283059_, int p_283575_, int p_283192_, int p_281790_, int p_283642_, int p_282691_, int p_281912_, int p_281728_, int p_282324_, int textureWidth, int textureHeight) {
        ...
        for(IntIterator intiterator = slices(p_281790_, p_281728_); intiterator.hasNext(); i += j) {
            ...
            for(IntIterator intiterator1 = slices(p_283642_, p_282324_); intiterator1.hasNext(); l += i1) {
                ...
                this.blit(p_283059_, i, l, (float)(p_282691_ + k), (float)(p_281912_ + j1), j, i1, textureWidth, textureHeight);
            }
        }
        ...
        if (!p_281675_.isEmpty()) {
            ...
            try {
                ...
                crashreportcategory.setDetail("Item Type", () -> {
                    return String.valueOf(p_281675_.getItem());
                });
                crashreportcategory.setDetail("Registry Name", () -> {
                    return String.valueOf(ForgeRegistries.ITEMS.getKey(p_281675_.getItem()));
                });
                crashreportcategory.setDetail("Item Damage", () -> {
                    return String.valueOf(p_281675_.getDamageValue());
                });
                crashreportcategory.setDetail("Item NBT", () -> {
                    return String.valueOf(p_281675_.getTag());
                });
    ...
    public void renderItemDecorations(Font p_282005_, ItemStack p_283349_, int p_282641_, int p_282146_, @Nullable String p_282803_) {
        if (!p_283349_.isEmpty()) {
            ...
            if (f > 0.0F) {
                i1 = p_282146_ + Mth.floor(16.0F * (1.0F - f));
                j1 = i1 + Mth.ceil(16.0F * f);
                this.fill(RenderType.guiOverlay(), p_282641_, i1, p_282641_ + 16, j1, Integer.MAX_VALUE);
            }

            this.pose.popPose();
            ItemDecoratorHandler.of(p_283349_).render(this, p_282005_, p_283349_, p_282641_, p_282146_);
        }
    ...
    public void renderTooltip(Font p_283128_, List<Component> p_282716_, Optional<TooltipComponent> p_281682_, int p_283678_, int p_281696_) {
        List<ClientTooltipComponent> list = ForgeHooksClient.gatherTooltipComponents(this.tooltipStack, p_282716_, p_281682_, p_283678_, this.guiWidth(), this.guiHeight(), p_283128_);
    ...
    public void renderComponentTooltip(Font p_282739_, List<Component> p_281832_, int p_282191_, int p_282446_) {
        List<ClientTooltipComponent> components = ForgeHooksClient.gatherTooltipComponents(this.tooltipStack, p_281832_, p_282191_, this.guiWidth(), this.guiHeight(), p_282739_);
    ...
    public void renderComponentTooltip(Font font, List<? extends FormattedText> tooltips, int mouseX, int mouseY, ItemStack stack) {
        this.tooltipStack = stack;
        List<ClientTooltipComponent> components = ForgeHooksClient.gatherTooltipComponents(stack, tooltips, mouseX, this.guiWidth(), this.guiHeight(), font);
    ...
    public void renderTooltip(Font p_282192_, List<? extends FormattedCharSequence> p_282297_, int p_281680_, int p_283325_) {
        this.renderTooltipInternal(p_282192_, (List)p_282297_.stream().map(ClientTooltipComponent::create).collect(Collectors.toList()), p_281680_, p_283325_, DefaultTooltipPositioner.INSTANCE);
    }
    ...
    public void renderTooltip(Font p_281627_, List<FormattedCharSequence> p_283313_, ClientTooltipPositioner p_283571_, int p_282367_, int p_282806_) {
        this.renderTooltipInternal(p_281627_, (List)p_283313_.stream().map(ClientTooltipComponent::create).collect(Collectors.toList()), p_282367_, p_282806_, p_283571_);
    }
    ...
    private void renderTooltipInternal(Font p_282675_, List<ClientTooltipComponent> p_282615_, int p_283230_, int p_283417_, ClientTooltipPositioner p_282442_) {
        if (!p_282615_.isEmpty()) {
            RenderTooltipEvent.Pre preEvent = ForgeHooksClient.onRenderTooltipPre(this.tooltipStack, this, p_283230_, p_283417_, this.guiWidth(), this.guiHeight(), p_282615_, p_282675_, p_282442_);
            ...
            for(Iterator var9 = p_282615_.iterator(); var9.hasNext(); j += clienttooltipcomponent.getHeight()) {
            ...
            Vector2ic vector2ic = p_282442_.positionTooltip(this.guiWidth(), this.guiHeight(), preEvent.getX(), preEvent.getY(), i, j);
            int l = vector2ic.x();
            int i1 = vector2ic.y();
            this.pose.pushPose();
            int j1 = true;
            this.drawManaged(() -> {
                RenderTooltipEvent.Color colorEvent = ForgeHooksClient.onRenderTooltipColor(this.tooltipStack, this, l, i1, preEvent.getFont(), p_282615_);
                TooltipRenderUtil.renderTooltipBackground(this, l, i1, i, j, 400, colorEvent.getBackgroundStart(), colorEvent.getBackgroundEnd(), colorEvent.getBorderStart(), colorEvent.getBorderEnd());
            });
            ...
            for(k2 = 0; k2 < p_282615_.size(); ++k2) {
                clienttooltipcomponent2 = (ClientTooltipComponent)p_282615_.get(k2);
    ...
    public void renderComponentHoverEffect(Font p_282584_, @Nullable Style p_282156_, int p_283623_, int p_282114_) {
        if (p_282156_ != null && p_282156_.getHoverEvent() != null) {
            ...
            HoverEvent.ItemStackInfo hoverevent$itemstackinfo = (HoverEvent.ItemStackInfo)hoverevent.getValue(Action.SHOW_ITEM);
            if (hoverevent$itemstackinfo != null) {
                this.renderTooltip(p_282584_, hoverevent$itemstackinfo.getItemStack(), p_283623_, p_282114_);
            } else {
                HoverEvent.EntityTooltipInfo hoverevent$entitytooltipinfo = (HoverEvent.EntityTooltipInfo)hoverevent.getValue(Action.SHOW_ENTITY);
    ...
    static class ScissorStack {
        ...
        public ScreenRectangle push(ScreenRectangle p_281812_) {
            ...
            if (screenrectangle != null) {
                ScreenRectangle screenrectangle1 = (ScreenRectangle)Objects.requireNonNullElse(p_281812_.intersection(screenrectangle), ScreenRectangle.empty());
