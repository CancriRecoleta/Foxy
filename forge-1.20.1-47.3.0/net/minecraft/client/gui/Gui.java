...
public class Gui {
        ...
        if (!this.minecraft.options.hideGui) {
            ...
            if (this.overlayMessageString != null && this.overlayMessageTime > 0) {
                ...
                if (k1 > 8) {
                    ...
                    j2 = k1 << 24 & -16777216;
                    l2 = font.width((FormattedText)this.overlayMessageString);
                    this.drawBackdrop(p_282884_, font, -4, l2, 16777215 | j2);
                    p_282884_.drawString(font, (Component)this.overlayMessageString, -l2 / 2, -4, i2 | j2);
            ...
            if (this.title != null && this.titleTime > 0) {
                ...
                if (k1 > 8) {
                    ...
                    i2 = k1 << 24 & -16777216;
                    j2 = font.width((FormattedText)this.title);
                    this.drawBackdrop(p_282884_, font, -10, j2, 16777215 | i2);
                    p_282884_.drawString(font, (Component)this.title, -j2 / 2, -10, 16777215 | i2);
                    p_282884_.pose().popPose();
                    if (this.subtitle != null) {
                        p_282884_.pose().pushPose();
                        p_282884_.pose().scale(2.0F, 2.0F, 2.0F);
                        l2 = font.width((FormattedText)this.subtitle);
                        this.drawBackdrop(p_282884_, font, 5, l2, 16777215 | i2);
                        p_282884_.drawString(font, (Component)this.subtitle, -l2 / 2, 5, 16777215 | i2);
                        p_282884_.pose().popPose();
                    }
    ...
    protected void drawBackdrop(GuiGraphics p_282548_, Font p_93041_, int p_93042_, int p_93043_, int p_93044_) {
        ...
        if (i != 0) {
            int j = -p_93043_ / 2;
            p_282548_.fill(j - 2, p_93042_ - 2, j + p_93043_ + 2, p_93042_ + 9 + 2, ARGB32.multiply(i, p_93044_));
        }
    ...
    private boolean canRenderCrosshairForSpectator(HitResult p_93025_) {
        if (p_93025_ == null) {
            return false;
        } else if (p_93025_.getType() == Type.ENTITY) {
            return ((EntityHitResult)p_93025_).getEntity() instanceof MenuProvider;
        } else if (p_93025_.getType() == Type.BLOCK) {
                ...
                if (renderer.isVisibleInGui(mobeffectinstance) && mobeffectinstance.showIcon()) {
                    ...
                    if (mobeffectinstance.isAmbient()) {
                        ...
                        if (mobeffectinstance.endsWithin(200)) {
                            ...
                            i1 = 10 - k / 20;
                            f = Mth.clamp((float)k / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F) + Mth.cos((float)k * 3.1415927F / 5.0F) * Mth.clamp((float)i1 / 10.0F * 0.25F, 0.0F, 0.25F);
                        }
                    }
    ...
    public void renderExperienceBar(GuiGraphics p_281906_, int p_282731_) {
        ...
        if (i > 0) {
            ...
            p_281906_.blit(GUI_ICONS_LOCATION, p_282731_, j1, 0, 64, 182, 5);
            if (i1 > 0) {
        ...
        if (this.minecraft.player.experienceLevel > 0) {
            ...
            p_281906_.drawString(this.getFont(), (String)s, i1 + 1, j1, 0, false);
            p_281906_.drawString(this.getFont(), (String)s, i1 - 1, j1, 0, false);
            p_281906_.drawString(this.getFont(), (String)s, i1, j1 + 1, 0, false);
            p_281906_.drawString(this.getFont(), (String)s, i1, j1 - 1, 0, false);
    ...
    public void renderSelectedItemName(GuiGraphics p_283501_, int yShift) {
        ...
        if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
            ...
            int i = this.getFont().width((FormattedText)highlightTip);
            ...
            if (l > 0) {
                ...
                Font font = IClientItemExtensions.of(this.lastToolHighlight).getFont(this.lastToolHighlight, FontContext.SELECTED_ITEM_NAME);
                if (font == null) {
                    p_283501_.drawString(this.getFont(), highlightTip, j, k, 16777215 + (l << 24));
                } else {
                    j = (this.screenWidth - font.width((FormattedText)highlightTip)) / 2;
    ...
    public void displayScoreboardSidebar(GuiGraphics p_282008_, Objective p_283455_) {
        ...
        for(Iterator var11 = ((Collection)collection).iterator(); var11.hasNext(); j = Math.max(j, this.getFont().width((FormattedText)component1) + k + this.getFont().width(Integer.toString(score.getScore())))) {
        ...
        while(var18.hasNext()) {
            ...
            p_282008_.drawString(this.getFont(), (Component)component2, l2, k1, -1, false);
            p_282008_.drawString(this.getFont(), (String)s, l1 - this.getFont().width(s), k1, -1, false);
            if (l == ((Collection)collection).size()) {
                p_282008_.fill(l2 - 2, k1 - 9 - 1, l1, k1 - 1, j1);
                p_282008_.fill(l2 - 2, k1 - 1, l1, k1, i1);
                p_282008_.drawString(this.getFont(), (Component)component, l2 + j / 2 - i / 2, k1 - 9, -1, false);
            }
        }
    ...
    protected void renderHearts(GuiGraphics p_282497_, Player p_168690_, int p_168691_, int p_168692_, int p_168693_, int p_168694_, float p_168695_, int p_168696_, int p_168697_, int p_168698_, boolean p_168699_) {
        HeartType gui$hearttype = net.minecraft.client.gui.Gui.HeartType.forPlayer(p_168690_);
        ...
        for(int i1 = j + k - 1; i1 >= 0; --i1) {
            ...
            this.renderHeart(p_282497_, net.minecraft.client.gui.Gui.HeartType.CONTAINER, l1, i2, i, p_168699_, false);
            int j2 = i1 * 2;
            boolean flag = i1 >= j;
            if (flag) {
                int k2 = j2 - l;
                if (k2 < p_168698_) {
                    ...
                    this.renderHeart(p_282497_, gui$hearttype == net.minecraft.client.gui.Gui.HeartType.WITHERED ? gui$hearttype : net.minecraft.client.gui.Gui.HeartType.ABSORBING, l1, i2, i, false, flag1);
                }
            }
