...
public class Font implements IForgeFont {
    ...
    FontSet getFontSet(ResourceLocation p_92864_) {
        return (FontSet)this.fonts.apply(p_92864_);
    }
    ...
    public void drawInBatch8xOutline(FormattedCharSequence p_168646_, float p_168647_, float p_168648_, int p_168649_, int p_168650_, Matrix4f p_254170_, MultiBufferSource p_168652_, int p_168653_) {
        ...
        StringRenderOutput font$stringrenderoutput = new StringRenderOutput(p_168652_, 0.0F, 0.0F, i, false, p_254170_, net.minecraft.client.gui.Font.DisplayMode.NORMAL, p_168653_);
        ...
        StringRenderOutput font$stringrenderoutput1 = new StringRenderOutput(p_168652_, p_168647_, p_168648_, adjustColor(p_168649_), false, p_254170_, net.minecraft.client.gui.Font.DisplayMode.POLYGON_OFFSET, p_168653_);
    ...
    private int drawInternal(FormattedCharSequence p_273025_, float p_273121_, float p_272717_, int p_273653_, boolean p_273531_, Matrix4f p_273265_, MultiBufferSource p_273560_, DisplayMode p_273342_, int p_273373_, int p_273266_) {
    ...
    private float renderText(String p_273765_, float p_273532_, float p_272783_, int p_273217_, boolean p_273583_, Matrix4f p_272734_, MultiBufferSource p_272595_, DisplayMode p_273610_, int p_273727_, int p_273199_) {
        ...
        StringDecomposer.iterateFormatted((String)p_273765_, Style.EMPTY, font$stringrenderoutput);
        return font$stringrenderoutput.finish(p_273727_, p_273532_);
    }

    private float renderText(FormattedCharSequence p_273322_, float p_272632_, float p_273541_, int p_273200_, boolean p_273312_, Matrix4f p_273276_, MultiBufferSource p_273392_, DisplayMode p_272625_, int p_273774_, int p_273371_) {
        StringRenderOutput font$stringrenderoutput = new StringRenderOutput(p_273392_, p_272632_, p_273541_, p_273200_, p_273312_, p_273276_, p_272625_, p_273371_);
    ...
    class StringRenderOutput implements FormattedCharSink {
        ...
        public boolean accept(int p_92967_, Style p_92968_, int p_92969_) {
            ...
            if (!(bakedglyph instanceof EmptyGlyph)) {
                ...
                f7 = this.dropShadow ? glyphinfo.getShadowOffset() : 0.0F;
                VertexConsumer vertexconsumer = this.bufferSource.getBuffer(bakedglyph.renderType(this.mode));
                Font.this.renderChar(bakedglyph, flag, p_92968_.isItalic(), f6, this.x + f7, this.y + f7, this.pose, vertexconsumer, f, f1, f2, f3, this.packedLightCoords);
            }

            f6 = glyphinfo.getAdvance(flag);
            f7 = this.dropShadow ? 1.0F : 0.0F;
