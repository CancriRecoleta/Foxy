...
public class DeathScreen extends Screen {
    ...
    public void render(GuiGraphics p_283488_, int p_283551_, int p_283002_, float p_281981_) {
        ...
        p_283488_.drawCenteredString(this.font, (Component)this.title, this.width / 2 / 2, 30, 16777215);
        p_283488_.pose().popPose();
        if (this.causeOfDeath != null) {
            p_283488_.drawCenteredString(this.font, (Component)this.causeOfDeath, this.width / 2, 85, 16777215);
        }

        p_283488_.drawCenteredString(this.font, (Component)this.deathScore, this.width / 2, 100, 16777215);
    ...
    private Style getClickedComponentStyleAt(int p_95918_) {
        if (this.causeOfDeath == null) {
            ...
            int $$1 = this.minecraft.font.width((FormattedText)this.causeOfDeath);
            int $$2 = this.width / 2 - $$1 / 2;
            int $$3 = this.width / 2 + $$1 / 2;
            return p_95918_ >= $$2 && p_95918_ <= $$3 ? this.minecraft.font.getSplitter().componentStyleAtWidth((FormattedText)this.causeOfDeath, p_95918_ - $$2) : null;
        }
    }
    ...
    private void setButtonsActive(boolean p_273413_) {
        Button $$1;
        for(Iterator var2 = this.exitButtons.iterator(); var2.hasNext(); $$1.active = p_273413_) {
            $$1 = (Button)var2.next();
        }
