...
public class RecipeBookComponent implements PlaceRecipe<Ingredient>, Renderable, GuiEventListener, NarratableEntry, RecipeShownListener {
    ...
    public void initVisuals() {
        ...
        Iterator var4 = this.menu.getRecipeBookCategories().iterator();
        ...
        if (this.selectedTab != null) {
            this.selectedTab = (RecipeBookTabButton)this.tabButtons.stream().filter((p_100329_) -> {
        ...
        if (this.isVisible() && !this.minecraft.player.isSpectator()) {
            if (this.recipeBookPage.mouseClicked(p_100294_, p_100295_, p_100296_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
                ...
                if (this.filterButton.mouseClicked(p_100294_, p_100295_, p_100296_)) {
                    ...
                    } while(!recipebooktabbutton.mouseClicked(p_100294_, p_100295_, p_100296_));
    ...
    public void recipesShown(List<Recipe<?>> p_100344_) {
        Iterator var2 = p_100344_.iterator();
    ...
    public void setupGhostRecipe(Recipe<?> p_100316_, List<Slot> p_100317_) {
        ...
        this.ghostRecipe.addIngredient(Ingredient.of(itemstack), ((Slot)p_100317_.get(0)).x, ((Slot)p_100317_.get(0)).y);
    ...
    public void addItemToSlot(Iterator<Ingredient> p_100338_, int p_100339_, int p_100340_, int p_100341_, int p_100342_) {
        Ingredient ingredient = (Ingredient)p_100338_.next();
        if (!ingredient.isEmpty()) {
            Slot slot = (Slot)this.menu.slots.get(p_100339_);
    ...
    protected void sendUpdateSettings() {
        if (this.minecraft.getConnection() != null) {
            ...
            this.minecraft.getConnection().send((Packet)(new ServerboundRecipeBookChangeSettingsPacket(recipebooktype, flag, flag1)));
        }

    }

    public NarratableEntry.NarrationPriority narrationPriority() {
        return this.visible ? net.minecraft.client.gui.narration.NarratableEntry.NarrationPriority.HOVERED : net.minecraft.client.gui.narration.NarratableEntry.NarrationPriority.NONE;
    }
