...
public class WorldCreationUiState {
    ...
    public WorldCreationUiState(Path p_276024_, WorldCreationContext p_276050_, Optional<ResourceKey<WorldPreset>> p_276022_, OptionalLong p_276014_) {
        ...
        this.gameMode = net.minecraft.client.gui.screens.worldselection.WorldCreationUiState.SelectedGameMode.SURVIVAL;
        ...
        this.worldType = new WorldTypeEntry((Holder)findPreset(p_276050_, p_276022_).orElse((Holder)null));
    ...
    public void setGameMode(SelectedGameMode p_268231_) {
        this.gameMode = p_268231_;
        this.onChanged();
    }

    public SelectedGameMode getGameMode() {
        return this.isDebug() ? net.minecraft.client.gui.screens.worldselection.WorldCreationUiState.SelectedGameMode.DEBUG : this.gameMode;
    }
    ...
    public boolean isHardcore() {
        return this.getGameMode() == net.minecraft.client.gui.screens.worldselection.WorldCreationUiState.SelectedGameMode.HARDCORE;
    }
    ...
    public boolean isAllowCheats() {
        if (this.isDebug()) {
            ...
            return this.getGameMode() == net.minecraft.client.gui.screens.worldselection.WorldCreationUiState.SelectedGameMode.CREATIVE;
        } else {
    ...
    public void setWorldType(WorldTypeEntry p_268117_) {
    ...
    public PresetEditor getPresetEditor() {
        ...
        return holder != null ? (PresetEditor)holder.unwrapKey().map(PresetEditorManager::get).orElse((Object)null) : null;
    }
    ...
    private void updatePresetLists() {
        ...
        this.normalPresetList.addAll((Collection)getNonEmptyList(registry, WorldPresetTags.NORMAL).orElseGet(() -> {
            return registry.holders().map(WorldTypeEntry::new).toList();
        }));
        ...
        if (holder != null) {
            this.worldType = (WorldTypeEntry)findPreset(this.getSettings(), holder.unwrapKey()).map(WorldTypeEntry::new).orElse((WorldTypeEntry)this.normalPresetList.get(0));
        }
    ...
    private static Optional<List<WorldTypeEntry>> getNonEmptyList(Registry<WorldPreset> p_268296_, TagKey<WorldPreset> p_268097_) {
        return p_268296_.getTag(p_268097_).map((p_268149_) -> {
            return p_268149_.stream().map(WorldTypeEntry::new).toList();
        }).filter((p_268066_) -> {
    ...
    public static record WorldTypeEntry(@Nullable Holder<WorldPreset> preset) {
        ...
        public Component describePreset() {
            return (Component)Optional.ofNullable(this.preset).flatMap(Holder::unwrapKey).map((p_268048_) -> {
                return Component.translatable(p_268048_.location().toLanguageKey("generator"));
