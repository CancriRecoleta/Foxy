...
public class ServerSelectionList extends ObjectSelectionList<Entry> {
    ...
    public void updateNetworkServers(List<LanServer> p_99800_) {
        ...
        Iterator var3 = p_99800_.iterator();
        ...
        for(int i1 = this.networkServers.size() - i; i1 < this.networkServers.size(); ++i1) {
            NetworkServerEntry serverselectionlist$networkserverentry = (NetworkServerEntry)this.networkServers.get(i1);
    ...
    static {
        ...
        CANT_RESOLVE_TEXT = Component.translatable("multiplayer.status.cannot_resolve").withStyle((p_264689_) -> {
            return p_264689_.withColor(-65536);
        });
        CANT_CONNECT_TEXT = Component.translatable("multiplayer.status.cannot_connect").withStyle((p_264688_) -> {
    ...
    public static class LANHeader extends Entry {
        ...
        public void render(GuiGraphics p_281475_, int p_282477_, int p_282819_, int p_282001_, int p_281911_, int p_283126_, int p_282303_, int p_281998_, boolean p_282625_, float p_281811_) {
            ...
            p_281475_.drawString(this.minecraft.font, ServerSelectionList.SCANNING_LABEL, this.minecraft.screen.width / 2 - this.minecraft.font.width((FormattedText)ServerSelectionList.SCANNING_LABEL) / 2, i, 16777215, false);
    ...
    public class OnlineServerEntry extends Entry {
        ...
        public void render(GuiGraphics p_281406_, int p_281506_, int p_282921_, int p_281363_, int p_283596_, int p_281630_, int p_283567_, int p_282864_, boolean p_282999_, float p_281423_) {
            ...
            for(int i = 0; i < Math.min(list.size(), 2); ++i) {
                p_281406_.drawString(this.minecraft.font, (FormattedCharSequence)list.get(i), p_281363_ + 32 + 3, p_282921_ + 12 + 9 * i, 8421504, false);
            }

            Component component1 = flag ? this.serverData.version.copy().withStyle(ChatFormatting.RED) : this.serverData.status;
            int j = this.minecraft.font.width((FormattedText)component1);
            p_281406_.drawString(this.minecraft.font, (Component)component1, p_281363_ + p_283596_ - j - 15 - 2, p_282921_ + 1, 8421504, false);
            int k = 0;
            int l;
            List list1;
            Object component;
            ...
            ForgeHooksClient.drawForgePingInfo(this.screen, this.serverData, p_281406_, p_281363_, p_282921_, p_283596_, i1, j1);
            if ((Boolean)this.minecraft.options.touchscreen().get() || p_282999_) {
        ...
        public Component getNarration() {
            ...
            mutablecomponent.append((Component)Component.translatable("narrator.select", this.serverData.name));
            ...
            if (!this.isCompatible()) {
                ...
                mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                mutablecomponent.append((Component)Component.translatable("multiplayer.status.version.narration", this.serverData.version));
                mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                mutablecomponent.append((Component)Component.translatable("multiplayer.status.motd.narration", this.serverData.motd));
                ...
                mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                mutablecomponent.append((Component)Component.translatable("multiplayer.status.ping.narration", this.serverData.ping));
                mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                mutablecomponent.append((Component)Component.translatable("multiplayer.status.motd.narration", this.serverData.motd));
                if (this.serverData.players != null) {
                    mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutablecomponent.append((Component)Component.translatable("multiplayer.status.player_count.narration", this.serverData.players.online(), this.serverData.players.max()));
                    mutablecomponent.append(CommonComponents.NARRATION_SEPARATOR);
                    mutablecomponent.append(ComponentUtils.formatList(this.serverData.playerList, (Component)Component.literal(", ")));
                }
            }
