...
public class LoadingOverlay extends Overlay {
    ...
    public static void registerTextures(Minecraft p_96190_) {
        p_96190_.getTextureManager().register((ResourceLocation)MOJANG_STUDIOS_LOGO_LOCATION, (AbstractTexture)(new LogoTexture()));
    }
    ...
    public void render(GuiGraphics p_281839_, int p_282704_, int p_283650_, float p_283394_) {
        ...
        l1 = (int)((double)p_281839_.guiWidth() * 0.5);
        ...
        p_281839_.blit(MOJANG_STUDIOS_LOGO_LOCATION, l1 - j1, k2 - i1, j1, (int)d1, -0.0625F, 0.0F, 120, 60, 120, 120);
        p_281839_.blit(MOJANG_STUDIOS_LOGO_LOCATION, l1, k2 - i1, j1, (int)d1, 0.0625F, 60.0F, 120, 60, 120, 120);
    ...
    private void drawProgressBar(GuiGraphics p_283125_, int p_96184_, int p_96185_, int p_96186_, int p_96187_, float p_96188_) {
        ...
        int k = ARGB32.color(j, 255, 255, 255);
