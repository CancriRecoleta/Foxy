...
public class PauseScreen extends Screen {
    ...
    private void createPauseMenu() {
        ...
        ((Button)gridlayout$rowhelper.addChild(this.openLinkButton(REPORT_BUGS, "https://aka.ms/snapshotbugs?ref=game"))).active = !SharedConstants.getCurrentVersion().getDataVersion().isSideSeries();
        ...
        gridlayout$rowhelper.addChild(Button.builder(Component.translatable("fml.menu.mods"), (p_280815_) -> {
        ...
        this.disconnectButton = (Button)gridlayout$rowhelper.addChild(Button.builder(component, (p_280815_) -> {
    ...
    private Button openScreenButton(Component p_262567_, Supplier<Screen> p_262581_) {
        return Button.builder(p_262567_, (p_280817_) -> {
            this.minecraft.setScreen((Screen)p_262581_.get());
        }).width(98).build();
    }
