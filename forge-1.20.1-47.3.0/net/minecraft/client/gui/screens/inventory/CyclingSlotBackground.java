...
public class CyclingSlotBackground {
    ...
    public void render(AbstractContainerMenu p_267293_, GuiGraphics p_282894_, float p_266785_, int p_266711_, int p_266841_) {
        Slot $$5 = p_267293_.getSlot(this.slotIndex);
        if (!this.icons.isEmpty() && !$$5.hasItem()) {
            boolean $$6 = this.icons.size() > 1 && this.tick >= 30;
            float $$7 = $$6 ? this.getIconTransitionTransparency(p_266785_) : 1.0F;
            if ($$7 < 1.0F) {
                int $$8 = Math.floorMod(this.iconIndex - 1, this.icons.size());
                this.renderIcon($$5, (ResourceLocation)this.icons.get($$8), 1.0F - $$7, p_282894_, p_266711_, p_266841_);
            }

            this.renderIcon($$5, (ResourceLocation)this.icons.get(this.iconIndex), $$7, p_282894_, p_266711_, p_266841_);
        }
    }
    ...
    private void renderIcon(Slot p_283532_, ResourceLocation p_283004_, float p_282627_, GuiGraphics p_282825_, int p_281375_, int p_283041_) {
        TextureAtlasSprite $$6 = (TextureAtlasSprite)Minecraft.getInstance().getTextureAtlas(TextureAtlas.LOCATION_BLOCKS).apply(p_283004_);
        p_282825_.blit(p_281375_ + p_283532_.x, p_283041_ + p_283532_.y, 0, 16, 16, $$6, 1.0F, 1.0F, 1.0F, p_282627_);
    }

    private float getIconTransitionTransparency(float p_266904_) {
        float $$1 = (float)(this.tick % 30) + p_266904_;
