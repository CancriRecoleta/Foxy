...
public class MerchantScreen extends AbstractContainerScreen<MerchantMenu> {
    ...
    protected void init() {
        ...
        for(int l = 0; l < 7; ++l) {
            this.tradeOfferButtons[l] = (TradeOfferButton)this.addRenderableWidget(new TradeOfferButton(i + 5, k, l, (p_99174_) -> {
    ...
    protected void renderLabels(GuiGraphics p_283337_, int p_282009_, int p_283691_) {
        ...
        if (i > 0 && i <= 5 && ((MerchantMenu)this.menu).showProgressBar()) {
            Component component = this.title.copy().append(LEVEL_SEPARATOR).append((Component)Component.translatable("merchant.level." + i));
            int j = this.font.width((FormattedText)component);
            int k = 49 + this.imageWidth / 2 - j / 2;
            p_283337_.drawString(this.font, (Component)component, k, 6, 4210752, false);
        } else {
            p_283337_.drawString(this.font, (Component)this.title, 49 + this.imageWidth / 2 - this.font.width((FormattedText)this.title) / 2, 6, 4210752, false);
        }
        ...
        p_283337_.drawString(this.font, (Component)TRADES_LABEL, 5 - l / 2 + 48, 6, 4210752, false);
    }
    ...
    private void renderProgressBar(GuiGraphics p_281426_, int p_283008_, int p_283085_, MerchantOffer p_282094_) {
        int i = ((MerchantMenu)this.menu).getTraderLevel();
        int j = ((MerchantMenu)this.menu).getTraderXp();
        if (i < 5) {
            ...
            if (j >= k && VillagerData.canLevelUp(i)) {
                ...
                int j1 = ((MerchantMenu)this.menu).getFutureTraderXp();
                if (j1 > 0) {
        ...
        if (!merchantoffers.isEmpty()) {
            ...
            while(true) {
                ...
                if (((MerchantMenu)this.menu).showProgressBar()) {
                    this.renderProgressBar(p_283487_, i, j, merchantoffer);
                }

                if (merchantoffer.isOutOfStock() && this.isHovering(186, 35, 22, 21, (double)p_281994_, (double)p_282099_) && ((MerchantMenu)this.menu).canRestock()) {
                ...
                for(int var21 = 0; var21 < var20; ++var21) {
                    ...
                    merchantscreen$tradeofferbutton.visible = merchantscreen$tradeofferbutton.index < ((MerchantMenu)this.menu).getOffers().size();
                }
    ...
    private void renderAndDecorateCostA(GuiGraphics p_281357_, ItemStack p_283466_, ItemStack p_282046_, int p_282403_, int p_283601_) {
        ...
        if (p_282046_.getCount() == p_283466_.getCount()) {
            ...
            this.font.drawInBatch(count, (float)(p_282403_ + 14) + 19.0F - 2.0F - (float)this.font.width(count), (float)p_283601_ + 6.0F + 3.0F, 16777215, true, p_281357_.pose().last().pose(), p_281357_.bufferSource(), DisplayMode.NORMAL, 0, 15728880, false);
    ...
    public boolean mouseClicked(double p_99131_, double p_99132_, int p_99133_) {
        ...
        int i = (this.width - this.imageWidth) / 2;
        int j = (this.height - this.imageHeight) / 2;
        if (this.canScroll(((MerchantMenu)this.menu).getOffers().size()) && p_99131_ > (double)(i + 94) && p_99131_ < (double)(i + 94 + 6) && p_99132_ > (double)(j + 18) && p_99132_ <= (double)(j + 18 + 139 + 1)) {
        ...
        public void renderToolTip(GuiGraphics p_281313_, int p_283342_, int p_283060_) {
            if (this.isHovered && ((MerchantMenu)MerchantScreen.this.menu).getOffers().size() > this.index + MerchantScreen.this.scrollOff) {
                ...
                if (p_283342_ < this.getX() + 20) {
                    itemstack1 = ((MerchantOffer)((MerchantMenu)MerchantScreen.this.menu).getOffers().get(this.index + MerchantScreen.this.scrollOff)).getCostA();
                    ...
                    itemstack1 = ((MerchantOffer)((MerchantMenu)MerchantScreen.this.menu).getOffers().get(this.index + MerchantScreen.this.scrollOff)).getCostB();
                    if (!itemstack1.isEmpty()) {
                        p_281313_.renderTooltip(MerchantScreen.this.font, itemstack1, p_283342_, p_283060_);
                    }
                } else if (p_283342_ > this.getX() + 65) {
                    itemstack1 = ((MerchantOffer)((MerchantMenu)MerchantScreen.this.menu).getOffers().get(this.index + MerchantScreen.this.scrollOff)).getResult();
                    p_281313_.renderTooltip(MerchantScreen.this.font, itemstack1, p_283342_, p_283060_);
                }
            }
