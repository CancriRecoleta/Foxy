...
public class SignEditScreen extends AbstractSignEditScreen {
    ...
    protected void offsetSign(GuiGraphics p_282503_, BlockState p_282571_) {
        ...
        boolean $$2 = p_282571_.getBlock() instanceof StandingSignBlock;
        if (!$$2) {
    ...
    protected void renderSignBackground(GuiGraphics p_281440_, BlockState p_282401_) {
        if (this.signModel != null) {
            boolean $$2 = p_282401_.getBlock() instanceof StandingSignBlock;
            p_281440_.pose().translate(0.0F, 31.0F, 0.0F);
            p_281440_.pose().scale(62.500004F, 62.500004F, -62.500004F);
            Material $$3 = Sheets.getSignMaterial(this.woodType);
            MultiBufferSource.BufferSource var10001 = p_281440_.bufferSource();
            SignRenderer.SignModel var10002 = this.signModel;
            Objects.requireNonNull(var10002);
            VertexConsumer $$4 = $$3.buffer(var10001, var10002::renderType);
            this.signModel.stick.visible = $$2;
            this.signModel.root.render(p_281440_.pose(), $$4, 15728880, OverlayTexture.NO_OVERLAY);
        }
    }
