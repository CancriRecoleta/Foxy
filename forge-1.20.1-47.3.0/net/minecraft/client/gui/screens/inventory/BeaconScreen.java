...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
    ...
    private <T extends AbstractWidget & BeaconButton> void addBeaconButton(T p_169617_) {
        this.addRenderableWidget(p_169617_);
        this.beaconButtons.add((BeaconButton)p_169617_);
    }
    ...
    protected void init() {
        ...
        int $$9;
        MobEffect $$10;
        BeaconPowerButton $$11;
        for(int $$0 = 0; $$0 <= 2; ++$$0) {
            $$7 = BeaconBlockEntity.BEACON_EFFECTS[$$0].length;
            $$8 = $$7 * 22 + ($$7 - 1) * 2;

            for($$9 = 0; $$9 < $$7; ++$$9) {
                $$10 = BeaconBlockEntity.BEACON_EFFECTS[$$0][$$9];
                $$11 = new BeaconPowerButton(this.leftPos + 76 + $$9 * 24 - $$8 / 2, this.topPos + 22 + $$0 * 25, $$10, true, $$0);
                $$11.active = false;
        ...
        int $$6 = true;
        $$7 = BeaconBlockEntity.BEACON_EFFECTS[3].length + 1;
        $$8 = $$7 * 22 + ($$7 - 1) * 2;

        for($$9 = 0; $$9 < $$7 - 1; ++$$9) {
            $$10 = BeaconBlockEntity.BEACON_EFFECTS[3][$$9];
            $$11 = new BeaconPowerButton(this.leftPos + 167 + $$9 * 24 - $$8 / 2, this.topPos + 47, $$10, false, 3);
            $$11.active = false;
            this.addBeaconButton($$11);
        }

        BeaconPowerButton $$12 = new BeaconUpgradePowerButton(this.leftPos + 167 + ($$7 - 1) * 24 - $$8 / 2, this.topPos + 47, BeaconBlockEntity.BEACON_EFFECTS[0][0]);
        $$12.visible = false;
    ...
    void updateButtons() {
        ...
        this.beaconButtons.forEach((p_169615_) -> {
            p_169615_.updateStatus($$0);
        });
    }

    protected void renderLabels(GuiGraphics p_283369_, int p_282699_, int p_281296_) {
        p_283369_.drawCenteredString(this.font, (Component)PRIMARY_EFFECT_LABEL, 62, 10, 14737632);
        p_283369_.drawCenteredString(this.font, (Component)SECONDARY_EFFECT_LABEL, 169, 10, 14737632);
    }
    ...
    protected void renderBg(GuiGraphics p_282454_, float p_282185_, int p_282362_, int p_282987_) {
        ...
        p_282454_.blit(BEACON_LOCATION, $$4, $$5, 0, 0, this.imageWidth, this.imageHeight);
        p_282454_.pose().pushPose();
        p_282454_.pose().translate(0.0F, 0.0F, 100.0F);
        p_282454_.renderItem(new ItemStack(Items.NETHERITE_INGOT), $$4 + 20, $$5 + 109);
        p_282454_.renderItem(new ItemStack(Items.EMERALD), $$4 + 41, $$5 + 109);
        p_282454_.renderItem(new ItemStack(Items.DIAMOND), $$4 + 41 + 22, $$5 + 109);
        p_282454_.renderItem(new ItemStack(Items.GOLD_INGOT), $$4 + 42 + 44, $$5 + 109);
        p_282454_.renderItem(new ItemStack(Items.IRON_INGOT), $$4 + 42 + 66, $$5 + 109);
    ...
    private abstract static class BeaconScreenButton extends AbstractButton implements BeaconButton {
        ...
        public void renderWidget(GuiGraphics p_281837_, int p_281780_, int p_283603_, float p_283562_) {
            ...
            p_281837_.blit(BeaconScreen.BEACON_LOCATION, this.getX(), this.getY(), $$5, 219, this.width, this.height);
