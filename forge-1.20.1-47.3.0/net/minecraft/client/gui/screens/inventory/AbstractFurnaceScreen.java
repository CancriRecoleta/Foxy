...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceMenu> extends AbstractContainerScreen<T> implements RecipeUpdateListener {
    ...
    protected void renderBg(GuiGraphics p_282928_, float p_281631_, int p_281252_, int p_281891_) {
        int $$4 = this.leftPos;
        int $$5 = this.topPos;
        p_282928_.blit(this.texture, $$4, $$5, 0, 0, this.imageWidth, this.imageHeight);
        int $$7;
        if (((AbstractFurnaceMenu)this.menu).isLit()) {
            $$7 = ((AbstractFurnaceMenu)this.menu).getLitProgress();
            p_282928_.blit(this.texture, $$4 + 56, $$5 + 36 + 12 - $$7, 176, 12 - $$7, 14, $$7 + 1);
        }

        $$7 = ((AbstractFurnaceMenu)this.menu).getBurnProgress();
        p_282928_.blit(this.texture, $$4 + 79, $$5 + 34, 176, 14, $$7 + 1, 16);
    }
    ...
    protected boolean hasClickedOutside(double p_97838_, double p_97839_, int p_97840_, int p_97841_, int p_97842_) {
        boolean $$5 = p_97838_ < (double)p_97840_ || p_97839_ < (double)p_97841_ || p_97838_ >= (double)(p_97840_ + this.imageWidth) || p_97839_ >= (double)(p_97841_ + this.imageHeight);
        return this.recipeBookComponent.hasClickedOutside(p_97838_, p_97839_, this.leftPos, this.topPos, this.imageWidth, this.imageHeight, p_97842_) && $$5;
    }
