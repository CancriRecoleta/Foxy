...
public class TitleScreen extends Screen {
    ...
    public TitleScreen(boolean p_265779_, @Nullable LogoRenderer p_265067_) {
        ...
        this.logoRenderer = (LogoRenderer)Objects.requireNonNullElseGet(p_265067_, () -> {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ImageButton(this.width / 2 - 124, l + 72 + 12, 20, 20, 0, 106, 20, Button.WIDGETS_LOCATION, 256, 256, (p_280838_) -> {
        ...
        this.addRenderableWidget(new ImageButton(this.width / 2 + 104, l + 72 + 12, 20, 20, 0, 0, 20, Button.ACCESSIBILITY_TEXTURE, 32, 64, (p_280834_) -> {
    ...
    private void createDemoMenuOptions(int p_96773_, int p_96774_) {
        ...
        this.resetDemoButton = (Button)this.addRenderableWidget(Button.builder(Component.translatable("menu.resetdemo"), (p_232770_) -> {
    ...
    public void render(GuiGraphics p_282860_, int p_281753_, int p_283539_, float p_282628_) {
        ...
        if ((i & -67108864) != 0) {
            ...
            ForgeHooksClient.renderMainMenu(this, p_282860_, this.font, this.width, this.height, i);
            if (this.splash != null) {
            ...
            BrandingControl.forEachLine(true, true, (brdline, brd) -> {
                ...
                p_282860_.drawString(var10001, (String)brd, 2, var10004 - (10 + var10006 * (9 + 1)), 16777215 | i);
            });
            BrandingControl.forEachAboveCopyrightLine((brdline, brd) -> {
                ...
                Objects.requireNonNull(this.font);
                p_282860_.drawString(var10001, brd, var10003, var10004 - (10 + var10006 * (9 + 1)), 16777215 | i);
            });
