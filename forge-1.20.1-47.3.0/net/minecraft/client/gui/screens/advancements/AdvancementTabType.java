...
enum AdvancementTabType {
    ...
    public static final int MAX_TABS = Arrays.stream(values()).mapToInt((e) -> {
        return e.max;
    }).sum();
    ...
    public int getX(int p_97212_) {
        switch (this) {
            case ABOVE -> return (this.width + 4) * p_97212_;
            case BELOW -> return (this.width + 4) * p_97212_;
            case LEFT -> return -this.width + 4;
            case RIGHT -> return 248;
    ...
    public int getY(int p_97233_) {
        switch (this) {
            case ABOVE -> return -this.height + 4;
            case BELOW -> return 136;
            case LEFT -> return this.height * p_97233_;
            case RIGHT -> return this.height * p_97233_;
            default -> throw new UnsupportedOperationException("Don't know what this tab type is!" + this);
        }
    }
