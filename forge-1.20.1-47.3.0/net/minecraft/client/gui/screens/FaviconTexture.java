...
public class FaviconTexture implements AutoCloseable {
    ...
    public static FaviconTexture forWorld(TextureManager p_289550_, String p_289565_) {
        String var10006 = Util.sanitizeName(p_289565_, ResourceLocation::validPathChar);
        return new FaviconTexture(p_289550_, new ResourceLocation("minecraft", "worlds/" + var10006 + "/" + Hashing.sha1().hashUnencodedChars(p_289565_) + "/icon"));
    }
    ...
    public void upload(NativeImage p_289543_) {
        if (p_289543_.getWidth() == 64 && p_289543_.getHeight() == 64) {
            ...
            p_289543_.close();
            int var10002 = p_289543_.getWidth();
            throw new IllegalArgumentException("Icon must be 64x64, but was " + var10002 + "x" + p_289543_.getHeight());
        }
    }
