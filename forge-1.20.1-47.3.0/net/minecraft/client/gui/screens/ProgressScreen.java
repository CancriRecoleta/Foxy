...
public class ProgressScreen extends Screen implements ProgressListener {
    ...
    public void render(GuiGraphics p_283582_, int p_96516_, int p_96517_, float p_96518_) {
        if (this.stop) {
            ...
            if (this.header != null) {
                p_283582_.drawCenteredString(this.font, (Component)this.header, this.width / 2, 70, 16777215);
            }

            if (this.stage != null && this.progress != 0) {
                p_283582_.drawCenteredString(this.font, (Component)Component.empty().append(this.stage).append(" " + this.progress + "%"), this.width / 2, 90, 16777215);
            }
