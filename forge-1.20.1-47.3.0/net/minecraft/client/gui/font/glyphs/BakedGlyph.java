...
public class BakedGlyph {
    ...
    public void render(boolean p_95227_, float p_95228_, float p_95229_, Matrix4f p_253706_, VertexConsumer p_95231_, float p_95232_, float p_95233_, float p_95234_, float p_95235_, int p_95236_) {
        int $$10 = true;
        float $$11 = p_95228_ + this.left;
        float $$12 = p_95228_ + this.right;
        ...
        p_95231_.vertex(p_253706_, $$11 + $$17, $$15, 0.0F).color(p_95232_, p_95233_, p_95234_, p_95235_).uv(this.u0, this.v0).uv2(p_95236_).endVertex();
        p_95231_.vertex(p_253706_, $$11 + $$18, $$16, 0.0F).color(p_95232_, p_95233_, p_95234_, p_95235_).uv(this.u0, this.v1).uv2(p_95236_).endVertex();
        p_95231_.vertex(p_253706_, $$12 + $$18, $$16, 0.0F).color(p_95232_, p_95233_, p_95234_, p_95235_).uv(this.u1, this.v1).uv2(p_95236_).endVertex();
        p_95231_.vertex(p_253706_, $$12 + $$17, $$15, 0.0F).color(p_95232_, p_95233_, p_95234_, p_95235_).uv(this.u1, this.v0).uv2(p_95236_).endVertex();
    }

    public void renderEffect(Effect p_95221_, Matrix4f p_254370_, VertexConsumer p_95223_, int p_95224_) {
