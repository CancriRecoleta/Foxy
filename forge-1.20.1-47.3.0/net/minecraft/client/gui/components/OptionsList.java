...
public class OptionsList extends ContainerObjectSelectionList<Entry> {
    ...
    public int addBig(OptionInstance<?> p_232529_) {
        return this.addEntry(net.minecraft.client.gui.components.OptionsList.Entry.big(this.minecraft.options, this.width, p_232529_));
    }

    public void addSmall(OptionInstance<?> p_232531_, @Nullable OptionInstance<?> p_232532_) {
        this.addEntry(net.minecraft.client.gui.components.OptionsList.Entry.small(this.minecraft.options, this.width, p_232531_, p_232532_));
    }

    public void addSmall(OptionInstance<?>[] p_232534_) {
        for(int $$1 = 0; $$1 < p_232534_.length; $$1 += 2) {
            this.addSmall(p_232534_[$$1], $$1 < p_232534_.length - 1 ? p_232534_[$$1 + 1] : null);
        }
    ...
    public AbstractWidget findOption(OptionInstance<?> p_232536_) {
        ...
        do {
            ...
            $$2 = (AbstractWidget)$$1.options.get(p_232536_);
        } while($$2 == null);
    ...
    public Optional<AbstractWidget> getMouseOver(double p_94481_, double p_94482_) {
        ...
        while(var5.hasNext()) {
            Entry $$2 = (Entry)var5.next();
            Iterator var7 = $$2.children.iterator();

            while(var7.hasNext()) {
                AbstractWidget $$3 = (AbstractWidget)var7.next();
                if ($$3.isMouseOver(p_94481_, p_94482_)) {
    ...
    protected static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public static Entry big(Options p_232538_, int p_232539_, OptionInstance<?> p_232540_) {
            return new Entry(ImmutableMap.of(p_232540_, p_232540_.createButton(p_232538_, p_232539_ / 2 - 155, 0, 310)));
        }

        public static Entry small(Options p_232542_, int p_232543_, OptionInstance<?> p_232544_, @Nullable OptionInstance<?> p_232545_) {
            AbstractWidget $$4 = p_232544_.createButton(p_232542_, p_232543_ / 2 - 155, 0, 150);
            return p_232545_ == null ? new Entry(ImmutableMap.of(p_232544_, $$4)) : new Entry(ImmutableMap.of(p_232544_, $$4, p_232545_, p_232545_.createButton(p_232542_, p_232543_ / 2 - 155 + 160, 0, 150)));
        }
