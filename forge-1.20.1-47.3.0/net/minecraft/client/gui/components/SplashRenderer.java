...
public class SplashRenderer {
    ...
    public void render(GuiGraphics p_282218_, int p_281824_, Font p_281962_, int p_282586_) {
        ...
        float $$4 = 1.8F - Mth.abs(Mth.sin((float)(Util.getMillis() % 1000L) / 1000.0F * 6.2831855F) * 0.1F);
        $$4 = $$4 * 100.0F / (float)(p_281962_.width(this.splash) + 32);
        p_282218_.pose().scale($$4, $$4, $$4);
        p_282218_.drawCenteredString(p_281962_, (String)this.splash, 0, -8, 16776960 | p_282586_);
