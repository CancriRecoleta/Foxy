    ...
    public void renderWidget(GuiGraphics p_283252_, int p_281594_, int p_282100_, float p_283101_) {
        if (this.isVisible()) {
            ...
            if (this.isBordered()) {
                ...
                p_283252_.fill(this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1, this.getY() + this.height + 1, $$5);
            ...
            if (!$$8.isEmpty()) {
                ...
                $$13 = p_283252_.drawString(this.font, (FormattedCharSequence)this.formatter.apply($$14, this.displayPos), $$13, $$12, $$5);
            }
            ...
            if (!$$8.isEmpty() && $$9 && $$6 < $$8.length()) {
                p_283252_.drawString(this.font, (FormattedCharSequence)this.formatter.apply($$8.substring($$6), this.cursorPos), $$13, $$12, $$5);
            }

            if (this.hint != null && $$8.isEmpty() && !this.isFocused()) {
                p_283252_.drawString(this.font, this.hint, $$13, $$12, $$5);
            }
            ...
            if ($$7 != $$6) {
                ...
                var10005 = $$12 + 1;
                Objects.requireNonNull(this.font);
                this.renderHighlight(p_283252_, $$16, var10003, var10004, var10005 + 9);
            }
