...
public class TutorialToast implements Toast {
    ...
    public Toast.Visibility render(GuiGraphics p_283197_, ToastComponent p_283009_, long p_281902_) {
        ...
        if (this.message == null) {
            p_283197_.drawString(p_283009_.getMinecraft().font, (Component)this.title, 30, 12, -11534256, false);
        } else {
            p_283197_.drawString(p_283009_.getMinecraft().font, (Component)this.title, 30, 7, -11534256, false);
            p_283197_.drawString(p_283009_.getMinecraft().font, (Component)this.message, 30, 18, -16777216, false);
        }

        if (this.progressable) {
            p_283197_.fill(3, 28, 157, 29, -1);
            float $$3 = Mth.clampedLerp(this.lastProgress, this.progress, (float)(p_281902_ - this.lastProgressTime) / 100.0F);
            int $$5;
            ...
            p_283197_.fill(3, 28, (int)(3.0F + 154.0F * $$3), 29, $$5);
            this.lastProgress = $$3;
