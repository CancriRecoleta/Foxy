...
public abstract class AbstractSelectionList<E extends Entry<E>> extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
    ...
    protected E getEntry(int p_93501_) {
        return (Entry)this.children().get(p_93501_);
    }
    ...
    protected final E getEntryAtPosition(double p_93413_, double p_93414_) {
        ...
        return p_93413_ < (double)this.getScrollbarPosition() && p_93413_ >= (double)k && p_93413_ <= (double)l && j1 >= 0 && i1 >= 0 && j1 < this.getItemCount() ? (Entry)this.children().get(j1) : null;
    }
    ...
    public void render(GuiGraphics p_282708_, int p_283242_, int p_282891_, float p_283683_) {
        ...
        if (this.renderTopAndBottom) {
            ...
            p_282708_.setColor(1.0F, 1.0F, 1.0F, 1.0F);
            int j1 = true;
            p_282708_.fillGradient((RenderType)RenderType.guiOverlay(), this.x0, this.y0, this.x1, this.y0 + 4, -16777216, 0, 0);
            p_282708_.fillGradient((RenderType)RenderType.guiOverlay(), this.x0, this.y1 - 4, this.x1, this.y1, 0, -16777216, 0);
        }
    ...
    public NarratableEntry.NarrationPriority narrationPriority() {
        if (this.isFocused()) {
            ...
            return this.hovered != null ? net.minecraft.client.gui.narration.NarratableEntry.NarrationPriority.HOVERED : net.minecraft.client.gui.narration.NarratableEntry.NarrationPriority.NONE;
        }
    }

    @Nullable
    protected E remove(int p_93515_) {
        E e = (Entry)this.children.get(p_93515_);
        return this.removeEntry((Entry)this.children.get(p_93515_)) ? e : null;
    }
    ...
    class TrackedList extends AbstractList<E> {
        ...
        public E set(int p_93559_, E p_93560_) {
            E e = (Entry)this.delegate.set(p_93559_, p_93560_);
