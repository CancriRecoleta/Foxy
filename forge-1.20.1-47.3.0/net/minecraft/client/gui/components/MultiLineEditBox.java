...
public class MultiLineEditBox extends AbstractScrollWidget {
    ...
    protected void renderDecorations(GuiGraphics p_282551_) {
        ...
        if (this.textField.hasCharacterLimit()) {
            ...
            p_282551_.drawString(this.font, (Component)$$2, this.getX() + this.width - this.font.width((FormattedText)$$2), this.getY() + this.height + 4, 10526880);
        }
    ...
    private void scrollToCursor() {
        ...
        Objects.requireNonNull(this.font);
        MultilineTextField.StringView $$1 = var10000.getLineView((int)($$0 / 9.0));
        int var5;
        if (this.textField.cursor() <= $$1.beginIndex()) {
            ...
            Objects.requireNonNull(this.font);
            MultilineTextField.StringView $$2 = var10000.getLineView((int)(var10001 / 9.0) - 1);
