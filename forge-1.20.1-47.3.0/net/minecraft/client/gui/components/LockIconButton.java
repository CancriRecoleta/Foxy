...
public class LockIconButton extends Button {
    ...
    public void renderWidget(GuiGraphics p_282701_, int p_282638_, int p_283565_, float p_282549_) {
        Icon $$6;
        if (!this.active) {
            $$6 = this.locked ? net.minecraft.client.gui.components.LockIconButton.Icon.LOCKED_DISABLED : net.minecraft.client.gui.components.LockIconButton.Icon.UNLOCKED_DISABLED;
        } else if (this.isHoveredOrFocused()) {
            $$6 = this.locked ? net.minecraft.client.gui.components.LockIconButton.Icon.LOCKED_HOVER : net.minecraft.client.gui.components.LockIconButton.Icon.UNLOCKED_HOVER;
        } else {
        ...
        p_282701_.blit(Button.WIDGETS_LOCATION, this.getX(), this.getY(), $$6.getX(), $$6.getY(), this.width, this.height);
    }
