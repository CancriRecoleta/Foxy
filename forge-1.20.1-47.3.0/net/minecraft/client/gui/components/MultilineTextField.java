...
public class MultilineTextField {
    ...
    public int getLineAtCursor() {
        for(int $$0 = 0; $$0 < this.displayLines.size(); ++$$0) {
            StringView $$1 = (StringView)this.displayLines.get($$0);
    ...
    public StringView getLineView(int p_239145_) {
        return (StringView)this.displayLines.get(Mth.clamp(p_239145_, 0, this.displayLines.size() - 1));
    }

    public void seekCursor(Whence p_239798_, int p_239799_) {
        switch (p_239798_) {
            case ABSOLUTE -> this.cursor = p_239799_;
            case RELATIVE -> this.cursor += p_239799_;
            case END -> this.cursor = this.value.length() + p_239799_;
        }
    ...
    public void seekCursorLine(int p_239394_) {
        if (p_239394_ != 0) {
            ...
            StringView $$2 = this.getCursorLineView(p_239394_);
    ...
    public void seekCursorToPoint(double p_239579_, double p_239580_) {
        ...
        StringView $$4 = (StringView)this.displayLines.get(Mth.clamp($$3, 0, this.displayLines.size() - 1));
    ...
    private StringView getCursorLineView(int p_239855_) {
        ...
        if ($$1 < 0) {
            ...
            return (StringView)this.displayLines.get(Mth.clamp($$1 + p_239855_, 0, this.displayLines.size() - 1));
        }
    }
    ...
    public StringView getPreviousWord() {
        if (this.value.isEmpty()) {
            return net.minecraft.client.gui.components.MultilineTextField.StringView.EMPTY;
        } else {
            int $$0;
    ...
    private void reflowDisplayLines() {
        ...
        if (this.value.isEmpty()) {
            this.displayLines.add(net.minecraft.client.gui.components.MultilineTextField.StringView.EMPTY);
        } else {
            this.font.getSplitter().splitLines(this.value, this.width, Style.EMPTY, false, (p_239846_, p_239847_, p_239848_) -> {
                this.displayLines.add(new StringView(p_239847_, p_239848_));
            });
