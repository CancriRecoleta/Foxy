...
public class StringWidget extends AbstractStringWidget {
    ...
    public StringWidget(Component p_268211_, Font p_267963_) {
        int var10003 = p_267963_.width(p_268211_.getVisualOrderText());
        Objects.requireNonNull(p_267963_);
        this(0, 0, var10003, 9, p_268211_, p_267963_);
    }
    ...
    public void renderWidget(GuiGraphics p_281367_, int p_268221_, int p_268001_, float p_268214_) {
        ...
        Font $$5 = this.getFont();
        int $$6 = this.getX() + Math.round(this.alignX * (float)(this.getWidth() - $$5.width((FormattedText)$$4)));
        int var10000 = this.getY();
        int var10001 = this.getHeight();
        Objects.requireNonNull($$5);
        int $$7 = var10000 + (var10001 - 9) / 2;
        p_281367_.drawString($$5, $$4, $$6, $$7, this.getColor());
    }
}
