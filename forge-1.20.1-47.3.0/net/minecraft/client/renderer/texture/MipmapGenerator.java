...
public class MipmapGenerator {
    ...
    private static final float[] POW22 = (float[])Util.make(new float[256], (p_118058_) -> {
    ...
    public static NativeImage[] generateMipLevels(NativeImage[] p_251300_, int p_252326_) {
        if (p_252326_ + 1 <= p_251300_.length) {
            ...
            int maxMipmapLevel = ForgeHooksClient.getMaxMipmapLevel(anativeimage[0].getWidth(), anativeimage[0].getHeight());
