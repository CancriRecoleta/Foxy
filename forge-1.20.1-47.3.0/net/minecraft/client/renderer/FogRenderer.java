...
public class FogRenderer {
    ...
    public static void setupColor(Camera p_109019_, float p_109020_, ClientLevel p_109021_, int p_109022_, float p_109023_) {
        ...
        MobEffectFogFunction fogrenderer$mobeffectfogfunction = getPriorityFogFunction(entity, p_109020_);
    ...
    private static MobEffectFogFunction getPriorityFogFunction(Entity p_234166_, float p_234167_) {
        if (p_234166_ instanceof LivingEntity livingentity) {
            return (MobEffectFogFunction)MOB_EFFECT_FOG.stream().filter((p_234171_) -> {
    ...
    public static void setupFog(Camera p_234173_, FogMode p_234174_, float p_234175_, boolean p_234176_, float p_234177_) {
        ...
        MobEffectFogFunction fogrenderer$mobeffectfogfunction = getPriorityFogFunction(entity, p_234177_);
        ...
        } else if (p_234174_ == net.minecraft.client.renderer.FogRenderer.FogMode.FOG_SKY) {
            fogrenderer$fogdata.start = 0.0F;
            fogrenderer$fogdata.end = p_234175_;
            fogrenderer$fogdata.shape = FogShape.CYLINDER;
        } else {
    ...
    static class BlindnessFogFunction implements MobEffectFogFunction {
        ...
        public void setupFog(FogData p_234181_, LivingEntity p_234182_, MobEffectInstance p_234183_, float p_234184_, float p_234185_) {
            ...
            if (p_234181_.mode == net.minecraft.client.renderer.FogRenderer.FogMode.FOG_SKY) {
    ...
    static class DarknessFogFunction implements MobEffectFogFunction {
        ...
        public void setupFog(FogData p_234194_, LivingEntity p_234195_, MobEffectInstance p_234196_, float p_234197_, float p_234198_) {
            if (!p_234196_.getFactorData().isEmpty()) {
                float f = Mth.lerp(((MobEffectInstance.FactorData)p_234196_.getFactorData().get()).getFactor(p_234195_, p_234198_), p_234197_, 15.0F);
                p_234194_.start = p_234194_.mode == net.minecraft.client.renderer.FogRenderer.FogMode.FOG_SKY ? 0.0F : f * 0.75F;
                p_234194_.end = f;
            }
        ...
        public float getModifiedVoidDarkness(LivingEntity p_234189_, MobEffectInstance p_234190_, float p_234191_, float p_234192_) {
            return p_234190_.getFactorData().isEmpty() ? 0.0F : 1.0F - ((MobEffectInstance.FactorData)p_234190_.getFactorData().get()).getFactor(p_234189_, p_234192_);
        }
    }
}
