...
public class ItemModelGenerator {
    ...
    public BlockModel generateBlockModel(Function<Material, TextureAtlasSprite> p_111671_, BlockModel p_111672_) {
        ...
        for(int i = 0; i < LAYERS.size(); ++i) {
            ...
            SpriteContents spritecontents = ((TextureAtlasSprite)p_111671_.apply(material)).contents();
            list.addAll(this.processFrames(i, s, spritecontents));
        }

        map.put("particle", p_111672_.hasTexture("particle") ? Either.left(p_111672_.getMaterial("particle")) : (Either)map.get("layer0"));
    ...
    private List<BlockElement> createSideElements(SpriteContents p_248810_, String p_111663_, int p_111664_) {
        ...
        List<BlockElement> list = Lists.newArrayList();
        Iterator var7 = this.getSpans(p_248810_).iterator();
        ...
        p_250338_.getUniqueFrames().forEach((p_173444_) -> {
            for(int k = 0; k < j; ++k) {
                for(int l = 0; l < i; ++l) {
                    ...
                    this.checkTransition(net.minecraft.client.renderer.block.model.ItemModelGenerator.SpanFacing.UP, list, p_250338_, p_173444_, l, k, i, j, flag);
                    this.checkTransition(net.minecraft.client.renderer.block.model.ItemModelGenerator.SpanFacing.DOWN, list, p_250338_, p_173444_, l, k, i, j, flag);
                    this.checkTransition(net.minecraft.client.renderer.block.model.ItemModelGenerator.SpanFacing.LEFT, list, p_250338_, p_173444_, l, k, i, j, flag);
                    this.checkTransition(net.minecraft.client.renderer.block.model.ItemModelGenerator.SpanFacing.RIGHT, list, p_250338_, p_173444_, l, k, i, j, flag);
                }
            }
    ...
    private void createOrExpandSpan(List<Span> p_111666_, SpanFacing p_111667_, int p_111668_, int p_111669_) {
        ...
        Iterator var6 = p_111666_.iterator();
