...
public class ItemTransform {
    ...
    public void apply(boolean p_111764_, PoseStack p_111765_) {
        if (this != NO_TRANSFORM) {
            ...
            p_111765_.mulPose((new Quaternionf()).rotationXYZ(f * 0.017453292F, f1 * 0.017453292F, f2 * 0.017453292F));
            p_111765_.scale(this.scale.x(), this.scale.y(), this.scale.z());
            p_111765_.mulPose(TransformationHelper.quatFromXYZ(this.rightRotation.x(), this.rightRotation.y() * (float)(p_111764_ ? -1 : 1), this.rightRotation.z() * (float)(p_111764_ ? -1 : 1), true));
        }
