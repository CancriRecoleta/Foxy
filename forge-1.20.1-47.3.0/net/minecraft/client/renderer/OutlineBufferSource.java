...
public class OutlineBufferSource implements MultiBufferSource {
    ...
    public VertexConsumer getBuffer(RenderType p_109935_) {
        ...
        if (p_109935_.isOutline()) {
            $$2 = this.outlineBufferSource.getBuffer(p_109935_);
            return new EntityOutlineGenerator($$2, this.teamR, this.teamG, this.teamB, this.teamA);
        } else {
            $$2 = this.bufferSource.getBuffer(p_109935_);
            Optional<RenderType> $$3 = p_109935_.outline();
            if ($$3.isPresent()) {
