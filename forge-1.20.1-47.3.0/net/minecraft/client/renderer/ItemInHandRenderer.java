...
public class ItemInHandRenderer {
    ...
    private void renderOneHandedMap(PoseStack p_109354_, MultiBufferSource p_109355_, int p_109356_, float p_109357_, HumanoidArm p_109358_, float p_109359_, ItemStack p_109360_) {
        ...
        float f5 = -0.3F * Mth.sin(p_109359_ * 3.1415927F);
    ...
    private void renderTwoHandedMap(PoseStack p_109340_, MultiBufferSource p_109341_, int p_109342_, float p_109343_, float p_109344_, float p_109345_) {
        ...
        float f1 = -0.2F * Mth.sin(p_109345_ * 3.1415927F);
    ...
    private void renderMap(PoseStack p_109367_, MultiBufferSource p_109368_, int p_109369_, ItemStack p_109370_) {
        ...
        MapItemSavedData mapitemsaveddata = MapItem.getSavedData((Integer)integer, this.minecraft.level);
    ...
    private void renderPlayerArm(PoseStack p_109347_, MultiBufferSource p_109348_, int p_109349_, float p_109350_, float p_109351_, HumanoidArm p_109352_) {
        ...
        float f4 = -0.4F * Mth.sin(p_109351_ * 3.1415927F);
        ...
        float f5 = Mth.sin(p_109351_ * p_109351_ * 3.1415927F);
    ...
    private void applyEatTransform(PoseStack p_109331_, float p_109332_, HumanoidArm p_109333_, ItemStack p_109334_) {
        ...
        if (f1 < 0.8F) {
            ...
            p_109331_.translate(0.0F, f3, 0.0F);
        }
    ...
    private void applyBrushTransform(PoseStack p_273513_, float p_273245_, HumanoidArm p_273726_, ItemStack p_272809_, float p_273333_) {
        ...
        float f6 = -15.0F;
        int i = true;
        float f7 = -15.0F + 75.0F * Mth.cos(f2 * 2.0F * 3.1415927F);
    ...
    private void applyItemArmAttackTransform(PoseStack p_109336_, HumanoidArm p_109337_, float p_109338_) {
        ...
        float f = Mth.sin(p_109338_ * p_109338_ * 3.1415927F);
        p_109336_.mulPose(Axis.YP.rotationDegrees((float)i * (45.0F + f * -20.0F)));
        float f1 = Mth.sin(Mth.sqrt(p_109338_) * 3.1415927F);
    ...
    public void renderHandsWithItems(float p_109315_, PoseStack p_109316_, MultiBufferSource.BufferSource p_109317_, LocalPlayer p_109318_, int p_109319_) {
        ...
        HandRenderSelection iteminhandrenderer$handrenderselection = evaluateWhichHandsToRender(p_109318_);
        ...
        if (iteminhandrenderer$handrenderselection.renderMainHand) {
            ...
            f7 = 1.0F - Mth.lerp(p_109315_, this.oMainHandHeight, this.mainHandHeight);
            if (!ForgeHooksClient.renderSpecificFirstPersonHand(InteractionHand.MAIN_HAND, p_109316_, p_109317_, p_109319_, p_109315_, f1, f6, f7, this.mainHandItem)) {
                this.renderArmWithItem(p_109318_, p_109315_, f1, InteractionHand.MAIN_HAND, f6, this.mainHandItem, f7, p_109316_, p_109317_, p_109319_);
            }
        }

        if (iteminhandrenderer$handrenderselection.renderOffHand) {
            f6 = interactionhand == InteractionHand.OFF_HAND ? f : 0.0F;
            f7 = 1.0F - Mth.lerp(p_109315_, this.oOffHandHeight, this.offHandHeight);
            if (!ForgeHooksClient.renderSpecificFirstPersonHand(InteractionHand.OFF_HAND, p_109316_, p_109317_, p_109319_, p_109315_, f1, f6, f7, this.offHandItem)) {
    ...
    static HandRenderSelection evaluateWhichHandsToRender(LocalPlayer p_172915_) {
        ...
        if (!flag && !flag1) {
            ...
            return isChargedCrossbow(itemstack) ? net.minecraft.client.renderer.ItemInHandRenderer.HandRenderSelection.RENDER_MAIN_HAND_ONLY : net.minecraft.client.renderer.ItemInHandRenderer.HandRenderSelection.RENDER_BOTH_HANDS;
        }
    }
    ...
    private static HandRenderSelection selectionUsingItemWhileHoldingBowLike(LocalPlayer p_172917_) {
        ...
        if (!itemstack.is(Items.BOW) && !itemstack.is(Items.CROSSBOW)) {
            return interactionhand == InteractionHand.MAIN_HAND && isChargedCrossbow(p_172917_.getOffhandItem()) ? net.minecraft.client.renderer.ItemInHandRenderer.HandRenderSelection.RENDER_MAIN_HAND_ONLY : net.minecraft.client.renderer.ItemInHandRenderer.HandRenderSelection.RENDER_BOTH_HANDS;
        } else {
            return net.minecraft.client.renderer.ItemInHandRenderer.HandRenderSelection.onlyForHand(interactionhand);
        }
    }
    ...
    private void renderArmWithItem(AbstractClientPlayer p_109372_, float p_109373_, float p_109374_, InteractionHand p_109375_, float p_109376_, ItemStack p_109377_, float p_109378_, PoseStack p_109379_, MultiBufferSource p_109380_, int p_109381_) {
        if (!p_109372_.isScoping()) {
            ...
            if (p_109377_.isEmpty()) {
                ...
                float f17;
                float f7;
                if (p_109377_.getItem() instanceof CrossbowItem) {
                    flag3 = CrossbowItem.isCharged(p_109377_);
                    ...
                    if (p_109372_.isUsingItem() && p_109372_.getUseItemRemainingTicks() > 0 && p_109372_.getUsedItemHand() == p_109375_) {
                        ...
                        f12 = (float)p_109377_.getUseDuration() - ((float)this.minecraft.player.getUseItemRemainingTicks() - p_109373_ + 1.0F);
                        f7 = f12 / (float)CrossbowItem.getChargeDuration(p_109377_);
                        if (f7 > 1.0F) {
                            f7 = 1.0F;
                        }
                        ...
                        if (f7 > 0.1F) {
                            ...
                            f14 = f7 - 0.1F;
                            f17 = f11 * f14;
                            p_109379_.translate(f17 * 0.0F, f17 * 0.004F, f17 * 0.0F);
                        }

                        p_109379_.translate(f7 * 0.0F, f7 * 0.0F, f7 * 0.04F);
                        p_109379_.scale(1.0F, 1.0F, 1.0F + f7 * 0.2F);
                        p_109379_.mulPose(Axis.YN.rotationDegrees((float)i * 45.0F));
                    } else {
                        f12 = -0.4F * Mth.sin(Mth.sqrt(p_109376_) * 3.1415927F);
                        f7 = 0.2F * Mth.sin(Mth.sqrt(p_109376_) * 6.2831855F);
                        f11 = -0.2F * Mth.sin(p_109376_ * 3.1415927F);
                        p_109379_.translate((float)i * f12, f7, f11);
                        this.applyItemArmTransform(p_109379_, humanoidarm, p_109378_);
                        this.applyItemArmAttackTransform(p_109379_, humanoidarm, p_109376_);
                        if (flag3 && p_109376_ < 0.001F && flag) {
                    ...
                    if (!IClientItemExtensions.of(p_109377_).applyForgeHandTransform(p_109379_, this.minecraft.player, humanoidarm, p_109377_, p_109373_, p_109378_, p_109376_)) {
                        int k;
                        float f8;
                        if (p_109372_.isUsingItem() && p_109372_.getUseItemRemainingTicks() > 0 && p_109372_.getUsedItemHand() == p_109375_) {
                            k = flag3 ? 1 : -1;
                            switch (p_109377_.getUseAnimation()) {
                                ...
                                case BOW:
                                    ...
                                    f8 = (float)p_109377_.getUseDuration() - ((float)this.minecraft.player.getUseItemRemainingTicks() - p_109373_ + 1.0F);
                                    f12 = f8 / 20.0F;
                                ...
                                case SPEAR:
                                    ...
                                    p_109379_.mulPose(Axis.YP.rotationDegrees((float)k * 35.3F));
                                    p_109379_.mulPose(Axis.ZP.rotationDegrees((float)k * -9.785F));
                                    f7 = (float)p_109377_.getUseDuration() - ((float)this.minecraft.player.getUseItemRemainingTicks() - p_109373_ + 1.0F);
                                    f11 = f7 / 10.0F;
                                    if (f11 > 1.0F) {
                                        f11 = 1.0F;
                                    }
                            ...
                            this.applyItemArmTransform(p_109379_, humanoidarm, p_109378_);
                            k = flag3 ? 1 : -1;
                            p_109379_.translate((float)k * -0.4F, 0.8F, 0.3F);
                            p_109379_.mulPose(Axis.YP.rotationDegrees((float)k * 65.0F));
                            p_109379_.mulPose(Axis.ZP.rotationDegrees((float)k * -85.0F));
                        } else {
                            float f5 = -0.4F * Mth.sin(Mth.sqrt(p_109376_) * 3.1415927F);
                            f8 = 0.2F * Mth.sin(Mth.sqrt(p_109376_) * 6.2831855F);
                            f12 = -0.2F * Mth.sin(p_109376_ * 3.1415927F);
                            int l = flag3 ? 1 : -1;
                            p_109379_.translate((float)l * f5, f8, f12);
                            this.applyItemArmTransform(p_109379_, humanoidarm, p_109378_);
                            this.applyItemArmAttackTransform(p_109379_, humanoidarm, p_109376_);
                        }
                    }
