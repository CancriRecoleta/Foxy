...
public class ItemProperties {
    ...
    public static void register(Item p_174571_, ResourceLocation p_174572_, ItemPropertyFunction p_174573_) {
        ((Map)PROPERTIES.computeIfAbsent(p_174571_, (p_117828_) -> {
    ...
    public static ItemPropertyFunction getProperty(Item p_117830_, ResourceLocation p_117831_) {
        ...
        ItemPropertyFunction itempropertyfunction = (ItemPropertyFunction)GENERIC_PROPERTIES.get(p_117831_);
        if (itempropertyfunction != null) {
            return itempropertyfunction;
        } else {
            Map<ResourceLocation, ItemPropertyFunction> map = (Map)PROPERTIES.get(p_117830_);
            return map == null ? null : (ItemPropertyFunction)map.get(p_117831_);
        }
    }
    ...
    static {
        ...
        ClampedItemPropertyFunction clampeditempropertyfunction = (p_289244_, p_289245_, p_289246_, p_289247_) -> {
            if (!p_289244_.is(ItemTags.TRIMMABLE_ARMOR)) {
                ...
                return p_289245_ == null ? 0.0F : (Float)ArmorTrim.getTrim(p_289245_.registryAccess(), p_289244_).map(ArmorTrim::material).map(Holder::value).map(TrimMaterial::itemModelIndex).orElse(0.0F);
            }
        };
        ...
        register(Items.CLOCK, new ResourceLocation("time"), new ClampedItemPropertyFunction() {
            ...
            public float unclampedCall(ItemStack p_174665_, @Nullable ClientLevel p_174666_, @Nullable LivingEntity p_174667_, int p_174668_) {
                ...
                if (entity == null) {
                    ...
                    if (p_174666_ == null && ((Entity)entity).level() instanceof ClientLevel) {
                        p_174666_ = (ClientLevel)((Entity)entity).level();
                    }
        ...
        register(Items.COMPASS, new ResourceLocation("angle"), (ClampedItemPropertyFunction)(new CompassItemPropertyFunction((p_234992_, p_234993_, p_234994_) -> {
        ...
        register(Items.RECOVERY_COMPASS, new ResourceLocation("angle"), (ClampedItemPropertyFunction)(new CompassItemPropertyFunction((p_234983_, p_234984_, p_234985_) -> {
            if (p_234985_ instanceof Player player) {
                return (GlobalPos)player.getLastDeathLocation().orElse((GlobalPos)null);
            } else {
                return null;
            }
        })));
