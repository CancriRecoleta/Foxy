...
public class EntityRenderers {
    ...
    public static Map<EntityType<?>, EntityRenderer<?>> createEntityRenderers(EntityRendererProvider.Context p_174050_) {
        ImmutableMap.Builder<EntityType<?>, EntityRenderer<?>> $$1 = ImmutableMap.builder();
        PROVIDERS.forEach((p_258154_, p_258155_) -> {
            try {
                $$1.put(p_258154_, p_258155_.create(p_174050_));
            } catch (Exception var5) {
                Exception $$4 = var5;
                throw new IllegalArgumentException("Failed to create model for " + BuiltInRegistries.ENTITY_TYPE.getKey(p_258154_), $$4);
            }
        });
        return $$1.build();
    }
    ...
    public static Map<String, EntityRenderer<? extends Player>> createPlayerRenderers(EntityRendererProvider.Context p_174052_) {
        ImmutableMap.Builder<String, EntityRenderer<? extends Player>> $$1 = ImmutableMap.builder();
        PLAYER_PROVIDERS.forEach((p_234607_, p_234608_) -> {
            try {
                $$1.put(p_234607_, p_234608_.create(p_174052_));
            } catch (Exception var5) {
                Exception $$4 = var5;
    ...
    public static boolean validateRegistrations() {
        ...
        while(var1.hasNext()) {
            EntityType<?> $$1 = (EntityType)var1.next();
