...
public class ItemEntityRenderer extends EntityRenderer<ItemEntity> {
    ...
    public void render(ItemEntity p_115036_, float p_115037_, float p_115038_, PoseStack p_115039_, MultiBufferSource p_115040_, int p_115041_) {
        ...
        float f = 0.25F;
        float f1 = this.shouldBob() ? Mth.sin(((float)p_115036_.getAge() + p_115038_) / 10.0F + p_115036_.bobOffs) * 0.1F + 0.1F : 0.0F;
        ...
        if (!flag) {
            ...
            p_115039_.translate(f7, f11, f13);
        }
        ...
        for(int k = 0; k < j; ++k) {
            ...
            if (k > 0) {
                if (flag) {
                    ...
                    p_115039_.translate(this.shouldSpreadItems() ? f11 : 0.0F, this.shouldSpreadItems() ? f13 : 0.0F, this.shouldSpreadItems() ? f10 : 0.0F);
                } else {
                    f11 = (this.random.nextFloat() * 2.0F - 1.0F) * 0.15F * 0.5F;
                    f13 = (this.random.nextFloat() * 2.0F - 1.0F) * 0.15F * 0.5F;
                    p_115039_.translate(this.shouldSpreadItems() ? (double)f11 : 0.0, this.shouldSpreadItems() ? (double)f13 : 0.0, 0.0);
                }
            }
            ...
            p_115039_.popPose();
            if (!flag) {
                p_115039_.translate(0.0, 0.0, 0.09375);
            }
        }
