...
public abstract class EntityRenderer<T extends Entity> {
    ...
    public boolean shouldRender(T p_114491_, Frustum p_114492_, double p_114493_, double p_114494_, double p_114495_) {
        if (!p_114491_.shouldRender(p_114493_, p_114494_, p_114495_)) {
            ...
            if (aabb.hasNaN() || aabb.getSize() == 0.0) {
                aabb = new AABB(p_114491_.getX() - 2.0, p_114491_.getY() - 2.0, p_114491_.getZ() - 2.0, p_114491_.getX() + 2.0, p_114491_.getY() + 2.0, p_114491_.getZ() + 2.0);
            }
    ...
    public void render(T p_114485_, float p_114486_, float p_114487_, PoseStack p_114488_, MultiBufferSource p_114489_, int p_114490_) {
        RenderNameTagEvent renderNameTagEvent = new RenderNameTagEvent(p_114485_, p_114485_.getDisplayName(), this, p_114488_, p_114489_, p_114490_, p_114487_);
        MinecraftForge.EVENT_BUS.post(renderNameTagEvent);
        if (renderNameTagEvent.getResult() != Result.DENY && (renderNameTagEvent.getResult() == Result.ALLOW || this.shouldShowName(p_114485_))) {
    ...
    protected void renderNameTag(T p_114498_, Component p_114499_, PoseStack p_114500_, MultiBufferSource p_114501_, int p_114502_) {
        ...
        if (ForgeHooksClient.isNameplateInRenderDistance(p_114498_, d0)) {
            ...
            float f2 = (float)(-font.width((FormattedText)p_114499_) / 2);
            font.drawInBatch(p_114499_, f2, (float)i, 553648127, false, matrix4f, p_114501_, flag ? DisplayMode.SEE_THROUGH : DisplayMode.NORMAL, j, p_114502_);
            if (flag) {
                font.drawInBatch((Component)p_114499_, f2, (float)i, -1, false, matrix4f, p_114501_, DisplayMode.NORMAL, 0, p_114502_);
            }
