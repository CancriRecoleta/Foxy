...
public class IllusionerRenderer extends IllagerRenderer<Illusioner> {
        ...
        this.addLayer(new ItemInHandLayer<Illusioner, IllagerModel<Illusioner>>(this, p_174186_.getItemInHandRenderer()) {
            public void render(PoseStack p_114989_, MultiBufferSource p_114990_, int p_114991_, Illusioner p_114992_, float p_114993_, float p_114994_, float p_114995_, float p_114996_, float p_114997_, float p_114998_) {
                if (p_114992_.isCastingSpell() || p_114992_.isAggressive()) {
                    super.render(p_114989_, p_114990_, p_114991_, (LivingEntity)p_114992_, p_114993_, p_114994_, p_114995_, p_114996_, p_114997_, p_114998_);
                }
    ...
    public void render(Illusioner p_114952_, float p_114953_, float p_114954_, PoseStack p_114955_, MultiBufferSource p_114956_, int p_114957_) {
        if (p_114952_.isInvisible()) {
            Vec3[] $$6 = p_114952_.getIllusionOffsets(p_114954_);
            float $$7 = this.getBob(p_114952_, p_114954_);

            for(int $$8 = 0; $$8 < $$6.length; ++$$8) {
                p_114955_.pushPose();
                p_114955_.translate($$6[$$8].x + (double)Mth.cos((float)$$8 + $$7 * 0.5F) * 0.025, $$6[$$8].y + (double)Mth.cos((float)$$8 + $$7 * 0.75F) * 0.0125, $$6[$$8].z + (double)Mth.cos((float)$$8 + $$7 * 0.7F) * 0.025);
