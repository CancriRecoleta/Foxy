...
public abstract class LivingEntityRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements RenderLayerParent<T, M> {
    ...
    public void render(T p_115308_, float p_115309_, float p_115310_, PoseStack p_115311_, MultiBufferSource p_115312_, int p_115313_) {
        if (!MinecraftForge.EVENT_BUS.post(new RenderLivingEvent.Pre(p_115308_, this, p_115310_, p_115311_, p_115312_, p_115313_))) {
            p_115311_.pushPose();
            ...
            if (p_115308_.hasPose(Pose.SLEEPING)) {
                ...
                if (direction != null) {
                    f8 = p_115308_.getEyeHeight(Pose.STANDING) - 0.1F;
                    p_115311_.translate((float)(-direction.getStepX()) * f8, 0.0F, (float)(-direction.getStepZ()) * f8);
                }
            }

            f7 = this.getBob(p_115308_, p_115310_);
            ...
            MinecraftForge.EVENT_BUS.post(new RenderLivingEvent.Post(p_115308_, this, p_115310_, p_115311_, p_115312_, p_115313_));
        }
    }
            ...
            if (p_115333_ != localplayer) {
                ...
                if (team != null) {
                    ...
                    switch (team$visibility) {
                        ...
                        case HIDE_FOR_OTHER_TEAMS -> return team1 == null ? flag : team.isAlliedTo(team1) && (team.canSeeFriendlyInvisibles() || flag);
                        case HIDE_FOR_OWN_TEAM -> return team1 == null ? flag : !team.isAlliedTo(team1) && flag;
                        default -> return true;
                    }
                }
            }
