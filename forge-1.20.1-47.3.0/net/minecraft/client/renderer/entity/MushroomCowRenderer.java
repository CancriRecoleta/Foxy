...
public class MushroomCowRenderer extends MobRenderer<MushroomCow, CowModel<MushroomCow>> {
    private static final Map<MushroomCow.MushroomType, ResourceLocation> TEXTURES = (Map)Util.make(Maps.newHashMap(), (p_115516_) -> {
        p_115516_.put(MushroomType.BROWN, new ResourceLocation("textures/entity/cow/brown_mooshroom.png"));
        p_115516_.put(MushroomType.RED, new ResourceLocation("textures/entity/cow/red_mooshroom.png"));
    });
    ...
    public ResourceLocation getTextureLocation(MushroomCow p_115514_) {
        return (ResourceLocation)TEXTURES.get(p_115514_.getVariant());
    }
}
