...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
    ...
    public <E extends Entity> void render(E p_114385_, double p_114386_, double p_114387_, double p_114388_, float p_114389_, float p_114390_, PoseStack p_114391_, MultiBufferSource p_114392_, int p_114393_) {
        ...
        try {
            ...
            if ((Boolean)this.options.entityShadows().get() && this.shouldRenderShadow && entityrenderer.shadowRadius > 0.0F && !p_114385_.isInvisible()) {
            ...
            crashreportcategory1.setDetail("Location", (Object)CrashReportCategory.formatLocation(this.level, p_114386_, p_114387_, p_114388_));
            crashreportcategory1.setDetail("Rotation", (Object)p_114389_);
            crashreportcategory1.setDetail("Delta", (Object)p_114390_);
    ...
    private static void renderHitbox(PoseStack p_114442_, VertexConsumer p_114443_, Entity p_114444_, float p_114445_) {
        ...
        if (p_114444_.isMultipartEntity()) {
            ...
            PartEntity[] var11 = p_114444_.getParts();
        ...
        p_114443_.vertex(matrix4f, (float)(vec3.x * 2.0), (float)((double)p_114444_.getEyeHeight() + vec3.y * 2.0), (float)(vec3.z * 2.0)).color(0, 0, 255, 255).normal(matrix3f, (float)vec3.x, (float)vec3.y, (float)vec3.z).endVertex();
    }
    ...
    public void onResourceManagerReload(ResourceManager p_174004_) {
        ...
        ModLoader.get().postEvent(new EntityRenderersEvent.AddLayers(this.renderers, this.playerRenderers, entityrendererprovider$context));
    }
}
