...
public class BoatRenderer extends EntityRenderer<Boat> {
    ...
    public BoatRenderer(EntityRendererProvider.Context p_234563_, boolean p_234564_) {
        ...
        this.boatResources = (Map)Stream.of(Type.values()).collect(ImmutableMap.toImmutableMap((p_173938_) -> {
            return p_173938_;
        }, (p_247941_) -> {
    ...
    public void render(Boat p_113929_, float p_113930_, float p_113931_, PoseStack p_113932_, MultiBufferSource p_113933_, int p_113934_) {
        ...
        if (!Mth.equal(f2, 0.0F)) {
            p_113932_.mulPose((new Quaternionf()).setAngleAxis(p_113929_.getBubbleAngle(p_113931_) * 0.017453292F, 1.0F, 0.0F, 1.0F));
        }
    ...
    public Pair<ResourceLocation, ListModel<Boat>> getModelWithLocation(Boat boat) {
        return (Pair)this.boatResources.get(boat.getVariant());
    }
}
