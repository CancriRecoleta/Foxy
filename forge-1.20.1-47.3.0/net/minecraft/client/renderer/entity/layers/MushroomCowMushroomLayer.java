...
public class MushroomCowMushroomLayer<T extends MushroomCow> extends RenderLayer<T, CowModel<T>> {
    ...
    public void render(PoseStack p_117256_, MultiBufferSource p_117257_, int p_117258_, T p_117259_, float p_117260_, float p_117261_, float p_117262_, float p_117263_, float p_117264_, float p_117265_) {
        if (!p_117259_.isBaby()) {
            ...
            boolean $$11 = $$10.shouldEntityAppearGlowing(p_117259_) && p_117259_.isInvisible();
            if (!p_117259_.isInvisible() || $$11) {
                BlockState $$12 = p_117259_.getVariant().getBlockState();
                int $$13 = LivingEntityRenderer.getOverlayCoords(p_117259_, 0.0F);
                ...
                this.renderMushroomBlock(p_117256_, p_117257_, p_117258_, $$11, $$12, $$13, $$14);
                p_117256_.popPose();
                p_117256_.pushPose();
                p_117256_.translate(0.2F, -0.35F, 0.5F);
                ...
                p_117256_.popPose();
                p_117256_.pushPose();
                ((CowModel)this.getParentModel()).getHead().translateAndRotate(p_117256_);
