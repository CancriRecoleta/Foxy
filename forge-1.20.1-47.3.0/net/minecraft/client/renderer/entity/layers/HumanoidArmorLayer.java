...
public class HumanoidArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T, M> {
        ...
        if ($$9 instanceof ArmorItem armoritem) {
            if (armoritem.getEquipmentSlot() == p_117122_) {
                ...
                if (armoritem instanceof DyeableLeatherItem) {
                    ...
                    this.renderModel(p_117119_, p_117120_, p_117123_, armoritem, model, flag, f, f1, f2, this.getArmorResource(p_117121_, itemstack, p_117122_, (String)null));
                    ...
                    this.renderModel(p_117119_, p_117120_, p_117123_, armoritem, model, flag, 1.0F, 1.0F, 1.0F, this.getArmorResource(p_117121_, itemstack, p_117122_, (String)null));
                }
    ...
    private void renderModel(PoseStack p_289664_, MultiBufferSource p_289689_, int p_289681_, ArmorItem p_289650_, A p_289658_, boolean p_289668_, float p_289678_, float p_289674_, float p_289693_, @Nullable String p_289682_) {
        this.renderModel(p_289664_, p_289689_, p_289681_, p_289650_, (Model)p_289658_, p_289668_, p_289678_, p_289674_, p_289693_, (ResourceLocation)this.getArmorLocation(p_289650_, p_289668_, p_289682_));
    }
