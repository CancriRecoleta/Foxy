...
public class IronGolemCrackinessLayer extends RenderLayer<IronGolem, IronGolemModel<IronGolem>> {
    ...
    public void render(PoseStack p_117148_, MultiBufferSource p_117149_, int p_117150_, IronGolem p_117151_, float p_117152_, float p_117153_, float p_117154_, float p_117155_, float p_117156_, float p_117157_) {
        if (!p_117151_.isInvisible()) {
            IronGolem.Crackiness $$10 = p_117151_.getCrackiness();
            if ($$10 != Crackiness.NONE) {
                ResourceLocation $$11 = (ResourceLocation)resourceLocations.get($$10);
                renderColoredCutoutModel(this.getParentModel(), $$11, p_117148_, p_117149_, p_117150_, p_117151_, 1.0F, 1.0F, 1.0F);
            }
        }
    }

    static {
        resourceLocations = ImmutableMap.of(Crackiness.LOW, new ResourceLocation("textures/entity/iron_golem/iron_golem_crackiness_low.png"), Crackiness.MEDIUM, new ResourceLocation("textures/entity/iron_golem/iron_golem_crackiness_medium.png"), Crackiness.HIGH, new ResourceLocation("textures/entity/iron_golem/iron_golem_crackiness_high.png"));
    }
}
