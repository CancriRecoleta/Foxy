...
public class CatCollarLayer extends RenderLayer<Cat, CatModel<Cat>> {
    ...
    public void render(PoseStack p_116666_, MultiBufferSource p_116667_, int p_116668_, Cat p_116669_, float p_116670_, float p_116671_, float p_116672_, float p_116673_, float p_116674_, float p_116675_) {
        if (p_116669_.isTame()) {
            float[] $$10 = p_116669_.getCollarColor().getTextureDiffuseColors();
            coloredCutoutModelCopyLayerRender(this.getParentModel(), this.catModel, CAT_COLLAR_LOCATION, p_116666_, p_116667_, p_116668_, p_116669_, p_116670_, p_116671_, p_116673_, p_116674_, p_116675_, p_116672_, $$10[0], $$10[1], $$10[2]);
        }
    }
}
