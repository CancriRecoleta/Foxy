...
public class SoundEngine {
    ...
    public SoundEngine(SoundManager p_120236_, Options p_120237_, ResourceProvider p_249332_) {
        ...
        this.devicePoolState = new AtomicReference(net.minecraft.client.sounds.SoundEngine.DeviceCheckState.NO_CHANGE);
        ...
        ModLoader.get().postEvent(new SoundEngineLoadEvent(this));
    }
    ...
    private synchronized void loadLibrary() {
        if (!this.loaded) {
            try {
                ...
                this.library.init("".equals(s) ? null : s, (Boolean)this.options.directionalAudio().get());
                this.listener.reset();
    ...
    public void stop(SoundInstance p_120275_) {
        if (this.loaded) {
            ChannelAccess.ChannelHandle channelaccess$channelhandle = (ChannelAccess.ChannelHandle)this.instanceToChannel.get(p_120275_);
    ...
    private boolean shouldChangeDevice() {
        if (this.library.isCurrentDeviceDisconnected()) {
            ...
            if (flag) {
                ...
                if (this.devicePoolState.compareAndSet(net.minecraft.client.sounds.SoundEngine.DeviceCheckState.NO_CHANGE, net.minecraft.client.sounds.SoundEngine.DeviceCheckState.ONGOING)) {
                    String s = (String)this.options.soundDevice().get();
                    Util.ioPool().execute(() -> {
                        if ("".equals(s)) {
                            if (this.library.hasDefaultDeviceChanged()) {
                                LOGGER.info("System default audio device has changed!");
                                this.devicePoolState.compareAndSet(net.minecraft.client.sounds.SoundEngine.DeviceCheckState.ONGOING, net.minecraft.client.sounds.SoundEngine.DeviceCheckState.CHANGE_DETECTED);
                            }
                        ...
                        this.devicePoolState.compareAndSet(net.minecraft.client.sounds.SoundEngine.DeviceCheckState.ONGOING, net.minecraft.client.sounds.SoundEngine.DeviceCheckState.NO_CHANGE);
                    });
                }
            }

            return this.devicePoolState.compareAndSet(net.minecraft.client.sounds.SoundEngine.DeviceCheckState.CHANGE_DETECTED, net.minecraft.client.sounds.SoundEngine.DeviceCheckState.NO_CHANGE);
        }
    }
    ...
    private void tickNonPaused() {
        ...
        while(iterator.hasNext()) {
            ...
            if (tickablesoundinstance.isStopped()) {
                ...
                ChannelAccess.ChannelHandle channelaccess$channelhandle = (ChannelAccess.ChannelHandle)this.instanceToChannel.get(tickablesoundinstance);
                if (channelaccess$channelhandle != null) {
        ...
        while(iterator.hasNext()) {
            ...
            ChannelAccess.ChannelHandle channelaccess$channelhandle1 = (ChannelAccess.ChannelHandle)entry.getValue();
        ...
        while(iterator1.hasNext()) {
            Map.Entry<SoundInstance, Integer> entry1 = (Map.Entry)iterator1.next();
            if (this.tickCount >= (Integer)entry1.getValue()) {
                soundinstance = (SoundInstance)entry1.getKey();
                if (soundinstance instanceof TickableSoundInstance) {
    ...
    public boolean isActive(SoundInstance p_120306_) {
        if (!this.loaded) {
            ...
            return this.soundDeleteTime.containsKey(p_120306_) && (Integer)this.soundDeleteTime.get(p_120306_) <= this.tickCount ? true : this.instanceToChannel.containsKey(p_120306_);
        }
    }

    public void play(SoundInstance p_120313_) {
        if (this.loaded) {
            p_120313_ = ForgeHooksClient.playSound(this, p_120313_);
                        ...
                        if (sound == SoundManager.EMPTY_SOUND) {
                            ...
                            if (f2 == 0.0F && !p_120313_.canStartSilent()) {
                                ...
                                if (!this.listeners.isEmpty()) {
                                    flag2 = flag || soundinstance$attenuation == Attenuation.NONE || this.listener.getListenerPosition().distanceToSqr(vec3) < (double)(f1 * f1);
                                    if (flag2) {
                                ...
                                if (this.listener.getGain() <= 0.0F) {
                                    ...
                                    flag2 = shouldLoopAutomatically(p_120313_);
                                    boolean flag3 = sound.shouldStream();
                                    CompletableFuture<ChannelAccess.ChannelHandle> completablefuture = this.channelAccess.createHandle(sound.shouldStream() ? Pool.STREAMING : Pool.STATIC);
                                    ...
                                    if (channelaccess$channelhandle == null) {
                                        ...
                                        channelaccess$channelhandle.execute((p_194488_) -> {
                                            ...
                                            if (soundinstance$attenuation == Attenuation.LINEAR) {
                                        ...
                                        if (!flag3) {
                                            this.soundBuffers.getCompleteBuffer(sound.getPath()).thenAccept((p_194501_) -> {
                                                channelaccess$channelhandle.execute((p_194495_) -> {
                                                    ...
                                                    p_194495_.play();
                                                    MinecraftForge.EVENT_BUS.post(new PlaySoundSourceEvent(this, soundinstance, p_194495_));
                                                });
                                            });
                                        } else {
                                            soundinstance.getStream(this.soundBuffers, sound, flag2).thenAccept((p_194504_) -> {
                                                channelaccess$channelhandle.execute((p_194498_) -> {
                                                    ...
                                                    p_194498_.play();
                                                    MinecraftForge.EVENT_BUS.post(new PlayStreamingSourceEvent(this, soundinstance, p_194498_));
                                                });
                                            });
                                        }
    ...
    public void stop(@Nullable ResourceLocation p_120300_, @Nullable SoundSource p_120301_) {
        Iterator var3;
        SoundInstance soundinstance1;
        if (p_120301_ != null) {
            var3 = this.instanceBySource.get(p_120301_).iterator();
            ...
            while(true) {
                do {
                    ...
                    soundinstance1 = (SoundInstance)var3.next();
                } while(p_120300_ != null && !soundinstance1.getLocation().equals(p_120300_));
