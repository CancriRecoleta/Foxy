...
public class Main {
    ...
    public static void main(String[] p_129642_) {
        ...
        OptionSpec<File> optionspec5 = optionparser.accepts("gameDir").withRequiredArg().ofType(File.class).defaultsTo(new File("."), new File[0]);
        ...
        OptionSpec<String> optionspec12 = optionparser.accepts("username").withRequiredArg().defaultsTo("Player" + Util.getMillis() % 1000L, new String[0]);
        OptionSpec<String> optionspec13 = optionparser.accepts("uuid").withRequiredArg();
        OptionSpec<String> optionspec14 = optionparser.accepts("xuid").withOptionalArg().defaultsTo("", new String[0]);
        OptionSpec<String> optionspec15 = optionparser.accepts("clientId").withOptionalArg().defaultsTo("", new String[0]);
        ...
        OptionSpec<Integer> optionspec18 = optionparser.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo(854, new Integer[0]);
        OptionSpec<Integer> optionspec19 = optionparser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(480, new Integer[0]);
        ...
        OptionSpec<String> optionspec22 = optionparser.accepts("userProperties").withRequiredArg().defaultsTo("{}", new String[0]);
        OptionSpec<String> optionspec23 = optionparser.accepts("profileProperties").withRequiredArg().defaultsTo("{}", new String[0]);
        OptionSpec<String> optionspec24 = optionparser.accepts("assetIndex").withRequiredArg();
        OptionSpec<String> optionspec25 = optionparser.accepts("userType").withRequiredArg().defaultsTo(Type.LEGACY.getName(), new String[0]);
        OptionSpec<String> optionspec26 = optionparser.accepts("versionType").withRequiredArg().defaultsTo("release", new String[0]);
        ...
        String s = (String)parseArgument(optionset, optionspec8);
        Proxy proxy = Proxy.NO_PROXY;
        if (s != null) {
            try {
                proxy = new Proxy(java.net.Proxy.Type.SOCKS, new InetSocketAddress(s, (Integer)parseArgument(optionset, optionspec9)));
            } catch (Exception var83) {
            }
        }

        final String s1 = (String)parseArgument(optionset, optionspec10);
        final String s2 = (String)parseArgument(optionset, optionspec11);
        ...
        int i = (Integer)parseArgument(optionset, optionspec18);
        int j = (Integer)parseArgument(optionset, optionspec19);
        OptionalInt optionalint = ofNullable((Integer)parseArgument(optionset, optionspec20));
        OptionalInt optionalint1 = ofNullable((Integer)parseArgument(optionset, optionspec21));
        ...
        String s3 = (String)parseArgument(optionset, optionspec17);
        Gson gson = (new GsonBuilder()).registerTypeAdapter(PropertyMap.class, new PropertyMap.Serializer()).create();
        PropertyMap propertymap = (PropertyMap)GsonHelper.fromJson(gson, (String)parseArgument(optionset, optionspec22), PropertyMap.class);
        PropertyMap propertymap1 = (PropertyMap)GsonHelper.fromJson(gson, (String)parseArgument(optionset, optionspec23), PropertyMap.class);
        String s4 = (String)parseArgument(optionset, optionspec26);
        File file1 = (File)parseArgument(optionset, optionspec5);
        File file2 = optionset.has(optionspec6) ? (File)parseArgument(optionset, optionspec6) : new File(file1, "assets/");
        File file3 = optionset.has(optionspec7) ? (File)parseArgument(optionset, optionspec7) : new File(file1, "resourcepacks/");
        String s5 = optionset.has(optionspec13) ? (String)optionspec13.value(optionset) : UUIDUtil.createOfflinePlayerUUID((String)optionspec12.value(optionset)).toString();
        String s6 = optionset.has(optionspec24) ? (String)optionspec24.value(optionset) : null;
        String s7 = (String)optionset.valueOf(optionspec14);
        String s8 = (String)optionset.valueOf(optionspec15);
        String s9 = (String)parseArgument(optionset, optionspec1);
        String s10 = (String)parseArgument(optionset, optionspec2);
        String s11 = (String)parseArgument(optionset, optionspec3);
        String s12 = (String)parseArgument(optionset, optionspec4);
        ...
        User.Type user$type = Type.byName(s13);
        if (user$type == null) {
            LOGGER.warn("Unrecognized user type: {}", s13);
        }

        User user = new User((String)optionspec12.value(optionset), s5, (String)optionspec16.value(optionset), emptyStringToEmptyOptional(s7), emptyStringToEmptyOptional(s8), user$type);
        ...
        try {
            ...
            SilentInitException silentinitexception = var81;
            LOGGER.warn("Failed to create window: ", silentinitexception);
            return;
        } catch (Throwable var82) {
            Throwable throwable1 = var82;
        ...
        try {
            ...
            InterruptedException interruptedexception = var78;
