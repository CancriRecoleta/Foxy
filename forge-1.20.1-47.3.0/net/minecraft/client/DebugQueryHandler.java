...
public class DebugQueryHandler {
    ...
    public void queryEntityTag(int p_90703_, Consumer<CompoundTag> p_90704_) {
        int $$2 = this.startTransaction(p_90704_);
        this.connection.send((Packet)(new ServerboundEntityTagQuery($$2, p_90703_)));
    }

    public void queryBlockEntityTag(BlockPos p_90709_, Consumer<CompoundTag> p_90710_) {
        int $$2 = this.startTransaction(p_90710_);
        this.connection.send((Packet)(new ServerboundBlockEntityTagQuery($$2, p_90709_)));
    }
}
