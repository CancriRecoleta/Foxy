...
public class ClientMetricsSamplersProvider implements MetricsSamplerProvider {
    ...
    private void registerStaticSamplers() {
        ...
        this.samplers.add(MetricSampler.create("toUpload", MetricCategory.CHUNK_RENDERING_DISPATCHING, $$0, ChunkRenderDispatcher::getToUpload));
        this.samplers.add(MetricSampler.create("freeBufferCount", MetricCategory.CHUNK_RENDERING_DISPATCHING, $$0, ChunkRenderDispatcher::getFreeBufferCount));
        this.samplers.add(MetricSampler.create("toBatchCount", MetricCategory.CHUNK_RENDERING_DISPATCHING, $$0, ChunkRenderDispatcher::getToBatchCount));
