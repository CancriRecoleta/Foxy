...
public class RabbitModel<T extends Rabbit> extends EntityModel<T> {
    ...
    public void setupAnim(T p_103548_, float p_103549_, float p_103550_, float p_103551_, float p_103552_, float p_103553_) {
        float $$6 = p_103551_ - (float)p_103548_.tickCount;
        this.nose.xRot = p_103553_ * 0.017453292F;
        this.head.xRot = p_103553_ * 0.017453292F;
        this.rightEar.xRot = p_103553_ * 0.017453292F;
        this.leftEar.xRot = p_103553_ * 0.017453292F;
        this.nose.yRot = p_103552_ * 0.017453292F;
        this.head.yRot = p_103552_ * 0.017453292F;
        this.rightEar.yRot = this.nose.yRot - 0.2617994F;
        this.leftEar.yRot = this.nose.yRot + 0.2617994F;
        this.jumpRotation = Mth.sin(p_103548_.getJumpCompletion($$6) * 3.1415927F);
    ...
    public void prepareMobModel(T p_103543_, float p_103544_, float p_103545_, float p_103546_) {
        ...
        this.jumpRotation = Mth.sin(p_103543_.getJumpCompletion(p_103546_) * 3.1415927F);
    }
}
