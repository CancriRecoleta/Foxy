...
public class LayerDefinitions {
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        Boat.Type[] var24 = Type.values();
        int var25 = var24.length;

        for(int var26 = 0; var26 < var25; ++var26) {
            Boat.Type boat$type = var24[var26];
            if (boat$type == Type.BAMBOO) {
        ...
        List<ModelLayerLocation> list = (List)ModelLayers.getKnownLocations().filter((p_171117_) -> {
