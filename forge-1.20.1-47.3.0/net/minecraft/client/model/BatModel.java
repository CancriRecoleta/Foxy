...
public class BatModel extends HierarchicalModel<Bat> {
    ...
    public void setupAnim(Bat p_102200_, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) {
        if (p_102200_.isResting()) {
            this.head.xRot = p_102205_ * 0.017453292F;
            this.head.yRot = 3.1415927F - p_102204_ * 0.017453292F;
            ...
            this.head.xRot = p_102205_ * 0.017453292F;
            this.head.yRot = p_102204_ * 0.017453292F;
            this.head.zRot = 0.0F;
            this.head.setPos(0.0F, 0.0F, 0.0F);
            this.rightWing.setPos(0.0F, 0.0F, 0.0F);
            this.leftWing.setPos(0.0F, 0.0F, 0.0F);
            this.body.xRot = 0.7853982F + Mth.cos(p_102203_ * 0.1F) * 0.15F;
            this.body.yRot = 0.0F;
            this.rightWing.yRot = Mth.cos(p_102203_ * 74.48451F * 0.017453292F) * 3.1415927F * 0.25F;
            this.leftWing.yRot = -this.rightWing.yRot;
