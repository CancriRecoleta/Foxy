...
public class RaftModel extends ListModel<Boat> {
    ...
    protected ImmutableList.Builder<ModelPart> createPartsBuilder(ModelPart p_250773_) {
        ...
        $$1.add(new ModelPart[]{p_250773_.getChild("bottom"), this.leftPaddle, this.rightPaddle});
        return $$1;
    }
    ...
    public static void createChildren(PartDefinition p_250262_) {
        ...
        p_250262_.addOrReplaceChild("right_paddle", CubeListBuilder.create().texOffs(40, 24).addBox(-1.0F, 0.0F, -5.0F, 2.0F, 2.0F, 18.0F).addBox(0.001F, -3.0F, 8.0F, 1.0F, 6.0F, 7.0F), PartPose.offsetAndRotation(3.0F, -4.0F, -9.0F, 0.0F, 3.1415927F, 0.19634955F));
    }
    ...
    private static void animatePaddle(Boat p_250792_, int p_249947_, ModelPart p_248943_, float p_251990_) {
        ...
        if (p_249947_ == 1) {
            p_248943_.yRot = 3.1415927F - p_248943_.yRot;
        }
