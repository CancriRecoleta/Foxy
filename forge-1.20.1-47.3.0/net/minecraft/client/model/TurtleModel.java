...
public class TurtleModel<T extends Turtle> extends QuadrupedModel<T> {
    ...
    public void setupAnim(T p_103994_, float p_103995_, float p_103996_, float p_103997_, float p_103998_, float p_103999_) {
        ...
        this.leftHindLeg.xRot = Mth.cos(p_103995_ * 0.6662F * 0.6F + 3.1415927F) * 0.5F * p_103996_;
        this.rightFrontLeg.zRot = Mth.cos(p_103995_ * 0.6662F * 0.6F + 3.1415927F) * 0.5F * p_103996_;
        ...
        if (!p_103994_.isInWater() && p_103994_.onGround()) {
            float $$6 = p_103994_.isLayingEgg() ? 4.0F : 1.0F;
            float $$7 = p_103994_.isLayingEgg() ? 2.0F : 1.0F;
            float $$8 = 5.0F;
            this.rightFrontLeg.yRot = Mth.cos($$6 * p_103995_ * 5.0F + 3.1415927F) * 8.0F * p_103996_ * $$7;
            this.rightFrontLeg.zRot = 0.0F;
            this.leftFrontLeg.yRot = Mth.cos($$6 * p_103995_ * 5.0F) * 8.0F * p_103996_ * $$7;
            this.leftFrontLeg.zRot = 0.0F;
            this.rightHindLeg.yRot = Mth.cos(p_103995_ * 5.0F + 3.1415927F) * 3.0F * p_103996_;
