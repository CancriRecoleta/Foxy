...
public class HumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
    ...
    public void setupAnim(T p_102866_, float p_102867_, float p_102868_, float p_102869_, float p_102870_, float p_102871_) {
        ...
        this.rightArm.xRot = Mth.cos(p_102867_ * 0.6662F + 3.1415927F) * 2.0F * p_102868_ * 0.5F / f;
        ...
        this.leftLeg.xRot = Mth.cos(p_102867_ * 0.6662F + 3.1415927F) * 1.4F * p_102868_ / f;
        ...
        if (p_102866_.isUsingItem()) {
            flag3 = p_102866_.getUsedItemHand() == InteractionHand.MAIN_HAND;
            if (flag3 == flag2) {
        ...
        if (this.swimAmount > 0.0F) {
            ...
            this.leftLeg.xRot = Mth.lerp(this.swimAmount, this.leftLeg.xRot, 0.3F * Mth.cos(p_102867_ * 0.33333334F + 3.1415927F));
    ...
    protected float rotlerpRad(float p_102836_, float p_102837_, float p_102838_) {
        float f = (p_102838_ - p_102837_) % 6.2831855F;
        if (f < -3.1415927F) {
            f += 6.2831855F;
        }
