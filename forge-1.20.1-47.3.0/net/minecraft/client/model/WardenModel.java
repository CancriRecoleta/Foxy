...
public class WardenModel<T extends Warden> extends HierarchicalModel<T> {
    ...
    private void animateHeadLookTarget(float p_233517_, float p_233518_) {
        this.head.xRot = p_233518_ * 0.017453292F;
        this.head.yRot = p_233517_ * 0.017453292F;
    }
    ...
    private void animateIdlePose(float p_233515_) {
        ...
        var10000.zRot += 0.06F * $$2;
        var10000 = this.head;
        var10000.xRot += 0.06F * $$3;
        var10000 = this.body;
        var10000.zRot += 0.025F * $$3;
        var10000 = this.body;
        var10000.xRot += 0.025F * $$2;
    }
    ...
    private void animateWalk(float p_233539_, float p_233540_) {
        ...
        ModelPart var10000 = this.head;
        var10000.zRot += 0.3F * $$5 * $$2;
        var10000 = this.head;
        var10000.xRot += 1.2F * Mth.cos($$3 + 1.5707964F) * $$6;
        this.body.zRot = 0.1F * $$5 * $$2;
        this.body.xRot = 1.0F * $$4 * $$6;
        this.leftLeg.xRot = 1.0F * $$4 * $$2;
        this.rightLeg.xRot = 1.0F * Mth.cos($$3 + 3.1415927F) * $$2;
    ...
    private void animateTendrils(T p_233527_, float p_233528_, float p_233529_) {
        float $$3 = p_233527_.getTendrilAnimation(p_233529_) * (float)(Math.cos((double)p_233528_ * 2.25) * Math.PI * 0.10000000149011612);
