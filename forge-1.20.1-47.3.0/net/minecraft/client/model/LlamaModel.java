...
public class LlamaModel<T extends AbstractChestedHorse> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation p_170726_) {
        ...
        $$2.addOrReplaceChild("body", CubeListBuilder.create().texOffs(29, 0).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, p_170726_), PartPose.offsetAndRotation(0.0F, 5.0F, 2.0F, 1.5707964F, 0.0F, 0.0F));
        $$2.addOrReplaceChild("right_chest", CubeListBuilder.create().texOffs(45, 28).addBox(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, p_170726_), PartPose.offsetAndRotation(-8.5F, 3.0F, 3.0F, 0.0F, 1.5707964F, 0.0F));
        $$2.addOrReplaceChild("left_chest", CubeListBuilder.create().texOffs(45, 41).addBox(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, p_170726_), PartPose.offsetAndRotation(5.5F, 3.0F, 3.0F, 0.0F, 1.5707964F, 0.0F));
        int $$3 = true;
        int $$4 = true;
        CubeListBuilder $$5 = CubeListBuilder.create().texOffs(29, 29).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, p_170726_);
    ...
    public void setupAnim(T p_103049_, float p_103050_, float p_103051_, float p_103052_, float p_103053_, float p_103054_) {
        this.head.xRot = p_103054_ * 0.017453292F;
        this.head.yRot = p_103053_ * 0.017453292F;
        this.rightHindLeg.xRot = Mth.cos(p_103050_ * 0.6662F) * 1.4F * p_103051_;
        this.leftHindLeg.xRot = Mth.cos(p_103050_ * 0.6662F + 3.1415927F) * 1.4F * p_103051_;
        this.rightFrontLeg.xRot = Mth.cos(p_103050_ * 0.6662F + 3.1415927F) * 1.4F * p_103051_;
        this.leftFrontLeg.xRot = Mth.cos(p_103050_ * 0.6662F) * 1.4F * p_103051_;
        boolean $$6 = !p_103049_.isBaby() && p_103049_.hasChest();
