...
public class ClientChunkCache extends ChunkSource {
    ...
    public ClientChunkCache(ClientLevel p_104414_, int p_104415_) {
        ...
        this.storage = new Storage(calculateStorageRange(p_104415_));
    }
    ...
    final class Storage {
        ...
        protected void replace(int p_104485_, @Nullable LevelChunk p_104486_) {
            LevelChunk levelchunk = (LevelChunk)this.chunks.getAndSet(p_104485_, p_104486_);
            if (levelchunk != null) {
                --this.chunkCount;
        ...
        protected LevelChunk getChunk(int p_104480_) {
            return (LevelChunk)this.chunks.get(p_104480_);
        }
