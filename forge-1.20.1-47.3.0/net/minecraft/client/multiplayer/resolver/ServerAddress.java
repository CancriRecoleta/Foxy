...
public final class ServerAddress {
    ...
    public static ServerAddress parseString(String p_171865_) {
        if (p_171865_ == null) {
            ...
            try {
                HostAndPort $$1 = HostAndPort.fromString(p_171865_).withDefaultPort(25565);
                return $$1.getHost().isEmpty() ? INVALID : new ServerAddress($$1);
            } catch (IllegalArgumentException var2) {
                IllegalArgumentException $$2 = var2;
                LOGGER.info("Failed to parse URL {}", p_171865_, $$2);
                return INVALID;
            }
        }
    }
    ...
    public static boolean isValidAddress(String p_171868_) {
        try {
            HostAndPort $$1 = HostAndPort.fromString(p_171868_);
            String $$2 = $$1.getHost();
            if (!$$2.isEmpty()) {
                IDN.toASCII($$2);
                return true;
