...
public class ChatListener {
    ...
    public void tick() {
        if (this.messageDelay != 0L && Util.getMillis() >= this.previousMessageTime + this.messageDelay) {
            for(Message chatlistener$message = (Message)this.delayedMessageQueue.poll(); chatlistener$message != null && !chatlistener$message.accept(); chatlistener$message = (Message)this.delayedMessageQueue.poll()) {
            }
        }
    ...
    public void handleDisguisedChatMessage(Component p_250375_, ChatType.Bound p_251256_) {
        ...
        this.handleMessage((MessageSignature)null, () -> {
            ...
            Component forgeComponent = ForgeHooksClient.onClientChat(p_251256_, component, Util.NIL_UUID);
    ...
    private boolean showMessageToPlayer(ChatType.Bound p_251766_, PlayerChatMessage p_249430_, Component p_249231_, GameProfile p_249177_, boolean p_251638_, Instant p_249665_) {
        ...
        if (p_251638_ && chattrustlevel.isNotSecure()) {
            ...
            if (filtermask.isEmpty()) {
                component = ForgeHooksClient.onClientPlayerChat(p_251766_, p_249231_, p_249430_, p_249430_.sender());
                if (component == null) {
                    return false;
                }
                ...
                component = filtermask.applyWithFormatting(p_249430_.signedContent());
                if (component != null) {
                    Component forgeComponent = ForgeHooksClient.onClientPlayerChat(p_251766_, p_251766_.decorate(component), p_249430_, p_249430_.sender());
                    if (forgeComponent == null) {
                        return false;
                    }
    ...
    public void handleSystemMessage(Component p_240522_, boolean p_240642_) {
        if (!(Boolean)this.minecraft.options.hideMatchedNames().get() || !this.minecraft.isBlocked(this.guessChatUUID(p_240522_))) {
            p_240522_ = ForgeHooksClient.onClientSystemChat(p_240522_, p_240642_);
            if (p_240522_ == null) {
                return;
            }
