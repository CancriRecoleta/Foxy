...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
    ...
    private Component authenticateServer(String p_104532_) {
        try {
            ...
            AuthenticationException authenticationexception = var7;
    ...
    public void onDisconnect(Component p_104543_) {
        if (this.parent != null && this.parent instanceof RealmsScreen) {
            ...
            this.minecraft.setScreen((Screen)(NetworkHooks.getModMismatchData(this.connection) != null ? new ModMismatchDisconnectedScreen(this.parent, CommonComponents.CONNECT_FAILED, p_104543_, NetworkHooks.getModMismatchData(this.connection)) : new DisconnectedScreen(this.parent, CommonComponents.CONNECT_FAILED, p_104543_)));
        }
    ...
    public void handleCustomQuery(ClientboundCustomQueryPacket p_104545_) {
        if (!NetworkHooks.onCustomPayload(p_104545_, this.connection)) {
