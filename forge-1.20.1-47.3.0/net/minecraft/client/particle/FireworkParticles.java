...
public class FireworkParticles {
    ...
    public static class Starter extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life == 0 && this.explosions != null) {
                flag3 = this.isFarAwayFromCamera();
                boolean flag1 = false;
                if (this.explosions.size() >= 3) {
                    ...
                    for(int i = 0; i < this.explosions.size(); ++i) {
                        CompoundTag compoundtag = this.explosions.getCompound(i);
                        if (Shape.getShape(compoundtag) == Shape.LARGE_BALL) {
                            flag1 = true;
                            break;
                        }
                    }
                ...
                if (flag1) {
                    soundevent1 = flag3 ? SoundEvents.FIREWORK_ROCKET_LARGE_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_LARGE_BLAST;
                } else {
                    soundevent1 = flag3 ? SoundEvents.FIREWORK_ROCKET_BLAST_FAR : SoundEvents.FIREWORK_ROCKET_BLAST;
                }
            ...
            if (this.life % 2 == 0 && this.explosions != null && this.life / 2 < this.explosions.size()) {
                ...
                FireworkRocketItem.Shape fireworkrocketitem$shape = Shape.getShape(compoundtag1);
                ...
                FireworkShapeFactoryRegistry.Factory factory = FireworkShapeFactoryRegistry.get(fireworkrocketitem$shape);
                if (factory != null) {
                    ...
                    switch (fireworkrocketitem$shape) {
                        ...
                        case LARGE_BALL:
                            ...
                            break;
                        case STAR:
                            this.createParticleShape(0.5, new double[][]{{0.0, 1.0}, {0.3455, 0.309}, {0.9511, 0.309}, {0.3795918367346939, -0.12653061224489795}, {0.6122448979591837, -0.8040816326530612}, {0.0, -0.35918367346938773}}, aint, aint1, flag4, flag2, false);
                            break;
                        case CREEPER:
                            this.createParticleShape(0.5, new double[][]{{0.0, 0.2}, {0.2, 0.2}, {0.2, 0.6}, {0.6, 0.6}, {0.6, 0.2}, {0.2, 0.2}, {0.2, 0.0}, {0.4, 0.0}, {0.4, -0.6}, {0.2, -0.6}, {0.2, -0.4}, {0.0, -0.4}}, aint, aint1, flag4, flag2, true);
                            break;
                        case BURST:
        ...
        public void createParticle(double p_106768_, double p_106769_, double p_106770_, double p_106771_, double p_106772_, double p_106773_, int[] p_106774_, int[] p_106775_, boolean p_106776_, boolean p_106777_) {
            SparkParticle fireworkparticles$sparkparticle = (SparkParticle)this.engine.createParticle(ParticleTypes.FIREWORK, p_106768_, p_106769_, p_106770_, p_106771_, p_106772_, p_106773_);
    ...
    public static class SparkProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106744_, ClientLevel p_106745_, double p_106746_, double p_106747_, double p_106748_, double p_106749_, double p_106750_, double p_106751_) {
            SparkParticle fireworkparticles$sparkparticle = new SparkParticle(p_106745_, p_106746_, p_106747_, p_106748_, p_106749_, p_106750_, p_106751_, Minecraft.getInstance().particleEngine, this.sprites);
            fireworkparticles$sparkparticle.setAlpha(0.99F);
    ...
    static class SparkParticle extends SimpleAnimatedParticle {
        ...
        public void tick() {
            ...
            if (this.trail && this.age < this.lifetime / 2 && (this.age + this.lifetime) % 2 == 0) {
                SparkParticle fireworkparticles$sparkparticle = new SparkParticle(this.level, this.x, this.y, this.z, 0.0, 0.0, 0.0, this.engine, this.sprites);
                fireworkparticles$sparkparticle.setAlpha(0.99F);
    ...
    public static class OverlayParticle extends TextureSheetParticle {
        ...
        public float getQuadSize(float p_106693_) {
            return 7.1F * Mth.sin(((float)this.age + p_106693_ - 1.0F) * 0.25F * 3.1415927F);
        }
    }
    ...
    public static class FlashProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106668_, ClientLevel p_106669_, double p_106670_, double p_106671_, double p_106672_, double p_106673_, double p_106674_, double p_106675_) {
            OverlayParticle fireworkparticles$overlayparticle = new OverlayParticle(p_106669_, p_106670_, p_106671_, p_106672_);
