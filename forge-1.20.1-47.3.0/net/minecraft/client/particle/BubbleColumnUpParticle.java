...
public class BubbleColumnUpParticle extends TextureSheetParticle {
    BubbleColumnUpParticle(ClientLevel p_105733_, double p_105734_, double p_105735_, double p_105736_, double p_105737_, double p_105738_, double p_105739_) {
        ...
        this.xd = p_105737_ * 0.20000000298023224 + (Math.random() * 2.0 - 1.0) * 0.019999999552965164;
        this.yd = p_105738_ * 0.20000000298023224 + (Math.random() * 2.0 - 1.0) * 0.019999999552965164;
        this.zd = p_105739_ * 0.20000000298023224 + (Math.random() * 2.0 - 1.0) * 0.019999999552965164;
