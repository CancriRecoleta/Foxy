...
public abstract class Particle {
    ...
    public Particle(ClientLevel p_107239_, double p_107240_, double p_107241_, double p_107242_, double p_107243_, double p_107244_, double p_107245_) {
        ...
        this.xd = p_107243_ + (Math.random() * 2.0 - 1.0) * 0.4000000059604645;
        this.yd = p_107244_ + (Math.random() * 2.0 - 1.0) * 0.4000000059604645;
        this.zd = p_107245_ + (Math.random() * 2.0 - 1.0) * 0.4000000059604645;
        ...
        this.xd = this.xd / d1 * d0 * 0.4000000059604645;
        this.yd = this.yd / d1 * d0 * 0.4000000059604645 + 0.10000000149011612;
        this.zd = this.zd / d1 * d0 * 0.4000000059604645;
    }

    public Particle setPower(float p_107269_) {
        this.xd *= (double)p_107269_;
        this.yd = (this.yd - 0.10000000149011612) * (double)p_107269_ + 0.10000000149011612;
    ...
    public void move(double p_107246_, double p_107247_, double p_107248_) {
        if (!this.stoppedByCollision) {
            ...
            double d1 = p_107247_;
            double d2 = p_107248_;
            if (this.hasPhysics && (p_107246_ != 0.0 || p_107247_ != 0.0 || p_107248_ != 0.0) && p_107246_ * p_107246_ + p_107247_ * p_107247_ + p_107248_ * p_107248_ < MAXIMUM_COLLISION_VELOCITY_SQUARED) {
            ...
            if (Math.abs(d1) >= 9.999999747378752E-6 && Math.abs(p_107247_) < 9.999999747378752E-6) {
