...
public class BreakingItemParticle extends TextureSheetParticle {
    ...
    protected BreakingItemParticle(ClientLevel p_105665_, double p_105666_, double p_105667_, double p_105668_, ItemStack p_105669_) {
        ...
        BakedModel model = Minecraft.getInstance().getItemRenderer().getModel(p_105669_, p_105665_, (LivingEntity)null, 0);
        this.setSprite(model.getOverrides().resolve(model, p_105669_, p_105665_, (LivingEntity)null, 0).getParticleIcon(ModelData.EMPTY));
        this.gravity = 1.0F;
        this.quadSize /= 2.0F;
