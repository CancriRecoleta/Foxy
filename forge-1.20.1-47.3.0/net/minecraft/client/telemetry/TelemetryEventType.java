...
public class TelemetryEventType {
    ...
    public static Builder builder(String p_261734_, String p_261807_) {
        return new Builder(p_261734_, p_261807_);
    }
    ...
    public TelemetryEvent export(TelemetrySession p_262179_, TelemetryPropertyMap p_262018_) {
        TelemetryEvent $$2 = p_262179_.createNewEvent(this.exportKey);
        Iterator var4 = this.properties.iterator();

        while(var4.hasNext()) {
            TelemetryProperty<?> $$3 = (TelemetryProperty)var4.next();
            $$3.export(p_262018_, $$2);
        }
    ...
    static {
        CODEC = Codec.STRING.comapFlatMap((p_274719_) -> {
            TelemetryEventType $$1 = (TelemetryEventType)REGISTRY.get(p_274719_);
    ...
    public static class Builder {
        ...
        public Builder defineAll(List<TelemetryProperty<?>> p_261497_) {
            this.properties.addAll(p_261497_);
            return this;
        }

        public <T> Builder define(TelemetryProperty<T> p_261756_) {
