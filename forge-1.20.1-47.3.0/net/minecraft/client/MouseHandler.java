...
public class MouseHandler {
    ...
    private void onPress(long p_91531_, int p_91532_, int p_91533_, int p_91534_) {
        if (p_91531_ == this.minecraft.getWindow().getWindow()) {
            ...
            if (ForgeHooksClient.onMouseButtonPre(p_91532_, p_91533_, p_91534_)) {
                return;
            }
                ...
                if (this.minecraft.screen == null) {
                    ...
                    if (flag) {
                        ...
                        Screen.wrapScreenError(() -> {
                            aboolean[0] = ForgeHooksClient.onScreenMouseClickedPre(screen, d0, d1, i);
                            if (!aboolean[0]) {
                                aboolean[0] = this.minecraft.screen.mouseClicked(d0, d1, i);
                                aboolean[0] = ForgeHooksClient.onScreenMouseClickedPost(screen, d0, d1, i, aboolean[0]);
                            }

                        }, "mouseClicked event handler", screen.getClass().getCanonicalName());
                    } else {
                        Screen.wrapScreenError(() -> {
                            aboolean[0] = ForgeHooksClient.onScreenMouseReleasedPre(screen, d0, d1, i);
                            if (!aboolean[0]) {
                                aboolean[0] = this.minecraft.screen.mouseReleased(d0, d1, i);
                                aboolean[0] = ForgeHooksClient.onScreenMouseReleasedPost(screen, d0, d1, i, aboolean[0]);
                            }
    ...
    private void onScroll(long p_91527_, double p_91528_, double p_91529_) {
        if (p_91527_ == Minecraft.getInstance().getWindow().getWindow()) {
            ...
            if (Minecraft.ON_OSX && p_91529_ == 0.0) {
                offset = p_91528_;
            }

            double d0 = ((Boolean)this.minecraft.options.discreteMouseScroll().get() ? Math.signum(offset) : offset) * (Double)this.minecraft.options.mouseWheelSensitivity().get();
            if (this.minecraft.getOverlay() == null) {
                if (this.minecraft.screen != null) {
                    ...
                    if (ForgeHooksClient.onScreenMouseScrollPre(this, this.minecraft.screen, d0)) {
                        return;
                    }
                    ...
                    ForgeHooksClient.onScreenMouseScrollPost(this, this.minecraft.screen, d0);
        ...
        if (p_91562_ == Minecraft.getInstance().getWindow().getWindow()) {
            ...
            if (screen != null && this.minecraft.getOverlay() == null) {
                ...
                if (this.activeButton != -1 && this.mousePressedTime > 0.0) {
                    ...
                    Screen.wrapScreenError(() -> {
                        if (!ForgeHooksClient.onScreenMouseDragPre(screen, d0, d1, this.activeButton, d2, d3)) {
                            if (!screen.mouseDragged(d0, d1, this.activeButton, d2, d3)) {
                                ForgeHooksClient.onScreenMouseDragPost(screen, d0, d1, this.activeButton, d2, d3);
                            }
                        }
