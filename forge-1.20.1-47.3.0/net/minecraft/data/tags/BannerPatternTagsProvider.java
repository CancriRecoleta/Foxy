...
public class BannerPatternTagsProvider extends TagsProvider<BannerPattern> {
    ...
    public BannerPatternTagsProvider(PackOutput p_256451_, CompletableFuture<HolderLookup.Provider> p_256420_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
