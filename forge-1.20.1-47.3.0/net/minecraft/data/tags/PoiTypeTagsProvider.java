...
public class PoiTypeTagsProvider extends TagsProvider<PoiType> {
    ...
    public PoiTypeTagsProvider(PackOutput p_256012_, CompletableFuture<HolderLookup.Provider> p_256617_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
