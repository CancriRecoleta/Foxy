...
public class DamageTypeTagsProvider extends TagsProvider<DamageType> {
    ...
    public DamageTypeTagsProvider(PackOutput p_270719_, CompletableFuture<HolderLookup.Provider> p_270256_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
