...
public class GameEventTagsProvider extends IntrinsicHolderTagsProvider<GameEvent> {
    ...
    public GameEventTagsProvider(PackOutput p_256060_, CompletableFuture<HolderLookup.Provider> p_255621_) {
        this(p_256060_, p_255621_, "vanilla", (ExistingFileHelper)null);
    }

    public GameEventTagsProvider(PackOutput p_256060_, CompletableFuture<HolderLookup.Provider> p_255621_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
