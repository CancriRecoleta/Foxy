...
public class StructureTagsProvider extends TagsProvider<Structure> {
    ...
    public StructureTagsProvider(PackOutput p_256522_, CompletableFuture<HolderLookup.Provider> p_256661_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
