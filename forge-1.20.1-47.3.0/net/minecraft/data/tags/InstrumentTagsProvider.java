...
public class InstrumentTagsProvider extends TagsProvider<Instrument> {
    ...
    public InstrumentTagsProvider(PackOutput p_256418_, CompletableFuture<HolderLookup.Provider> p_256038_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
