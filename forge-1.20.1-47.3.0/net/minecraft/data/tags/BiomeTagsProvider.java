...
public class BiomeTagsProvider extends TagsProvider<Biome> {
    ...
    public BiomeTagsProvider(PackOutput p_255800_, CompletableFuture<HolderLookup.Provider> p_256205_, String modId, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.Provider p_256485_) {
        ...
        Stream var10000 = Preset.NETHER.usedBiomes();
        Objects.requireNonNull(tagappender);
        var10000.forEach(tagappender::add);
        TagsProvider.TagAppender<Biome> tagappender1 = this.tag(BiomeTags.IS_OVERWORLD);
        var10000 = Preset.OVERWORLD.usedBiomes();
        Objects.requireNonNull(tagappender1);
        var10000.forEach(tagappender1::add);
