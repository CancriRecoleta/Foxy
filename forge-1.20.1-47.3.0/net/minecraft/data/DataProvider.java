...
public interface DataProvider {
    ToIntFunction<String> FIXED_ORDER_FIELDS = (ToIntFunction)Util.make(new Object2IntOpenHashMap(), (p_236070_) -> {
        ...
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                try {
                    ...
                    $$5.setIndent("  ");
                    GsonHelper.writeValue($$5, p_254542_, KEY_COMPARATOR);
                ...
                $$5.close();
                p_253653_.writeIfNeeded(p_254467_, $$3.toByteArray(), $$4.hash());
            } catch (IOException var10) {
                IOException $$6 = var10;
                LOGGER.error("Failed to save file to {}", p_254467_, $$6);
            }
