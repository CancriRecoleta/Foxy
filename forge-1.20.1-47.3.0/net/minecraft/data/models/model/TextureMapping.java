...
public class TextureMapping {
    ...
    public TextureMapping copySlot(TextureSlot p_176478_, TextureSlot p_176479_) {
        this.slots.put(p_176479_, (ResourceLocation)this.slots.get(p_176478_));
        return this;
    }

    public TextureMapping copyForced(TextureSlot p_125774_, TextureSlot p_125775_) {
        this.slots.put(p_125775_, (ResourceLocation)this.slots.get(p_125774_));
        this.forcedSlots.add(p_125775_);
        return this;
    }

    public ResourceLocation get(TextureSlot p_125757_) {
        for(TextureSlot $$1 = p_125757_; $$1 != null; $$1 = $$1.getParent()) {
    ...
    public TextureMapping copyAndUpdate(TextureSlot p_125786_, ResourceLocation p_125787_) {
        ...
        $$2.put(p_125786_, p_125787_);
        return $$2;
    }

    public static TextureMapping cube(Block p_125749_) {
        ResourceLocation $$1 = getBlockTexture(p_125749_);
        return cube($$1);
    }

    public static TextureMapping defaultTexture(Block p_125769_) {
        ResourceLocation $$1 = getBlockTexture(p_125769_);
    ...
    public static TextureMapping cubeBottomTopWithWall(Block p_125829_) {
        ResourceLocation $$1 = getBlockTexture(p_125829_);
        return (new TextureMapping()).put(TextureSlot.WALL, $$1).put(TextureSlot.SIDE, $$1).put(TextureSlot.TOP, getBlockTexture(p_125829_, "_top")).put(TextureSlot.BOTTOM, getBlockTexture(p_125829_, "_bottom"));
    }

    public static TextureMapping columnWithWall(Block p_125831_) {
        ResourceLocation $$1 = getBlockTexture(p_125831_);
        return (new TextureMapping()).put(TextureSlot.TEXTURE, $$1).put(TextureSlot.WALL, $$1).put(TextureSlot.SIDE, $$1).put(TextureSlot.END, getBlockTexture(p_125831_, "_top"));
    }
    ...
    public static TextureMapping sculkShrieker(boolean p_236351_) {
        String $$1 = p_236351_ ? "_can_summon" : "";
