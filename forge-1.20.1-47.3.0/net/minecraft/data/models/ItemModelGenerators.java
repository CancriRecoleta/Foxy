...
public class ItemModelGenerators {
    ...
    private void generateCompassItem(Item p_236322_) {
        for(int $$1 = 0; $$1 < 32; ++$$1) {
            if ($$1 != 16) {
                this.generateFlatItem(p_236322_, String.format(Locale.ROOT, "_%02d", $$1), ModelTemplates.FLAT_ITEM);
            }
        }
    ...
    private void generateClockItem(Item p_236324_) {
        for(int $$1 = 1; $$1 < 64; ++$$1) {
            this.generateFlatItem(p_236324_, String.format(Locale.ROOT, "_%02d", $$1), ModelTemplates.FLAT_ITEM);
        }
    ...
    private JsonObject generateBaseArmorTrimTemplate(ResourceLocation p_266939_, Map<TextureSlot, ResourceLocation> p_267324_, ArmorMaterial p_267970_) {
        JsonObject $$3 = ModelTemplates.TWO_LAYERED_ITEM.createBaseTemplate(p_266939_, p_267324_);
        JsonArray $$4 = new JsonArray();
        Iterator var6 = GENERATED_TRIM_MODELS.iterator();

        while(var6.hasNext()) {
            TrimModelData $$5 = (TrimModelData)var6.next();
            JsonObject $$6 = new JsonObject();
            JsonObject $$7 = new JsonObject();
            $$7.addProperty(TRIM_TYPE_PREDICATE_ID.getPath(), $$5.itemModelIndex());
            $$6.add("predicate", $$7);
            $$6.addProperty("model", this.getItemModelForTrimMaterial(p_266939_, $$5.name(p_267970_)).toString());
            $$4.add($$6);
        }
    ...
    private void generateArmorTrims(ArmorItem p_267151_) {
        ResourceLocation $$1 = ModelLocationUtils.getModelLocation((Item)p_267151_);
        ResourceLocation $$2 = TextureMapping.getItemTexture(p_267151_);
        ResourceLocation $$3 = TextureMapping.getItemTexture(p_267151_, "_overlay");
        if (p_267151_.getMaterial() == ArmorMaterials.LEATHER) {
            ModelTemplates.TWO_LAYERED_ITEM.create($$1, TextureMapping.layered($$2, $$3), this.output, (p_267902_, p_267903_) -> {
                return this.generateBaseArmorTrimTemplate(p_267902_, p_267903_, p_267151_.getMaterial());
            });
        } else {
            ModelTemplates.FLAT_ITEM.create($$1, TextureMapping.layer0($$2), this.output, (p_267905_, p_267906_) -> {
        ...
        while(var5.hasNext()) {
            TrimModelData $$4 = (TrimModelData)var5.next();
            String $$5 = $$4.name(p_267151_.getMaterial());
            ResourceLocation $$6 = this.getItemModelForTrimMaterial($$1, $$5);
            String var10000 = p_267151_.getType().getName();
            String $$7 = var10000 + "_trim_" + $$5;
    ...
    private static record TrimModelData(String name, float itemModelIndex, Map<ArmorMaterial, String> overrideArmorMaterials) {
        TrimModelData(String name, float itemModelIndex, Map<ArmorMaterial, String> overrideArmorMaterials) {
            this.name = name;
