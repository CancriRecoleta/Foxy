...
public final class Selector {
    ...
    public Selector extend(Property.Value<?> p_125487_) {
        return new Selector(ImmutableList.builder().addAll(this.values).add(p_125487_).build());
    }

    public Selector extend(Selector p_125489_) {
        return new Selector(ImmutableList.builder().addAll(this.values).addAll(p_125489_.values).build());
    }
