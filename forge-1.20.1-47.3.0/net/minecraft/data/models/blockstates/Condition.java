...
public interface Condition extends Supplier<JsonElement> {
    ...
    static Condition and(Condition... p_176294_) {
        return new CompositeCondition(net.minecraft.data.models.blockstates.Condition.Operation.AND, Arrays.asList(p_176294_));
    }

    static Condition or(Condition... p_125138_) {
        return new CompositeCondition(net.minecraft.data.models.blockstates.Condition.Operation.OR, Arrays.asList(p_125138_));
    }
    ...
    public static class TerminalCondition implements Condition {
        ...
        private static <T extends Comparable<T>> String joinValues(Property<T> p_125187_, Stream<T> p_125188_) {
            Objects.requireNonNull(p_125187_);
            return (String)p_125188_.map(p_125187_::getName).collect(Collectors.joining("|"));
        }
        ...
        private <T extends Comparable<T>> void putValue(Property<T> p_125184_, String p_125185_) {
            String $$2 = (String)this.terms.put(p_125184_, p_125185_);
            if ($$2 != null) {
                throw new IllegalStateException("Tried to replace " + p_125184_ + " value from " + $$2 + " to " + p_125185_);
            }
        }

        public final <T extends Comparable<T>> TerminalCondition term(Property<T> p_125177_, T p_125178_) {
            this.putValue(p_125177_, p_125177_.getName(p_125178_));
            return this;
        }

        @SafeVarargs
        public final <T extends Comparable<T>> TerminalCondition term(Property<T> p_125180_, T p_125181_, T... p_125182_) {
            this.putValue(p_125180_, getTerm(p_125180_, p_125181_, p_125182_));
            return this;
        }

        public final <T extends Comparable<T>> TerminalCondition negatedTerm(Property<T> p_176297_, T p_176298_) {
            String var10002 = p_176297_.getName(p_176298_);
            this.putValue(p_176297_, "!" + var10002);
            return this;
        }

        @SafeVarargs
        public final <T extends Comparable<T>> TerminalCondition negatedTerm(Property<T> p_176300_, T p_176301_, T... p_176302_) {
            String var10002 = getTerm(p_176300_, p_176301_, p_176302_);
            this.putValue(p_176300_, "!" + var10002);
            return this;
        }
        ...
        public JsonElement get() {
            ...
            this.terms.forEach((p_125191_, p_125192_) -> {
                $$0.addProperty(p_125191_.getName(), p_125192_);
            });
            return $$0;
        }

        public void validate(StateDefinition<?, ?> p_125172_) {
            List<Property<?>> $$1 = (List)this.terms.keySet().stream().filter((p_125175_) -> {
