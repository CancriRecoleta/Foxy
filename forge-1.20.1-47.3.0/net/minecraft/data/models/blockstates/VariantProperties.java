...
public class VariantProperties {
    public static final VariantProperty<Rotation> X_ROT = new VariantProperty("x", (p_125529_) -> {
        return new JsonPrimitive(p_125529_.value);
    });
    public static final VariantProperty<Rotation> Y_ROT = new VariantProperty("y", (p_125525_) -> {
