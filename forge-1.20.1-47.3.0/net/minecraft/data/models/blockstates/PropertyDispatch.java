...
public abstract class PropertyDispatch {
    ...
    protected void putValue(Selector p_125320_, List<Variant> p_125321_) {
        List<Variant> $$2 = (List)this.values.put(p_125320_, p_125321_);
        if ($$2 != null) {
    ...
    private void verifyComplete() {
        ...
        Property $$2;
        for(Iterator var3 = $$0.iterator(); var3.hasNext(); $$1 = $$1.flatMap((p_125316_) -> {
            Stream var10000 = $$2.getAllValues();
            Objects.requireNonNull(p_125316_);
            return var10000.map(p_125316_::extend);
        })) {
            $$2 = (Property)var3.next();
        }

        List<Selector> $$3 = (List)$$1.filter((p_125318_) -> {
    ...
    public static <T1 extends Comparable<T1>> C1<T1> property(Property<T1> p_125295_) {
        return new C1(p_125295_);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>> C2<T1, T2> properties(Property<T1> p_125297_, Property<T2> p_125298_) {
        return new C2(p_125297_, p_125298_);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> C3<T1, T2, T3> properties(Property<T1> p_125300_, Property<T2> p_125301_, Property<T3> p_125302_) {
        return new C3(p_125300_, p_125301_, p_125302_);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> C4<T1, T2, T3, T4> properties(Property<T1> p_125304_, Property<T2> p_125305_, Property<T3> p_125306_, Property<T4> p_125307_) {
        return new C4(p_125304_, p_125305_, p_125306_, p_125307_);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> C5<T1, T2, T3, T4, T5> properties(Property<T1> p_125309_, Property<T2> p_125310_, Property<T3> p_125311_, Property<T4> p_125312_, Property<T5> p_125313_) {
        return new C5(p_125309_, p_125310_, p_125311_, p_125312_, p_125313_);
    }
    ...
    public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
        ...
        public C1<T1> select(T1 p_125333_, List<Variant> p_125334_) {
            Selector $$2 = Selector.of(this.property1.value(p_125333_));
            this.putValue($$2, p_125334_);
            return this;
        }

        public C1<T1> select(T1 p_125330_, Variant p_125331_) {
        ...
        public PropertyDispatch generate(Function<T1, Variant> p_125336_) {
            this.property1.getPossibleValues().forEach((p_125340_) -> {
                this.select(p_125340_, (Variant)p_125336_.apply(p_125340_));
            });
            return this;
        }
        ...
        public PropertyDispatch generateList(Function<T1, List<Variant>> p_176314_) {
            this.property1.getPossibleValues().forEach((p_176312_) -> {
                this.select(p_176312_, (List)p_176314_.apply(p_176312_));
            });
            return this;
        }
    }
    ...
    public static class C2<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch {
        ...
        public C2<T1, T2> select(T1 p_125355_, T2 p_125356_, List<Variant> p_125357_) {
            Selector $$3 = Selector.of(this.property1.value(p_125355_), this.property2.value(p_125356_));
            this.putValue($$3, p_125357_);
            return this;
        }

        public C2<T1, T2> select(T1 p_125351_, T2 p_125352_, Variant p_125353_) {
        ...
        public PropertyDispatch generate(BiFunction<T1, T2, Variant> p_125363_) {
            this.property1.getPossibleValues().forEach((p_125376_) -> {
                this.property2.getPossibleValues().forEach((p_176322_) -> {
                    this.select(p_125376_, p_176322_, (Variant)p_125363_.apply(p_125376_, p_176322_));
                });
            });
            return this;
        }
        ...
        public PropertyDispatch generateList(BiFunction<T1, T2, List<Variant>> p_125373_) {
            this.property1.getPossibleValues().forEach((p_125366_) -> {
                this.property2.getPossibleValues().forEach((p_176318_) -> {
                    this.select(p_125366_, p_176318_, (List)p_125373_.apply(p_125366_, p_176318_));
                });
            });
            return this;
        }
    ...
    public static class C3<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends PropertyDispatch {
        ...
        public C3<T1, T2, T3> select(T1 p_125397_, T2 p_125398_, T3 p_125399_, List<Variant> p_125400_) {
            Selector $$4 = Selector.of(this.property1.value(p_125397_), this.property2.value(p_125398_), this.property3.value(p_125399_));
            this.putValue($$4, p_125400_);
            return this;
        }

        public C3<T1, T2, T3> select(T1 p_125392_, T2 p_125393_, T3 p_125394_, Variant p_125395_) {
            return this.select(p_125392_, p_125393_, p_125394_, Collections.singletonList(p_125395_));
        }

        public PropertyDispatch generate(TriFunction<T1, T2, T3, Variant> p_125390_) {
            this.property1.getPossibleValues().forEach((p_125404_) -> {
                this.property2.getPossibleValues().forEach((p_176343_) -> {
                    this.property3.getPossibleValues().forEach((p_176339_) -> {
                        this.select(p_125404_, p_176343_, p_176339_, (Variant)p_125390_.apply(p_125404_, p_176343_, p_176339_));
                    });
                });
            });
            return this;
        ...
        public PropertyDispatch generateList(TriFunction<T1, T2, T3, List<Variant>> p_176345_) {
            this.property1.getPossibleValues().forEach((p_176334_) -> {
                this.property2.getPossibleValues().forEach((p_176331_) -> {
                    this.property3.getPossibleValues().forEach((p_176327_) -> {
                        this.select(p_176334_, p_176331_, p_176327_, (List)p_176345_.apply(p_176334_, p_176331_, p_176327_));
                    });
                });
            });
            return this;
    ...
    public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
        ...
        public C4<T1, T2, T3, T4> select(T1 p_125436_, T2 p_125437_, T3 p_125438_, T4 p_125439_, List<Variant> p_125440_) {
            Selector $$5 = Selector.of(this.property1.value(p_125436_), this.property2.value(p_125437_), this.property3.value(p_125438_), this.property4.value(p_125439_));
            this.putValue($$5, p_125440_);
            return this;
        }

        public C4<T1, T2, T3, T4> select(T1 p_125430_, T2 p_125431_, T3 p_125432_, T4 p_125433_, Variant p_125434_) {
            return this.select(p_125430_, p_125431_, p_125432_, p_125433_, Collections.singletonList(p_125434_));
        }

        public PropertyDispatch generate(QuadFunction<T1, T2, T3, T4, Variant> p_176362_) {
                ...
                this.property2.getPossibleValues().forEach((p_176380_) -> {
                    this.property3.getPossibleValues().forEach((p_176376_) -> {
                        this.property4.getPossibleValues().forEach((p_176371_) -> {
                            this.select(p_176385_, p_176380_, p_176376_, p_176371_, (Variant)p_176362_.apply(p_176385_, p_176380_, p_176376_, p_176371_));
                        });
                    });
                });
            });
        ...
        public PropertyDispatch generateList(QuadFunction<T1, T2, T3, T4, List<Variant>> p_176382_) {
                ...
                this.property2.getPossibleValues().forEach((p_176360_) -> {
                    this.property3.getPossibleValues().forEach((p_176356_) -> {
                        this.property4.getPossibleValues().forEach((p_176351_) -> {
                            this.select(p_176365_, p_176360_, p_176356_, p_176351_, (List)p_176382_.apply(p_176365_, p_176360_, p_176356_, p_176351_));
                        });
                    });
                });
            });
    ...
    public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> extends PropertyDispatch {
        ...
        public C5<T1, T2, T3, T4, T5> select(T1 p_125468_, T2 p_125469_, T3 p_125470_, T4 p_125471_, T5 p_125472_, List<Variant> p_125473_) {
            Selector $$6 = Selector.of(this.property1.value(p_125468_), this.property2.value(p_125469_), this.property3.value(p_125470_), this.property4.value(p_125471_), this.property5.value(p_125472_));
            this.putValue($$6, p_125473_);
            return this;
        }

        public C5<T1, T2, T3, T4, T5> select(T1 p_125461_, T2 p_125462_, T3 p_125463_, T4 p_125464_, T5 p_125465_, Variant p_125466_) {
            return this.select(p_125461_, p_125462_, p_125463_, p_125464_, p_125465_, Collections.singletonList(p_125466_));
        }

        public PropertyDispatch generate(PentaFunction<T1, T2, T3, T4, T5, Variant> p_176409_) {
                    ...
                    this.property3.getPossibleValues().forEach((p_176430_) -> {
                        this.property4.getPossibleValues().forEach((p_176425_) -> {
                            this.property5.getPossibleValues().forEach((p_176419_) -> {
                                this.select(p_176439_, p_176434_, p_176430_, p_176425_, p_176419_, (Variant)p_176409_.apply(p_176439_, p_176434_, p_176430_, p_176425_, p_176419_));
                            });
                        });
                    });
                });
        ...
        public PropertyDispatch generateList(PentaFunction<T1, T2, T3, T4, T5, List<Variant>> p_176436_) {
                    ...
                    this.property3.getPossibleValues().forEach((p_176403_) -> {
                        this.property4.getPossibleValues().forEach((p_176398_) -> {
                            this.property5.getPossibleValues().forEach((p_176392_) -> {
                                this.select(p_176412_, p_176407_, p_176403_, p_176398_, p_176392_, (List)p_176436_.apply(p_176412_, p_176407_, p_176403_, p_176398_, p_176392_));
                            });
                        });
                    });
                });
