...
public class ShapelessRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
        ...
        this.advancement.parent(ROOT_RECIPE_ADVANCEMENT).addCriterion("has_the_recipe", (CriterionTriggerInstance)RecipeUnlockedTrigger.unlocked(p_126206_)).rewards(net.minecraft.advancements.AdvancementRewards.Builder.recipe(p_126206_)).requirements(RequirementsStrategy.OR);
