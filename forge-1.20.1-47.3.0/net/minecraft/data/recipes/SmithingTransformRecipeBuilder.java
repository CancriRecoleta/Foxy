...
public class SmithingTransformRecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> p_267089_, ResourceLocation p_267287_) {
        ...
        this.advancement.parent(RecipeBuilder.ROOT_RECIPE_ADVANCEMENT).addCriterion("has_the_recipe", (CriterionTriggerInstance)RecipeUnlockedTrigger.unlocked(p_267287_)).rewards(net.minecraft.advancements.AdvancementRewards.Builder.recipe(p_267287_)).requirements(RequirementsStrategy.OR);
        p_267089_.accept(new Result(p_267287_, this.type, this.template, this.base, this.addition, this.result, this.advancement, p_267287_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
    }
    ...
    public static record Result(ResourceLocation id, RecipeSerializer<?> type, Ingredient template, Ingredient base, Ingredient addition, Item result, Advancement.Builder advancement, ResourceLocation advancementId) implements FinishedRecipe {
        public Result(ResourceLocation id, RecipeSerializer<?> type, Ingredient template, Ingredient base, Ingredient addition, Item result, Advancement.Builder advancement, ResourceLocation advancementId) {
            this.id = id;
            this.type = type;
