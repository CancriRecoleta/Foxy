...
public class ShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> p_126141_, ResourceLocation p_126142_) {
        ...
        this.advancement.parent(ROOT_RECIPE_ADVANCEMENT).addCriterion("has_the_recipe", (CriterionTriggerInstance)RecipeUnlockedTrigger.unlocked(p_126142_)).rewards(net.minecraft.advancements.AdvancementRewards.Builder.recipe(p_126142_)).requirements(RequirementsStrategy.OR);
