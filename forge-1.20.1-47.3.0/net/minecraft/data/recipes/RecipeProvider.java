...
public abstract class RecipeProvider implements DataProvider {
    ...
    public RecipeProvider(PackOutput p_248933_) {
        this.recipePathProvider = p_248933_.createPathProvider(Target.DATA_PACK, "recipes");
        this.advancementPathProvider = p_248933_.createPathProvider(Target.DATA_PACK, "advancements");
    }
    ...
    public CompletableFuture<?> run(CachedOutput p_254020_) {
        ...
        this.buildRecipes((p_253413_) -> {
            if (!set.add(p_253413_.getId())) {
                ...
                if (jsonobject != null) {
                    CompletableFuture<?> saveAdvancementFuture = this.saveAdvancement(p_254020_, p_253413_, jsonobject);
        ...
        return CompletableFuture.allOf((CompletableFuture[])list.toArray((p_253414_) -> {
    ...
    protected static void netheriteSmithing(Consumer<FinishedRecipe> p_251614_, Item p_250046_, RecipeCategory p_248986_, Item p_250389_) {
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.of(p_250046_), Ingredient.of(Items.NETHERITE_INGOT), p_248986_, p_250389_).unlocks("has_netherite_ingot", has((ItemLike)Items.NETHERITE_INGOT)).save(p_251614_, getItemName(p_250389_) + "_smithing");
    }

    protected static void trimSmithing(Consumer<FinishedRecipe> p_285086_, Item p_285461_, ResourceLocation p_285044_) {
        SmithingTrimRecipeBuilder.smithingTrim(Ingredient.of(p_285461_), Ingredient.of(ItemTags.TRIMMABLE_ARMOR), Ingredient.of(ItemTags.TRIM_MATERIALS), RecipeCategory.MISC).unlocks("has_smithing_trim_template", has((ItemLike)p_285461_)).save(p_285086_, p_285044_);
    }
    ...
    protected static void threeByThreePacker(Consumer<FinishedRecipe> p_259036_, RecipeCategory p_259247_, ItemLike p_259376_, ItemLike p_259717_, String p_260308_) {
        ShapelessRecipeBuilder.shapeless(p_259247_, p_259376_).requires((ItemLike)p_259717_, 9).unlockedBy(p_260308_, has(p_259717_)).save(p_259036_);
    }
    ...
    protected static void chestBoat(Consumer<FinishedRecipe> p_236372_, ItemLike p_236373_, ItemLike p_236374_) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.TRANSPORTATION, p_236373_).requires((ItemLike)Blocks.CHEST).requires(p_236374_).group("chest_boat").unlockedBy("has_boat", has(ItemTags.BOATS)).save(p_236372_);
    }
    ...
    protected static RecipeBuilder fenceBuilder(ItemLike p_176679_, Ingredient p_176680_) {
        ...
        return ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_176679_, i).define('W', p_176680_).define('#', (ItemLike)item).pattern("W#W").pattern("W#W");
    }

    protected static RecipeBuilder fenceGateBuilder(ItemLike p_176685_, Ingredient p_176686_) {
        return ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, p_176685_).define('#', (ItemLike)Items.STICK).define('W', p_176686_).pattern("#W#").pattern("#W#");
    }
    ...
    protected static RecipeBuilder signBuilder(ItemLike p_176727_, Ingredient p_176728_) {
        return ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_176727_, 3).group("sign").define('#', p_176728_).define('X', (ItemLike)Items.STICK).pattern("###").pattern("###").pattern(" X ");
    }

    protected static void hangingSign(Consumer<FinishedRecipe> p_250663_, ItemLike p_252355_, ItemLike p_250437_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_252355_, 6).group("hanging_sign").define('#', p_250437_).define('X', (ItemLike)Items.CHAIN).pattern("X X").pattern("###").pattern("###").unlockedBy("has_stripped_logs", has(p_250437_)).save(p_250663_);
    }
    ...
    protected static void colorBlockWithDye(Consumer<FinishedRecipe> p_289666_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) {
        for(int i = 0; i < p_289675_.size(); ++i) {
            Item item = (Item)p_289675_.get(i);
            Item item1 = (Item)p_289672_.get(i);
            ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, item1).requires((ItemLike)item).requires(Ingredient.of(p_289672_.stream().filter((p_288265_) -> {
                return !p_288265_.equals(item1);
            }).map(ItemStack::new))).group(p_289641_).unlockedBy("has_needed_dye", has((ItemLike)item)).save(p_289666_, "dye_" + getItemName(item1));
        }
    ...
    protected static void banner(Consumer<FinishedRecipe> p_126082_, ItemLike p_126083_, ItemLike p_126084_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126083_).define('#', p_126084_).define('|', (ItemLike)Items.STICK).pattern("###").pattern("###").pattern(" | ").group("banner").unlockedBy(getHasName(p_126084_), has(p_126084_)).save(p_126082_);
    }
    ...
    protected static void stainedGlassFromGlassAndDye(Consumer<FinishedRecipe> p_126086_, ItemLike p_126087_, ItemLike p_126088_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126087_, 8).define('#', (ItemLike)Blocks.GLASS).define('X', p_126088_).pattern("###").pattern("#X#").pattern("###").group("stained_glass").unlockedBy("has_glass", has((ItemLike)Blocks.GLASS)).save(p_126086_);
    }
    ...
    protected static void stainedGlassPaneFromGlassPaneAndDye(Consumer<FinishedRecipe> p_126094_, ItemLike p_126095_, ItemLike p_126096_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, p_126095_, 8).define('#', (ItemLike)Blocks.GLASS_PANE).define('$', p_126096_).pattern("###").pattern("#$#").pattern("###").group("stained_glass_pane").unlockedBy("has_glass_pane", has((ItemLike)Blocks.GLASS_PANE)).unlockedBy(getHasName(p_126096_), has(p_126096_)).save(p_126094_, getConversionRecipeName(p_126095_, Blocks.GLASS_PANE));
    }
    ...
    protected static void coloredTerracottaFromTerracottaAndDye(Consumer<FinishedRecipe> p_126098_, ItemLike p_126099_, ItemLike p_126100_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126099_, 8).define('#', (ItemLike)Blocks.TERRACOTTA).define('X', p_126100_).pattern("###").pattern("#X#").pattern("###").group("stained_terracotta").unlockedBy("has_terracotta", has((ItemLike)Blocks.TERRACOTTA)).save(p_126098_);
    }

    protected static void concretePowder(Consumer<FinishedRecipe> p_126102_, ItemLike p_126103_, ItemLike p_126104_) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_126103_, 8).requires(p_126104_).requires((ItemLike)Blocks.SAND, 4).requires((ItemLike)Blocks.GRAVEL, 4).group("concrete_powder").unlockedBy("has_sand", has((ItemLike)Blocks.SAND)).unlockedBy("has_gravel", has((ItemLike)Blocks.GRAVEL)).save(p_126102_);
    }

    protected static void candle(Consumer<FinishedRecipe> p_176543_, ItemLike p_176544_, ItemLike p_176545_) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, p_176544_).requires((ItemLike)Blocks.CANDLE).requires(p_176545_).group("dyed_candle").unlockedBy(getHasName(p_176545_), has(p_176545_)).save(p_176543_);
    }
    ...
    protected static void stonecutterResultFromBase(Consumer<FinishedRecipe> p_249145_, RecipeCategory p_250609_, ItemLike p_251254_, ItemLike p_249666_, int p_251462_) {
        SingleItemRecipeBuilder var10000 = SingleItemRecipeBuilder.stonecutting(Ingredient.of(p_249666_), p_250609_, p_251254_, p_251462_).unlockedBy(getHasName(p_249666_), has(p_249666_));
        String var10002 = getConversionRecipeName(p_251254_, p_249666_);
        var10000.save(p_249145_, var10002 + "_stonecutting");
    }
    ...
    protected static void copySmithingTemplate(Consumer<FinishedRecipe> p_267061_, ItemLike p_266974_, TagKey<Item> p_267283_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, p_266974_, 2).define('#', (ItemLike)Items.DIAMOND).define('C', p_267283_).define('S', p_266974_).pattern("#S#").pattern("#C#").pattern("###").unlockedBy(getHasName(p_266974_), has(p_266974_)).save(p_267061_);
    }

    protected static void copySmithingTemplate(Consumer<FinishedRecipe> p_266734_, ItemLike p_267133_, ItemLike p_267023_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, p_267133_, 2).define('#', (ItemLike)Items.DIAMOND).define('C', p_267023_).define('S', p_267133_).pattern("#S#").pattern("#C#").pattern("###").unlockedBy(getHasName(p_267133_), has(p_267133_)).save(p_266734_);
    }
    ...
    protected static void simpleCookingRecipe(Consumer<FinishedRecipe> p_249398_, String p_249709_, RecipeSerializer<? extends AbstractCookingRecipe> p_251876_, int p_249258_, ItemLike p_250669_, ItemLike p_250224_, float p_252138_) {
        SimpleCookingRecipeBuilder var10000 = SimpleCookingRecipeBuilder.generic(Ingredient.of(p_250669_), RecipeCategory.FOOD, p_250224_, p_252138_, p_249258_, p_251876_).unlockedBy(getHasName(p_250669_), has(p_250669_));
        String var10002 = getItemName(p_250224_);
        var10000.save(p_249398_, var10002 + "_from_" + p_249709_);
    }

    protected static void waxRecipes(Consumer<FinishedRecipe> p_176611_) {
        ((BiMap)HoneycombItem.WAXABLES.get()).forEach((p_248022_, p_248023_) -> {
            ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_248023_).requires((ItemLike)p_248022_).requires((ItemLike)Items.HONEYCOMB).group(getItemName(p_248023_)).unlockedBy(getHasName(p_248022_), has((ItemLike)p_248022_)).save(p_176611_, getConversionRecipeName(p_248023_, Items.HONEYCOMB));
        });
    }
    ...
    protected static void generateRecipes(Consumer<FinishedRecipe> p_176581_, BlockFamily p_176582_) {
        p_176582_.getVariants().forEach((p_176529_, p_176530_) -> {
            BiFunction<ItemLike, ItemLike, RecipeBuilder> bifunction = (BiFunction)SHAPE_BUILDERS.get(p_176529_);
            ItemLike itemlike = getBaseBlock(p_176582_, p_176529_);
            if (bifunction != null) {
                RecipeBuilder recipebuilder = (RecipeBuilder)bifunction.apply(p_176530_, itemlike);
                p_176582_.getRecipeGroupPrefix().ifPresent((p_176601_) -> {
                    recipebuilder.group(p_176601_ + (p_176529_ == Variant.CUT ? "" : "_" + p_176529_.getName()));
                });
                recipebuilder.unlockedBy((String)p_176582_.getRecipeUnlockedBy().orElseGet(() -> {
                    return getHasName(itemlike);
                }), has((ItemLike)itemlike));
                recipebuilder.save(p_176581_);
            }

            if (p_176529_ == Variant.CRACKED) {
    ...
    protected static Block getBaseBlock(BlockFamily p_176524_, BlockFamily.Variant p_176525_) {
        if (p_176525_ == Variant.CHISELED) {
            if (!p_176524_.getVariants().containsKey(Variant.SLAB)) {
                throw new IllegalStateException("Slab is not defined for the family.");
            } else {
                return p_176524_.get(Variant.SLAB);
            }
        } else {
    ...
    protected static InventoryChangeTrigger.TriggerInstance has(MinMaxBounds.Ints p_176521_, ItemLike p_176522_) {
        return inventoryTrigger(Builder.item().of(p_176522_).withCount(p_176521_).build());
    }

    protected static InventoryChangeTrigger.TriggerInstance has(ItemLike p_125978_) {
        return inventoryTrigger(Builder.item().of(p_125978_).build());
    }

    protected static InventoryChangeTrigger.TriggerInstance has(TagKey<Item> p_206407_) {
        return inventoryTrigger(Builder.item().of(p_206407_).build());
    }

    protected static InventoryChangeTrigger.TriggerInstance inventoryTrigger(ItemPredicate... p_126012_) {
        return new InventoryChangeTrigger.TriggerInstance(ContextAwarePredicate.ANY, Ints.ANY, Ints.ANY, Ints.ANY, p_126012_);
    }
    ...
    protected static String getConversionRecipeName(ItemLike p_176518_, ItemLike p_176519_) {
        String var10000 = getItemName(p_176518_);
        return var10000 + "_from_" + getItemName(p_176519_);
    }
    ...
    static {
        SHAPE_BUILDERS = ImmutableMap.builder().put(Variant.BUTTON, (p_176733_, p_176734_) -> {
            return buttonBuilder(p_176733_, Ingredient.of(p_176734_));
        }).put(Variant.CHISELED, (p_248037_, p_248038_) -> {
            return chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, p_248037_, Ingredient.of(p_248038_));
        }).put(Variant.CUT, (p_248026_, p_248027_) -> {
            return cutBuilder(RecipeCategory.BUILDING_BLOCKS, p_248026_, Ingredient.of(p_248027_));
        }).put(Variant.DOOR, (p_176714_, p_176715_) -> {
            return doorBuilder(p_176714_, Ingredient.of(p_176715_));
        }).put(Variant.CUSTOM_FENCE, (p_176708_, p_176709_) -> {
            return fenceBuilder(p_176708_, Ingredient.of(p_176709_));
        }).put(Variant.FENCE, (p_248031_, p_248032_) -> {
            return fenceBuilder(p_248031_, Ingredient.of(p_248032_));
        }).put(Variant.CUSTOM_FENCE_GATE, (p_176698_, p_176699_) -> {
            return fenceGateBuilder(p_176698_, Ingredient.of(p_176699_));
        }).put(Variant.FENCE_GATE, (p_248035_, p_248036_) -> {
            return fenceGateBuilder(p_248035_, Ingredient.of(p_248036_));
        }).put(Variant.SIGN, (p_176688_, p_176689_) -> {
            return signBuilder(p_176688_, Ingredient.of(p_176689_));
        }).put(Variant.SLAB, (p_176733_, p_176734_) -> {
            return slabBuilder(RecipeCategory.BUILDING_BLOCKS, p_176733_, Ingredient.of(p_176734_));
        }).put(Variant.STAIRS, (p_248037_, p_248038_) -> {
            return stairBuilder(p_248037_, Ingredient.of(p_248038_));
        }).put(Variant.PRESSURE_PLATE, (p_248026_, p_248027_) -> {
            return pressurePlateBuilder(RecipeCategory.REDSTONE, p_248026_, Ingredient.of(p_248027_));
        }).put(Variant.POLISHED, (p_176714_, p_176715_) -> {
            return polishedBuilder(RecipeCategory.BUILDING_BLOCKS, p_176714_, Ingredient.of(p_176715_));
        }).put(Variant.TRAPDOOR, (p_176708_, p_176709_) -> {
            return trapdoorBuilder(p_176708_, Ingredient.of(p_176709_));
        }).put(Variant.WALL, (p_248031_, p_248032_) -> {
            return wallBuilder(RecipeCategory.DECORATIONS, p_248031_, Ingredient.of(p_248032_));
        }).build();
    }
}
