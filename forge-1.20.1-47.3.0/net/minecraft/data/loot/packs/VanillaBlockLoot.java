...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.TNT, LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(Blocks.TNT, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Blocks.TNT).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TNT).setProperties(Builder.properties().hasProperty(TntBlock.UNSTABLE, false)))))));
        this.add(Blocks.COCOA, (p_250228_) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_250228_, LootItem.lootTableItem(Items.COCOA_BEANS).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_250228_).setProperties(Builder.properties().hasProperty(CocoaBlock.AGE, 2)))))));
        });
        this.add(Blocks.SEA_PICKLE, (p_248918_) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, LootItem.lootTableItem(p_248918_).apply(List.of(2, 3, 4), (p_251952_) -> {
                return SetItemCountFunction.setCount(ConstantValue.exactly((float)p_251952_)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_248918_).setProperties(Builder.properties().hasProperty(SeaPickleBlock.PICKLES, p_251952_)));
            }))));
        });
        this.add(Blocks.COMPOSTER, (p_250064_) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_250064_, LootItem.lootTableItem(Items.COMPOSTER)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BONE_MEAL)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_250064_).setProperties(Builder.properties().hasProperty(ComposterBlock.LEVEL, 8))));
        });
        ...
        this.add(Blocks.PLAYER_HEAD, (p_250163_) -> {
            return LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(p_250163_, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(p_250163_).apply(CopyNbtFunction.copyData((NbtProvider)ContextNbtProvider.BLOCK_ENTITY).copy("SkullOwner", "SkullOwner").copy("note_block_sound", String.format(Locale.ROOT, "%s.%s", "BlockEntityTag", "note_block_sound"))))));
        });
        ...
        LootItemCondition.Builder $$0 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.BEETROOTS).setProperties(Builder.properties().hasProperty(BeetrootBlock.AGE, 3));
        this.add(Blocks.BEETROOTS, this.createCropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, $$0));
        LootItemCondition.Builder $$1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.WHEAT).setProperties(Builder.properties().hasProperty(CropBlock.AGE, 7));
        this.add(Blocks.WHEAT, this.createCropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, $$1));
        LootItemCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.CARROTS).setProperties(Builder.properties().hasProperty(CarrotBlock.AGE, 7));
        LootItemCondition.Builder $$3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.MANGROVE_PROPAGULE).setProperties(Builder.properties().hasProperty(MangrovePropaguleBlock.AGE, 4));
        this.add(Blocks.MANGROVE_PROPAGULE, (LootTable.Builder)this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.lootTable().withPool(LootPool.lootPool().when($$3).add(LootItem.lootTableItem(Items.MANGROVE_PROPAGULE)))));
        ...
        this.add(Blocks.PITCHER_PLANT, (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_PLANT, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PITCHER_PLANT).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_PLANT).setProperties(Builder.properties().hasProperty(DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)))))));
        this.add(Blocks.CARROTS, (LootTable.Builder)this.applyExplosionDecay(Blocks.CARROTS, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CARROT))).withPool(LootPool.lootPool().when($$2).add(LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286F, 3))))));
        LootItemCondition.Builder $$4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.POTATOES).setProperties(Builder.properties().hasProperty(PotatoBlock.AGE, 7));
        this.add(Blocks.POTATOES, (LootTable.Builder)this.applyExplosionDecay(Blocks.POTATOES, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(LootPool.lootPool().when($$4).add(LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286F, 3)))).withPool(LootPool.lootPool().when($$4).add(LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02F))))));
        this.add(Blocks.SWEET_BERRY_BUSH, (p_249159_) -> {
            return (LootTable.Builder)this.applyExplosionDecay(p_249159_, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 3))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 2))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))));
        });
        ...
        this.add(Blocks.NETHER_GOLD_ORE, (p_251177_) -> {
            return createSilkTouchDispatchTable(p_251177_, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_251177_, LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 6.0F))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE))));
        });
        ...
        this.add(Blocks.COBWEB, (p_250546_) -> {
            return createSilkTouchOrShearsDispatchTable(p_250546_, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(p_250546_, LootItem.lootTableItem(Items.STRING)));
        });
        this.add(Blocks.DEAD_BUSH, (p_249226_) -> {
            return createShearsDispatchTable(p_249226_, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_249226_, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F)))));
        });
        ...
        this.add(Blocks.CHORUS_FLOWER, (p_249769_) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(((LootPoolSingletonContainer.Builder)this.applyExplosionCondition(p_249769_, LootItem.lootTableItem(p_249769_))).when(LootItemEntityPropertyCondition.entityPresent(EntityTarget.THIS))));
        });
        ...
        this.add(Blocks.GLOWSTONE, (p_251150_) -> {
            return createSilkTouchDispatchTable(p_251150_, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_251150_, LootItem.lootTableItem(Items.GLOWSTONE_DUST).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)).apply(LimitCount.limitCount(IntRange.range(1, 4)))));
        });
        this.add(Blocks.MELON, (p_251856_) -> {
            return createSilkTouchDispatchTable(p_251856_, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_251856_, LootItem.lootTableItem(Items.MELON_SLICE).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 7.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)).apply(LimitCount.limitCount(IntRange.upperBound(9)))));
        });
        ...
        this.add(Blocks.SEA_LANTERN, (p_250026_) -> {
            return createSilkTouchDispatchTable(p_250026_, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_250026_, LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 3.0F))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)).apply(LimitCount.limitCount(IntRange.range(1, 5)))));
        });
        this.add(Blocks.NETHER_WART, (p_250097_) -> {
            return LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionDecay(p_250097_, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.NETHER_WART).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_250097_).setProperties(Builder.properties().hasProperty(NetherWartBlock.AGE, 3)))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_250097_).setProperties(Builder.properties().hasProperty(NetherWartBlock.AGE, 3)))))));
        });
        this.add(Blocks.SNOW, (p_251108_) -> {
            return LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(EntityTarget.THIS)).add(AlternativesEntry.alternatives(AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (p_252097_) -> {
                return ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_251108_).setProperties(Builder.properties().hasProperty(SnowLayerBlock.LAYERS, p_252097_)))).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)p_252097_)));
            }).when(HAS_NO_SILK_TOUCH), AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (p_251216_) -> {
                return (LootPoolEntryContainer.Builder)(p_251216_ == 8 ? LootItem.lootTableItem(Blocks.SNOW_BLOCK) : LootItem.lootTableItem(Blocks.SNOW).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)p_251216_))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_251108_).setProperties(Builder.properties().hasProperty(SnowLayerBlock.LAYERS, p_251216_))));
            }))));
        });
        this.add(Blocks.GRAVEL, (p_248523_) -> {
            return createSilkTouchDispatchTable(p_248523_, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(p_248523_, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).otherwise(LootItem.lootTableItem(p_248523_))));
        });
        this.add(Blocks.CAMPFIRE, (p_248528_) -> {
            return createSilkTouchDispatchTable(p_248528_, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(p_248528_, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))));
        });
        this.add(Blocks.GILDED_BLACKSTONE, (p_250428_) -> {
            return createSilkTouchDispatchTable(p_250428_, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(p_250428_, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F))).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).otherwise(LootItem.lootTableItem(p_250428_))));
        });
        this.add(Blocks.SOUL_CAMPFIRE, (p_248898_) -> {
            return createSilkTouchDispatchTable(p_248898_, (LootPoolEntryContainer.Builder)this.applyExplosionCondition(p_248898_, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))));
        });
        this.add(Blocks.AMETHYST_CLUSTER, (p_252201_) -> {
            return createSilkTouchDispatchTable(p_252201_, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE)).when(MatchTool.toolMatches(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(ItemTags.CLUSTER_MAX_HARVESTABLES)))).otherwise((LootPoolEntryContainer.Builder)this.applyExplosionDecay(p_252201_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))))));
        });
    ...
    private LootTable.Builder createDecoratedPotTable(Block p_277929_) {
        return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)DynamicLoot.dynamicEntry(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).when(MatchTool.toolMatches(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(ItemTags.BREAKS_DECORATED_POTS)))).when(HAS_NO_SILK_TOUCH)).otherwise(LootItem.lootTableItem(p_277929_).apply(CopyNbtFunction.copyData((NbtProvider)ContextNbtProvider.BLOCK_ENTITY).copy("sherds", "BlockEntityTag.sherds")))));
    }

    private LootTable.Builder createPitcherCropLoot() {
        return (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(PitcherCropBlock.AGE.getPossibleValues(), (p_277248_) -> {
            LootItemBlockStatePropertyCondition.Builder $$1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(Builder.properties().hasProperty(DoublePlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER));
            LootItemBlockStatePropertyCondition.Builder $$2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(Builder.properties().hasProperty(PitcherCropBlock.AGE, p_277248_));
            return p_277248_ == 4 ? ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_PLANT).when($$2)).when($$1)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))) : ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_POD).when($$2)).when($$1)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)));
        }))));
    }
