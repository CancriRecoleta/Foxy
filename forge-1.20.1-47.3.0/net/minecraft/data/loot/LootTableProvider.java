...
public class LootTableProvider implements DataProvider {
    ...
    public LootTableProvider(PackOutput p_254123_, Set<ResourceLocation> p_254481_, List<SubProviderEntry> p_253798_) {
        this.pathProvider = p_254123_.createPathProvider(Target.DATA_PACK, "loot_tables");
    ...
    public CompletableFuture<?> run(CachedOutput p_254060_) {
        ...
        this.getTables().forEach((p_288263_) -> {
            ((LootTableSubProvider)p_288263_.provider().get()).generate((p_288259_, p_288260_) -> {
                ResourceLocation resourcelocation1 = (ResourceLocation)map1.put(RandomSequence.seedForKey(p_288259_), p_288259_);
        ...
        ValidationContext validationcontext = new ValidationContext(LootContextParamSets.ALL_PARAMS, new LootDataResolver() {
            ...
            public <T> T getElement(LootDataId<T> p_279283_) {
                return p_279283_.type() == LootDataType.TABLE ? (LootTable)map.get(p_279283_.location()) : null;
            }
        });
    ...
    protected void validate(Map<ResourceLocation, LootTable> map, ValidationContext validationcontext) {
        UnmodifiableIterator var3 = Sets.difference(this.requiredTables, map.keySet()).iterator();
