...
public class Pools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> p_255897_) {
        HolderGetter<StructureTemplatePool> $$1 = p_255897_.lookup(Registries.TEMPLATE_POOL);
        Holder<StructureTemplatePool> $$2 = $$1.getOrThrow(EMPTY);
        p_255897_.register(EMPTY, new StructureTemplatePool($$2, ImmutableList.of(), Projection.RIGID));
