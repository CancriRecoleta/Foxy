...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256317_) {
        HolderGetter<Block> $$1 = p_256317_.lookup(Registries.BLOCK);
        ...
        FeatureUtils.register(p_256317_, CRIMSON_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, false));
        FeatureUtils.register(p_256317_, CRIMSON_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, true));
        FeatureUtils.register(p_256317_, WARPED_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, false));
        FeatureUtils.register(p_256317_, WARPED_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, true));
        ...
        FeatureUtils.register(p_256317_, HUGE_RED_MUSHROOM, Feature.HUGE_RED_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState)Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState)((BlockState)Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, false)).setValue(HugeMushroomBlock.DOWN, false)), 2));
        ...
        FeatureUtils.register(p_256317_, CHERRY_BEES_005, Feature.TREE, cherry().decorators(List.of($$6)).build());
        ...
        FeatureUtils.register(p_256317_, SUPER_BIRCH_BEES_0002, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$3)).build());
        FeatureUtils.register(p_256317_, SUPER_BIRCH_BEES, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$7)).build());
        ...
        FeatureUtils.register(p_256317_, OAK_BEES_0002, Feature.TREE, createOak().decorators(List.of($$3)).build());
        FeatureUtils.register(p_256317_, OAK_BEES_002, Feature.TREE, createOak().decorators(List.of($$5)).build());
        FeatureUtils.register(p_256317_, OAK_BEES_005, Feature.TREE, createOak().decorators(List.of($$6)).build());
        FeatureUtils.register(p_256317_, BIRCH_BEES_0002, Feature.TREE, createBirch().decorators(List.of($$3)).build());
        FeatureUtils.register(p_256317_, BIRCH_BEES_002, Feature.TREE, createBirch().decorators(List.of($$5)).build());
        FeatureUtils.register(p_256317_, BIRCH_BEES_005, Feature.TREE, createBirch().decorators(List.of($$6)).build());
        FeatureUtils.register(p_256317_, FANCY_OAK_BEES_0002, Feature.TREE, createFancyOak().decorators(List.of($$3)).build());
        FeatureUtils.register(p_256317_, FANCY_OAK_BEES_002, Feature.TREE, createFancyOak().decorators(List.of($$5)).build());
        FeatureUtils.register(p_256317_, FANCY_OAK_BEES_005, Feature.TREE, createFancyOak().decorators(List.of($$6)).build());
        FeatureUtils.register(p_256317_, FANCY_OAK_BEES, Feature.TREE, createFancyOak().decorators(List.of($$7)).build());
    }
}
