...
public class VegetationPlacements {
    ...
    private static List<PlacementModifier> getMushroomPlacement(int p_195477_, @Nullable PlacementModifier p_195478_) {
        ...
        if (p_195477_ != 0) {
            $$2.add(RarityFilter.onAverageOnceEvery(p_195477_));
        }
    ...
    private static ImmutableList.Builder<PlacementModifier> treePlacementBase(PlacementModifier p_195485_) {
        return ImmutableList.builder().add(p_195485_).add(InSquarePlacement.spread()).add(TREE_THRESHOLD).add(PlacementUtils.HEIGHTMAP_OCEAN_FLOOR).add(BiomeFilter.biome());
    }
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> p_255657_) {
        HolderGetter<ConfiguredFeature<?, ?>> $$1 = p_255657_.lookup(Registries.CONFIGURED_FEATURE);
        ...
        PlacementUtils.register(p_255657_, BAMBOO_LIGHT, $$2, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, BAMBOO, $$3, (PlacementModifier[])(NoiseBasedCountPlacement.of(160, 80.0, 0.3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, VINES, $$4, (PlacementModifier[])(CountPlacement.of(127), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(100)), BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_SUNFLOWER, $$5, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_PUMPKIN, $$6, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(300), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_GRASS_PLAIN, $$7, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_GRASS_FOREST, $$7, (List)worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(p_255657_, PATCH_GRASS_BADLANDS, $$7, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_GRASS_SAVANNA, $$7, (List)worldSurfaceSquaredWithCount(20));
        PlacementUtils.register(p_255657_, PATCH_GRASS_NORMAL, $$7, (List)worldSurfaceSquaredWithCount(5));
        PlacementUtils.register(p_255657_, PATCH_GRASS_TAIGA_2, $$8, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_GRASS_TAIGA, $$8, (List)worldSurfaceSquaredWithCount(7));
        PlacementUtils.register(p_255657_, PATCH_GRASS_JUNGLE, $$9, (List)worldSurfaceSquaredWithCount(25));
        PlacementUtils.register(p_255657_, GRASS_BONEMEAL, $$10, (PlacementModifier[])(PlacementUtils.isEmpty()));
        PlacementUtils.register(p_255657_, PATCH_DEAD_BUSH_2, $$11, (List)worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(p_255657_, PATCH_DEAD_BUSH, $$11, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_DEAD_BUSH_BADLANDS, $$11, (List)worldSurfaceSquaredWithCount(20));
        PlacementUtils.register(p_255657_, PATCH_MELON, $$12, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_MELON_SPARSE, $$12, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(64), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_BERRY_COMMON, $$13, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_BERRY_RARE, $$13, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(384), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_WATERLILY, $$14, (List)worldSurfaceSquaredWithCount(4));
        PlacementUtils.register(p_255657_, PATCH_TALL_GRASS_2, $$15, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8, 0, 7), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_TALL_GRASS, $$15, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_LARGE_FERN, $$16, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_CACTUS_DESERT, $$17, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_CACTUS_DECORATED, $$17, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(13), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_SUGAR_CANE_SWAMP, $$18, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_SUGAR_CANE_DESERT, $$18, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_SUGAR_CANE_BADLANDS, $$18, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, PATCH_SUGAR_CANE, $$18, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, BROWN_MUSHROOM_NETHER, $$19, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, RED_MUSHROOM_NETHER, $$20, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, BROWN_MUSHROOM_NORMAL, $$19, (List)getMushroomPlacement(256, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, RED_MUSHROOM_NORMAL, $$20, (List)getMushroomPlacement(512, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, BROWN_MUSHROOM_TAIGA, $$19, (List)getMushroomPlacement(4, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, RED_MUSHROOM_TAIGA, $$20, (List)getMushroomPlacement(256, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, BROWN_MUSHROOM_OLD_GROWTH, $$19, (List)getMushroomPlacement(4, CountPlacement.of(3)));
        PlacementUtils.register(p_255657_, RED_MUSHROOM_OLD_GROWTH, $$20, (List)getMushroomPlacement(171, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, BROWN_MUSHROOM_SWAMP, $$19, (List)getMushroomPlacement(0, CountPlacement.of(2)));
        PlacementUtils.register(p_255657_, RED_MUSHROOM_SWAMP, $$20, (List)getMushroomPlacement(64, (PlacementModifier)null));
        PlacementUtils.register(p_255657_, FLOWER_WARM, $$21, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_DEFAULT, $$21, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_FLOWER_FOREST, $$22, (PlacementModifier[])(CountPlacement.of(3), RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_SWAMP, $$23, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_PLAINS, $$24, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8, 15, 4), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_CHERRY, $$26, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_MEADOW, $$25, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementModifier $$51 = SurfaceWaterDepthFilter.forMaxDepth(0);
        PlacementUtils.register(p_255657_, TREES_PLAINS, $$27, (PlacementModifier[])(PlacementUtils.countExtra(0, 0.05F, 1), InSquarePlacement.spread(), $$51, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, DARK_FOREST_VEGETATION, $$28, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), $$51, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FLOWER_FOREST_FLOWERS, $$29, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-1, 3), 0, 3)), BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, FOREST_FLOWERS, $$29, (PlacementModifier[])(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, TREES_FLOWER_FOREST, $$30, (List)treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_MEADOW, $$31, (List)treePlacement(RarityFilter.onAverageOnceEvery(100)));
        PlacementUtils.register(p_255657_, TREES_CHERRY, $$36, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
        PlacementUtils.register(p_255657_, TREES_TAIGA, $$32, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_GROVE, $$33, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_BADLANDS, $$34, (List)treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
        PlacementUtils.register(p_255657_, TREES_SNOWY, $$35, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(p_255657_, TREES_SWAMP, $$37, (PlacementModifier[])(PlacementUtils.countExtra(2, 0.1F, 1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(2), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO))));
        PlacementUtils.register(p_255657_, TREES_WINDSWEPT_SAVANNA, $$38, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_SAVANNA, $$38, (List)treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
        PlacementUtils.register(p_255657_, BIRCH_TALL, $$39, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_BIRCH, $$40, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
        PlacementUtils.register(p_255657_, TREES_WINDSWEPT_FOREST, $$41, (List)treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_WINDSWEPT_HILLS, $$41, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_WATER, $$42, (List)treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_BIRCH_AND_OAK, $$43, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_SPARSE_JUNGLE, $$44, (List)treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_OLD_GROWTH_SPRUCE_TAIGA, $$45, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_OLD_GROWTH_PINE_TAIGA, $$46, (List)treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
        PlacementUtils.register(p_255657_, TREES_JUNGLE, $$47, (List)treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
        PlacementUtils.register(p_255657_, BAMBOO_VEGETATION, $$48, (List)treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
        PlacementUtils.register(p_255657_, MUSHROOM_ISLAND_VEGETATION, $$49, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        PlacementUtils.register(p_255657_, TREES_MANGROVE, $$50, (PlacementModifier[])(CountPlacement.of(25), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(5), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome(), BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.defaultBlockState(), BlockPos.ZERO))));
    }
}
