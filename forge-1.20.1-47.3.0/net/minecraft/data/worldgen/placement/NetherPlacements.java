...
public class NetherPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> p_256373_) {
        HolderGetter<ConfiguredFeature<?, ?>> $$1 = p_256373_.lookup(Registries.CONFIGURED_FEATURE);
        ...
        PlacementUtils.register(p_256373_, DELTA, $$2, (PlacementModifier[])(CountOnEveryLayerPlacement.of(40), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, SMALL_BASALT_COLUMNS, $$3, (PlacementModifier[])(CountOnEveryLayerPlacement.of(4), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, LARGE_BASALT_COLUMNS, $$4, (PlacementModifier[])(CountOnEveryLayerPlacement.of(2), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, BASALT_BLOBS, $$5, (PlacementModifier[])(CountPlacement.of(75), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, BLACKSTONE_BLOBS, $$6, (PlacementModifier[])(CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, GLOWSTONE_EXTRA, $$7, (PlacementModifier[])(CountPlacement.of(BiasedToBottomInt.of(0, 9)), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, GLOWSTONE, $$7, (PlacementModifier[])(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, CRIMSON_FOREST_VEGETATION, $$8, (PlacementModifier[])(CountOnEveryLayerPlacement.of(6), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, WARPED_FOREST_VEGETATION, $$9, (PlacementModifier[])(CountOnEveryLayerPlacement.of(5), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, NETHER_SPROUTS, $$10, (PlacementModifier[])(CountOnEveryLayerPlacement.of(4), BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, TWISTING_VINES, $$11, (PlacementModifier[])(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, WEEPING_VINES, $$12, (PlacementModifier[])(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, PATCH_CRIMSON_ROOTS, $$13, (PlacementModifier[])(PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, BASALT_PILLAR, $$14, (PlacementModifier[])(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, SPRING_DELTA, $$15, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, SPRING_CLOSED, $$16, (PlacementModifier[])(CountPlacement.of(16), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, SPRING_CLOSED_DOUBLE, $$16, (PlacementModifier[])(CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.RANGE_10_10, BiomeFilter.biome()));
        PlacementUtils.register(p_256373_, SPRING_OPEN, $$17, (PlacementModifier[])(CountPlacement.of(8), InSquarePlacement.spread(), PlacementUtils.RANGE_4_4, BiomeFilter.biome()));
        ...
        PlacementUtils.register(p_256373_, PATCH_SOUL_FIRE, $$18, (List)$$20);
        PlacementUtils.register(p_256373_, PATCH_FIRE, $$19, (List)$$20);
    }
}
