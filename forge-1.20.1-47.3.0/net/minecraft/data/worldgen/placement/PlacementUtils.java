...
public class PlacementUtils {
    ...
    public static PlacementModifier countExtra(int p_195365_, float p_195366_, int p_195367_) {
        ...
        if (Math.abs($$3 - (float)((int)$$3)) > 1.0E-5F) {
            ...
            SimpleWeightedRandomList<IntProvider> $$4 = SimpleWeightedRandomList.builder().add(ConstantInt.of(p_195365_), (int)$$3 - 1).add(ConstantInt.of(p_195365_ + p_195367_), 1).build();
    ...
    static {
        HEIGHTMAP = HeightmapPlacement.onHeightmap(Types.MOTION_BLOCKING);
        HEIGHTMAP_TOP_SOLID = HeightmapPlacement.onHeightmap(Types.OCEAN_FLOOR_WG);
        HEIGHTMAP_WORLD_SURFACE = HeightmapPlacement.onHeightmap(Types.WORLD_SURFACE_WG);
        HEIGHTMAP_OCEAN_FLOOR = HeightmapPlacement.onHeightmap(Types.OCEAN_FLOOR);
