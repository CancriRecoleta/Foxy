...
public class ResourceLocationArgument implements ArgumentType<ResourceLocation> {
    ...
    public static Recipe<?> getRecipe(CommandContext<CommandSourceStack> p_106995_, String p_106996_) throws CommandSyntaxException {
        ...
        return (Recipe)recipemanager.byKey(resourcelocation).orElseThrow(() -> {
    ...
    public static LootItemCondition getPredicate(CommandContext<CommandSourceStack> p_107002_, String p_107003_) throws CommandSyntaxException {
        ...
        LootDataManager lootdatamanager = ((CommandSourceStack)p_107002_.getSource()).getServer().getLootData();
        LootItemCondition lootitemcondition = (LootItemCondition)lootdatamanager.getElement(LootDataType.PREDICATE, resourcelocation);
    ...
    public static LootItemFunction getItemModifier(CommandContext<CommandSourceStack> p_171032_, String p_171033_) throws CommandSyntaxException {
        ...
        LootDataManager lootdatamanager = ((CommandSourceStack)p_171032_.getSource()).getServer().getLootData();
        LootItemFunction lootitemfunction = (LootItemFunction)lootdatamanager.getElement(LootDataType.MODIFIER, resourcelocation);
