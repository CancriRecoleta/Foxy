...
public class OperationArgument implements ArgumentType<Operation> {
    ...
    public static Operation getOperation(CommandContext<CommandSourceStack> p_103276_, String p_103277_) {
    ...
    public Operation parse(StringReader p_103274_) throws CommandSyntaxException {
        if (!p_103274_.canRead()) {
            ...
            return getOperation(p_103274_.getString().substring($$1, p_103274_.getCursor()));
        }
    }
    ...
    private static Operation getOperation(String p_103282_) throws CommandSyntaxException {
        return (Operation)(p_103282_.equals("><") ? (p_103279_, p_103280_) -> {
    ...
    private static SimpleOperation getSimpleOperation(String p_103287_) throws CommandSyntaxException {
        switch (p_103287_) {
            case "=" -> return (p_103298_, p_103299_) -> {
    return p_103299_;
};
            case "+=" -> return (p_103295_, p_103296_) -> {
    return p_103295_ + p_103296_;
};
            case "-=" -> return (p_103292_, p_103293_) -> {
    return p_103292_ - p_103293_;
};
            case "*=" -> return (p_103289_, p_103290_) -> {
    return p_103289_ * p_103290_;
};
            case "/=" -> return (p_264713_, p_264714_) -> {
    if (p_264714_ == 0) {
        ...
        return Mth.floorDiv(p_264713_, p_264714_);
            ...
            case "%=" -> return (p_103271_, p_103272_) -> {
    if (p_103272_ == 0) {
        throw ERROR_DIVIDE_BY_ZERO.create();
    } else {
        return Mth.positiveModulo(p_103271_, p_103272_);
            ...
            case "<" -> return Math::min;
            case ">" -> return Math::max;
