...
public class ItemPredicateArgument implements ArgumentType<Result> {
    ...
    public Result parse(StringReader p_121039_) throws CommandSyntaxException {
        Either<ItemParser.ItemResult, ItemParser.TagResult> $$1 = ItemParser.parseForTesting(this.items, p_121039_);
        return (Result)$$1.map((p_235356_) -> {
            return createResult((p_235359_) -> {
                return p_235359_ == p_235356_.item();
            }, p_235356_.nbt());
        }, (p_235361_) -> {
            HolderSet var10000 = p_235361_.tag();
            Objects.requireNonNull(var10000);
            return createResult(var10000::contains, p_235361_.nbt());
        });
    }
    ...
    private static Result createResult(Predicate<Holder<Item>> p_235366_, @Nullable CompoundTag p_235367_) {
