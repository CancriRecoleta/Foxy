    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_120854_, SuggestionsBuilder p_120855_) {
        if (!(p_120854_.getSource() instanceof SharedSuggestionProvider)) {
            ...
            if (!$$2.isEmpty() && $$2.charAt(0) == '^') {
                ...
                $$4 = ((SharedSuggestionProvider)p_120854_.getSource()).getAbsoluteCoordinates();
            }

            return SharedSuggestionProvider.suggestCoordinates($$2, (Collection)$$4, p_120855_, Commands.createValidator(this::parse));
        }
    }
