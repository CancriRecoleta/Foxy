...
public class MetricSampler {
    ...
    public static MetricSampler create(String p_146010_, MetricCategory p_146011_, DoubleSupplier p_146012_) {
        return new MetricSampler(p_146010_, p_146011_, p_146012_, (Runnable)null, (ThresholdTest)null);
    }
    ...
    public static <T> MetricSamplerBuilder<T> builder(String p_146014_, MetricCategory p_146015_, ToDoubleFunction<T> p_146016_, T p_146017_) {
        return new MetricSamplerBuilder(p_146014_, p_146015_, p_146016_, p_146017_);
    }
    ...
    public SamplerResult result() {
        ...
        return new SamplerResult($$1, $$2, $$0);
    }
    ...
    public static class MetricSamplerBuilder<T> {
        ...
        public MetricSamplerBuilder<T> withBeforeTick(Consumer<T> p_146043_) {
            this.beforeTick = () -> {
        ...
        public MetricSamplerBuilder<T> withThresholdAlert(ThresholdTest p_146041_) {
    ...
    public static class ValueIncreasedByPercentage implements ThresholdTest {
        ...
        public boolean test(double p_146066_) {
            ...
            if (this.previousValue != Double.MIN_VALUE && !(p_146066_ <= this.previousValue)) {
                $$2 = (p_146066_ - this.previousValue) / this.previousValue >= (double)this.percentageIncreaseThreshold;
            } else {
                $$2 = false;
            }
