...
public class ActiveProfiler implements ProfileCollector {
    ...
    private PathEntry getCurrentEntry() {
        if (this.currentEntry == null) {
            this.currentEntry = (PathEntry)this.entries.computeIfAbsent(this.path, (p_18405_) -> {
    ...
    public void incrementCounter(Supplier<String> p_185250_, int p_185251_) {
        this.getCurrentEntry().counters.addTo((String)p_185250_.get(), (long)p_185251_);
    }
    ...
    @Nullable
    public PathEntry getEntry(String p_145930_) {
        return (PathEntry)this.entries.get(p_145930_);
    }
