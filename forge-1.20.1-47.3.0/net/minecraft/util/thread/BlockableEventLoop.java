...
public abstract class BlockableEventLoop<R extends Runnable> implements ProfilerMeasured, ProcessorHandle<R>, Executor {
    ...
    public boolean pollTask() {
        R $$0 = (Runnable)this.pendingRunnables.peek();
        if ($$0 == null) {
            return false;
        } else if (this.blockingCount == 0 && !this.shouldRun($$0)) {
            return false;
        } else {
    ...
    protected void doRunTask(R p_18700_) {
        try {
            ...
            Exception $$1 = var3;
            LOGGER.error(LogUtils.FATAL_MARKER, "Error executing task on {}", this.name(), $$1);
        }
