...
public class ResourceLocationPattern {
    ...
    private ResourceLocationPattern(Optional<Pattern> p_261800_, Optional<Pattern> p_262131_) {
        ...
        this.namespacePredicate = (Predicate)p_261800_.map(Pattern::asPredicate).orElse((p_261999_) -> {
            return true;
        });
        this.pathPattern = p_262131_;
        this.pathPredicate = (Predicate)p_262131_.map(Pattern::asPredicate).orElse((p_261815_) -> {
            return true;
        });
