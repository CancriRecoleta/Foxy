...
public class GsonHelper {
    ...
    public static JsonElement getNonNull(JsonObject p_289782_, String p_289789_) {
        JsonElement $$2 = p_289782_.get(p_289789_);
    ...
    public static Item convertToItem(JsonElement p_13875_, String p_13876_) {
        if (p_13875_.isJsonPrimitive()) {
            ...
            return (Item)BuiltInRegistries.ITEM.getOptional(new ResourceLocation($$2)).orElseThrow(() -> {
                return new JsonSyntaxException("Expected " + p_13876_ + " to be an item, was unknown string '" + $$2 + "'");
            });
        } else {
    ...
    public static String getType(@Nullable JsonElement p_13884_) {
        String $$1 = StringUtils.abbreviateMiddle(String.valueOf(p_13884_), "...", 10);
        if (p_13884_ == null) {
            return "null (missing)";
    ...
    public static <T> T fromNullableJson(Gson p_13781_, Reader p_13782_, Class<T> p_13783_, boolean p_13784_) {
        try {
            ...
            return p_13781_.getAdapter(p_13783_).read($$4);
    ...
    public static <T> T fromJson(Gson p_263516_, Reader p_263522_, Class<T> p_263539_, boolean p_263489_) {
        T $$4 = fromNullableJson(p_263516_, p_263522_, p_263539_, p_263489_);
        if ($$4 == null) {
    ...
    public static <T> T fromNullableJson(Gson p_13772_, Reader p_13773_, TypeToken<T> p_13774_, boolean p_13775_) {
        try {
            ...
            return p_13772_.getAdapter(p_13774_).read($$4);
        } catch (IOException var5) {
            IOException $$5 = var5;
            throw new JsonParseException($$5);
        }
    ...
    public static <T> T fromJson(Gson p_263499_, Reader p_263527_, TypeToken<T> p_263525_, boolean p_263507_) {
        T $$4 = fromNullableJson(p_263499_, p_263527_, p_263525_, p_263507_);
        if ($$4 == null) {
            throw new JsonParseException("JSON data was null or empty");
        } else {
            return $$4;
    ...
    public static <T> T fromNullableJson(Gson p_13790_, String p_13791_, TypeToken<T> p_13792_, boolean p_13793_) {
        return fromNullableJson(p_13790_, (Reader)(new StringReader(p_13791_)), (TypeToken)p_13792_, p_13793_);
    }

    public static <T> T fromJson(Gson p_263492_, String p_263488_, Class<T> p_263503_, boolean p_263506_) {
        return fromJson(p_263492_, (Reader)(new StringReader(p_263488_)), (Class)p_263503_, p_263506_);
    }

    @Nullable
    public static <T> T fromNullableJson(Gson p_13799_, String p_13800_, Class<T> p_13801_, boolean p_13802_) {
        return fromNullableJson(p_13799_, (Reader)(new StringReader(p_13800_)), (Class)p_13801_, p_13802_);
    }
    ...
    public static JsonObject parse(String p_13870_, boolean p_13871_) {
        return parse((Reader)(new StringReader(p_13870_)), p_13871_);
    }

    public static JsonObject parse(Reader p_13862_, boolean p_13863_) {
        return (JsonObject)fromJson(GSON, p_13862_, JsonObject.class, p_13863_);
    }
    ...
    public static JsonArray parseArray(String p_216215_) {
        return parseArray((Reader)(new StringReader(p_216215_)));
    }

    public static JsonArray parseArray(Reader p_144766_) {
        return (JsonArray)fromJson(GSON, p_144766_, JsonArray.class, false);
    }
    ...
    public static String toStableString(JsonElement p_216217_) {
        ...
        try {
            writeValue($$2, p_216217_, Comparator.naturalOrder());
    ...
    public static void writeValue(JsonWriter p_216208_, @Nullable JsonElement p_216209_, @Nullable Comparator<String> p_216210_) throws IOException {
        if (p_216209_ != null && !p_216209_.isJsonNull()) {
            if (p_216209_.isJsonPrimitive()) {
                ...
                Iterator var5;
                if (p_216209_.isJsonArray()) {
                    p_216208_.beginArray();
                    var5 = p_216209_.getAsJsonArray().iterator();

                    while(var5.hasNext()) {
                        JsonElement $$4 = (JsonElement)var5.next();
                        writeValue(p_216208_, $$4, p_216210_);
                    }
                    ...
                    var5 = sortByKeyIfNeeded(p_216209_.getAsJsonObject().entrySet(), p_216210_).iterator();

                    while(var5.hasNext()) {
                        Map.Entry<String, JsonElement> $$5 = (Map.Entry)var5.next();
                        p_216208_.name((String)$$5.getKey());
                        writeValue(p_216208_, (JsonElement)$$5.getValue(), p_216210_);
                    }
    ...
    private static Collection<Map.Entry<String, JsonElement>> sortByKeyIfNeeded(Collection<Map.Entry<String, JsonElement>> p_216212_, @Nullable Comparator<String> p_216213_) {
        if (p_216213_ == null) {
            ...
            List<Map.Entry<String, JsonElement>> $$2 = new ArrayList(p_216212_);
            $$2.sort(Entry.comparingByKey(p_216213_));
            return $$2;
        }
    }
}
