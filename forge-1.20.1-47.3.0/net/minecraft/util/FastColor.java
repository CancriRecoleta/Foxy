...
public class FastColor {
    ...
    public static class ARGB32 {
        ...
        public static int lerp(float p_270972_, int p_270081_, int p_270150_) {
            int $$3 = Mth.lerpInt(p_270972_, alpha(p_270081_), alpha(p_270150_));
            int $$4 = Mth.lerpInt(p_270972_, red(p_270081_), red(p_270150_));
            int $$5 = Mth.lerpInt(p_270972_, green(p_270081_), green(p_270150_));
            int $$6 = Mth.lerpInt(p_270972_, blue(p_270081_), blue(p_270150_));
