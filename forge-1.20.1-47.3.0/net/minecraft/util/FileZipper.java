    ...
    public void add(Path p_144699_) {
        try {
            ...
            if (Files.isRegularFile(p_144699_, new LinkOption[0])) {
                ...
                Files.copy($$2, p_144699_);
            } else {
                Stream<Path> $$3 = Files.find(p_144699_, Integer.MAX_VALUE, (p_144707_, p_144708_) -> {
                    return p_144708_.isRegularFile();
                }, new FileVisitOption[0]);

                try {
                    Iterator var4 = ((List)$$3.collect(Collectors.toList())).iterator();
