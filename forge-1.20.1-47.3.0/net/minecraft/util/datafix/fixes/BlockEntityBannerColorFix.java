...
public class BlockEntityBannerColorFix extends NamedEntityFix {
    ...
    public Dynamic<?> fixTag(Dynamic<?> p_14798_) {
        ...
        p_14798_ = p_14798_.update("Patterns", (p_14802_) -> {
            DataResult var10000 = p_14802_.asStreamOpt().map((p_145125_) -> {
            ...
            Objects.requireNonNull(p_14802_);
            return (Dynamic)DataFixUtils.orElse(var10000.map(p_14802_::createList).result(), p_14802_);
        });
        return p_14798_;
    }
