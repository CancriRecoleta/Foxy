...
public class BlockEntityRenameFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        TaggedChoice.TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(References.BLOCK_ENTITY);
        TaggedChoice.TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(References.BLOCK_ENTITY);
        return this.fixTypeEverywhere(this.name, $$0, $$1, (p_277946_) -> {
            return (p_277512_) -> {
