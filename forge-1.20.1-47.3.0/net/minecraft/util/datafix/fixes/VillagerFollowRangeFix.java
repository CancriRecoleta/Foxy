    ...
    private static Dynamic<?> fixValue(Dynamic<?> p_17068_) {
        return p_17068_.update("Attributes", (p_17071_) -> {
            return p_17068_.createList(p_17071_.asStream().map((p_145760_) -> {
                return p_145760_.get("Name").asString("").equals("generic.follow_range") && p_145760_.get("Base").asDouble(0.0) == 16.0 ? p_145760_.set("Base", p_145760_.createDouble(48.0)) : p_145760_;
            }));
        });
    }
}
