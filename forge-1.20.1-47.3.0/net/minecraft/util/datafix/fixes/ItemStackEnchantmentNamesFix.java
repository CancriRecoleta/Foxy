...
public class ItemStackEnchantmentNamesFix extends DataFix {
    private static final Int2ObjectMap<String> MAP = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_16075_) -> {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemStackEnchantmentFix", $$0, (p_16069_) -> {
            return p_16069_.updateTyped($$1, (p_145419_) -> {
    ...
    private Dynamic<?> fixTag(Dynamic<?> p_16073_) {
        DataResult var10000 = p_16073_.get("ench").asStreamOpt().map((p_16081_) -> {
            return p_16081_.map((p_145425_) -> {
                return p_145425_.set("id", p_145425_.createString((String)MAP.getOrDefault(p_145425_.get("id").asInt(0), "null")));
            });
        });
        Objects.requireNonNull(p_16073_);
        Optional<? extends Dynamic<?>> $$1 = var10000.map(p_16073_::createList).result();
        if ($$1.isPresent()) {
            p_16073_ = p_16073_.remove("ench").set("Enchantments", (Dynamic)$$1.get());
        }

        return p_16073_.update("StoredEnchantments", (p_16079_) -> {
            DataResult var10000 = p_16079_.asStreamOpt().map((p_145421_) -> {
                return p_145421_.map((p_145423_) -> {
                    return p_145423_.set("id", p_145423_.createString((String)MAP.getOrDefault(p_145423_.get("id").asInt(0), "null")));
                });
            });
            Objects.requireNonNull(p_16079_);
            return (Dynamic)DataFixUtils.orElse(var10000.map(p_16079_::createList).result(), p_16079_);
        });
    }
}
