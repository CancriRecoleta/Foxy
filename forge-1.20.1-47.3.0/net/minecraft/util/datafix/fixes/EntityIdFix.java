...
public class EntityIdFix extends DataFix {
    private static final Map<String, String> ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_15465_) -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", $$2, $$3), this.fixTypeEverywhere("EntityIdFix", $$0, $$1, (p_15461_) -> {
            return (p_145282_) -> {
                return p_145282_.mapFirst((p_145284_) -> {
                    return (String)ID_MAP.getOrDefault(p_145284_, p_145284_);
                });
            };
        }));
    }
