...
public abstract class AbstractUUIDFix extends DataFix {
    ...
    protected Typed<?> updateNamedChoice(Typed<?> p_14575_, String p_14576_, Function<Dynamic<?>, Dynamic<?>> p_14577_) {
        Type<?> $$3 = this.getInputSchema().getChoiceType(this.typeReference, p_14576_);
        Type<?> $$4 = this.getOutputSchema().getChoiceType(this.typeReference, p_14576_);
        return p_14575_.updateTyped(DSL.namedChoice(p_14576_, $$3), $$4, (p_14607_) -> {
    ...
    protected static Optional<Dynamic<?>> replaceUUIDLeastMost(Dynamic<?> p_14618_, String p_14619_, String p_14620_) {
        String $$3 = p_14619_ + "Most";
        String $$4 = p_14619_ + "Least";
        return createUUIDFromLongs(p_14618_, $$3, $$4).map((p_14604_) -> {
            return p_14618_.remove($$3).remove($$4).set(p_14620_, p_14604_);
        });
    }
    ...
    protected static Optional<Dynamic<?>> createUUIDFromString(Dynamic<?> p_14588_, String p_14589_) {
        return p_14588_.get(p_14589_).result().flatMap((p_14586_) -> {
            String $$2 = p_14586_.asString((String)null);
            if ($$2 != null) {
                try {
                    UUID $$3 = UUID.fromString($$2);
                    return createUUIDTag(p_14588_, $$3.getMostSignificantBits(), $$3.getLeastSignificantBits());
    ...
    protected static Optional<Dynamic<?>> createUUIDFromLongs(Dynamic<?> p_14622_, String p_14623_, String p_14624_) {
        long $$3 = p_14622_.get(p_14623_).asLong(0L);
        long $$4 = p_14622_.get(p_14624_).asLong(0L);
        return $$3 != 0L && $$4 != 0L ? createUUIDTag(p_14622_, $$3, $$4) : Optional.empty();
    }
