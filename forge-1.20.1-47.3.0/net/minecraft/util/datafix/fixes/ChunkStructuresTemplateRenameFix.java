...
public class ChunkStructuresTemplateRenameFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", $$0, (p_274927_) -> {
    ...
    private Dynamic<?> fixTag(Dynamic<?> p_15281_, Dynamic<?> p_15282_) {
        ...
        if (RENAMES.containsKey($$2)) {
            ...
            if (((String)$$3.getFirst()).equals(p_15282_.get("id").asString(""))) {
                String $$4 = p_15282_.get("Template").asString("");
                p_15282_ = p_15282_.set("Template", p_15282_.createString((String)((ImmutableMap)$$3.getSecond()).getOrDefault($$4, $$4)));
            }
        }
