...
public class JigsawRotationFix extends DataFix {
    ...
    private static Dynamic<?> fix(Dynamic<?> p_16196_) {
        Optional<String> $$1 = p_16196_.get("Name").asString().result();
        return $$1.equals(Optional.of("minecraft:jigsaw")) ? p_16196_.update("Properties", (p_16198_) -> {
            String $$1 = p_16198_.get("facing").asString("north");
            return p_16198_.remove("facing").set("orientation", p_16198_.createString((String)RENAMES.getOrDefault($$1, $$1)));
        }) : p_16196_;
    }
