...
public class BlockEntityIdFix extends DataFix {
    private static final Map<String, String> ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_14839_) -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        TaggedChoice.TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(References.BLOCK_ENTITY);
        TaggedChoice.TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(References.BLOCK_ENTITY);
        return TypeRewriteRule.seq(this.convertUnchecked("item stack block entity name hook converter", $$0, $$1), this.fixTypeEverywhere("BlockEntityIdFix", $$2, $$3, (p_14835_) -> {
            return (p_145135_) -> {
                return p_145135_.mapFirst((p_145137_) -> {
                    return (String)ID_MAP.getOrDefault(p_145137_, p_145137_);
                });
            };
        }));
    }
