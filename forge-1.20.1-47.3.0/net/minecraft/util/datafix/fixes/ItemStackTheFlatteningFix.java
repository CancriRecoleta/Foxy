...
public class ItemStackTheFlatteningFix extends DataFix {
    private static final Map<String, String> MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_16126_) -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, (p_16119_) -> {
            ...
            if (!$$3.isPresent()) {
                ...
                if ($$7 != null) {
                    $$4 = $$4.set($$1, Pair.of(References.ITEM_NAME.typeName(), $$7));
                }
                ...
                $$4 = $$4.set(DSL.remainderFinder(), $$5.remove("Damage"));
                return $$4;
            }
        });
    }
    ...
    public static String updateItem(@Nullable String p_16123_, int p_16124_) {
        if (IDS.contains(p_16123_)) {
            String $$2 = (String)MAP.get(p_16123_ + "." + p_16124_);
            return $$2 == null ? (String)MAP.get(p_16123_ + ".0") : $$2;
        } else {
            return null;
        }
    }
    ...
    static {
        IDS = (Set)MAP.keySet().stream().map((p_16121_) -> {
