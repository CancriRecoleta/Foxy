    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", $$1, (p_16044_) -> {
            ...
            if ($$7x.isPresent() && Objects.equals(((Pair)$$7x.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                Optional<? extends Typed<?>> $$11 = $$10.flatMap((p_145417_) -> {
                    return p_145417_.getOptionalTyped($$5);
                });
                Optional<? extends Typed<?>> $$12 = $$11.flatMap((p_145414_) -> {
                    return p_145414_.getOptionalTyped($$6);
                });
                Optional<String> $$13 = $$12.flatMap((p_145406_) -> {
                    return p_145406_.getOptional($$3);
                });
                Typed<?> $$14 = p_16044_;
                ...
                if ($$15 != null && (!$$13.isPresent() || !Objects.equals($$13.get(), $$15))) {
                    ...
                    Dynamic<?> $$19 = $$8;
                    Typed<?> $$20 = (Typed)((Pair)$$18.write().flatMap((p_145411_) -> {
                        return $$7.readTyped(p_145411_.set("id", $$19.createString($$15)));
                    }).result().orElseThrow(() -> {
                        return new IllegalStateException("Could not parse new entity");
                    })).getFirst();
                    $$14 = $$14.set($$4, $$16.set($$5, $$17.set($$6, $$20)));
                }
