...
public class EntityBlockStateFix extends DataFix {
    private static final Map<String, Integer> MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_15368_) -> {
    ...
    public static int getBlockId(String p_15366_) {
        Integer $$1 = (Integer)MAP.get(p_15366_);
        return $$1 == null ? 0 : $$1;
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        Function<Typed<?>, Typed<?>> $$5 = (p_15348_) -> {
            return p_15348_.update($$4.finder(), DSL.remainderType(), Pair::getSecond);
        };
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", $$0.getType(References.ENTITY), $$1.getType(References.ENTITY), (p_15373_) -> {
            ...
            p_15373_ = this.updateEntity(p_15373_, "minecraft:arrow", $$3);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:spectral_arrow", $$3);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:egg", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:ender_pearl", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:fireball", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:potion", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:small_fireball", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:snowball", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:wither_skull", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:xp_bottle", $$5);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:commandblock_minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:chest_minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:furnace_minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:tnt_minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:hopper_minecart", $$2);
            p_15373_ = this.updateEntity(p_15373_, "minecraft:spawner_minecart", $$2);
            return p_15373_;
        });
    }
    ...
    private Typed<?> updateFallingBlock(Typed<?> p_15336_) {
        ...
        Dynamic<?> $$3 = (Dynamic)p_15336_.get(DSL.remainderFinder());
        return p_15336_.update($$1.finder(), $$2, (p_15355_) -> {
            int $$2 = (Integer)p_15355_.map((p_145262_) -> {
                return (Integer)((Either)p_145262_.getSecond()).map((p_145273_) -> {
                    return p_145273_;
                }, EntityBlockStateFix::getBlockId);
            }, (p_145267_) -> {
                Optional<Number> $$2 = $$3.get("TileID").asNumber().result();
                return (Integer)$$2.map(Number::intValue).orElseGet(() -> {
                    return $$3.get("Tile").asByte((byte)0) & 255;
                });
            });
            int $$3x = $$3.get("Data").asInt(0) & 15;
            return Either.left(Pair.of(References.BLOCK_STATE.typeName(), BlockStateData.getTag($$2 << 4 | $$3x)));
    ...
    private Typed<?> updateBlockToBlockState(Typed<?> p_15338_, String p_15339_, String p_15340_, String p_15341_) {
        Type<Pair<String, Either<Integer, String>>> $$4 = DSL.field(p_15339_, DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString())));
        Type<Pair<String, Dynamic<?>>> $$5 = DSL.field(p_15341_, DSL.named(References.BLOCK_STATE.typeName(), DSL.remainderType()));
        Dynamic<?> $$6 = (Dynamic)p_15338_.getOrCreate(DSL.remainderFinder());
        return p_15338_.update($$4.finder(), $$5, (p_15362_) -> {
            int $$3 = (Integer)((Either)p_15362_.getSecond()).map((p_145269_) -> {
                return p_145269_;
            }, EntityBlockStateFix::getBlockId);
            int $$4 = $$6.get(p_15340_).asInt(0) & 15;
            return Pair.of(References.BLOCK_STATE.typeName(), BlockStateData.getTag($$3 << 4 | $$4));
        }).set(DSL.remainderFinder(), $$6.remove(p_15340_));
    }

    private Typed<?> updateEntity(Typed<?> p_15343_, String p_15344_, Function<Typed<?>, Typed<?>> p_15345_) {
        Type<?> $$3 = this.getInputSchema().getChoiceType(References.ENTITY, p_15344_);
        Type<?> $$4 = this.getOutputSchema().getChoiceType(References.ENTITY, p_15344_);
        return p_15343_.updateTyped(DSL.namedChoice(p_15344_, $$3), $$4, p_15345_);
    }
}
