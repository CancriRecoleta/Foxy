...
public class CauldronRenameFix extends DataFix {
    ...
    private static Dynamic<?> fix(Dynamic<?> p_145201_) {
        Optional<String> $$1 = p_145201_.get("Name").asString().result();
        if ($$1.equals(Optional.of("minecraft:cauldron"))) {
            Dynamic<?> $$2 = p_145201_.get("Properties").orElseEmptyMap();
            return $$2.get("level").asString("0").equals("0") ? p_145201_.remove("Properties") : p_145201_.set("Name", p_145201_.createString("minecraft:water_cauldron"));
        } else {
            return p_145201_;
        }
    }
