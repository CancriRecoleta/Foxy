...
public class OptionsKeyLwjgl3Fix extends DataFix {
    ...
    private static final Int2ObjectMap<String> MAP = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_16640_) -> {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(References.OPTIONS), (p_16633_) -> {
            return p_16633_.update(DSL.remainderFinder(), (p_145575_) -> {
                return (Dynamic)p_145575_.getMapValues().map((p_145578_) -> {
                    return p_145575_.createMap((Map)p_145578_.entrySet().stream().map((p_145580_) -> {
                        if (((Dynamic)p_145580_.getKey()).asString("").startsWith("key_")) {
                            ...
                            if ($$1 < 0) {
                                ...
                                return Pair.of((Dynamic)p_145580_.getKey(), ((Dynamic)p_145580_.getValue()).createString($$6));
                            } else {
