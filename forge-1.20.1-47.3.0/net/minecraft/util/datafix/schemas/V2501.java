...
public class V2501 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_17857_) {
        Map<String, Supplier<TypeTemplate>> $$1 = super.registerBlockEntities(p_17857_);
        registerFurnace(p_17857_, $$1, "minecraft:furnace");
        registerFurnace(p_17857_, $$1, "minecraft:smoker");
        registerFurnace(p_17857_, $$1, "minecraft:blast_furnace");
        return $$1;
    }
}
