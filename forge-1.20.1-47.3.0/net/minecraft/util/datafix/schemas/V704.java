...
public class V704 extends Schema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_18063_) {
        ...
        registerInventory(p_18063_, $$1, "minecraft:furnace");
        registerInventory(p_18063_, $$1, "minecraft:chest");
        p_18063_.registerSimple($$1, "minecraft:ender_chest");
        p_18063_.register($$1, "minecraft:jukebox", (p_18058_) -> {
            return DSL.optionalFields("RecordItem", References.ITEM_STACK.in(p_18063_));
        });
        registerInventory(p_18063_, $$1, "minecraft:dispenser");
        registerInventory(p_18063_, $$1, "minecraft:dropper");
        p_18063_.registerSimple($$1, "minecraft:sign");
        p_18063_.register($$1, "minecraft:mob_spawner", (p_18055_) -> {
            return References.UNTAGGED_SPAWNER.in(p_18063_);
        });
        p_18063_.registerSimple($$1, "minecraft:noteblock");
        p_18063_.registerSimple($$1, "minecraft:piston");
        registerInventory(p_18063_, $$1, "minecraft:brewing_stand");
        p_18063_.registerSimple($$1, "minecraft:enchanting_table");
        p_18063_.registerSimple($$1, "minecraft:end_portal");
        p_18063_.registerSimple($$1, "minecraft:beacon");
        p_18063_.registerSimple($$1, "minecraft:skull");
        p_18063_.registerSimple($$1, "minecraft:daylight_detector");
        registerInventory(p_18063_, $$1, "minecraft:hopper");
        p_18063_.registerSimple($$1, "minecraft:comparator");
        p_18063_.register($$1, "minecraft:flower_pot", (p_18042_) -> {
            return DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in(p_18063_)));
        });
        p_18063_.registerSimple($$1, "minecraft:banner");
        p_18063_.registerSimple($$1, "minecraft:structure_block");
        p_18063_.registerSimple($$1, "minecraft:end_gateway");
        p_18063_.registerSimple($$1, "minecraft:command_block");
        return $$1;
    }
