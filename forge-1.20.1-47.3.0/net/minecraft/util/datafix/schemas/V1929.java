...
public class V1929 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_17820_) {
        Map<String, Supplier<TypeTemplate>> $$1 = super.registerEntities(p_17820_);
        p_17820_.register($$1, "minecraft:wandering_trader", (p_17818_) -> {
        ...
        p_17820_.register($$1, "minecraft:trader_llama", (p_17815_) -> {
