...
public class WorldGenTickAccess<T> implements LevelTickAccess<T> {
    ...
    public boolean hasScheduledTick(BlockPos p_193459_, T p_193460_) {
        return ((TickContainerAccess)this.containerGetter.apply(p_193459_)).hasScheduledTick(p_193459_, p_193460_);
    }

    public void schedule(ScheduledTick<T> p_193457_) {
        ((TickContainerAccess)this.containerGetter.apply(p_193457_.pos())).schedule(p_193457_);
    }
