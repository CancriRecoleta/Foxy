...
public class BeaconMenu extends AbstractContainerMenu {
    ...
    public BeaconMenu(int p_39039_, Container p_39040_, ContainerData p_39041_, ContainerLevelAccess p_39042_) {
        ...
        for(i1 = 0; i1 < 3; ++i1) {
            for(int l = 0; l < 9; ++l) {
                this.addSlot(new Slot(p_39040_, l + i1 * 9 + 9, 36 + l * 18, 137 + i1 * 18));
            }
        }
    ...
    public ItemStack quickMoveStack(Player p_39051_, int p_39052_) {
        ...
        Slot slot = (Slot)this.slots.get(p_39052_);
    ...
    public void updateEffects(Optional<MobEffect> p_219973_, Optional<MobEffect> p_219974_) {
        if (this.paymentSlot.hasItem()) {
            this.beaconData.set(1, (Integer)p_219973_.map(MobEffect::getId).orElse(-1));
            this.beaconData.set(2, (Integer)p_219974_.map(MobEffect::getId).orElse(-1));
