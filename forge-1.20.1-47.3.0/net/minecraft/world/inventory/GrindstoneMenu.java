...
public class GrindstoneMenu extends AbstractContainerMenu {
    ...
    public GrindstoneMenu(int p_39566_, Inventory p_39567_, final ContainerLevelAccess p_39568_) {
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34) {
            ...
            public void onTake(Player p_150574_, ItemStack p_150575_) {
                if (!ForgeHooks.onGrindstoneTake(GrindstoneMenu.this.repairSlots, p_39568_, this::getExperienceAmount)) {
        ...
        for(k = 0; k < 3; ++k) {
            for(int j = 0; j < 9; ++j) {
                this.addSlot(new Slot(p_39567_, j + k * 9 + 9, 8 + j * 18, 84 + k * 18));
            }
        }
    ...
    private void createResult() {
        ...
        this.xp = ForgeHooks.onGrindstoneChange(itemstack, itemstack1, this.resultSlots, -1);
    ...
    private ItemStack mergeEnchants(ItemStack p_39591_, ItemStack p_39592_) {
        ...
        while(true) {
            ...
            } while(enchantment.isCurse() && EnchantmentHelper.getTagEnchantmentLevel(enchantment, itemstack) != 0);
    ...
    private ItemStack removeNonCurses(ItemStack p_39580_, int p_39581_, int p_39582_) {
        ...
        Map<Enchantment, Integer> map = (Map)EnchantmentHelper.getEnchantments(p_39580_).entrySet().stream().filter((p_39584_) -> {
            return ((Enchantment)p_39584_.getKey()).isCurse();
