...
public class InventoryMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public InventoryMenu(Inventory p_39706_, boolean p_39707_, final Player p_39708_) {
        ...
        for(i1 = 0; i1 < 4; ++i1) {
            final EquipmentSlot equipmentslot = SLOT_IDS[i1];
            this.addSlot(new Slot(p_39706_, 39 - i1, 8, 8 + i1 * 18) {
                ...
                public boolean mayPlace(ItemStack p_39746_) {
                    return p_39746_.canEquip(equipmentslot, InventoryMenu.this.owner);
                }
        ...
        for(i1 = 0; i1 < 3; ++i1) {
            for(j1 = 0; j1 < 9; ++j1) {
                this.addSlot(new Slot(p_39706_, j1 + (i1 + 1) * 9, 8 + j1 * 18, 84 + i1 * 18));
            }
        }
    ...
    public ItemStack quickMoveStack(Player p_39723_, int p_39724_) {
        ...
        Slot slot = (Slot)this.slots.get(p_39724_);
        if (slot.hasItem()) {
            ...
            } else if (equipmentslot.getType() == Type.ARMOR && !((Slot)this.slots.get(8 - equipmentslot.getIndex())).hasItem()) {
