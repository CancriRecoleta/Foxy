...
public class StonecutterMenu extends AbstractContainerMenu {
            ...
            public void onTake(Player p_150672_, ItemStack p_150673_) {
                ...
                p_40299_.execute((p_40364_, p_40365_) -> {
                    ...
                    if (StonecutterMenu.this.lastSoundTime != $$2) {
                        p_40364_.playSound((Player)null, (BlockPos)p_40365_, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
    ...
    public ItemStack quickMoveStack(Player p_40328_, int p_40329_) {
        ...
        if ($$3 != null && $$3.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(RecipeType.STONECUTTING, new SimpleContainer(new ItemStack[]{$$4}), this.level).isPresent()) {
