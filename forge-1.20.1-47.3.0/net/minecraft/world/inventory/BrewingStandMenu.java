...
public class BrewingStandMenu extends AbstractContainerMenu {
    ...
    public BrewingStandMenu(int p_39093_, Inventory p_39094_, Container p_39095_, ContainerData p_39096_) {
        ...
        for(k = 0; k < 3; ++k) {
            for(int j = 0; j < 9; ++j) {
                this.addSlot(new Slot(p_39094_, j + k * 9 + 9, 8 + j * 18, 84 + k * 18));
            }
        }
    ...
    public ItemStack quickMoveStack(Player p_39100_, int p_39101_) {
        ...
        Slot slot = (Slot)this.slots.get(p_39101_);
        if (slot != null && slot.hasItem()) {
            ItemStack itemstack1 = slot.getItem();
            itemstack = itemstack1.copy();
            if ((p_39101_ < 0 || p_39101_ > 2) && p_39101_ != 3 && p_39101_ != 4) {
                if (net.minecraft.world.inventory.BrewingStandMenu.FuelSlot.mayPlaceItem(itemstack)) {
                ...
                } else if (net.minecraft.world.inventory.BrewingStandMenu.PotionSlot.mayPlaceItem(itemstack)) {
    ...
    static class PotionSlot extends Slot {
        ...
        public void onTake(Player p_150499_, ItemStack p_150500_) {
            ...
            if (p_150499_ instanceof ServerPlayer) {
                ForgeEventFactory.onPlayerBrewedPotion(p_150499_, p_150500_);
        ...
        public static boolean mayPlaceItem(ItemStack p_39134_) {
            return BrewingRecipeRegistry.isValidInput(p_39134_);
        }
    }
    ...
    static class IngredientsSlot extends Slot {
        ...
        public boolean mayPlace(ItemStack p_39121_) {
            return BrewingRecipeRegistry.isValidIngredient(p_39121_);
        }
