...
public class ItemFrame extends HangingEntity {
    ...
    public boolean survives() {
        if (this.fixed) {
            ...
            return $$0.isSolid() || this.direction.getAxis().isHorizontal() && DiodeBlock.isDiode($$0) ? this.level().getEntities((Entity)this, this.getBoundingBox(), HANGING_ENTITY).isEmpty() : false;
        }
    }
