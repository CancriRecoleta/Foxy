...
public class PaintingVariants {
    ...
    public static PaintingVariant bootstrap(Registry<PaintingVariant> p_218943_) {
        Registry.register(p_218943_, (ResourceKey)KEBAB, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)AZTEC, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)ALBAN, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)AZTEC2, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)BOMB, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)PLANT, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)WASTELAND, new PaintingVariant(16, 16));
        Registry.register(p_218943_, (ResourceKey)POOL, new PaintingVariant(32, 16));
        Registry.register(p_218943_, (ResourceKey)COURBET, new PaintingVariant(32, 16));
        Registry.register(p_218943_, (ResourceKey)SEA, new PaintingVariant(32, 16));
        Registry.register(p_218943_, (ResourceKey)SUNSET, new PaintingVariant(32, 16));
        Registry.register(p_218943_, (ResourceKey)CREEBET, new PaintingVariant(32, 16));
        Registry.register(p_218943_, (ResourceKey)WANDERER, new PaintingVariant(16, 32));
        Registry.register(p_218943_, (ResourceKey)GRAHAM, new PaintingVariant(16, 32));
        Registry.register(p_218943_, (ResourceKey)MATCH, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)BUST, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)STAGE, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)VOID, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)SKULL_AND_ROSES, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)WITHER, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)FIGHTERS, new PaintingVariant(64, 32));
        Registry.register(p_218943_, (ResourceKey)POINTER, new PaintingVariant(64, 64));
        Registry.register(p_218943_, (ResourceKey)PIGSCENE, new PaintingVariant(64, 64));
        Registry.register(p_218943_, (ResourceKey)BURNING_SKULL, new PaintingVariant(64, 64));
        Registry.register(p_218943_, (ResourceKey)SKELETON, new PaintingVariant(64, 48));
        Registry.register(p_218943_, (ResourceKey)EARTH, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)WIND, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)WATER, new PaintingVariant(32, 32));
        Registry.register(p_218943_, (ResourceKey)FIRE, new PaintingVariant(32, 32));
        return (PaintingVariant)Registry.register(p_218943_, (ResourceKey)DONKEY_KONG, new PaintingVariant(64, 48));
    }
