...
public class ArmorStand extends LivingEntity {
    ...
    public ItemStack getItemBySlot(EquipmentSlot p_31612_) {
        switch (p_31612_.getType()) {
            case HAND -> return (ItemStack)this.handItems.get(p_31612_.getIndex());
            case ARMOR -> return (ItemStack)this.armorItems.get(p_31612_.getIndex());
    ...
    public void setItemSlot(EquipmentSlot p_31584_, ItemStack p_31585_) {
        ...
        switch (p_31584_.getType()) {
            case HAND -> this.onEquipItem(p_31584_, (ItemStack)this.handItems.set(p_31584_.getIndex(), p_31585_), p_31585_);
            case ARMOR -> this.onEquipItem(p_31584_, (ItemStack)this.armorItems.set(p_31584_.getIndex(), p_31585_), p_31585_);
        }
    ...
    public void readAdditionalSaveData(CompoundTag p_31600_) {
        ...
        if (p_31600_.contains("ArmorItems", 9)) {
            listtag1 = p_31600_.getList("ArmorItems", 10);
        ...
        if (p_31600_.contains("HandItems", 9)) {
            listtag1 = p_31600_.getList("HandItems", 10);
    ...
    protected void pushEntities() {
        List<Entity> list = this.level().getEntities((Entity)this, this.getBoundingBox(), RIDABLE_MINECARTS);
        ...
        if (!this.isMarker() && !itemstack.is(Items.NAME_TAG)) {
            if (p_31594_.isSpectator()) {
                ...
                if (itemstack.isEmpty()) {
                    ...
                    if (equipmentslot.getType() == Type.HAND && !this.isShowArms()) {
                        return InteractionResult.FAIL;
                    }
    ...
    private boolean isDisabled(EquipmentSlot p_31627_) {
        return (this.disabledSlots & 1 << p_31627_.getFilterFlag()) != 0 || p_31627_.getType() == Type.HAND && !this.isShowArms();
    }
    ...
    private void setSmall(boolean p_31604_) {
        this.entityData.set(DATA_CLIENT_FLAGS, this.setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 1, p_31604_));
    }
    ...
    public void setShowArms(boolean p_31676_) {
        this.entityData.set(DATA_CLIENT_FLAGS, this.setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 4, p_31676_));
    }
    ...
    public void setNoBasePlate(boolean p_31679_) {
        this.entityData.set(DATA_CLIENT_FLAGS, this.setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 8, p_31679_));
    }
    ...
    private void setMarker(boolean p_31682_) {
        this.entityData.set(DATA_CLIENT_FLAGS, this.setBit((Byte)this.entityData.get(DATA_CLIENT_FLAGS), 16, p_31682_));
    }
