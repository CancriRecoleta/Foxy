...
public abstract class HangingEntity extends Entity {
        ...
        if (!this.level().noCollision(this)) {
            ...
            for(int k = 0; k < i; ++k) {
                for(int l = 0; l < j; ++l) {
                    ...
                    if (!Block.canSupportCenter(this.level(), blockpos$mutableblockpos, this.direction) && !blockstate.isSolid() && !DiodeBlock.isDiode(blockstate)) {
                        return false;
                    }
                }
            }
    ...
    public float rotate(Rotation p_31727_) {
        if (this.direction.getAxis() != Axis.Y) {
            switch (p_31727_) {
        ...
        switch (p_31727_) {
            ...
            case COUNTERCLOCKWISE_90 -> return f + 90.0F;
            case CLOCKWISE_90 -> return f + 270.0F;
            default -> return f;
        }
    }
