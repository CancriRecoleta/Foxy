...
public class ItemEntity extends Entity implements TraceableEntity {
    ...
    private void mergeWithNeighbours() {
        if (this.isMergable()) {
            Iterator var1 = this.level().getEntitiesOfClass(ItemEntity.class, this.getBoundingBox().inflate(0.5, 0.0, 0.5), (p_186268_) -> {
    ...
    public void playerTouch(Player p_32040_) {
        if (!this.level().isClientSide) {
            ...
            int hook = ForgeEventFactory.onItemPickup(this, p_32040_);
            if (hook < 0) {
                return;
            }
            ...
            if (this.pickupDelay == 0 && (this.target == null || this.target.equals(p_32040_.getUUID())) && (hook == 1 || i <= 0 || p_32040_.getInventory().add(itemstack))) {
                ...
                copy.setCount(i);
                ForgeEventFactory.firePlayerItemPickupEvent(p_32040_, this, copy);
