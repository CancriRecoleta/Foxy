...
public class EndCrystal extends Entity {
        ...
        if (this.isInvulnerableTo(p_31050_)) {
            ...
            if (!this.isRemoved() && !this.level().isClientSide) {
                ...
                if (!p_31050_.is(DamageTypeTags.IS_EXPLOSION)) {
                    DamageSource $$2 = p_31050_.getEntity() != null ? this.damageSources().explosion(this, p_31050_.getEntity()) : null;
                    this.level().explode(this, $$2, (ExplosionDamageCalculator)null, this.getX(), this.getY(), this.getZ(), 6.0F, false, ExplosionInteraction.BLOCK);
                }
    ...
    private void onDestroyedBy(DamageSource p_31048_) {
        if (this.level() instanceof ServerLevel) {
            EndDragonFight $$1 = ((ServerLevel)this.level()).getDragonFight();
            if ($$1 != null) {
                $$1.onCrystalDestroyed(this, p_31048_);
            }
        }
