...
public final class EntitySelector {
    ...
    public static Predicate<Entity> withinDistance(double p_20411_, double p_20412_, double p_20413_, double p_20414_) {
        ...
        return (p_20420_) -> {
            return p_20420_ != null && p_20420_.distanceToSqr(p_20411_, p_20412_, p_20413_) <= $$4;
        };
    }

    public static Predicate<Entity> pushableBy(Entity p_20422_) {
        Team $$1 = p_20422_.getTeam();
        Team.CollisionRule $$2 = $$1 == null ? CollisionRule.ALWAYS : $$1.getCollisionRule();
        return (Predicate)($$2 == CollisionRule.NEVER ? Predicates.alwaysFalse() : NO_SPECTATORS.and((p_20430_) -> {
            if (!p_20430_.isPushable()) {
                ...
                Team.CollisionRule $$5 = $$4 == null ? CollisionRule.ALWAYS : $$4.getCollisionRule();
                if ($$5 == CollisionRule.NEVER) {
                    return false;
                } else {
                    boolean $$6 = $$1 != null && $$1.isAlliedTo($$4);
                    if (($$2 == CollisionRule.PUSH_OWN_TEAM || $$5 == CollisionRule.PUSH_OWN_TEAM) && $$6) {
                        return false;
                    } else {
                        return $$2 != CollisionRule.PUSH_OTHER_TEAMS && $$5 != CollisionRule.PUSH_OTHER_TEAMS || $$6;
                    }
                }
            }
        }));
