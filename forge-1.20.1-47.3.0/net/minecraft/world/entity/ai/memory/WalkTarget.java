...
public class WalkTarget {
    ...
    public WalkTarget(BlockPos p_26417_, float p_26418_, int p_26419_) {
        this((PositionTracker)(new BlockPosTracker(p_26417_)), p_26418_, p_26419_);
    }

    public WalkTarget(Vec3 p_26413_, float p_26414_, int p_26415_) {
        this((PositionTracker)(new BlockPosTracker(BlockPos.containing(p_26413_))), p_26414_, p_26415_);
    }

    public WalkTarget(Entity p_148209_, float p_148210_, int p_148211_) {
        this((PositionTracker)(new EntityTracker(p_148209_, false)), p_148210_, p_148211_);
    }
