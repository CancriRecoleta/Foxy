...
public class VillageSiege implements CustomSpawner {
    ...
    public int tick(ServerLevel p_27013_, boolean p_27014_, boolean p_27015_) {
        if (!p_27013_.isDay() && p_27014_) {
            ...
            if ((double)f == 0.5) {
                this.siegeState = p_27013_.random.nextInt(10) == 0 ? net.minecraft.world.entity.ai.village.VillageSiege.State.SIEGE_TONIGHT : net.minecraft.world.entity.ai.village.VillageSiege.State.SIEGE_DONE;
            }
    ...
    private boolean tryToSetupSiege(ServerLevel p_27008_) {
        Iterator var2 = p_27008_.players().iterator();
        ...
        while(var2.hasNext()) {
            ...
            if (!player.isSpectator()) {
                ...
                if (p_27008_.isVillage(blockpos) && !p_27008_.getBiome(blockpos).is(BiomeTags.WITHOUT_ZOMBIE_SIEGES)) {
                    for(int i = 0; i < 10; ++i) {
                        float f = p_27008_.random.nextFloat() * 6.2831855F;
                        ...
                        if (siegeLocation != null) {
                            if (MinecraftForge.EVENT_BUS.post(new VillageSiegeEvent(this, p_27008_, player, siegeLocation))) {
                                return false;
                            }
    ...
    private void trySpawn(ServerLevel p_27017_) {
        ...
        if (vec3 != null) {
            Zombie zombie;
            try {
                zombie = (Zombie)EntityType.ZOMBIE.create(p_27017_);
    ...
    private Vec3 findRandomSpawnPos(ServerLevel p_27010_, BlockPos p_27011_) {
        for(int i = 0; i < 10; ++i) {
            ...
            int l = p_27010_.getHeight(Types.WORLD_SURFACE, j, k);
