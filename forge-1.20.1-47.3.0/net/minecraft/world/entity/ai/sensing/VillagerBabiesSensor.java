...
public class VillagerBabiesSensor extends Sensor<LivingEntity> {
    ...
    protected void doTick(ServerLevel p_26834_, LivingEntity p_26835_) {
        p_26835_.getBrain().setMemory(MemoryModuleType.VISIBLE_VILLAGER_BABIES, (Object)this.getNearestVillagerBabies(p_26835_));
    }
    ...
    private NearestVisibleLivingEntities getVisibleEntities(LivingEntity p_186204_) {
        return (NearestVisibleLivingEntities)p_186204_.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).orElse(NearestVisibleLivingEntities.empty());
    }
}
