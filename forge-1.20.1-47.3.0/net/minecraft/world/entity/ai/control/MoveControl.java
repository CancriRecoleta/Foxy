...
public class MoveControl implements Control {
    ...
    public boolean hasWanted() {
        return this.operation == net.minecraft.world.entity.ai.control.MoveControl.Operation.MOVE_TO;
    }
    ...
    public void tick() {
        ...
        if (this.operation == net.minecraft.world.entity.ai.control.MoveControl.Operation.STRAFE) {
            ...
            if (d2 > (double)this.mob.getStepHeight() && d0 * d0 + d1 * d1 < (double)Math.max(1.0F, this.mob.getBbWidth()) || !voxelshape.isEmpty() && this.mob.getY() < voxelshape.max(Axis.Y) + (double)blockpos.getY() && !blockstate.is(BlockTags.DOORS) && !blockstate.is(BlockTags.FENCES)) {
