...
public class DefaultAttributes {
    ...
    public static AttributeSupplier getSupplier(EntityType<? extends LivingEntity> p_22298_) {
        AttributeSupplier supplier = (AttributeSupplier)ForgeHooks.getAttributesView().get(p_22298_);
        return supplier != null ? supplier : (AttributeSupplier)SUPPLIERS.get(p_22298_);
    }

    public static boolean hasSupplier(EntityType<?> p_22302_) {
        return SUPPLIERS.containsKey(p_22302_) || ForgeHooks.getAttributesView().containsKey(p_22302_);
    }

    public static void validate() {
        Stream var10000 = BuiltInRegistries.ENTITY_TYPE.stream().filter((p_22306_) -> {
        ...
        var10000.map(var10001::getKey).forEach((p_22300_) -> {
