...
public abstract class PathNavigation {
    ...
    public Path createPath(Stream<BlockPos> p_26557_, int p_26558_) {
        return this.createPath((Set)p_26557_.collect(Collectors.toSet()), 8, false, p_26558_);
    }
    ...
    public boolean moveTo(Entity p_26532_, double p_26533_) {
        Path path = this.createPath((Entity)p_26532_, 1);
    ...
    public void tick() {
        ...
        if (!this.isDone()) {
            ...
            if (this.canUpdatePath()) {
                ...
                vec32 = this.getTempMobPos();
                Vec3 vec31 = this.path.getNextEntityPos(this.mob);
                if (vec32.y > vec31.y && !this.mob.onGround() && Mth.floor(vec32.x) == Mth.floor(vec31.x) && Mth.floor(vec32.z) == Mth.floor(vec31.z)) {
                    this.path.advance();
                }
            }
    ...
    protected static boolean isClearForMovementBetween(Mob p_262599_, Vec3 p_262674_, Vec3 p_262586_, boolean p_262676_) {
        ...
        return p_262599_.level().clip(new ClipContext(p_262674_, vec3, Block.COLLIDER, p_262676_ ? Fluid.ANY : Fluid.NONE, p_262599_)).getType() == Type.MISS;
    }
