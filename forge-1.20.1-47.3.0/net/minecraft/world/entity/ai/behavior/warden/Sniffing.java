...
public class Sniffing<E extends Warden> extends Behavior<E> {
    ...
    protected void stop(ServerLevel p_217672_, E p_217673_, long p_217674_) {
        ...
        Optional var10000 = p_217673_.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE);
        Objects.requireNonNull(p_217673_);
        var10000.filter(p_217673_::canTargetEntity).ifPresent((p_289391_) -> {
            if (p_217673_.closerThan(p_289391_, 6.0, 20.0)) {
