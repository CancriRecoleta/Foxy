...
public class JumpOnBed extends Behavior<Mob> {
    ...
    private void startWalkingTowardsBed(Mob p_23362_, BlockPos p_23363_) {
        p_23362_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(p_23363_, this.speedModifier, 0)));
    }
    ...
    private boolean onOrOverBed(ServerLevel p_23380_, Mob p_23381_) {
        BlockPos $$2 = p_23381_.blockPosition();
        BlockPos $$3 = $$2.below();
        return this.isBed(p_23380_, $$2) || this.isBed(p_23380_, $$3);
    }
