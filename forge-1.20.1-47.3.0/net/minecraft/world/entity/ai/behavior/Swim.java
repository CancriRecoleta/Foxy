...
public class Swim extends Behavior<Mob> {
    ...
    protected boolean checkExtraStartConditions(ServerLevel p_24388_, Mob p_24389_) {
        return p_24389_.isInWater() && p_24389_.getFluidHeight(FluidTags.WATER) > p_24389_.getFluidJumpThreshold() || p_24389_.isInLava() || p_24389_.isInFluidType((fluidType, height) -> {
            return p_24389_.canSwimInFluidType(fluidType) && height > p_24389_.getFluidJumpThreshold();
        });
    }
