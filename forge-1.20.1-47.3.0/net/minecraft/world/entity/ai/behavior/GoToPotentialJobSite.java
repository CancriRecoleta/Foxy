...
public class GoToPotentialJobSite extends Behavior<Villager> {
    ...
    protected boolean checkExtraStartConditions(ServerLevel p_23103_, Villager p_23104_) {
        return (Boolean)p_23104_.getBrain().getActiveNonCoreActivity().map((p_23115_) -> {
    ...
    protected void tick(ServerLevel p_23121_, Villager p_23122_, long p_23123_) {
        BehaviorUtils.setWalkAndLookTargetMemories(p_23122_, (BlockPos)((GlobalPos)p_23122_.getBrain().getMemory(MemoryModuleType.POTENTIAL_JOB_SITE).get()).pos(), this.speedModifier, 1);
    }
