...
public class RandomLookAround extends Behavior<Mob> {
    ...
    protected void start(ServerLevel p_250941_, Mob p_248765_, long p_251801_) {
        RandomSource $$3 = p_248765_.getRandom();
        float $$4 = Mth.clamp($$3.nextFloat() * this.pitchRange + this.minPitch, -90.0F, 90.0F);
        float $$5 = Mth.wrapDegrees(p_248765_.getYRot() + 2.0F * $$3.nextFloat() * this.maxYaw - this.maxYaw);
        Vec3 $$6 = Vec3.directionFromRotation($$4, $$5);
        p_248765_.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, (Object)(new BlockPosTracker(p_248765_.getEyePosition().add($$6))));
        p_248765_.getBrain().setMemory(MemoryModuleType.GAZE_COOLDOWN_TICKS, (Object)this.interval.sample($$3));
    }
}
