...
public class LongJumpMidJump extends Behavior<Mob> {
    ...
    protected void stop(ServerLevel p_147619_, Mob p_147620_, long p_147621_) {
        if (p_147620_.onGround()) {
            p_147620_.setDeltaMovement(p_147620_.getDeltaMovement().multiply(0.10000000149011612, 1.0, 0.10000000149011612));
        ...
        p_147620_.getBrain().setMemory(MemoryModuleType.LONG_JUMP_COOLDOWN_TICKS, (Object)this.timeBetweenLongJumps.sample(p_147619_.random));
    }
}
