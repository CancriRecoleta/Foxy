...
public abstract class Display extends Entity {
    ...
    private static Transformation createTransformation(SynchedEntityData p_270278_) {
        Vector3f $$1 = (Vector3f)p_270278_.get(DATA_TRANSLATION_ID);
        Quaternionf $$2 = (Quaternionf)p_270278_.get(DATA_LEFT_ROTATION_ID);
        Vector3f $$3 = (Vector3f)p_270278_.get(DATA_SCALE_ID);
        Quaternionf $$4 = (Quaternionf)p_270278_.get(DATA_RIGHT_ROTATION_ID);
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            if (this.updateStartTick) {
                ...
                int $$1 = this.getInterpolationDelay();
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_BILLBOARD_RENDER_CONSTRAINTS_ID, net.minecraft.world.entity.Display.BillboardConstraints.FIXED.getId());
    ...
    protected void readAdditionalSaveData(CompoundTag p_270854_) {
        ...
        if (p_270854_.contains("transformation")) {
            var10000 = Transformation.EXTENDED_CODEC.decode(NbtOps.INSTANCE, p_270854_.get("transformation"));
            var10002 = LOGGER;
            Objects.requireNonNull(var10002);
            var10000.resultOrPartial(Util.prefix("Display entity", var10002::error)).ifPresent((p_270952_) -> {
                this.setTransformation((Transformation)p_270952_.getFirst());
            });
        }

        int $$2;
        if (p_270854_.contains("interpolation_duration", 99)) {
            $$2 = p_270854_.getInt("interpolation_duration");
            this.setInterpolationDuration($$2);
        }

        if (p_270854_.contains("start_interpolation", 99)) {
            $$2 = p_270854_.getInt("start_interpolation");
            this.setInterpolationDelay($$2);
        }

        if (p_270854_.contains("billboard", 8)) {
            var10000 = net.minecraft.world.entity.Display.BillboardConstraints.CODEC.decode(NbtOps.INSTANCE, p_270854_.get("billboard"));
            var10002 = LOGGER;
            Objects.requireNonNull(var10002);
            var10000.resultOrPartial(Util.prefix("Display entity", var10002::error)).ifPresent((p_270691_) -> {
                this.setBillboardConstraints((BillboardConstraints)p_270691_.getFirst());
            });
        }
        ...
        if (p_270854_.contains("brightness", 10)) {
            var10000 = Brightness.CODEC.decode(NbtOps.INSTANCE, p_270854_.get("brightness"));
            var10002 = LOGGER;
            Objects.requireNonNull(var10002);
            var10000.resultOrPartial(Util.prefix("Display entity", var10002::error)).ifPresent((p_270247_) -> {
                this.setBrightnessOverride((Brightness)p_270247_.getFirst());
            });
        } else {
    ...
    protected void addAdditionalSaveData(CompoundTag p_270779_) {
        ...
        net.minecraft.world.entity.Display.BillboardConstraints.CODEC.encodeStart(NbtOps.INSTANCE, this.getBillboardConstraints()).result().ifPresent((p_270227_) -> {
        ...
        if ($$1 != null) {
            Brightness.CODEC.encodeStart(NbtOps.INSTANCE, $$1).result().ifPresent((p_270121_) -> {
    ...
    private BillboardConstraints getBillboardConstraints() {
        return (BillboardConstraints)net.minecraft.world.entity.Display.BillboardConstraints.BY_ID.apply((Byte)this.entityData.get(DATA_BILLBOARD_RENDER_CONSTRAINTS_ID));
    }
    ...
    private RenderState createFreshRenderState() {
        return new RenderState(net.minecraft.world.entity.Display.GenericInterpolator.constant(createTransformation(this.entityData)), this.getBillboardConstraints(), this.getPackedBrightnessOverride(), net.minecraft.world.entity.Display.FloatInterpolator.constant(this.getShadowRadius()), net.minecraft.world.entity.Display.FloatInterpolator.constant(this.getShadowStrength()), this.getGlowColorOverride());
    }

    private RenderState createInterpolatedRenderState(RenderState p_277365_, float p_277948_) {
        Transformation $$2 = (Transformation)p_277365_.transformation.get(p_277948_);
        float $$3 = p_277365_.shadowRadius.get(p_277948_);
        float $$4 = p_277365_.shadowStrength.get(p_277948_);
        return new RenderState(new TransformationInterpolator($$2, createTransformation(this.entityData)), this.getBillboardConstraints(), this.getPackedBrightnessOverride(), new LinearFloatInterpolator($$3, this.getShadowRadius()), new LinearFloatInterpolator($$4, this.getShadowStrength()), this.getGlowColorOverride());
    }
    ...
    public static enum BillboardConstraints implements StringRepresentable {
        ...
        public static final IntFunction<BillboardConstraints> BY_ID = ByIdMap.continuous(BillboardConstraints::getId, values(), OutOfBoundsStrategy.ZERO);
    ...
    public interface GenericInterpolator<T> {
        static <T> GenericInterpolator<T> constant(T p_277718_) {
            return (p_277907_) -> {
                return p_277718_;
            };
        }
    ...
    public interface FloatInterpolator {
        static FloatInterpolator constant(float p_277894_) {
            return (p_278040_) -> {
                return p_277894_;
            };
        }
    ...
    static record ColorInterpolator(int previous, int current) implements IntInterpolator {
        ...
        public int get(float p_278012_) {
            return ARGB32.lerp(p_278012_, this.previous, this.current);
        }
    ...
    public interface IntInterpolator {
        static IntInterpolator constant(int p_277348_) {
            return (p_277356_) -> {
                return p_277348_;
            };
        }
    ...
    public static class TextDisplay extends Display {
        ...
        protected void readAdditionalSaveData(CompoundTag p_270714_) {
            ...
            byte $$1 = loadFlag((byte)0, p_270714_, "shadow", (byte)1);
            $$1 = loadFlag($$1, p_270714_, "see_through", (byte)2);
            $$1 = loadFlag($$1, p_270714_, "default_background", (byte)4);
            DataResult var10000 = net.minecraft.world.entity.Display.TextDisplay.Align.CODEC.decode(NbtOps.INSTANCE, p_270714_.get("alignment"));
            Logger var10002 = Display.LOGGER;
            Objects.requireNonNull(var10002);
            Optional<Align> $$2 = var10000.resultOrPartial(Util.prefix("Display entity", var10002::error)).map(Pair::getFirst);
            if ($$2.isPresent()) {
                byte var10;
                switch ((Align)$$2.get()) {
                    case CENTER -> var10 = $$1;
                    case LEFT -> var10 = (byte)($$1 | 8);
                    case RIGHT -> var10 = (byte)($$1 | 16);
            ...
            if (p_270714_.contains("text", 8)) {
                String $$3 = p_270714_.getString("text");

                try {
                    Component $$4 = Serializer.fromJson($$3);
                    if ($$4 != null) {
                        CommandSourceStack $$5 = this.createCommandSourceStack().withPermission(2);
                        Component $$6 = ComponentUtils.updateForEntity($$5, (Component)$$4, this, 0);
                        this.setText($$6);
                    } else {
        ...
        protected void addAdditionalSaveData(CompoundTag p_270268_) {
            ...
            p_270268_.putString("text", Serializer.toJson(this.getText()));
            ...
            storeFlag($$1, p_270268_, "shadow", (byte)1);
            storeFlag($$1, p_270268_, "see_through", (byte)2);
            storeFlag($$1, p_270268_, "default_background", (byte)4);
            net.minecraft.world.entity.Display.TextDisplay.Align.CODEC.encodeStart(NbtOps.INSTANCE, getAlign($$1)).result().ifPresent((p_271001_) -> {
        ...
        private TextRenderState createFreshTextRenderState() {
            return new TextRenderState(this.getText(), this.getLineWidth(), net.minecraft.world.entity.Display.IntInterpolator.constant(this.getTextOpacity()), net.minecraft.world.entity.Display.IntInterpolator.constant(this.getBackgroundColor()), this.getFlags());
        }
        ...
        public static Align getAlign(byte p_270911_) {
            if ((p_270911_ & 8) != 0) {
                ...
                return (p_270911_ & 16) != 0 ? net.minecraft.world.entity.Display.TextDisplay.Align.RIGHT : net.minecraft.world.entity.Display.TextDisplay.Align.CENTER;
            }
        }
    ...
    public static class ItemDisplay extends Display {
        ...
        protected void readAdditionalSaveData(CompoundTag p_270713_) {
            ...
            if (p_270713_.contains("item_display", 8)) {
                DataResult var10000 = ItemDisplayContext.CODEC.decode(NbtOps.INSTANCE, p_270713_.get("item_display"));
                Logger var10002 = Display.LOGGER;
                Objects.requireNonNull(var10002);
                var10000.resultOrPartial(Util.prefix("Display entity", var10002::error)).ifPresent((p_270456_) -> {
                    this.setItemTransform((ItemDisplayContext)p_270456_.getFirst());
                });
            }
