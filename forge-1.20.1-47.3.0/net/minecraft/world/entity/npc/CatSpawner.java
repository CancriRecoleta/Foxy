...
public class CatSpawner implements CustomSpawner {
            ...
            if (this.nextTick > 0) {
                ...
                if (player == null) {
                    ...
                    if (!p_35330_.hasChunksAt(blockpos.getX() - 10, blockpos.getZ() - 10, blockpos.getX() + 10, blockpos.getZ() + 10)) {
                        ...
                        if (NaturalSpawner.isSpawnPositionOk(Type.ON_GROUND, p_35330_, blockpos, EntityType.CAT)) {
    ...
    private int spawnInVillage(ServerLevel p_35327_, BlockPos p_35328_) {
        ...
        }, p_35328_, 48, Occupancy.IS_OCCUPIED) > 4L) {
    ...
    private int spawnCat(BlockPos p_35334_, ServerLevel p_35335_) {
        Cat cat = (Cat)EntityType.CAT.create(p_35335_);
        if (cat == null) {
            return 0;
        } else {
