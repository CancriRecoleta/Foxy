...
public final class VillagerType {
    ...
    private static final Map<ResourceKey<Biome>, VillagerType> BY_BIOME = (Map)Util.make(Maps.newHashMap(), (p_35834_) -> {
    ...
    private static VillagerType register(String p_35832_) {
        return (VillagerType)Registry.register(BuiltInRegistries.VILLAGER_TYPE, (ResourceLocation)(new ResourceLocation(p_35832_)), new VillagerType(p_35832_));
    }

    public static VillagerType byBiome(Holder<Biome> p_204074_) {
        Optional var10000 = p_204074_.unwrapKey();
