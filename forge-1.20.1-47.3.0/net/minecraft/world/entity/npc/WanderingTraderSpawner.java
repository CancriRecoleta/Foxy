...
public class WanderingTraderSpawner implements CustomSpawner {
    ...
    private boolean spawn(ServerLevel p_35916_) {
        Player $$1 = p_35916_.getRandomPlayer();
        if ($$1 == null) {
            return true;
            ...
            int $$3 = true;
            PoiManager $$4 = p_35916_.getPoiManager();
            Optional<BlockPos> $$5 = $$4.find((p_219713_) -> {
                return p_219713_.is(PoiTypes.MEETING);
            }, (p_219711_) -> {
                return true;
            }, $$2, 48, Occupancy.ANY);
            BlockPos $$6 = (BlockPos)$$5.orElse($$2);
            BlockPos $$7 = this.findSpawnPositionNear(p_35916_, $$6, 48);
            if ($$7 != null && this.hasEnoughSpace(p_35916_, $$7)) {
                if (p_35916_.getBiome($$7).is(BiomeTags.WITHOUT_WANDERING_TRADER_SPAWNS)) {
                    return false;
                }

                WanderingTrader $$8 = (WanderingTrader)EntityType.WANDERING_TRADER.spawn(p_35916_, $$7, MobSpawnType.EVENT);
                if ($$8 != null) {
                    for(int $$9 = 0; $$9 < 2; ++$$9) {
                        this.tryToSpawnLlamaFor(p_35916_, $$8, 4);
                    }
    ...
    private void tryToSpawnLlamaFor(ServerLevel p_35918_, WanderingTrader p_35919_, int p_35920_) {
        BlockPos $$3 = this.findSpawnPositionNear(p_35918_, p_35919_.blockPosition(), p_35920_);
        if ($$3 != null) {
            TraderLlama $$4 = (TraderLlama)EntityType.TRADER_LLAMA.spawn(p_35918_, $$3, MobSpawnType.EVENT);
            if ($$4 != null) {
                $$4.setLeashedTo(p_35919_, true);
            }
        }
    }
    ...
    private BlockPos findSpawnPositionNear(LevelReader p_35929_, BlockPos p_35930_, int p_35931_) {
        ...
        for(int $$4 = 0; $$4 < 10; ++$$4) {
            int $$5 = p_35930_.getX() + this.random.nextInt(p_35931_ * 2) - p_35931_;
            int $$6 = p_35930_.getZ() + this.random.nextInt(p_35931_ * 2) - p_35931_;
            int $$7 = p_35929_.getHeight(Types.WORLD_SURFACE, $$5, $$6);
            BlockPos $$8 = new BlockPos($$5, $$7, $$6);
            if (NaturalSpawner.isSpawnPositionOk(Type.ON_GROUND, p_35929_, $$8, EntityType.WANDERING_TRADER)) {
                $$3 = $$8;
                break;
            }
        }
    ...
    private boolean hasEnoughSpace(BlockGetter p_35926_, BlockPos p_35927_) {
        Iterator var3 = BlockPos.betweenClosed(p_35927_, p_35927_.offset(1, 2, 1)).iterator();
        ...
        do {
            ...
            $$2 = (BlockPos)var3.next();
        } while(p_35926_.getBlockState($$2).getCollisionShape(p_35926_, $$2).isEmpty());
