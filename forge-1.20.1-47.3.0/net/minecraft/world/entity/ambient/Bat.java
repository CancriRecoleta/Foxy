...
public class Bat extends AmbientCreature {
    ...
    protected void customServerAiStep() {
        ...
        if (this.isResting()) {
            ...
            if (this.level().getBlockState($$1).isRedstoneConductor(this.level(), $$0)) {
                ...
                if (this.level().getNearestPlayer(BAT_RESTING_TARGETING, this) != null) {
                    ...
                    if (!$$2) {
                        this.level().levelEvent((Player)null, 1025, $$0, 0);
                    }
                }
            } else {
                this.setResting(false);
            ...
            Vec3 $$7 = $$6.add((Math.signum($$3) * 0.5 - $$6.x) * 0.10000000149011612, (Math.signum($$4) * 0.699999988079071 - $$6.y) * 0.10000000149011612, (Math.signum($$5) * 0.5 - $$6.z) * 0.10000000149011612);
            ...
            if (this.random.nextInt(100) == 0 && this.level().getBlockState($$1).isRedstoneConductor(this.level(), $$1)) {
                this.setResting(true);
            }
        }
    ...
    public void addAdditionalSaveData(CompoundTag p_27443_) {
        ...
        p_27443_.putByte("BatFlags", (Byte)this.entityData.get(DATA_ID_FLAGS));
    }
    ...
    public static boolean checkBatSpawnRules(EntityType<Bat> p_218099_, LevelAccessor p_218100_, MobSpawnType p_218101_, BlockPos p_218102_, RandomSource p_218103_) {
        if (p_218102_.getY() >= p_218100_.getSeaLevel()) {
            ...
            return $$5 > p_218103_.nextInt($$6) ? false : checkMobSpawnRules(p_218099_, p_218100_, p_218101_, p_218102_, p_218103_);
        }
    }
