...
public class Pillager extends AbstractIllager implements CrossbowAttackMob, InventoryCarrier {
    ...
    public AbstractIllager.IllagerArmPose getArmPose() {
        if (this.isChargingCrossbow()) {
            return net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.CROSSBOW_CHARGE;
        } else if (this.isHolding((is) -> {
            return is.getItem() instanceof CrossbowItem;
        })) {
            return net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.CROSSBOW_HOLD;
        } else {
            return this.isAggressive() ? net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.ATTACKING : net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.NEUTRAL;
        }
    }
