...
public class Slime extends Mob implements Enemy {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, Player.class, 10, true, false, (p_289461_) -> {
            return Math.abs(p_289461_.getY() - this.getY()) <= 4.0;
        }));
    ...
    protected void dealDamage(LivingEntity p_33638_) {
        if (this.isAlive()) {
            int i = this.getSize();
            if (this.distanceToSqr(p_33638_) < 0.6 * (double)i * 0.6 * (double)i && this.hasLineOfSight(p_33638_) && p_33638_.hurt(this.damageSources().mobAttack(this), this.getAttackDamage())) {
    ...
    static class SlimeMoveControl extends MoveControl {
        ...
        public SlimeMoveControl(Slime p_33668_) {
            super(p_33668_);
            this.slime = p_33668_;
            this.yRot = 180.0F * p_33668_.getYRot() / 3.1415927F;
        }
