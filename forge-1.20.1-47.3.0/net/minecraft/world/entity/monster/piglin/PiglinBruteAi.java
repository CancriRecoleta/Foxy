...
public class PiglinBruteAi {
    ...
    protected static void initMemories(PiglinBrute p_35095_) {
        ...
        p_35095_.getBrain().setMemory(MemoryModuleType.HOME, (Object)$$1);
    }
    ...
    private static void initIdleActivity(PiglinBrute p_35120_, Brain<PiglinBrute> p_35121_) {
        p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(StartAttacking.create(PiglinBruteAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), SetLookAndInteract.create(EntityType.PLAYER, 4)));
    }

    private static void initFightActivity(PiglinBrute p_35125_, Brain<PiglinBrute> p_35126_) {
        p_35126_.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 10, ImmutableList.of(StopAttackingIfTargetInvalid.create((p_35118_) -> {
    ...
    protected static void updateActivity(PiglinBrute p_35110_) {
        ...
        Activity $$2 = (Activity)$$1.getActiveNonCoreActivity().orElse((Object)null);
        $$1.setActiveActivityToFirstValid(ImmutableList.of(Activity.FIGHT, Activity.IDLE));
        Activity $$3 = (Activity)$$1.getActiveNonCoreActivity().orElse((Object)null);
        if ($$2 != $$3) {
    ...
    private static Optional<? extends LivingEntity> findNearestValidAttackTarget(AbstractPiglin p_35087_) {
        ...
        if ($$1.isPresent() && Sensor.isEntityAttackableIgnoringLineOfSight(p_35087_, (LivingEntity)$$1.get())) {
            return $$1;
        } else {
            Optional<? extends LivingEntity> $$2 = getTargetIfWithinRange(p_35087_, MemoryModuleType.NEAREST_VISIBLE_ATTACKABLE_PLAYER);
            return $$2.isPresent() ? $$2 : p_35087_.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_NEMESIS);
        }
    }
    ...
    private static Optional<? extends LivingEntity> getTargetIfWithinRange(AbstractPiglin p_35092_, MemoryModuleType<? extends LivingEntity> p_35093_) {
        return p_35092_.getBrain().getMemory(p_35093_).filter((p_35108_) -> {
            return p_35108_.closerThan(p_35092_, 12.0);
        });
    }
