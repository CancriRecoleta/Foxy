...
public class Ravager extends Raider {
    ...
    private void roar() {
        if (this.isAlive()) {
            ...
            for(Iterator var1 = this.level().getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(4.0), NO_RAVAGER_AND_ALIVE).iterator(); var1.hasNext(); this.strongKnockback(livingentity)) {
                livingentity = (LivingEntity)var1.next();
