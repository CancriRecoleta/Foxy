...
public class Zoglin extends Monster implements Enemy, HoglinBase {
    ...
    protected Brain<?> makeBrain(Dynamic<?> p_34221_) {
        Brain<Zoglin> $$1 = this.brainProvider().makeBrain(p_34221_);
        initCoreActivity($$1);
        initIdleActivity($$1);
        initFightActivity($$1);
    ...
    private boolean isTargetable(LivingEntity p_34253_) {
        EntityType<?> $$1 = p_34253_.getType();
        return $$1 != EntityType.ZOGLIN && $$1 != EntityType.CREEPER && Sensor.isEntityAttackable(this, p_34253_);
    }
    ...
    public boolean hurt(DamageSource p_34214_, float p_34215_) {
        boolean $$2 = super.hurt(p_34214_, p_34215_);
        if (this.level().isClientSide) {
            return false;
        } else if ($$2 && p_34214_.getEntity() instanceof LivingEntity) {
            LivingEntity $$3 = (LivingEntity)p_34214_.getEntity();
    ...
    protected void updateActivity() {
        Activity $$0 = (Activity)this.brain.getActiveNonCoreActivity().orElse((Object)null);
        this.brain.setActiveActivityToFirstValid(ImmutableList.of(Activity.FIGHT, Activity.IDLE));
        Activity $$1 = (Activity)this.brain.getActiveNonCoreActivity().orElse((Object)null);
