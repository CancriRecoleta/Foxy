...
public class Drowned extends Zombie implements RangedAttackMob {
    ...
    public static boolean checkDrownedSpawnRules(EntityType<Drowned> p_218956_, ServerLevelAccessor p_218957_, MobSpawnType p_218958_, BlockPos p_218959_, RandomSource p_218960_) {
        if (!p_218957_.getFluidState(p_218959_.below()).is(FluidTags.WATER)) {
            ...
            Holder<Biome> $$5 = p_218957_.getBiome(p_218959_);
            boolean $$6 = p_218957_.getDifficulty() != Difficulty.PEACEFUL && isDarkEnoughToSpawn(p_218957_, p_218959_, p_218960_) && (p_218958_ == MobSpawnType.SPAWNER || p_218957_.getFluidState(p_218959_).is(FluidTags.WATER));
            if ($$5.is(BiomeTags.MORE_FREQUENT_DROWNED_SPAWNS)) {
                return p_218960_.nextInt(15) == 0 && $$6;
            } else {
                return p_218960_.nextInt(40) == 0 && isDeepEnoughToSpawn(p_218957_, p_218959_) && $$6;
            }
        }
    }
    ...
    private static class DrownedGoToBeachGoal extends MoveToBlockGoal {
        ...
        protected boolean isValidTarget(LevelReader p_32413_, BlockPos p_32414_) {
            ...
            return p_32413_.isEmptyBlock($$2) && p_32413_.isEmptyBlock($$2.above()) ? p_32413_.getBlockState(p_32414_).entityCanStandOn(p_32413_, p_32414_, this.drowned) : false;
        }
