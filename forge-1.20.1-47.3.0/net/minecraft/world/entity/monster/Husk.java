...
public class Husk extends Zombie {
    ...
    public boolean doHurtTarget(Entity p_32892_) {
        boolean $$1 = super.doHurtTarget(p_32892_);
        if ($$1 && this.getMainHandItem().isEmpty() && p_32892_ instanceof LivingEntity) {
            float $$2 = this.level().getCurrentDifficultyAt(this.blockPosition()).getEffectiveDifficulty();
            ((LivingEntity)p_32892_).addEffect(new MobEffectInstance(MobEffects.HUNGER, 140 * (int)$$2), this);
        }
