...
public class Warden extends Monster implements VibrationSystem {
    ...
    public void tick() {
        ...
        if (var2 instanceof ServerLevel $$0) {
            net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Ticker.tick($$0, this.vibrationData, this.vibrationUser);
    ...
    public void updateDynamicGameEventListener(BiConsumer<DynamicGameEventListener<?>, ServerLevel> p_219413_) {
        ...
        if (var3 instanceof ServerLevel $$1) {
            p_219413_.accept(this.dynamicGameEventListener, $$1);
        }
    ...
    public boolean canTargetEntity(@Nullable Entity p_219386_) {
        ...
        if (p_219386_ instanceof LivingEntity $$1) {
            if (this.level() == p_219386_.level() && EntitySelector.NO_CREATIVE_OR_SPECTATOR.test(p_219386_) && !this.isAlliedTo(p_219386_) && $$1.getType() != EntityType.ARMOR_STAND && $$1.getType() != EntityType.WARDEN && !$$1.isInvulnerable() && !$$1.isDeadOrDying() && this.level().getWorldBorder().isWithinBounds($$1.getBoundingBox())) {
                var10000 = true;
                return var10000;
            }
        }
    ...
    public static void applyDarknessAround(ServerLevel p_219376_, Vec3 p_219377_, @Nullable Entity p_219378_, int p_219379_) {
        ...
        MobEffectUtil.addEffectToPlayersAround(p_219376_, p_219378_, p_219377_, (double)p_219379_, $$4, 200);
    }
    ...
    public void addAdditionalSaveData(CompoundTag p_219434_) {
        ...
        var10000.resultOrPartial(var10001::error).ifPresent((p_219437_) -> {
            p_219434_.put("anger", p_219437_);
        });
        var10000 = net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Data.CODEC.encodeStart(NbtOps.INSTANCE, this.vibrationData);
        var10001 = LOGGER;
        Objects.requireNonNull(var10001);
        var10000.resultOrPartial(var10001::error).ifPresent((p_219418_) -> {
    ...
    public void readAdditionalSaveData(CompoundTag p_219415_) {
        ...
        if (p_219415_.contains("anger")) {
            var10000 = AngerManagement.codec(this::canTargetEntity).parse(new Dynamic(NbtOps.INSTANCE, p_219415_.get("anger")));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var10000.resultOrPartial(var10001::error).ifPresent((p_219394_) -> {
        ...
        if (p_219415_.contains("listener", 10)) {
            var10000 = net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Data.CODEC.parse(new Dynamic(NbtOps.INSTANCE, p_219415_.getCompound("listener")));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var10000.resultOrPartial(var10001::error).ifPresent((p_281093_) -> {
    ...
    public void increaseAngerAt(@Nullable Entity p_219388_, int p_219389_, boolean p_219390_) {
        if (!this.isNoAi() && this.canTargetEntity(p_219388_)) {
            WardenAi.setDigCooldown(this);
            boolean $$3 = !(this.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET).orElse((Object)null) instanceof Player);
    ...
    public boolean hurt(DamageSource p_219381_, float p_219382_) {
        boolean $$2 = super.hurt(p_219381_, p_219382_);
        if (!this.level().isClientSide && !this.isNoAi() && !this.isDiggingOrEmerging()) {
            Entity $$3 = p_219381_.getEntity();
            ...
            if (this.brain.getMemory(MemoryModuleType.ATTACK_TARGET).isEmpty() && $$3 instanceof LivingEntity) {
                ...
                if (!p_219381_.isIndirect() || this.closerThan($$4, 5.0)) {
