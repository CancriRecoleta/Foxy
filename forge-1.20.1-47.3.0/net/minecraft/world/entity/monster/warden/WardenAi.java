...
public class WardenAi {
    ...
    protected static Brain<?> makeBrain(Warden p_219521_, Dynamic<?> p_219522_) {
        ...
        Brain<Warden> $$3 = $$2.makeBrain(p_219522_);
        initCoreActivity($$3);
    ...
    private static void initFightActivity(Warden p_219518_, Brain<Warden> p_219519_) {
        p_219519_.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 10, ImmutableList.of(DIG_COOLDOWN_SETTER, StopAttackingIfTargetInvalid.create((p_219540_) -> {
    ...
    static {
        ...
        DIG_COOLDOWN_SETTER = BehaviorBuilder.create((p_258953_) -> {
