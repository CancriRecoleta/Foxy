...
public class Evoker extends SpellcasterIllager {
    ...
    class EvokerSummonSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        protected SpellcasterIllager.IllagerSpell getSpell() {
            return net.minecraft.world.entity.monster.SpellcasterIllager.IllagerSpell.SUMMON_VEX;
        }
    }
    ...
    class EvokerAttackSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        protected void performSpellCasting() {
            ...
            if (Evoker.this.distanceToSqr(livingentity) < 9.0) {
                ...
                for(k = 0; k < 5; ++k) {
                    ...
                    this.createSpellEntity(Evoker.this.getX() + (double)Mth.cos(f2) * 1.5, Evoker.this.getZ() + (double)Mth.sin(f2) * 1.5, d0, d1, f2, 0);
                }
        ...
        protected SpellcasterIllager.IllagerSpell getSpell() {
            return net.minecraft.world.entity.monster.SpellcasterIllager.IllagerSpell.FANGS;
        }
    }
    ...
    public class EvokerWololoSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            if (Evoker.this.getTarget() != null) {
                ...
                return false;
            } else if (!ForgeEventFactory.getMobGriefingEvent(Evoker.this.level(), Evoker.this)) {
                return false;
            } else {
        ...
        protected SpellcasterIllager.IllagerSpell getSpell() {
            return net.minecraft.world.entity.monster.SpellcasterIllager.IllagerSpell.WOLOLO;
        }
    }
}
