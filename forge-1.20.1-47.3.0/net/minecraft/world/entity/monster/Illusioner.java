...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
        ...
        if (this.level().isClientSide && this.isInvisible()) {
            ...
            if (this.hurtTime != 1 && this.tickCount % 1200 != 0) {
                ...
                for(l = 0; l < 4; ++l) {
                    ...
                    this.clientSideIllusionOffsets[1][l] = new Vec3((double)(-6.0F + (float)this.random.nextInt(13)) * 0.5, (double)Math.max(0, this.random.nextInt(6) - 4), (double)(-6.0F + (float)this.random.nextInt(13)) * 0.5);
                }
    ...
    public void performRangedAttack(LivingEntity p_32918_, float p_32919_) {
        ItemStack itemstack = this.getProjectile(this.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, (Predicate)((item) -> {
    ...
    public AbstractIllager.IllagerArmPose getArmPose() {
        if (this.isCastingSpell()) {
            ...
            return this.isAggressive() ? net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.BOW_AND_ARROW : net.minecraft.world.entity.monster.AbstractIllager.IllagerArmPose.CROSSED;
        }
    }
    ...
    class IllusionerMirrorSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        protected SpellcasterIllager.IllagerSpell getSpell() {
            return net.minecraft.world.entity.monster.SpellcasterIllager.IllagerSpell.DISAPPEAR;
        }
    }
    ...
    class IllusionerBlindnessSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            if (!super.canUse()) {
                ...
                return Illusioner.this.getTarget().getId() == this.lastTargetId ? false : Illusioner.this.level().getCurrentDifficultyAt(Illusioner.this.blockPosition()).isHarderThan((float)Difficulty.NORMAL.ordinal());
            }
        }
        ...
        protected SpellcasterIllager.IllagerSpell getSpell() {
            return net.minecraft.world.entity.monster.SpellcasterIllager.IllagerSpell.BLINDNESS;
        }
    }
}
