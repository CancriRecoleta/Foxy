...
public class HoglinAi {
    ...
    protected static void updateActivity(Hoglin p_34578_) {
        ...
        if ($$2 != $$3) {
            Optional var10000 = getSoundForCurrentActivity(p_34578_);
            Objects.requireNonNull(p_34578_);
            var10000.ifPresent(p_34578_::playSoundEvent);
        }
    ...
    static boolean isPosNearNearestRepellent(Hoglin p_34586_, BlockPos p_34587_) {
        ...
        return $$2.isPresent() && ((BlockPos)$$2.get()).closerThan(p_34587_, 8.0);
    }
    ...
    private static boolean piglinsOutnumberHoglins(Hoglin p_34623_) {
        if (p_34623_.isBaby()) {
            ...
            int $$1 = (Integer)p_34623_.getBrain().getMemory(MemoryModuleType.VISIBLE_ADULT_PIGLIN_COUNT).orElse(0);
            int $$2 = (Integer)p_34623_.getBrain().getMemory(MemoryModuleType.VISIBLE_ADULT_HOGLIN_COUNT).orElse(0) + 1;
            return $$1 > $$2;
        }
    }

    protected static void wasHurtBy(Hoglin p_34596_, LivingEntity p_34597_) {
        Brain<Hoglin> $$2 = p_34596_.getBrain();
    ...
    private static List<Hoglin> getVisibleAdultHoglins(Hoglin p_34628_) {
        return (List)p_34628_.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_ADULT_HOGLINS).orElse(ImmutableList.of());
    }
