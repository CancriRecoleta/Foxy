...
public class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    protected void customServerAiStep() {
        ...
        if (this.isConverting()) {
            ...
            if (this.timeInOverworld > 300 && ForgeEventFactory.canLivingConvert(this, EntityType.ZOGLIN, (timer) -> {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_149900_, AgeableMob p_149901_) {
        Hoglin hoglin = (Hoglin)EntityType.HOGLIN.create(p_149900_);
        if (hoglin != null) {
    ...
    protected SoundEvent getAmbientSound() {
        return this.level().isClientSide ? null : (SoundEvent)HoglinAi.getSoundForCurrentActivity(this).orElse((SoundEvent)null);
    }
