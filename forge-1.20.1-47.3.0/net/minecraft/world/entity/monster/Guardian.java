...
public class Guardian extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.randomStrollGoal.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK));
        $$0.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK));
        ...
        if (this.isAlive()) {
            if (this.level().isClientSide) {
                ...
                if (!this.isInWater()) {
                    ...
                    this.clientSideTouchedGround = $$1.y < 0.0 && this.level().loadedAndEntityCanStandOn(this.blockPosition().below(), this);
                ...
                if (this.hasActiveAttackTarget()) {
                    ...
                    if ($$3 != null) {
                        ...
                        while($$9 < $$8) {
                            ...
                            this.level().addParticle(ParticleTypes.BUBBLE, this.getX() + $$5 * $$9, this.getEyeY() + $$6 * $$9, this.getZ() + $$7 * $$9, 0.0, 0.0, 0.0);
                        }
                    }
                }
            }
            ...
            if ($$0 != null) {
                ...
                if (!this.guardian.hasLineOfSight($$0)) {
                    ...
                    if (this.attackTime == 0) {
                        ...
                        $$0.hurt(this.guardian.damageSources().mobAttack(this.guardian), (float)this.guardian.getAttributeValue(Attributes.ATTACK_DAMAGE));
                        this.guardian.setTarget((LivingEntity)null);
                    }
