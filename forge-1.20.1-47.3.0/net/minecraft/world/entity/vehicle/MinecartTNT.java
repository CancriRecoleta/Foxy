...
public class MinecartTNT extends AbstractMinecart {
    ...
    public AbstractMinecart.Type getMinecartType() {
        return net.minecraft.world.entity.vehicle.AbstractMinecart.Type.TNT;
    }
    ...
    public boolean hurt(DamageSource p_38666_, float p_38667_) {
        Entity $$2 = p_38666_.getDirectEntity();
        if ($$2 instanceof AbstractArrow $$3) {
            if ($$3.isOnFire()) {
                DamageSource $$4 = this.damageSources().explosion(this, p_38666_.getEntity());
    ...
    public void destroy(DamageSource p_38664_) {
        ...
        if (!p_38664_.is(DamageTypeTags.IS_FIRE) && !p_38664_.is(DamageTypeTags.IS_EXPLOSION) && !($$1 >= 0.009999999776482582)) {
    ...
    protected void explode(@Nullable DamageSource p_259539_, double p_260287_) {
        if (!this.level().isClientSide) {
            double $$2 = Math.sqrt(p_260287_);
            if ($$2 > 5.0) {
                $$2 = 5.0;
            }

            this.level().explode(this, p_259539_, (ExplosionDamageCalculator)null, this.getX(), this.getY(), this.getZ(), (float)(4.0 + this.random.nextDouble() * 1.5 * $$2), false, ExplosionInteraction.TNT);
            this.discard();
        }
