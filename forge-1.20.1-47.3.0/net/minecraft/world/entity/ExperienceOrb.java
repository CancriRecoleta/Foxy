...
public class ExperienceOrb extends Entity {
    ...
    private void scanForEntities() {
        ...
        if (this.level() instanceof ServerLevel) {
            Iterator var1 = this.level().getEntities(EntityTypeTest.forClass(ExperienceOrb.class), this.getBoundingBox().inflate(0.5), this::canMerge).iterator();
    ...
    public void playerTouch(Player p_20792_) {
        if (!this.level().isClientSide && p_20792_.takeXpDelay == 0) {
            if (MinecraftForge.EVENT_BUS.post(new PlayerXpEvent.PickupXp(p_20792_, this))) {
                return;
            }
