...
public class ShulkerBullet extends Projectile {
        ...
        if (this.level().isClientSide) {
            ...
            if (this.currentMoveDirection != null) {
                ...
                if (this.level().loadedAndEntityCanStandOn(blockpos.relative(this.currentMoveDirection), this)) {
                    ...
                    if (direction$axis == Axis.X && blockpos.getX() == blockpos1.getX() || direction$axis == Axis.Z && blockpos.getZ() == blockpos1.getZ() || direction$axis == Axis.Y && blockpos.getY() == blockpos1.getY()) {
                        this.selectNextMoveDirection(direction$axis);
                    }
                }
            }
    ...
    private void destroy() {
        this.discard();
        this.level().gameEvent(GameEvent.ENTITY_DAMAGE, this.position(), Context.of((Entity)this));
    }
