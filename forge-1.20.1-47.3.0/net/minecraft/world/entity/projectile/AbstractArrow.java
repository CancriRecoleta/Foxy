...
public abstract class AbstractArrow extends Projectile {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        this(p_36717_, p_36718_.getX(), p_36718_.getEyeY() - 0.10000000149011612, p_36718_.getZ(), p_36719_);
    ...
    public void tick() {
        ...
        if (this.inGround && !flag) {
            ...
            while(!this.isRemoved()) {
                ...
                if (hitresult != null && ((HitResult)hitresult).getType() != Type.MISS && !flag) {
                    switch (ForgeEventFactory.onProjectileImpactResult(this, (HitResult)hitresult)) {
                        case SKIP_ENTITY:
                            if (((HitResult)hitresult).getType() != Type.ENTITY) {
                                this.onHit((HitResult)hitresult);
                                this.hasImpulse = true;
                            } else {
                                this.ignoredEntities.add(entityhitresult.getEntity().getId());
                                entityhitresult = null;
                            }
                            break;
    ...
    public void readAdditionalSaveData(CompoundTag p_36761_) {
        ...
        this.pickup = net.minecraft.world.entity.projectile.AbstractArrow.Pickup.byOrdinal(p_36761_.getByte("pickup"));
        ...
        if (p_36761_.contains("SoundEvent", 8)) {
            this.soundEvent = (SoundEvent)BuiltInRegistries.SOUND_EVENT.getOptional(new ResourceLocation(p_36761_.getString("SoundEvent"))).orElse(this.getDefaultHitGroundSoundEvent());
        }
    ...
    public void setOwner(@Nullable Entity p_36770_) {
        ...
        if (p_36770_ instanceof Player) {
            this.pickup = ((Player)p_36770_).getAbilities().instabuild ? net.minecraft.world.entity.projectile.AbstractArrow.Pickup.CREATIVE_ONLY : net.minecraft.world.entity.projectile.AbstractArrow.Pickup.ALLOWED;
        }

    }

    public void playerTouch(Player p_36766_) {
        if (!this.level().isClientSide && (this.inGround || this.isNoPhysics()) && this.shakeTime <= 0 && this.tryPickup(p_36766_)) {
    ...
    protected boolean tryPickup(Player p_150121_) {
        switch (this.pickup) {
            case ALLOWED -> return p_150121_.getInventory().add(this.getPickupItem());
            case CREATIVE_ONLY -> return p_150121_.getAbilities().instabuild;
