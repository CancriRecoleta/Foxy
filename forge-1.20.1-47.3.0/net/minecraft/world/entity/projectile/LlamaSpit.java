...
public class LlamaSpit extends Projectile {
    ...
    public LlamaSpit(Level p_37235_, Llama p_37236_) {
        ...
        this.setPos(p_37236_.getX() - (double)(p_37236_.getBbWidth() + 1.0F) * 0.5 * (double)Mth.sin(p_37236_.yBodyRot * 0.017453292F), p_37236_.getEyeY() - 0.10000000149011612, p_37236_.getZ() + (double)(p_37236_.getBbWidth() + 1.0F) * 0.5 * (double)Mth.cos(p_37236_.yBodyRot * 0.017453292F));
    }
