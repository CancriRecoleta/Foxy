...
public class Tadpole extends AbstractFish {
    ...
    public InteractionResult mobInteract(Player p_218703_, InteractionHand p_218704_) {
        ItemStack $$2 = p_218703_.getItemInHand(p_218704_);
        if (this.isFood($$2)) {
            this.feed(p_218703_, $$2);
            return InteractionResult.sidedSuccess(this.level().isClientSide);
        } else {
            return (InteractionResult)Bucketable.bucketMobPickup(p_218703_, p_218704_, this).orElse(super.mobInteract(p_218703_, p_218704_));
        }
    }
    ...
    public void saveToBucketTag(ItemStack p_218725_) {
        ...
        CompoundTag $$1 = p_218725_.getOrCreateTag();
    ...
    private void ageUp() {
        ...
        if (var2 instanceof ServerLevel $$0) {
            Frog $$1 = (Frog)EntityType.FROG.create(this.level());
            if ($$1 != null) {
                $$1.moveTo(this.getX(), this.getY(), this.getZ(), this.getYRot(), this.getXRot());
                $$1.finalizeSpawn($$0, this.level().getCurrentDifficultyAt($$1.blockPosition()), MobSpawnType.CONVERSION, (SpawnGroupData)null, (CompoundTag)null);
