...
public class Frog extends Animal implements VariantHolder<FrogVariant> {
    ...
    public void readAdditionalSaveData(CompoundTag p_218496_) {
        ...
        FrogVariant $$1 = (FrogVariant)BuiltInRegistries.FROG_VARIANT.get(ResourceLocation.tryParse(p_218496_.getString("variant")));
        if ($$1 != null) {
            this.setVariant($$1);
        }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_218476_, AgeableMob p_218477_) {
        Frog $$2 = (Frog)EntityType.FROG.create(p_218476_);
        if ($$2 != null) {
            FrogAi.initMemories($$2, p_218476_.getRandom());
        }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_218488_, DifficultyInstance p_218489_, MobSpawnType p_218490_, @Nullable SpawnGroupData p_218491_, @Nullable CompoundTag p_218492_) {
        Holder<Biome> $$5 = p_218488_.getBiome(this.blockPosition());
    ...
    public static boolean canEat(LivingEntity p_218533_) {
        if (p_218533_ instanceof Slime $$1) {
            if ($$1.getSize() != 1) {
                return false;
            }
        }
    ...
    private static class FrogNodeEvaluator extends AmphibiousNodeEvaluator {
        ...
        public BlockPathTypes getBlockPathType(BlockGetter p_218551_, int p_218552_, int p_218553_, int p_218554_) {
            ...
            BlockState $$4 = p_218551_.getBlockState(this.belowPos);
            return $$4.is(BlockTags.FROG_PREFER_JUMP_TO) ? BlockPathTypes.OPEN : super.getBlockPathType(p_218551_, p_218552_, p_218553_, p_218554_);
        }
    }
}
