...
public class Axolotl extends Animal implements LerpingModel, VariantHolder<Variant>, Bucketable {
    ...
    public void readAdditionalSaveData(CompoundTag p_149145_) {
        ...
        this.setVariant(net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.byId(p_149145_.getInt("Variant")));
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_149132_, DifficultyInstance p_149133_, MobSpawnType p_149134_, @Nullable SpawnGroupData p_149135_, @Nullable CompoundTag p_149136_) {
        ...
        if (p_149134_ == MobSpawnType.BUCKET) {
            return (SpawnGroupData)p_149135_;
        } else {
            RandomSource $$6 = p_149132_.getRandom();
            if (p_149135_ instanceof AxolotlGroupData) {
                if (((AxolotlGroupData)p_149135_).getGroupSize() >= 2) {
                    $$5 = true;
                }
            } else {
                p_149135_ = new AxolotlGroupData(new Variant[]{net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.getCommonSpawnVariant($$6), net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.getCommonSpawnVariant($$6)});
            }

            this.setVariant(((AxolotlGroupData)p_149135_).getVariant($$6));
            if ($$5) {
                this.setAge(-24000);
            }

            return super.finalizeSpawn(p_149132_, p_149133_, p_149134_, (SpawnGroupData)p_149135_, p_149136_);
        }
    }
    ...
    public Variant getVariant() {
        return net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.byId((Integer)this.entityData.get(DATA_VARIANT));
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_149112_, AgeableMob p_149113_) {
        Axolotl $$2 = (Axolotl)EntityType.AXOLOTL.create(p_149112_);
        if ($$2 != null) {
            Variant $$4;
            if (useRareVariant(this.random)) {
                $$4 = net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.getRareSpawnVariant(this.random);
            } else {
                $$4 = this.random.nextBoolean() ? this.getVariant() : ((Axolotl)p_149113_).getVariant();
            }
    ...
    public double getMeleeAttackRangeSqr(LivingEntity p_149185_) {
        return 1.5 + (double)p_149185_.getBbWidth() * 2.0;
    }
    ...
    public boolean hurt(DamageSource p_149115_, float p_149116_) {
        ...
        if (!this.level().isClientSide && !this.isNoAi() && this.level().random.nextInt(3) == 0 && ((float)this.level().random.nextInt(3) < p_149116_ || $$2 / this.getMaxHealth() < 0.5F) && p_149116_ < $$2 && this.isInWater() && (p_149115_.getEntity() != null || p_149115_.getDirectEntity() != null) && !this.isPlayingDead()) {
    ...
    public InteractionResult mobInteract(Player p_149155_, InteractionHand p_149156_) {
        return (InteractionResult)Bucketable.bucketMobPickup(p_149155_, p_149156_, this).orElse(super.mobInteract(p_149155_, p_149156_));
    }

    public void saveToBucketTag(ItemStack p_149187_) {
        Bucketable.saveDefaultDataToBucketTag(this, p_149187_);
        CompoundTag $$1 = p_149187_.getOrCreateTag();
        $$1.putInt("Variant", this.getVariant().getId());
    ...
    public void loadFromBucketTag(CompoundTag p_149163_) {
        ...
        this.setVariant(net.minecraft.world.entity.animal.axolotl.Axolotl.Variant.byId(p_149163_.getInt("Variant")));
    ...
    public static void onStopAttacking(Axolotl p_218444_, LivingEntity p_218445_) {
        Level $$2 = p_218444_.level();
        if (p_218445_.isDeadOrDying()) {
            DamageSource $$3 = p_218445_.getLastDamageSource();
            if ($$3 != null) {
                Entity $$4 = $$3.getEntity();
                if ($$4 != null && $$4.getType() == EntityType.PLAYER) {
                    Player $$5 = (Player)$$4;
                    List<Player> $$6 = $$2.getEntitiesOfClass(Player.class, p_218444_.getBoundingBox().inflate(20.0));
                    if ($$6.contains($$5)) {
                        p_218444_.applySupportingEffects($$5);
                    }
                }
            }
        }
    ...
    public void applySupportingEffects(Player p_149174_) {
        MobEffectInstance $$1 = p_149174_.getEffect(MobEffects.REGENERATION);
        if ($$1 == null || $$1.endsWithin(2399)) {
            int $$2 = $$1 != null ? $$1.getDuration() : 0;
            int $$3 = Math.min(2400, 100 + $$2);
            p_149174_.addEffect(new MobEffectInstance(MobEffects.REGENERATION, $$3, 0), this);
        }
    ...
    public static enum Variant implements StringRepresentable {
        ...
        public static Variant byId(int p_262930_) {
            return (Variant)BY_ID.apply(p_262930_);
        }

        public static Variant getCommonSpawnVariant(RandomSource p_218449_) {
            return getSpawnVariant(p_218449_, true);
        }

        public static Variant getRareSpawnVariant(RandomSource p_218454_) {
            return getSpawnVariant(p_218454_, false);
        }

        private static Variant getSpawnVariant(RandomSource p_218451_, boolean p_218452_) {
            Variant[] $$2 = (Variant[])Arrays.stream(values()).filter((p_149252_) -> {
                return p_149252_.common == p_218452_;
            }).toArray((p_149244_) -> {
                return new Variant[p_149244_];
            });
            return (Variant)Util.getRandom((Object[])$$2, p_218451_);
        }
    }
