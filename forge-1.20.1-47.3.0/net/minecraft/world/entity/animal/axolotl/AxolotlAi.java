...
public class AxolotlAi {
    ...
    public static void updateActivity(Axolotl p_149293_) {
        Brain<Axolotl> $$1 = p_149293_.getBrain();
        ...
        if ($$2 != Activity.PLAY_DEAD) {
            ...
            if ($$2 == Activity.FIGHT && $$1.getActiveNonCoreActivity().orElse((Object)null) != Activity.FIGHT) {
