...
public class Chicken extends Animal {
    ...
    protected void positionRider(Entity p_289537_, Entity.MoveFunction p_289541_) {
        ...
        float $$2 = Mth.sin(this.yBodyRot * 0.017453292F);
        float $$3 = Mth.cos(this.yBodyRot * 0.017453292F);
        float $$4 = 0.1F;
        float $$5 = 0.0F;
        p_289541_.accept(p_289537_, this.getX() + (double)(0.1F * $$2), this.getY(0.5) + p_289537_.getMyRidingOffset() + 0.0, this.getZ() - (double)(0.1F * $$3));
