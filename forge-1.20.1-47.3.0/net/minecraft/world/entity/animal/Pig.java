...
public class Pig extends Animal implements ItemSteerable, Saddleable {
    ...
    public void equipSaddle(@Nullable SoundSource p_29476_) {
        ...
        if (p_29476_ != null) {
            this.level().playSound((Player)((Player)null), (Entity)this, SoundEvents.PIG_SADDLE, p_29476_, 0.5F, 1.0F);
        }
    ...
    public void thunderHit(ServerLevel p_29473_, LightningBolt p_29474_) {
        if (p_29473_.getDifficulty() != Difficulty.PEACEFUL && ForgeEventFactory.canLivingConvert(this, EntityType.ZOMBIFIED_PIGLIN, (timer) -> {
        })) {
            ZombifiedPiglin zombifiedpiglin = (ZombifiedPiglin)EntityType.ZOMBIFIED_PIGLIN.create(p_29473_);
    ...
    public Pig getBreedOffspring(ServerLevel p_149001_, AgeableMob p_149002_) {
        return (Pig)EntityType.PIG.create(p_149001_);
    }
