...
public class Rabbit extends Animal implements VariantHolder<Variant> {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_TYPE_ID, net.minecraft.world.entity.animal.Rabbit.Variant.BROWN.id);
    }
    ...
    public void customServerAiStep() {
        ...
        if (this.onGround()) {
            ...
            if (this.getVariant() == net.minecraft.world.entity.animal.Rabbit.Variant.EVIL && this.jumpDelayTicks == 0) {
            ...
            RabbitJumpControl rabbit$rabbitjumpcontrol = (RabbitJumpControl)this.jumpControl;
    ...
    private void facePoint(double p_29687_, double p_29688_) {
        this.setYRot((float)(Mth.atan2(p_29688_ - this.getZ(), p_29687_ - this.getX()) * 57.2957763671875) - 90.0F);
    }
    ...
    public void readAdditionalSaveData(CompoundTag p_29684_) {
        ...
        this.setVariant(net.minecraft.world.entity.animal.Rabbit.Variant.byId(p_29684_.getInt("RabbitType")));
    ...
    public boolean doHurtTarget(Entity p_29659_) {
        if (this.getVariant() == net.minecraft.world.entity.animal.Rabbit.Variant.EVIL) {
    ...
    public SoundSource getSoundSource() {
        return this.getVariant() == net.minecraft.world.entity.animal.Rabbit.Variant.EVIL ? SoundSource.HOSTILE : SoundSource.NEUTRAL;
    }
    ...
    public Rabbit getBreedOffspring(ServerLevel p_149035_, AgeableMob p_149036_) {
        Rabbit rabbit = (Rabbit)EntityType.RABBIT.create(p_149035_);
        if (rabbit != null) {
            Variant rabbit$variant = getRandomRabbitVariant(p_149035_, this.blockPosition());
    ...
    public Variant getVariant() {
        return net.minecraft.world.entity.animal.Rabbit.Variant.byId((Integer)this.entityData.get(DATA_TYPE_ID));
    }

    public void setVariant(Variant p_262578_) {
        if (p_262578_ == net.minecraft.world.entity.animal.Rabbit.Variant.EVIL) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_29678_, DifficultyInstance p_29679_, MobSpawnType p_29680_, @Nullable SpawnGroupData p_29681_, @Nullable CompoundTag p_29682_) {
        Variant rabbit$variant = getRandomRabbitVariant(p_29678_, this.blockPosition());
        if (p_29681_ instanceof RabbitGroupData) {
            rabbit$variant = ((RabbitGroupData)p_29681_).variant;
        } else {
    ...
    private static Variant getRandomRabbitVariant(LevelAccessor p_262699_, BlockPos p_262700_) {
        ...
        if (holder.is(BiomeTags.SPAWNS_WHITE_RABBITS)) {
            return i < 80 ? net.minecraft.world.entity.animal.Rabbit.Variant.WHITE : net.minecraft.world.entity.animal.Rabbit.Variant.WHITE_SPLOTCHED;
        } else if (holder.is(BiomeTags.SPAWNS_GOLD_RABBITS)) {
            return net.minecraft.world.entity.animal.Rabbit.Variant.GOLD;
        } else {
            return i < 50 ? net.minecraft.world.entity.animal.Rabbit.Variant.BROWN : (i < 90 ? net.minecraft.world.entity.animal.Rabbit.Variant.SALT : net.minecraft.world.entity.animal.Rabbit.Variant.BLACK);
        }
    }
    ...
    static class RabbitAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        ...
        public boolean canUse() {
            return this.rabbit.getVariant() != net.minecraft.world.entity.animal.Rabbit.Variant.EVIL && super.canUse();
        }
    }
    ...
    static class RaidGardenGoal extends MoveToBlockGoal {
        ...
        public RaidGardenGoal(Rabbit p_29782_) {
            super(p_29782_, 0.699999988079071, 16);
