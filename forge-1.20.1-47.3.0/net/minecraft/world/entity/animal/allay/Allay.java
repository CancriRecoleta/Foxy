...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    public Allay(EntityType<? extends Allay> p_218310_, Level p_218311_) {
        ...
        this.dynamicJukeboxListener = new DynamicGameEventListener(new JukeboxListener(this.vibrationUser.getPositionSource(), GameEvent.JUKEBOX_PLAY.getNotificationRadius()));
    }
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            ...
            net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Ticker.tick(this.level(), this.vibrationData, this.vibrationUser);
            if (this.isPanicking()) {
                this.setDancing(false);
            }
        }
    ...
    protected InteractionResult mobInteract(Player p_218361_, InteractionHand p_218362_) {
        ...
        if (this.isDancing() && this.isDuplicationItem(itemstack) && this.canDuplicate()) {
            ...
            this.level().playSound((Player)p_218361_, (Entity)this, SoundEvents.AMETHYST_BLOCK_CHIME, SoundSource.NEUTRAL, 2.0F, 1.0F);
            ...
            this.removeInteractionItem(p_218361_, itemstack);
            this.level().playSound((Player)p_218361_, (Entity)this, SoundEvents.ALLAY_ITEM_GIVEN, SoundSource.NEUTRAL, 2.0F, 1.0F);
            this.getBrain().setMemory(MemoryModuleType.LIKED_PLAYER, (Object)p_218361_.getUUID());
            return InteractionResult.SUCCESS;
        } else if (!itemstack1.isEmpty() && p_218362_ == InteractionHand.MAIN_HAND && itemstack.isEmpty()) {
            this.setItemSlot(EquipmentSlot.MAINHAND, ItemStack.EMPTY);
            this.level().playSound((Player)p_218361_, (Entity)this, SoundEvents.ALLAY_ITEM_TAKEN, SoundSource.NEUTRAL, 2.0F, 1.0F);
    ...
    public boolean wantsToPickUp(ItemStack p_218387_) {
        ...
        return !itemstack.isEmpty() && this.inventory.canAddItem(p_218387_) && this.allayConsidersItemEqual(itemstack, p_218387_) && ForgeEventFactory.getMobGriefingEvent(this.level(), this);
    }
    ...
    public void addAdditionalSaveData(CompoundTag p_218367_) {
        ...
        var10000.resultOrPartial(var10001::error).ifPresent((p_218353_) -> {
    ...
    public void readAdditionalSaveData(CompoundTag p_218350_) {
        ...
        if (p_218350_.contains("listener", 10)) {
            DataResult var10000 = net.minecraft.world.level.gameevent.vibrations.VibrationSystem.Data.CODEC.parse(new Dynamic(NbtOps.INSTANCE, p_218350_.getCompound("listener")));
            Logger var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var10000.resultOrPartial(var10001::error).ifPresent((p_281082_) -> {
