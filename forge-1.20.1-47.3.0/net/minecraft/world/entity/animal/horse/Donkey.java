...
public class Donkey extends AbstractChestedHorse {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_149530_, AgeableMob p_149531_) {
        EntityType<? extends AbstractHorse> $$2 = p_149531_ instanceof Horse ? EntityType.MULE : EntityType.DONKEY;
        AbstractHorse $$3 = (AbstractHorse)$$2.create(p_149530_);
        if ($$3 != null) {
            this.setOffspringAttributes(p_149531_, $$3);
        }
