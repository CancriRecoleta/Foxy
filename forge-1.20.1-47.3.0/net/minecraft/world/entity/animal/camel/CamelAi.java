...
public class CamelAi {
    ...
    private static void initCoreActivity(Brain<Camel> p_249998_) {
        p_249998_.addActivity(Activity.CORE, 0, ImmutableList.of(new Swim(0.8F), new CamelPanic(4.0F), new LookAtTargetSink(45, 90), new MoveToTargetSink(), new CountDownCooldownTicks(MemoryModuleType.TEMPTATION_COOLDOWN_TICKS), new CountDownCooldownTicks(MemoryModuleType.GAZE_COOLDOWN_TICKS)));
    }
    ...
    public static class CamelPanic extends AnimalPanic {
        ...
        protected void start(ServerLevel p_249530_, PathfinderMob p_248643_, long p_251124_) {
            if (p_248643_ instanceof Camel $$3) {
                $$3.standUpInstantly();
            }
