...
public class Camel extends AbstractHorse implements PlayerRideableJumping, RiderShieldingMount, Saddleable {
    ...
    public void addAdditionalSaveData(CompoundTag p_250330_) {
        ...
        p_250330_.putLong("LastPoseTick", (Long)this.entityData.get(LAST_POSE_CHANGE_TICK));
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return createBaseHorseAttributes().add(Attributes.MAX_HEALTH, 32.0).add(Attributes.MOVEMENT_SPEED, 0.09000000357627869).add(Attributes.JUMP_STRENGTH, 0.41999998688697815);
    }
    ...
    protected void executeRidersJump(float p_251967_, Vec3 p_275627_) {
        ...
        this.addDeltaMovement(this.getLookAngle().multiply(1.0, 0.0, 1.0).normalize().scale((double)(22.2222F * p_251967_) * this.getAttributeValue(Attributes.MOVEMENT_SPEED) * (double)this.getBlockSpeedFactor()).add(0.0, (double)(1.4285F * p_251967_) * d0, 0.0));
    ...
    protected void playStepSound(BlockPos p_252056_, BlockState p_251457_) {
        if (p_251457_.getSoundType(this.level(), p_252056_, this) == SoundType.SAND) {
    ...
    public Camel getBreedOffspring(ServerLevel p_251227_, AgeableMob p_251047_) {
        return (Camel)EntityType.CAMEL.create(p_251227_);
    }
    ...
    protected void positionRider(Entity p_289564_, Entity.MoveFunction p_289551_) {
        ...
        if (i >= 0) {
            boolean flag = i == 0;
            float f = 0.5F;
            float f1 = (float)(this.isRemoved() ? 0.009999999776482582 : this.getBodyAnchorAnimationYOffset(flag, 0.0F) + p_289564_.getMyRidingOffset());
    ...
    public Vec3 getLeashOffset(float p_251477_) {
        return new Vec3(0.0, this.getBodyAnchorAnimationYOffset(true, p_251477_) - (double)(0.2F * this.getScale()), (double)(this.getBbWidth() * 0.56F));
    }
    ...
    class CamelMoveControl extends MoveControl {
        ...
        public void tick() {
            if (this.operation == Operation.MOVE_TO && !Camel.this.isLeashed() && Camel.this.isCamelSitting() && !Camel.this.isInPoseTransition()) {
                Camel.this.standUp();
            }
