...
public class GoatAi {
    ...
    protected static void initMemories(Goat p_218765_, RandomSource p_218766_) {
        p_218765_.getBrain().setMemory(MemoryModuleType.LONG_JUMP_COOLDOWN_TICKS, (Object)TIME_BETWEEN_LONG_JUMPS.sample(p_218766_));
        p_218765_.getBrain().setMemory(MemoryModuleType.RAM_COOLDOWN_TICKS, (Object)TIME_BETWEEN_RAMS.sample(p_218766_));
    }
    ...
    private static void initRamActivity(Brain<Goat> p_149466_) {
        p_149466_.addActivityWithConditions(Activity.RAM, ImmutableList.of(Pair.of(0, new RamTarget((p_149474_) -> {
            ...
            return p_287490_.isBaby() ? 1.0 : 2.5;
        }, (p_149468_) -> {
