...
public class Pufferfish extends AbstractFish {
    ...
    private void touch(Mob p_29606_) {
        ...
        if (p_29606_.hurt(this.damageSources().mobAttack(this), (float)(1 + $$1))) {
    ...
    public void playerTouch(Player p_29617_) {
        int $$1 = this.getPuffState();
        if (p_29617_ instanceof ServerPlayer && $$1 > 0 && p_29617_.hurt(this.damageSources().mobAttack(this), (float)(1 + $$1))) {
            if (!this.isSilent()) {
                ((ServerPlayer)p_29617_).connection.send(new ClientboundGameEventPacket(ClientboundGameEventPacket.PUFFER_FISH_STING, 0.0F));
            }

            p_29617_.addEffect(new MobEffectInstance(MobEffects.POISON, 60 * $$1, 0), this);
        }
    ...
    private static class PufferfishPuffGoal extends Goal {
        ...
        public boolean canUse() {
            List<LivingEntity> $$0 = this.fish.level().getEntitiesOfClass(LivingEntity.class, this.fish.getBoundingBox().inflate(2.0), (p_149015_) -> {
