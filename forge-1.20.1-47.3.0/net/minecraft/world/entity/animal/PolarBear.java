...
public class PolarBear extends Animal implements NeutralMob {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_149005_, AgeableMob p_149006_) {
        return (AgeableMob)EntityType.POLAR_BEAR.create(p_149005_);
    }
    ...
    public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> p_218250_, LevelAccessor p_218251_, MobSpawnType p_218252_, BlockPos p_218253_, RandomSource p_218254_) {
        Holder<Biome> $$5 = p_218251_.getBiome(p_218253_);
    ...
    public EntityDimensions getDimensions(Pose p_29531_) {
        if (this.clientSideStandAnimation > 0.0F) {
            ...
            float $$2 = 1.0F + $$1;
            return super.getDimensions(p_29531_).scale(1.0F, $$2);
        } else {
    ...
    public boolean doHurtTarget(Entity p_29522_) {
        boolean $$1 = p_29522_.hurt(this.damageSources().mobAttack(this), (float)((int)this.getAttributeValue(Attributes.ATTACK_DAMAGE)));
        if ($$1) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_29533_, DifficultyInstance p_29534_, MobSpawnType p_29535_, @Nullable SpawnGroupData p_29536_, @Nullable CompoundTag p_29537_) {
        ...
        return super.finalizeSpawn(p_29533_, p_29534_, p_29535_, (SpawnGroupData)p_29536_, p_29537_);
    }
    ...
    class PolarBearMeleeAttackGoal extends MeleeAttackGoal {
        ...
        protected void checkAndPerformAttack(LivingEntity p_29589_, double p_29590_) {
            double $$2 = this.getAttackReachSqr(p_29589_);
            if (p_29590_ <= $$2 && this.isTimeToAttack()) {
        ...
        public boolean canUse() {
            if (PolarBear.this.isBaby()) {
                ...
                if (super.canUse()) {
                    ...
                    while(var2.hasNext()) {
                        PolarBear $$1 = (PolarBear)var2.next();
                        if ($$1.isBaby()) {
                            return true;
                        }
                    }
