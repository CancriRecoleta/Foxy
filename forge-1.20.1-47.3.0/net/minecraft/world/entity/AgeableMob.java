...
public abstract class AgeableMob extends PathfinderMob {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_146746_, DifficultyInstance p_146747_, MobSpawnType p_146748_, @Nullable SpawnGroupData p_146749_, @Nullable CompoundTag p_146750_) {
        ...
        AgeableMobGroupData $$5 = (AgeableMobGroupData)p_146749_;
        if ($$5.isShouldSpawnBaby() && $$5.getGroupSize() > 0 && p_146746_.getRandom().nextFloat() <= $$5.getBabySpawnChance()) {
            this.setAge(-24000);
        }

        $$5.increaseGroupSizeByOne();
        return super.finalizeSpawn(p_146746_, p_146747_, p_146748_, (SpawnGroupData)p_146749_, p_146750_);
    }
