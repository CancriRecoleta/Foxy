...
public class DyeItem extends Item implements SignApplicator {
    ...
    public InteractionResult interactLivingEntity(ItemStack p_41085_, Player p_41086_, LivingEntity p_41087_, InteractionHand p_41088_) {
        if (p_41087_ instanceof Sheep $$4) {
            if ($$4.isAlive() && !$$4.isSheared() && $$4.getColor() != this.dyeColor) {
                $$4.level().playSound((Player)p_41086_, (Entity)$$4, SoundEvents.DYE_USE, SoundSource.PLAYERS, 1.0F, 1.0F);
    ...
    public static DyeItem byColor(DyeColor p_41083_) {
        return (DyeItem)ITEM_BY_COLOR.get(p_41083_);
    }
    ...
    public boolean tryApplyToSign(Level p_277691_, SignBlockEntity p_277488_, boolean p_277951_, Player p_277932_) {
        if (p_277488_.updateText((p_277649_) -> {
            ...
            p_277691_.playSound((Player)null, (BlockPos)p_277488_.getBlockPos(), SoundEvents.DYE_USE, SoundSource.BLOCKS, 1.0F, 1.0F);
            return true;
        } else {
            return false;
        }
