...
public class Items {
    ...
    public static Item registerBlock(Block p_252092_, final Block... p_248886_) {
    ...
    public static Item registerBlock(BlockItem p_42804_) {
        return registerBlock(p_42804_.getBlock(), (Item)p_42804_);
    }
    ...
    public static Item registerItem(ResourceKey<Item> p_281502_, Item p_283159_) {
        ...
        return (Item)Registry.register(BuiltInRegistries.ITEM, (ResourceKey)p_281502_, p_283159_);
    }
    ...
    static {
        ...
        MINECART = registerItem((String)"minecart", new MinecartItem(Type.RIDEABLE, (new Item.Properties()).stacksTo(1)));
        CHEST_MINECART = registerItem((String)"chest_minecart", new MinecartItem(Type.CHEST, (new Item.Properties()).stacksTo(1)));
        FURNACE_MINECART = registerItem((String)"furnace_minecart", new MinecartItem(Type.FURNACE, (new Item.Properties()).stacksTo(1)));
        TNT_MINECART = registerItem((String)"tnt_minecart", new MinecartItem(Type.TNT, (new Item.Properties()).stacksTo(1)));
        HOPPER_MINECART = registerItem((String)"hopper_minecart", new MinecartItem(Type.HOPPER, (new Item.Properties()).stacksTo(1)));
        ...
        OAK_BOAT = registerItem((String)"oak_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.OAK, (new Item.Properties()).stacksTo(1)));
        OAK_CHEST_BOAT = registerItem((String)"oak_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.OAK, (new Item.Properties()).stacksTo(1)));
        SPRUCE_BOAT = registerItem((String)"spruce_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.SPRUCE, (new Item.Properties()).stacksTo(1)));
        SPRUCE_CHEST_BOAT = registerItem((String)"spruce_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.SPRUCE, (new Item.Properties()).stacksTo(1)));
        BIRCH_BOAT = registerItem((String)"birch_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.BIRCH, (new Item.Properties()).stacksTo(1)));
        BIRCH_CHEST_BOAT = registerItem((String)"birch_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.BIRCH, (new Item.Properties()).stacksTo(1)));
        JUNGLE_BOAT = registerItem((String)"jungle_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.JUNGLE, (new Item.Properties()).stacksTo(1)));
        JUNGLE_CHEST_BOAT = registerItem((String)"jungle_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.JUNGLE, (new Item.Properties()).stacksTo(1)));
        ACACIA_BOAT = registerItem((String)"acacia_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.ACACIA, (new Item.Properties()).stacksTo(1)));
        ACACIA_CHEST_BOAT = registerItem((String)"acacia_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.ACACIA, (new Item.Properties()).stacksTo(1)));
        CHERRY_BOAT = registerItem((String)"cherry_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.CHERRY, (new Item.Properties()).stacksTo(1)));
        CHERRY_CHEST_BOAT = registerItem((String)"cherry_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.CHERRY, (new Item.Properties()).stacksTo(1)));
        DARK_OAK_BOAT = registerItem((String)"dark_oak_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.DARK_OAK, (new Item.Properties()).stacksTo(1)));
        DARK_OAK_CHEST_BOAT = registerItem((String)"dark_oak_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.DARK_OAK, (new Item.Properties()).stacksTo(1)));
        MANGROVE_BOAT = registerItem((String)"mangrove_boat", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.MANGROVE, (new Item.Properties()).stacksTo(1)));
        MANGROVE_CHEST_BOAT = registerItem((String)"mangrove_chest_boat", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.MANGROVE, (new Item.Properties()).stacksTo(1)));
        BAMBOO_RAFT = registerItem((String)"bamboo_raft", new BoatItem(false, net.minecraft.world.entity.vehicle.Boat.Type.BAMBOO, (new Item.Properties()).stacksTo(1)));
        BAMBOO_CHEST_RAFT = registerItem((String)"bamboo_chest_raft", new BoatItem(true, net.minecraft.world.entity.vehicle.Boat.Type.BAMBOO, (new Item.Properties()).stacksTo(1)));
        ...
        TURTLE_HELMET = registerItem((String)"turtle_helmet", new ArmorItem(ArmorMaterials.TURTLE, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        ...
        LEATHER_HELMET = registerItem((String)"leather_helmet", new DyeableArmorItem(ArmorMaterials.LEATHER, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        LEATHER_CHESTPLATE = registerItem((String)"leather_chestplate", new DyeableArmorItem(ArmorMaterials.LEATHER, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        LEATHER_LEGGINGS = registerItem((String)"leather_leggings", new DyeableArmorItem(ArmorMaterials.LEATHER, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties()));
        LEATHER_BOOTS = registerItem((String)"leather_boots", new DyeableArmorItem(ArmorMaterials.LEATHER, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties()));
        CHAINMAIL_HELMET = registerItem((String)"chainmail_helmet", new ArmorItem(ArmorMaterials.CHAIN, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        CHAINMAIL_CHESTPLATE = registerItem((String)"chainmail_chestplate", new ArmorItem(ArmorMaterials.CHAIN, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        CHAINMAIL_LEGGINGS = registerItem((String)"chainmail_leggings", new ArmorItem(ArmorMaterials.CHAIN, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties()));
        CHAINMAIL_BOOTS = registerItem((String)"chainmail_boots", new ArmorItem(ArmorMaterials.CHAIN, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties()));
        IRON_HELMET = registerItem((String)"iron_helmet", new ArmorItem(ArmorMaterials.IRON, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        IRON_CHESTPLATE = registerItem((String)"iron_chestplate", new ArmorItem(ArmorMaterials.IRON, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        IRON_LEGGINGS = registerItem((String)"iron_leggings", new ArmorItem(ArmorMaterials.IRON, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties()));
        IRON_BOOTS = registerItem((String)"iron_boots", new ArmorItem(ArmorMaterials.IRON, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties()));
        DIAMOND_HELMET = registerItem((String)"diamond_helmet", new ArmorItem(ArmorMaterials.DIAMOND, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        DIAMOND_CHESTPLATE = registerItem((String)"diamond_chestplate", new ArmorItem(ArmorMaterials.DIAMOND, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        DIAMOND_LEGGINGS = registerItem((String)"diamond_leggings", new ArmorItem(ArmorMaterials.DIAMOND, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties()));
        DIAMOND_BOOTS = registerItem((String)"diamond_boots", new ArmorItem(ArmorMaterials.DIAMOND, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties()));
        GOLDEN_HELMET = registerItem((String)"golden_helmet", new ArmorItem(ArmorMaterials.GOLD, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties()));
        GOLDEN_CHESTPLATE = registerItem((String)"golden_chestplate", new ArmorItem(ArmorMaterials.GOLD, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        GOLDEN_LEGGINGS = registerItem((String)"golden_leggings", new ArmorItem(ArmorMaterials.GOLD, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties()));
        GOLDEN_BOOTS = registerItem((String)"golden_boots", new ArmorItem(ArmorMaterials.GOLD, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties()));
        NETHERITE_HELMET = registerItem((String)"netherite_helmet", new ArmorItem(ArmorMaterials.NETHERITE, net.minecraft.world.item.ArmorItem.Type.HELMET, (new Item.Properties()).fireResistant()));
        NETHERITE_CHESTPLATE = registerItem((String)"netherite_chestplate", new ArmorItem(ArmorMaterials.NETHERITE, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, (new Item.Properties()).fireResistant()));
        NETHERITE_LEGGINGS = registerItem((String)"netherite_leggings", new ArmorItem(ArmorMaterials.NETHERITE, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, (new Item.Properties()).fireResistant()));
        NETHERITE_BOOTS = registerItem((String)"netherite_boots", new ArmorItem(ArmorMaterials.NETHERITE, net.minecraft.world.item.ArmorItem.Type.BOOTS, (new Item.Properties()).fireResistant()));
        ...
        COMMAND_BLOCK_MINECART = registerItem((String)"command_block_minecart", new MinecartItem(Type.COMMAND_BLOCK, (new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC)));
