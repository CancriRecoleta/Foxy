...
public class FireworkStarRecipe extends CustomRecipe {
    ...
    public ItemStack assemble(CraftingContainer p_43893_, RegistryAccess p_266692_) {
        ...
        FireworkRocketItem.Shape fireworkrocketitem$shape = Shape.SMALL_BALL;
        ...
        for(int i = 0; i < p_43893_.getContainerSize(); ++i) {
            ...
            if (!itemstack1.isEmpty()) {
                if (SHAPE_INGREDIENT.test(itemstack1)) {
                    fireworkrocketitem$shape = (FireworkRocketItem.Shape)SHAPE_BY_ITEM.get(itemstack1.getItem());
    ...
    static {
        ...
        SHAPE_BY_ITEM = (Map)Util.make(Maps.newHashMap(), (p_261449_) -> {
            p_261449_.put(Items.FIRE_CHARGE, Shape.LARGE_BALL);
            p_261449_.put(Items.FEATHER, Shape.BURST);
            p_261449_.put(Items.GOLD_NUGGET, Shape.STAR);
            p_261449_.put(Items.SKELETON_SKULL, Shape.CREEPER);
            p_261449_.put(Items.WITHER_SKELETON_SKULL, Shape.CREEPER);
            p_261449_.put(Items.CREEPER_HEAD, Shape.CREEPER);
            p_261449_.put(Items.PLAYER_HEAD, Shape.CREEPER);
            p_261449_.put(Items.DRAGON_HEAD, Shape.CREEPER);
            p_261449_.put(Items.ZOMBIE_HEAD, Shape.CREEPER);
            p_261449_.put(Items.PIGLIN_HEAD, Shape.CREEPER);
        });
