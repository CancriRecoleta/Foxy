...
public class ShapedRecipe implements CraftingRecipe, IShapedRecipe<CraftingContainer> {
    ...
    public static class Serializer implements RecipeSerializer<ShapedRecipe> {
        ...
        public ShapedRecipe fromJson(ResourceLocation p_44236_, JsonObject p_44237_) {
            ...
            CraftingBookCategory craftingbookcategory = (CraftingBookCategory)CraftingBookCategory.CODEC.byName(GsonHelper.getAsString(p_44237_, "category", (String)null), CraftingBookCategory.MISC);
        ...
        public void toNetwork(FriendlyByteBuf p_44227_, ShapedRecipe p_44228_) {
            ...
            Iterator var3 = p_44228_.recipeItems.iterator();
