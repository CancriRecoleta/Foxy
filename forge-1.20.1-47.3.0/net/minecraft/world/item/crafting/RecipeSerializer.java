...
public interface RecipeSerializer<T extends Recipe<?>> extends IForgeRecipeSerializer<T> {
    ...
    @Nullable T fromNetwork(ResourceLocation var1, FriendlyByteBuf var2);
    ...
    static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(String p_44099_, S p_44100_) {
        return (RecipeSerializer)Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, (String)p_44099_, p_44100_);
    }
}
