...
public class MobBucketItem extends BucketItem {
    ...
    private void spawn(ServerLevel p_151142_, ItemStack p_151143_, BlockPos p_151144_) {
        Entity entity = this.getFishType().spawn(p_151142_, p_151143_, (Player)null, p_151144_, MobSpawnType.BUCKET, true, false);
    ...
    public void appendHoverText(ItemStack p_151155_, @Nullable Level p_151156_, List<Component> p_151157_, TooltipFlag p_151158_) {
        if (this.getFishType() == EntityType.TROPICAL_FISH) {
            ...
            if (compoundtag != null && compoundtag.contains("BucketVariantTag", 3)) {
                ...
                if (!s.equals(s1)) {
                    mutablecomponent.append(", ").append((Component)Component.translatable(s1));
                }
    ...
    protected SoundEvent getEmptySound() {
        return (SoundEvent)this.emptySoundSupplier.get();
    }
}
