...
public class Potions {
    ...
    private static Potion register(String p_43626_, Potion p_43627_) {
        return (Potion)Registry.register(BuiltInRegistries.POTION, (String)p_43626_, p_43627_);
    }

    private static Potion register(ResourceKey<Potion> p_270074_, Potion p_271009_) {
        return (Potion)Registry.register(BuiltInRegistries.POTION, (ResourceKey)p_270074_, p_271009_);
    }
