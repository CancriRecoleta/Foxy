...
public enum DyeColor implements StringRepresentable {
    ...
    private static final IntFunction<DyeColor> BY_ID = ByIdMap.continuous(DyeColor::getId, values(), OutOfBoundsStrategy.ZERO);
    private static final Int2ObjectOpenHashMap<DyeColor> BY_FIREWORK_COLOR = new Int2ObjectOpenHashMap((Map)Arrays.stream(values()).collect(Collectors.toMap((p_41064_) -> {
    ...
    private DyeColor(int p_41046_, String p_41047_, int p_41048_, MapColor p_285297_, int p_41050_, int p_41051_) {
        ...
        this.tag = ItemTags.create(new ResourceLocation("forge", "dyes/" + p_41047_));
    ...
    public static DyeColor byId(int p_41054_) {
        return (DyeColor)BY_ID.apply(p_41054_);
    }

    @Nullable
    @Contract("_,!null->!null;_,null->_")
    public static DyeColor byName(String p_41058_, @Nullable DyeColor p_41059_) {
        DyeColor dyecolor = (DyeColor)CODEC.byName(p_41058_);
