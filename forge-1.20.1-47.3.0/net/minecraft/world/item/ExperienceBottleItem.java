...
public class ExperienceBottleItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41196_, Player p_41197_, InteractionHand p_41198_) {
        ItemStack $$3 = p_41197_.getItemInHand(p_41198_);
        ...
        if (!p_41196_.isClientSide) {
            ...
            $$4.setItem($$3);
            $$4.shootFromRotation(p_41197_, p_41197_.getXRot(), p_41197_.getYRot(), -20.0F, 0.7F, 1.0F);
            p_41196_.addFreshEntity($$4);
        }
        ...
        return InteractionResultHolder.sidedSuccess($$3, p_41196_.isClientSide());
    }
}
