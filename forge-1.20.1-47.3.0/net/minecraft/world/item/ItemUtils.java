...
public class ItemUtils {
    ...
    public static ItemStack createFilledResult(ItemStack p_41818_, Player p_41819_, ItemStack p_41820_, boolean p_41821_) {
        boolean $$4 = p_41819_.getAbilities().instabuild;
        if (p_41821_ && $$4) {
    ...
    public static void onContainerDestroyed(ItemEntity p_150953_, Stream<ItemStack> p_150954_) {
        Level $$2 = p_150953_.level();
        if (!$$2.isClientSide) {
            p_150954_.forEach((p_289504_) -> {
                $$2.addFreshEntity(new ItemEntity($$2, p_150953_.getX(), p_150953_.getY(), p_150953_.getZ(), p_289504_));
            });
        }
    }
}
