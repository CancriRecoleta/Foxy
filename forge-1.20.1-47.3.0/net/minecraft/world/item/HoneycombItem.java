...
public class HoneycombItem extends Item implements SignApplicator {
    ...
    public InteractionResult useOn(UseOnContext p_150869_) {
        Level $$1 = p_150869_.getLevel();
        BlockPos $$2 = p_150869_.getClickedPos();
        BlockState $$3 = $$1.getBlockState($$2);
        return (InteractionResult)getWaxed($$3).map((p_238251_) -> {
            Player $$4 = p_150869_.getPlayer();
            ItemStack $$5 = p_150869_.getItemInHand();
            ...
            $$1.gameEvent(GameEvent.BLOCK_CHANGE, $$2, Context.of($$4, p_238251_));
    ...
    public static Optional<BlockState> getWaxed(BlockState p_150879_) {
        return Optional.ofNullable((Block)((BiMap)WAXABLES.get()).get(p_150879_.getBlock())).map((p_150877_) -> {
