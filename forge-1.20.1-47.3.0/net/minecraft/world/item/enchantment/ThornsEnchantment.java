...
public class ThornsEnchantment extends Enchantment {
    ...
    public void doPostHurt(LivingEntity p_45215_, Entity p_45216_, int p_45217_) {
        ...
        if (shouldHit(p_45217_, $$3)) {
            if (p_45216_ != null) {
                p_45216_.hurt(p_45215_.damageSources().thorns(p_45215_), (float)getDamage(p_45217_, $$3));
            }

            if ($$4 != null) {
                ((ItemStack)$$4.getValue()).hurtAndBreak(2, p_45215_, (p_45208_) -> {
                    p_45208_.broadcastBreakEvent((EquipmentSlot)$$4.getKey());
                });
            }
        }
