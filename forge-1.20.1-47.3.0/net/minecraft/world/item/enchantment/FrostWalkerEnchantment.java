            ...
            while(var7.hasNext()) {
                ...
                if (blockpos.closerToCenterThan(p_45019_.position(), (double)i)) {
                    ...
                    if (blockstate1.isAir()) {
                        ...
                        if (blockstate2 == FrostedIceBlock.meltsInto() && blockstate.canSurvive(p_45020_, blockpos) && p_45020_.isUnobstructed(blockstate, blockpos, CollisionContext.empty()) && !ForgeEventFactory.onBlockPlace(p_45019_, BlockSnapshot.create(p_45020_.dimension(), p_45020_, blockpos), Direction.UP)) {
