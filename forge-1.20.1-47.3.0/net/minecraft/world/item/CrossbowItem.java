...
public class CrossbowItem extends ProjectileWeaponItem implements Vanishable {
    ...
    private SoundEvent getStartSound(int p_40852_) {
        switch (p_40852_) {
            case 1 -> return SoundEvents.CROSSBOW_QUICK_CHARGE_1;
            case 2 -> return SoundEvents.CROSSBOW_QUICK_CHARGE_2;
            case 3 -> return SoundEvents.CROSSBOW_QUICK_CHARGE_3;
            default -> return SoundEvents.CROSSBOW_LOADING_START;
        }
    }
