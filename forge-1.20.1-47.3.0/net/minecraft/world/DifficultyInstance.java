...
public class DifficultyInstance {
    ...
    private float calculateDifficulty(Difficulty p_19052_, long p_19053_, long p_19054_, float p_19055_) {
        if (p_19052_ == Difficulty.PEACEFUL) {
            ...
            float $$5 = 0.75F;
            float $$6 = Mth.clamp(((float)p_19053_ + -72000.0F) / 1440000.0F, 0.0F, 1.0F) * 0.25F;
            $$5 += $$6;
            float $$7 = 0.0F;
            $$7 += Mth.clamp((float)p_19054_ / 3600000.0F, 0.0F, 1.0F) * ($$4 ? 1.0F : 0.75F);
            $$7 += Mth.clamp(p_19055_ * 0.25F, 0.0F, $$6);
            if (p_19052_ == Difficulty.EASY) {
                $$7 *= 0.5F;
            }

            $$5 += $$7;
            return (float)p_19052_.getId() * $$5;
        }
    }
}
