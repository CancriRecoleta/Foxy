...
public enum GameType implements StringRepresentable {
    ...
    private static final IntFunction<GameType> BY_ID = ByIdMap.continuous(GameType::getId, values(), OutOfBoundsStrategy.ZERO);
    ...
    public static GameType byId(int p_46394_) {
        return (GameType)BY_ID.apply(p_46394_);
    }
    ...
    public static GameType byName(String p_46403_, @Nullable GameType p_46404_) {
        GameType $$2 = (GameType)CODEC.byName(p_46403_);
        return $$2 != null ? $$2 : p_46404_;
    }
