...
public class LevelLightEngine implements LightEventListener {
    ...
    public LayerLightEventListener getLayerListener(LightLayer p_75815_) {
        if (p_75815_ == LightLayer.BLOCK) {
            return (LayerLightEventListener)(this.blockEngine == null ? DummyLightLayerEventListener.INSTANCE : this.blockEngine);
        } else {
            return (LayerLightEventListener)(this.skyEngine == null ? DummyLightLayerEventListener.INSTANCE : this.skyEngine);
        }
    }
    ...
    public int getRawBrightness(BlockPos p_75832_, int p_75833_) {
        int $$2 = this.skyEngine == null ? 0 : this.skyEngine.getLightValue(p_75832_) - p_75833_;
        int $$3 = this.blockEngine == null ? 0 : this.blockEngine.getLightValue(p_75832_);
        return Math.max($$3, $$2);
    }

    public boolean lightOnInSection(SectionPos p_285319_) {
        long $$1 = p_285319_.asLong();
