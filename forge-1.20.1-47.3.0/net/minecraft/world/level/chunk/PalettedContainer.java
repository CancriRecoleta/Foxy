...
public class PalettedContainer<T> implements PaletteResize<T>, PalettedContainerRO<T> {
    ...
    public PalettedContainer(IdMap<T> p_188035_, Strategy p_188036_, Configuration<T> p_188037_, BitStorage p_188038_, List<T> p_188039_) {
        ...
        this.data = new Data(p_188037_, p_188038_, p_188037_.factory().create(p_188037_.bits(), p_188035_, this, p_188039_));
    }
    ...
    public int onResize(int p_63142_, T p_63143_) {
        ...
        Data<T> data1 = this.createOrReuseData(data, p_63142_);
    ...
    private static <T> DataResult<PalettedContainer<T>> unpack(IdMap<T> p_188068_, Strategy p_188069_, PalettedContainerRO.PackedData<T> p_238258_) {
        ...
        if (j == 0) {
            ...
            try {
                if (configuration.factory() == net.minecraft.world.level.chunk.PalettedContainer.Strategy.GLOBAL_PALETTE_FACTORY) {
                ...
                SimpleBitStorage.InitializationException simplebitstorage$initializationexception = var13;
                return DataResult.error(() -> {
        ...
        return DataResult.success(new PalettedContainer(p_188068_, p_188069_, configuration, (BitStorage)bitstorage, list));
    }
    ...
    public abstract static class Strategy {
        ...
        public static final Strategy SECTION_STATES = new Strategy(4) {
            public <A> Configuration<A> getConfiguration(IdMap<A> p_188157_, int p_188158_) {
                Configuration palettedcontainer$configuration;
                switch (p_188158_) {
                    case 0:
                        palettedcontainer$configuration = new Configuration(SINGLE_VALUE_PALETTE_FACTORY, p_188158_);
                        break;
                    case 1:
                    case 2:
                    case 3:
                    case 4:
                        palettedcontainer$configuration = new Configuration(LINEAR_PALETTE_FACTORY, 4);
                        break;
                    case 5:
                    case 6:
                    case 7:
                    case 8:
                        palettedcontainer$configuration = new Configuration(HASHMAP_PALETTE_FACTORY, p_188158_);
                        break;
                    default:
                        palettedcontainer$configuration = new Configuration(net.minecraft.world.level.chunk.PalettedContainer.Strategy.GLOBAL_PALETTE_FACTORY, Mth.ceillog2(p_188157_.size()));
                }
        ...
        public static final Strategy SECTION_BIOMES = new Strategy(2) {
            public <A> Configuration<A> getConfiguration(IdMap<A> p_188162_, int p_188163_) {
                ...
                switch (p_188163_) {
                    case 0:
                        palettedcontainer$configuration = new Configuration(SINGLE_VALUE_PALETTE_FACTORY, p_188163_);
                        break;
                    case 1:
                    case 2:
                    case 3:
                        palettedcontainer$configuration = new Configuration(LINEAR_PALETTE_FACTORY, p_188163_);
                        break;
                    default:
                        palettedcontainer$configuration = new Configuration(net.minecraft.world.level.chunk.PalettedContainer.Strategy.GLOBAL_PALETTE_FACTORY, Mth.ceillog2(p_188162_.size()));
                }
