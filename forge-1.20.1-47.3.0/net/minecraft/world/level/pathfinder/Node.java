...
public class Node {
    ...
    public float distanceTo(Node p_77294_) {
        float $$1 = (float)(p_77294_.x - this.x);
        float $$2 = (float)(p_77294_.y - this.y);
        float $$3 = (float)(p_77294_.z - this.z);
        return Mth.sqrt($$1 * $$1 + $$2 * $$2 + $$3 * $$3);
    }

    public float distanceToXZ(Node p_230614_) {
        float $$1 = (float)(p_230614_.x - this.x);
        float $$2 = (float)(p_230614_.z - this.z);
        return Mth.sqrt($$1 * $$1 + $$2 * $$2);
    }

    public float distanceTo(BlockPos p_164698_) {
        float $$1 = (float)(p_164698_.getX() - this.x);
        float $$2 = (float)(p_164698_.getY() - this.y);
        float $$3 = (float)(p_164698_.getZ() - this.z);
        return Mth.sqrt($$1 * $$1 + $$2 * $$2 + $$3 * $$3);
    }

    public float distanceToSqr(Node p_77300_) {
        float $$1 = (float)(p_77300_.x - this.x);
        float $$2 = (float)(p_77300_.y - this.y);
        float $$3 = (float)(p_77300_.z - this.z);
        return $$1 * $$1 + $$2 * $$2 + $$3 * $$3;
    }

    public float distanceToSqr(BlockPos p_164703_) {
        float $$1 = (float)(p_164703_.getX() - this.x);
        float $$2 = (float)(p_164703_.getY() - this.y);
        float $$3 = (float)(p_164703_.getZ() - this.z);
        return $$1 * $$1 + $$2 * $$2 + $$3 * $$3;
    }

    public float distanceManhattan(Node p_77305_) {
        float $$1 = (float)Math.abs(p_77305_.x - this.x);
        float $$2 = (float)Math.abs(p_77305_.y - this.y);
        float $$3 = (float)Math.abs(p_77305_.z - this.z);
        return $$1 + $$2 + $$3;
    }

    public float distanceManhattan(BlockPos p_77307_) {
        float $$1 = (float)Math.abs(p_77307_.getX() - this.x);
        float $$2 = (float)Math.abs(p_77307_.getY() - this.y);
        float $$3 = (float)Math.abs(p_77307_.getZ() - this.z);
        return $$1 + $$2 + $$3;
    }
    ...
    protected static void readContents(FriendlyByteBuf p_262984_, Node p_263009_) {
        ...
        p_263009_.type = (BlockPathTypes)p_262984_.readEnum(BlockPathTypes.class);
