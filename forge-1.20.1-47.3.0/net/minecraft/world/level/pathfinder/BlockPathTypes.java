...
public enum BlockPathTypes implements IExtensibleEnum {
    BLOCKED(-1.0F),
    OPEN(0.0F),
    WALKABLE(0.0F),
    WALKABLE_DOOR(0.0F),
    ...
    public @Nullable BlockPathTypes getDanger() {
        return this != DAMAGE_FIRE && this != DANGER_FIRE ? (this != DAMAGE_OTHER && this != DANGER_OTHER ? (this == LAVA ? DAMAGE_FIRE : null) : DANGER_OTHER) : DANGER_FIRE;
    }
