...
public final class Biome {
    public static final Codec<Biome> DIRECT_CODEC = RecordCodecBuilder.create((p_220544_) -> {
        return p_220544_.group(net.minecraft.world.level.biome.Biome.ClimateSettings.CODEC.forGetter((p_151717_) -> {
            return p_151717_.modifiableBiomeInfo().getOriginalBiomeInfo().climateSettings();
        }), BiomeSpecialEffects.CODEC.fieldOf("effects").forGetter((p_220550_) -> {
            return p_220550_.modifiableBiomeInfo().getOriginalBiomeInfo().effects();
    ...
    public static final Codec<Biome> NETWORK_CODEC = RecordCodecBuilder.create((p_220540_) -> {
        return p_220540_.group(net.minecraft.world.level.biome.Biome.ClimateSettings.CODEC.forGetter((p_220542_) -> {
    ...
    public Precipitation getPrecipitationAt(BlockPos p_265163_) {
        if (!this.hasPrecipitation()) {
            ...
            return this.coldEnoughToSnow(p_265163_) ? net.minecraft.world.level.biome.Biome.Precipitation.SNOW : net.minecraft.world.level.biome.Biome.Precipitation.RAIN;
        }
    }
    ...
    public static record ClimateSettings(boolean hasPrecipitation, float temperature, TemperatureModifier temperatureModifier, float downfall) {
        public static final MapCodec<ClimateSettings> CODEC = RecordCodecBuilder.mapCodec((p_264995_) -> {
            ...
            }), net.minecraft.world.level.biome.Biome.TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", net.minecraft.world.level.biome.Biome.TemperatureModifier.NONE).forGetter((p_151735_) -> {
                return p_151735_.temperatureModifier;
            }), Codec.FLOAT.fieldOf("downfall").forGetter((p_151733_) -> {
                return p_151733_.downfall;
            })).apply(p_264995_, ClimateSettings::new);
        });
    ...
    public static class BiomeBuilder {
        ...
        public BiomeBuilder() {
            this.temperatureModifier = net.minecraft.world.level.biome.Biome.TemperatureModifier.NONE;
        }
