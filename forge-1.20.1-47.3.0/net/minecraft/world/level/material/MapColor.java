...
public class MapColor {
    ...
    public int calculateRGBColor(Brightness p_285401_) {
        if (this == NONE) {
            return 0;
        } else {
            int $$1 = p_285401_.modifier;
            int $$2 = (this.col >> 16 & 255) * $$1 / 255;
            int $$3 = (this.col >> 8 & 255) * $$1 / 255;
            int $$4 = (this.col & 255) * $$1 / 255;
            return -16777216 | $$4 << 16 | $$3 << 8 | $$2;
        }
    }
    ...
    private static MapColor byIdUnsafe(int p_285180_) {
        MapColor $$1 = MATERIAL_COLORS[p_285180_];
        return $$1 != null ? $$1 : NONE;
    }

    public static int getColorFromPackedId(int p_285190_) {
        int $$1 = p_285190_ & 255;
        return byIdUnsafe($$1 >> 2).calculateRGBColor(net.minecraft.world.level.material.MapColor.Brightness.byIdUnsafe($$1 & 3));
    }

    public byte getPackedId(Brightness p_285070_) {
