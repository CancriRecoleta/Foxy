...
public class PlayerDataStorage {
    ...
    public void save(Player p_78434_) {
        try {
            ...
            ForgeEventFactory.firePlayerSavingEvent(p_78434_, this.playerDir, p_78434_.getStringUUID());
    ...
    public CompoundTag load(Player p_78436_) {
        ...
        ForgeEventFactory.firePlayerLoadingEvent(p_78436_, this.playerDir, p_78436_.getStringUUID());
        return compoundtag;
    }
