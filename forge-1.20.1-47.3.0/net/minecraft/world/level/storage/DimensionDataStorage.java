...
public class DimensionDataStorage {
    ...
    public <T extends SavedData> T get(Function<CompoundTag, T> p_164859_, String p_164860_) {
        SavedData saveddata = (SavedData)this.cache.get(p_164860_);
        if (saveddata == DummySavedData.DUMMY) {
            ...
            if (saveddata == null && !this.cache.containsKey(p_164860_)) {
                ...
                this.cache.put(p_164860_, DummySavedData.DUMMY);
                return null;
            }
    ...
    private <T extends SavedData> T readSavedData(Function<CompoundTag, T> p_164869_, String p_164870_) {
        try {
            ...
            if (file1.exists()) {
                ...
                return (SavedData)p_164869_.apply(compoundtag.getCompound("data"));
            }
        ...
        try {
            ...
            try {
                ...
                if (this.isGzip(pushbackinputstream)) {
                    compoundtag = NbtIo.readCompressed((InputStream)pushbackinputstream);
                } else {
