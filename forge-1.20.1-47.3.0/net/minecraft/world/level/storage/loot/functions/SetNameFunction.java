...
public class SetNameFunction extends LootItemConditionalFunction {
    ...
    public static UnaryOperator<Component> createResolver(LootContext p_81140_, @Nullable LootContext.EntityTarget p_81141_) {
        if (p_81141_ != null) {
            Entity $$2 = (Entity)p_81140_.getParamOrNull(p_81141_.getParam());
            if ($$2 != null) {
                CommandSourceStack $$3 = $$2.createCommandSourceStack().withPermission(2);
                return (p_81147_) -> {
                    try {
                        return ComponentUtils.updateForEntity($$3, (Component)p_81147_, $$2, 0);
                    } catch (CommandSyntaxException var4) {
                        CommandSyntaxException $$3x = var4;
                        LOGGER.warn("Failed to resolve text component", $$3x);
                        return p_81147_;
                    }
                };
            }
    ...
    public ItemStack run(ItemStack p_81137_, LootContext p_81138_) {
        if (this.name != null) {
            p_81137_.setHoverName((Component)createResolver(p_81138_, this.resolutionContext).apply(this.name));
        }
    ...
    public static class Serializer extends LootItemConditionalFunction.Serializer<SetNameFunction> {
        ...
        public void serialize(JsonObject p_81163_, SetNameFunction p_81164_, JsonSerializationContext p_81165_) {
            super.serialize(p_81163_, (LootItemConditionalFunction)p_81164_, p_81165_);
            if (p_81164_.name != null) {
                p_81163_.add("name", net.minecraft.network.chat.Component.Serializer.toJsonTree(p_81164_.name));
            }
        ...
        public SetNameFunction deserialize(JsonObject p_81155_, JsonDeserializationContext p_81156_, LootItemCondition[] p_81157_) {
            Component $$3 = net.minecraft.network.chat.Component.Serializer.fromJson(p_81155_.get("name"));
            LootContext.EntityTarget $$4 = (LootContext.EntityTarget)GsonHelper.getAsObject(p_81155_, "entity", (Object)null, p_81156_, LootContext.EntityTarget.class);
