...
public class LootItemFunctions {
    ...
    private static LootItemFunctionType register(String p_80763_, Serializer<? extends LootItemFunction> p_80764_) {
        return (LootItemFunctionType)Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, (ResourceLocation)(new ResourceLocation(p_80763_)), new LootItemFunctionType(p_80764_));
    }
        ...
        switch (p_80771_.length) {
            ...
            case 2:
                ...
                return (p_80768_, p_80769_) -> {
                    return (ItemStack)$$2.apply((ItemStack)$$1.apply(p_80768_, p_80769_), p_80769_);
                };
            default:
                return (p_80774_, p_80775_) -> {
                    BiFunction[] var3 = p_80771_;
                    int var4 = p_80771_.length;

                    for(int var5 = 0; var5 < var4; ++var5) {
                        BiFunction<ItemStack, LootContext, ItemStack> $$3 = var3[var5];
