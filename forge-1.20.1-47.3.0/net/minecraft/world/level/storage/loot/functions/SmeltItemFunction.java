...
public class SmeltItemFunction extends LootItemConditionalFunction {
    ...
    public ItemStack run(ItemStack p_81268_, LootContext p_81269_) {
        if (p_81268_.isEmpty()) {
            ...
            Optional<SmeltingRecipe> optional = p_81269_.getLevel().getRecipeManager().getRecipeFor(RecipeType.SMELTING, new SimpleContainer(new ItemStack[]{p_81268_}), p_81269_.getLevel());
            if (optional.isPresent()) {
                ItemStack itemstack = ((SmeltingRecipe)optional.get()).getResultItem(p_81269_.getLevel().registryAccess());
