...
public class ExplorationMapFunction extends LootItemConditionalFunction {
    ...
    public ItemStack run(ItemStack p_80547_, LootContext p_80548_) {
        if (!p_80547_.is(Items.MAP)) {
            ...
            Vec3 $$2 = (Vec3)p_80548_.getParamOrNull(LootContextParams.ORIGIN);
            if ($$2 != null) {
                ServerLevel $$3 = p_80548_.getLevel();
    ...
    static {
        ...
        DEFAULT_DECORATION = Type.MANSION;
    }
    ...
    public static class Serializer extends LootItemConditionalFunction.Serializer<ExplorationMapFunction> {
        ...
        public void serialize(JsonObject p_80587_, ExplorationMapFunction p_80588_, JsonSerializationContext p_80589_) {
            super.serialize(p_80587_, (LootItemConditionalFunction)p_80588_, p_80589_);
        ...
        public ExplorationMapFunction deserialize(JsonObject p_80583_, JsonDeserializationContext p_80584_, LootItemCondition[] p_80585_) {
            TagKey<Structure> $$3 = readStructure(p_80583_);
            String $$4 = p_80583_.has("decoration") ? GsonHelper.getAsString(p_80583_, "decoration") : "mansion";
            MapDecoration.Type $$5 = ExplorationMapFunction.DEFAULT_DECORATION;

            try {
                $$5 = Type.valueOf($$4.toUpperCase(Locale.ROOT));
            ...
            byte $$7 = GsonHelper.getAsByte(p_80583_, "zoom", (byte)2);
            int $$8 = GsonHelper.getAsInt(p_80583_, "search_radius", 50);
            boolean $$9 = GsonHelper.getAsBoolean(p_80583_, "skip_existing_chunks", true);
        ...
        private static TagKey<Structure> readStructure(JsonObject p_210661_) {
            if (p_210661_.has("destination")) {
                String $$1 = GsonHelper.getAsString(p_210661_, "destination");
