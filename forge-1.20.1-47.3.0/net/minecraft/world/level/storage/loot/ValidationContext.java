...
public class ValidationContext {
    ...
    public ValidationContext enterElement(String p_279180_, LootDataId<?> p_279438_) {
        ImmutableSet<LootDataId<?>> $$2 = ImmutableSet.builder().addAll(this.visitedElements).add(p_279438_).build();
        return new ValidationContext(this.problems, () -> {
            String var10000 = this.getContext();
            return var10000 + p_279180_;
        }, this.params, this.resolver, $$2);
    }
