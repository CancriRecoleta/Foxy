...
public abstract class CompositeEntryBase extends LootPoolEntryContainer {
    ...
    public void validate(ValidationContext p_79434_) {
        ...
        for(int $$1 = 0; $$1 < this.children.length; ++$$1) {
            this.children[$$1].validate(p_79434_.forChild(".entry[" + $$1 + "]"));
        }
    ...
    public static <T extends CompositeEntryBase> LootPoolEntryContainer.Serializer<T> createSerializer(final CompositeEntryConstructor<T> p_79436_) {
        return new LootPoolEntryContainer.Serializer<T>() {
            ...
            public final T deserializeCustom(JsonObject p_79445_, JsonDeserializationContext p_79446_, LootItemCondition[] p_79447_) {
                LootPoolEntryContainer[] $$3 = (LootPoolEntryContainer[])GsonHelper.getAsObject(p_79445_, "children", p_79446_, LootPoolEntryContainer[].class);
                return p_79436_.create($$3, p_79447_);
            }
        };
    }
