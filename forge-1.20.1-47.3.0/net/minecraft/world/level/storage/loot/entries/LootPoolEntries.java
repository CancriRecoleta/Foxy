...
public class LootPoolEntries {
    ...
    private static LootPoolEntryType register(String p_79630_, Serializer<? extends LootPoolEntryContainer> p_79631_) {
        return (LootPoolEntryType)Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, (ResourceLocation)(new ResourceLocation(p_79630_)), new LootPoolEntryType(p_79631_));
    }
