...
public class LocationCheck implements LootItemCondition {
    ...
    public boolean test(LootContext p_81731_) {
        Vec3 $$1 = (Vec3)p_81731_.getParamOrNull(LootContextParams.ORIGIN);
        return $$1 != null && this.predicate.matches(p_81731_.getLevel(), $$1.x() + (double)this.offset.getX(), $$1.y() + (double)this.offset.getY(), $$1.z() + (double)this.offset.getZ());
    }
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<LocationCheck> {
        ...
        public LocationCheck deserialize(JsonObject p_81757_, JsonDeserializationContext p_81758_) {
            LocationPredicate $$2 = LocationPredicate.fromJson(p_81757_.get("predicate"));
            int $$3 = GsonHelper.getAsInt(p_81757_, "offsetX", 0);
            int $$4 = GsonHelper.getAsInt(p_81757_, "offsetY", 0);
            int $$5 = GsonHelper.getAsInt(p_81757_, "offsetZ", 0);
