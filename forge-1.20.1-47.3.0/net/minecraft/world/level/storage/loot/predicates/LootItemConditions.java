...
public class LootItemConditions {
    ...
    private static LootItemConditionType register(String p_81832_, Serializer<? extends LootItemCondition> p_81833_) {
        return (LootItemConditionType)Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, (ResourceLocation)(new ResourceLocation(p_81832_)), new LootItemConditionType(p_81833_));
    }
    ...
    public static <T> Predicate<T> andConditions(Predicate<T>[] p_81835_) {
        ...
        switch (p_81835_.length) {
            case 0 -> var10000 = (p_81840_) -> {
    return true;
};
            case 1 -> var10000 = p_81835_[0];
            case 2 -> var10000 = p_81835_[0].and(p_81835_[1]);
            default -> var10000 = (p_81845_) -> {
    Predicate[] var2 = p_81835_;
    int var3 = p_81835_.length;

    for(int var4 = 0; var4 < var3; ++var4) {
        Predicate<T> $$2 = var2[var4];
        if (!$$2.test(p_81845_)) {
            return false;
        }
    }
    ...
    public static <T> Predicate<T> orConditions(Predicate<T>[] p_81842_) {
        ...
        switch (p_81842_.length) {
            case 0 -> var10000 = (p_81830_) -> {
    return false;
};
            case 1 -> var10000 = p_81842_[0];
            case 2 -> var10000 = p_81842_[0].or(p_81842_[1]);
            default -> var10000 = (p_81838_) -> {
    Predicate[] var2 = p_81842_;
    int var3 = p_81842_.length;
