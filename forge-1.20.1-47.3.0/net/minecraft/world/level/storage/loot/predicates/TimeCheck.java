...
public class TimeCheck implements LootItemCondition {
    ...
    public boolean test(LootContext p_82033_) {
        ServerLevel $$1 = p_82033_.getLevel();
        long $$2 = $$1.getDayTime();
        if (this.period != null) {
            $$2 %= this.period;
        }

        return this.value.test(p_82033_, (int)$$2);
    }

    public static Builder time(IntRange p_165510_) {
    ...
    public static class Builder implements LootItemCondition.Builder {
        ...
        public Builder setPeriod(long p_165517_) {
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<TimeCheck> {
        ...
        public TimeCheck deserialize(JsonObject p_82054_, JsonDeserializationContext p_82055_) {
            Long $$2 = p_82054_.has("period") ? GsonHelper.getAsLong(p_82054_, "period") : null;
            IntRange $$3 = (IntRange)GsonHelper.getAsObject(p_82054_, "value", p_82055_, IntRange.class);
