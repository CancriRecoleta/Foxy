...
public class LootItemEntityPropertyCondition implements LootItemCondition {
    ...
    public boolean test(LootContext p_81871_) {
        Entity $$1 = (Entity)p_81871_.getParamOrNull(this.entityTarget.getParam());
        Vec3 $$2 = (Vec3)p_81871_.getParamOrNull(LootContextParams.ORIGIN);
        return this.predicate.matches(p_81871_.getLevel(), $$2, $$1);
    }

    public static LootItemCondition.Builder entityPresent(LootContext.EntityTarget p_81863_) {
        return hasProperties(p_81863_, net.minecraft.advancements.critereon.EntityPredicate.Builder.entity());
    }
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<LootItemEntityPropertyCondition> {
        ...
        public LootItemEntityPropertyCondition deserialize(JsonObject p_81892_, JsonDeserializationContext p_81893_) {
            EntityPredicate $$2 = EntityPredicate.fromJson(p_81892_.get("predicate"));
            return new LootItemEntityPropertyCondition($$2, (LootContext.EntityTarget)GsonHelper.getAsObject(p_81892_, "entity", p_81893_, LootContext.EntityTarget.class));
        }
    }
}
