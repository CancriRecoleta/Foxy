...
public class ScoreboardValue implements NumberProvider {
    ...
    public float getFloat(LootContext p_165758_) {
        String $$1 = this.target.getScoreboardName(p_165758_);
        if ($$1 == null) {
            return 0.0F;
        } else {
            Scoreboard $$2 = p_165758_.getLevel().getScoreboard();
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<ScoreboardValue> {
        ...
        public ScoreboardValue deserialize(JsonObject p_165772_, JsonDeserializationContext p_165773_) {
            String $$2 = GsonHelper.getAsString(p_165772_, "score");
            float $$3 = GsonHelper.getAsFloat(p_165772_, "scale", 1.0F);
            ScoreboardNameProvider $$4 = (ScoreboardNameProvider)GsonHelper.getAsObject(p_165772_, "target", p_165773_, ScoreboardNameProvider.class);
