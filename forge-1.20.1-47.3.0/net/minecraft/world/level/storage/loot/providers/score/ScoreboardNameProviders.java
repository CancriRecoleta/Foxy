...
public class ScoreboardNameProviders {
    ...
    private static LootScoreProviderType register(String p_165874_, Serializer<? extends ScoreboardNameProvider> p_165875_) {
        return (LootScoreProviderType)Registry.register(BuiltInRegistries.LOOT_SCORE_PROVIDER_TYPE, (ResourceLocation)(new ResourceLocation(p_165874_)), new LootScoreProviderType(p_165875_));
    }
