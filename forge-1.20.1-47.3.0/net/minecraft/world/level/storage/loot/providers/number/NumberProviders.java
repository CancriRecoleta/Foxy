...
public class NumberProviders {
    ...
    private static LootNumberProviderType register(String p_165739_, Serializer<? extends NumberProvider> p_165740_) {
        return (LootNumberProviderType)Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, (ResourceLocation)(new ResourceLocation(p_165739_)), new LootNumberProviderType(p_165740_));
    }
