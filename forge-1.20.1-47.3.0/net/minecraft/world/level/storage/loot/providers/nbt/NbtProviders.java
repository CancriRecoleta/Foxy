...
public class NbtProviders {
    ...
    private static LootNbtProviderType register(String p_165629_, Serializer<? extends NbtProvider> p_165630_) {
        return (LootNbtProviderType)Registry.register(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE, (ResourceLocation)(new ResourceLocation(p_165629_)), new LootNbtProviderType(p_165630_));
    }
