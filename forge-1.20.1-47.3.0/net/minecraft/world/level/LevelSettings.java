...
public final class LevelSettings {
    ...
    public LevelSettings(String p_250485_, GameType p_250207_, boolean p_251631_, Difficulty p_252122_, boolean p_248961_, GameRules p_248536_, WorldDataConfiguration p_249797_) {
        this(p_250485_, p_250207_, p_251631_, p_252122_, p_248961_, p_248536_, p_249797_, Lifecycle.stable());
    }

    public LevelSettings(String p_250485_, GameType p_250207_, boolean p_251631_, Difficulty p_252122_, boolean p_248961_, GameRules p_248536_, WorldDataConfiguration p_249797_, Lifecycle lifecycle) {
    ...
    public static LevelSettings parse(Dynamic<?> p_46925_, WorldDataConfiguration p_251697_) {
        ...
        return new LevelSettings(p_46925_.get("LevelName").asString(""), gametype, p_46925_.get("hardcore").asBoolean(false), (Difficulty)p_46925_.get("Difficulty").asNumber().map((p_46928_) -> {
            return Difficulty.byId(p_46928_.byteValue());
        }).result().orElse(Difficulty.NORMAL), p_46925_.get("allowCommands").asBoolean(gametype == GameType.CREATIVE), new GameRules(p_46925_.get("GameRules")), p_251697_, ForgeHooks.parseLifecycle(p_46925_.get("forgeLifecycle").asString("stable")));
    }
    ...
    public LevelSettings withDifficulty(Difficulty p_46919_) {
        ForgeHooks.onDifficultyChange(p_46919_, this.difficulty);
