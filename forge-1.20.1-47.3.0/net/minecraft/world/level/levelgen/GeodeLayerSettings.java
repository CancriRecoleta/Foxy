...
public class GeodeLayerSettings {
    ...
    public static final Codec<GeodeLayerSettings> CODEC = RecordCodecBuilder.create((p_158354_) -> {
        return p_158354_.group(LAYER_RANGE.fieldOf("filling").orElse(1.7).forGetter((p_158362_) -> {
            return p_158362_.filling;
        }), LAYER_RANGE.fieldOf("inner_layer").orElse(2.2).forGetter((p_158360_) -> {
            return p_158360_.innerLayer;
        }), LAYER_RANGE.fieldOf("middle_layer").orElse(3.2).forGetter((p_158358_) -> {
            return p_158358_.middleLayer;
        }), LAYER_RANGE.fieldOf("outer_layer").orElse(4.2).forGetter((p_158356_) -> {
