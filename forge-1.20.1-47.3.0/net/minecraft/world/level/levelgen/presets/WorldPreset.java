...
public class WorldPreset {
    ...
    private Registry<LevelStem> createRegistry() {
        WritableRegistry<LevelStem> $$0 = new MappedRegistry(Registries.LEVEL_STEM, Lifecycle.experimental());
        WorldDimensions.keysInOrder(this.dimensions.keySet().stream()).forEach((p_259013_) -> {
            LevelStem $$2 = (LevelStem)this.dimensions.get(p_259013_);
            if ($$2 != null) {
                $$0.register(p_259013_, $$2, Lifecycle.stable());
            }
