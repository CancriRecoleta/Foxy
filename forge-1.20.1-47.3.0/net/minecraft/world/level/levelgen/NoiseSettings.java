...
public record NoiseSettings(int minY, int height, int noiseSizeHorizontal, int noiseSizeVertical) {
    public static final Codec<NoiseSettings> CODEC = RecordCodecBuilder.create((p_64536_) -> {
    ...
    public static NoiseSettings create(int p_224526_, int p_224527_, int p_224528_, int p_224529_) {
        ...
        guardY($$4).error().ifPresent((p_158719_) -> {
    ...
    public NoiseSettings clampToHeightAccessor(LevelHeightAccessor p_224531_) {
        int $$1 = Math.max(this.minY, p_224531_.getMinBuildHeight());
        int $$2 = Math.min(this.minY + this.height, p_224531_.getMaxBuildHeight()) - $$1;
