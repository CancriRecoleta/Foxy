...
public class OceanRuinStructure extends Structure {
    public static final Codec<OceanRuinStructure> CODEC = RecordCodecBuilder.create((p_229075_) -> {
        return p_229075_.group(settingsCodec(p_229075_), net.minecraft.world.level.levelgen.structure.structures.OceanRuinStructure.Type.CODEC.fieldOf("biome_temp").forGetter((p_229079_) -> {
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext p_229065_) {
        return onTopOfChunkCenter(p_229065_, Types.OCEAN_FLOOR_WG, (p_229068_) -> {
