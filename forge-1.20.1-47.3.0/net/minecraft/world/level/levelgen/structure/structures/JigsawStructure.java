...
public final class JigsawStructure extends Structure {
    ...
    public static final Codec<JigsawStructure> CODEC = ExtraCodecs.validate(RecordCodecBuilder.mapCodec((p_227640_) -> {
        ...
        }), Types.CODEC.optionalFieldOf("project_start_to_heightmap").forGetter((p_227644_) -> {
    ...
    private static DataResult<JigsawStructure> verifyRange(JigsawStructure p_286886_) {
        ...
        int $$1 = var10000;
        return p_286886_.maxDistanceFromCenter + $$1 > 128 ? DataResult.error(() -> {
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext p_227636_) {
        ChunkPos $$1 = p_227636_.chunkPos();
        int $$2 = this.startHeight.sample(p_227636_.random(), new WorldGenerationContext(p_227636_.chunkGenerator(), p_227636_.heightAccessor()));
        BlockPos $$3 = new BlockPos($$1.getMinBlockX(), $$2, $$1.getMinBlockZ());
        return JigsawPlacement.addPieces(p_227636_, this.startPool, this.startJigsawName, this.maxDepth, $$3, this.useExpansionHack, this.projectStartToHeightmap, this.maxDistanceFromCenter);
    }
