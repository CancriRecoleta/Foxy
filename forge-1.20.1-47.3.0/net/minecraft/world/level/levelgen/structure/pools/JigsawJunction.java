...
public class JigsawJunction {
    ...
    public <T> Dynamic<T> serialize(DynamicOps<T> p_210256_) {
        ...
        $$1.put(p_210256_.createString("source_x"), p_210256_.createInt(this.sourceX)).put(p_210256_.createString("source_ground_y"), p_210256_.createInt(this.sourceGroundY)).put(p_210256_.createString("source_z"), p_210256_.createInt(this.sourceZ)).put(p_210256_.createString("delta_y"), p_210256_.createInt(this.deltaY)).put(p_210256_.createString("dest_proj"), p_210256_.createString(this.destProjection.getName()));
        return new Dynamic(p_210256_, p_210256_.createMap($$1.build()));
    }

    public static <T> JigsawJunction deserialize(Dynamic<T> p_210254_) {
        return new JigsawJunction(p_210254_.get("source_x").asInt(0), p_210254_.get("source_ground_y").asInt(0), p_210254_.get("source_z").asInt(0), p_210254_.get("delta_y").asInt(0), Projection.byName(p_210254_.get("dest_proj").asString("")));
    }
    ...
    public boolean equals(Object p_210262_) {
        if (this == p_210262_) {
            ...
            JigsawJunction $$1 = (JigsawJunction)p_210262_;
