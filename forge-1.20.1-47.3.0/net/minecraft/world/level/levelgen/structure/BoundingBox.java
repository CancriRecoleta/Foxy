...
public class BoundingBox {
    ...
    public static Optional<BoundingBox> encapsulatingPositions(Iterable<BlockPos> p_162379_) {
        Iterator<BlockPos> $$1 = p_162379_.iterator();
        if (!$$1.hasNext()) {
    ...
    public static Optional<BoundingBox> encapsulatingBoxes(Iterable<BoundingBox> p_162389_) {
        Iterator<BoundingBox> $$1 = p_162389_.iterator();
        if (!$$1.hasNext()) {
            return Optional.empty();
        } else {
    ...
    public void forAllCorners(Consumer<BlockPos> p_162381_) {
        ...
        p_162381_.accept($$1.set(this.maxX, this.maxY, this.maxZ));
        p_162381_.accept($$1.set(this.minX, this.maxY, this.maxZ));
        p_162381_.accept($$1.set(this.maxX, this.minY, this.maxZ));
        p_162381_.accept($$1.set(this.minX, this.minY, this.maxZ));
        p_162381_.accept($$1.set(this.maxX, this.maxY, this.minZ));
        p_162381_.accept($$1.set(this.minX, this.maxY, this.minZ));
        p_162381_.accept($$1.set(this.maxX, this.minY, this.minZ));
        p_162381_.accept($$1.set(this.minX, this.minY, this.minZ));
    }
    ...
    public boolean equals(Object p_162393_) {
        if (this == p_162393_) {
            ...
            BoundingBox $$1 = (BoundingBox)p_162393_;
    ...
    static {
        CODEC = Codec.INT_STREAM.comapFlatMap((p_162383_) -> {
            return Util.fixedSize((IntStream)p_162383_, 6).map((p_162385_) -> {
                return new BoundingBox(p_162385_[0], p_162385_[1], p_162385_[2], p_162385_[3], p_162385_[4], p_162385_[5]);
            });
        }, (p_162391_) -> {
            return IntStream.of(new int[]{p_162391_.minX, p_162391_.minY, p_162391_.minZ, p_162391_.maxX, p_162391_.maxY, p_162391_.maxZ});
        }).stable();
    }
}
