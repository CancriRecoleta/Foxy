...
public class GiantTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader p_226123_, BiConsumer<BlockPos, BlockState> p_226124_, RandomSource p_226125_, int p_226126_, BlockPos p_226127_, TreeConfiguration p_226128_) {
        BlockPos $$6 = p_226127_.below();
        setDirtAt(p_226123_, p_226124_, p_226125_, $$6, p_226128_);
        setDirtAt(p_226123_, p_226124_, p_226125_, $$6.east(), p_226128_);
        setDirtAt(p_226123_, p_226124_, p_226125_, $$6.south(), p_226128_);
        setDirtAt(p_226123_, p_226124_, p_226125_, $$6.south().east(), p_226128_);
        BlockPos.MutableBlockPos $$7 = new BlockPos.MutableBlockPos();

        for(int $$8 = 0; $$8 < p_226126_; ++$$8) {
            this.placeLogIfFreeWithOffset(p_226123_, p_226124_, p_226125_, $$7, p_226128_, p_226127_, 0, $$8, 0);
            if ($$8 < p_226126_ - 1) {
                this.placeLogIfFreeWithOffset(p_226123_, p_226124_, p_226125_, $$7, p_226128_, p_226127_, 1, $$8, 0);
                this.placeLogIfFreeWithOffset(p_226123_, p_226124_, p_226125_, $$7, p_226128_, p_226127_, 1, $$8, 1);
                this.placeLogIfFreeWithOffset(p_226123_, p_226124_, p_226125_, $$7, p_226128_, p_226127_, 0, $$8, 1);
            }
        }
