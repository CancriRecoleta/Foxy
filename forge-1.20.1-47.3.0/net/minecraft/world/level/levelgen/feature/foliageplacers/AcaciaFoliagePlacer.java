...
public class AcaciaFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(LevelSimulatedReader p_225499_, FoliagePlacer.FoliageSetter p_273746_, RandomSource p_225501_, TreeConfiguration p_225502_, int p_225503_, FoliagePlacer.FoliageAttachment p_225504_, int p_225505_, int p_225506_, int p_225507_) {
        boolean $$9 = p_225504_.doubleTrunk();
        BlockPos $$10 = p_225504_.pos().above(p_225507_);
        this.placeLeavesRow(p_225499_, p_273746_, p_225501_, p_225502_, $$10, p_225506_ + p_225504_.radiusOffset(), -1 - p_225505_, $$9);
        this.placeLeavesRow(p_225499_, p_273746_, p_225501_, p_225502_, $$10, p_225506_ - 1, -p_225505_, $$9);
        this.placeLeavesRow(p_225499_, p_273746_, p_225501_, p_225502_, $$10, p_225506_ + p_225504_.radiusOffset() - 1, 0, $$9);
    }
