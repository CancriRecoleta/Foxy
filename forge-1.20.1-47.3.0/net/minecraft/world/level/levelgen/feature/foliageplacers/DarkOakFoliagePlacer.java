...
public class DarkOakFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(LevelSimulatedReader p_225558_, FoliagePlacer.FoliageSetter p_273641_, RandomSource p_225560_, TreeConfiguration p_225561_, int p_225562_, FoliagePlacer.FoliageAttachment p_225563_, int p_225564_, int p_225565_, int p_225566_) {
        BlockPos $$9 = p_225563_.pos().above(p_225566_);
        boolean $$10 = p_225563_.doubleTrunk();
        if ($$10) {
            this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_ + 2, -1, $$10);
            this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_ + 3, 0, $$10);
            this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_ + 2, 1, $$10);
            if (p_225560_.nextBoolean()) {
                this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_, 2, $$10);
            }
        } else {
            this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_ + 2, -1, $$10);
            this.placeLeavesRow(p_225558_, p_273641_, p_225560_, p_225561_, $$9, p_225565_ + 1, 0, $$10);
        }
