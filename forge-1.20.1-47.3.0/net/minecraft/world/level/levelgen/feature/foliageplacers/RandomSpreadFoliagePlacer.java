...
public class RandomSpreadFoliagePlacer extends FoliagePlacer {
    ...
    protected void createFoliage(LevelSimulatedReader p_225723_, FoliagePlacer.FoliageSetter p_272842_, RandomSource p_225725_, TreeConfiguration p_225726_, int p_225727_, FoliagePlacer.FoliageAttachment p_225728_, int p_225729_, int p_225730_, int p_225731_) {
        BlockPos $$9 = p_225728_.pos();
        BlockPos.MutableBlockPos $$10 = $$9.mutable();

        for(int $$11 = 0; $$11 < this.leafPlacementAttempts; ++$$11) {
            $$10.setWithOffset($$9, p_225725_.nextInt(p_225730_) - p_225725_.nextInt(p_225730_), p_225725_.nextInt(p_225729_) - p_225725_.nextInt(p_225729_), p_225725_.nextInt(p_225730_) - p_225725_.nextInt(p_225730_));
            tryPlaceLeaf(p_225723_, p_272842_, p_225725_, p_225726_, $$10);
        }
