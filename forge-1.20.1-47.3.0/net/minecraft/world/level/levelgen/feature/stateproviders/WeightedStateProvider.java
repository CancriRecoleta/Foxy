...
public class WeightedStateProvider extends BlockStateProvider {
    ...
    public BlockState getState(RandomSource p_225966_, BlockPos p_225967_) {
        return (BlockState)this.weightedList.getRandomValue(p_225966_).orElseThrow(IllegalStateException::new);
    }

    static {
        CODEC = SimpleWeightedRandomList.wrappedCodec(BlockState.CODEC).comapFlatMap(WeightedStateProvider::create, (p_161600_) -> {
