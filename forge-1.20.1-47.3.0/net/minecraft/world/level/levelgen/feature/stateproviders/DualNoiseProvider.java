...
public class DualNoiseProvider extends NoiseProvider {
    public static final Codec<DualNoiseProvider> CODEC = RecordCodecBuilder.create((p_191414_) -> {
        ...
        }), NoiseParameters.DIRECT_CODEC.fieldOf("slow_noise").forGetter((p_191412_) -> {
    ...
    public BlockState getState(RandomSource p_225910_, BlockPos p_225911_) {
        double $$2 = this.getSlowNoiseValue(p_225911_);
        int $$3 = (int)Mth.clampedMap($$2, -1.0, 1.0, (double)(Integer)this.variety.minInclusive(), (double)((Integer)this.variety.maxInclusive() + 1));
        List<BlockState> $$4 = Lists.newArrayListWithCapacity($$3);

        for(int $$5 = 0; $$5 < $$3; ++$$5) {
            $$4.add(this.getRandomState(this.states, this.getSlowNoiseValue(p_225911_.offset($$5 * '픑', 0, $$5 * '薺'))));
        }

        return this.getRandomState($$4, p_225911_, (double)this.scale);
    }
