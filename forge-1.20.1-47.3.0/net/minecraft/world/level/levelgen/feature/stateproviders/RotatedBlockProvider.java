...
public class RotatedBlockProvider extends BlockStateProvider {
    ...
    public BlockState getState(RandomSource p_225922_, BlockPos p_225923_) {
        Direction.Axis $$2 = Axis.getRandom(p_225922_);
        return (BlockState)this.block.defaultBlockState().setValue(RotatedPillarBlock.AXIS, $$2);
    }

    static {
        CODEC = BlockState.CODEC.fieldOf("state").xmap(BlockBehaviour.BlockStateBase::getBlock, Block::defaultBlockState).xmap(RotatedBlockProvider::new, (p_68793_) -> {
