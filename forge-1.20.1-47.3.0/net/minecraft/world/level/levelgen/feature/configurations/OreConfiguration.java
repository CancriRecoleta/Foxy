...
public class OreConfiguration implements FeatureConfiguration {
    public static final Codec<OreConfiguration> CODEC = RecordCodecBuilder.create((p_67849_) -> {
        return p_67849_.group(Codec.list(net.minecraft.world.level.levelgen.feature.configurations.OreConfiguration.TargetBlockState.CODEC).fieldOf("targets").forGetter((p_161027_) -> {
    ...
    public OreConfiguration(RuleTest p_161008_, BlockState p_161009_, int p_161010_, float p_161011_) {
        this(ImmutableList.of(new TargetBlockState(p_161008_, p_161009_)), p_161010_, p_161011_);
    }

    public OreConfiguration(RuleTest p_67843_, BlockState p_67844_, int p_67845_) {
        this(ImmutableList.of(new TargetBlockState(p_67843_, p_67844_)), p_67845_, 0.0F);
    }
