...
public class GeodeConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<GeodeConfiguration> CODEC = RecordCodecBuilder.create((p_160842_) -> {
        ...
        }), CHANCE_RANGE.fieldOf("use_potential_placements_chance").orElse(0.35).forGetter((p_160862_) -> {
            return p_160862_.usePotentialPlacementsChance;
        }), CHANCE_RANGE.fieldOf("use_alternate_layer0_chance").orElse(0.0).forGetter((p_160860_) -> {
        ...
        }), CHANCE_RANGE.fieldOf("noise_multiplier").orElse(0.05).forGetter((p_160846_) -> {
