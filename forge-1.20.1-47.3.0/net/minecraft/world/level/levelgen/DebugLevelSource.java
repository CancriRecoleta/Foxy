...
public class DebugLevelSource extends ChunkGenerator {
        ...
        if (p_64149_ > 0 && p_64150_ > 0 && p_64149_ % 2 != 0 && p_64150_ % 2 != 0) {
            ...
            if (p_64149_ <= GRID_WIDTH && p_64150_ <= GRID_HEIGHT) {
                ...
                if (i < ALL_BLOCKS.size()) {
                    blockstate = (BlockState)ALL_BLOCKS.get(i);
                }
            }
        }
    ...
    public static void initValidStates() {
        ALL_BLOCKS = (List)StreamSupport.stream(BuiltInRegistries.BLOCK.spliterator(), false).flatMap((block) -> {
    ...
    static {
        ALL_BLOCKS = (List)StreamSupport.stream(BuiltInRegistries.BLOCK.spliterator(), false).flatMap((p_208208_) -> {
