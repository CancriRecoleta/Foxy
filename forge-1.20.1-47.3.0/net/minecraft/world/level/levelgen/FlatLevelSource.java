...
public class FlatLevelSource extends ChunkGenerator {
    ...
    public FlatLevelSource(FlatLevelGeneratorSettings p_256337_) {
        FixedBiomeSource var10001 = new FixedBiomeSource(p_256337_.getBiome());
        Objects.requireNonNull(p_256337_);
        super(var10001, Util.memoize(p_256337_::adjustGenerationSettings));
    ...
    public ChunkGeneratorStructureState createState(HolderLookup<StructureSet> p_256602_, RandomState p_255830_, long p_256355_) {
        Stream<Holder<StructureSet>> $$3 = (Stream)this.settings.structureOverrides().map(HolderSet::stream).orElseGet(() -> {
            return p_256602_.listElements().map((p_255579_) -> {
                return p_255579_;
            });
        });
        return ChunkGeneratorStructureState.createForFlat(p_255830_, p_256355_, this.biomeSource, $$3);
    }
    ...
    public CompletableFuture<ChunkAccess> fillFromNoise(Executor p_224183_, Blender p_224184_, RandomState p_224185_, StructureManager p_224186_, ChunkAccess p_224187_) {
        ...
        Heightmap $$7 = p_224187_.getOrCreateHeightmapUnprimed(Types.OCEAN_FLOOR_WG);
        Heightmap $$8 = p_224187_.getOrCreateHeightmapUnprimed(Types.WORLD_SURFACE_WG);

        for(int $$9 = 0; $$9 < Math.min(p_224187_.getHeight(), $$5.size()); ++$$9) {
            BlockState $$10 = (BlockState)$$5.get($$9);
            if ($$10 != null) {
                int $$11 = p_224187_.getMinBuildHeight() + $$9;

                for(int $$12 = 0; $$12 < 16; ++$$12) {
                    for(int $$13 = 0; $$13 < 16; ++$$13) {
                        p_224187_.setBlockState($$6.set($$12, $$11, $$13), $$10, false);
    ...
    public int getBaseHeight(int p_224160_, int p_224161_, Heightmap.Types p_224162_, LevelHeightAccessor p_224163_, RandomState p_224164_) {
        ...
        for(int $$6 = Math.min($$5.size(), p_224163_.getMaxBuildHeight()) - 1; $$6 >= 0; --$$6) {
            BlockState $$7 = (BlockState)$$5.get($$6);
            if ($$7 != null && p_224162_.isOpaque().test($$7)) {
                return p_224163_.getMinBuildHeight() + $$6 + 1;
            }
        }
    ...
    public NoiseColumn getBaseColumn(int p_224155_, int p_224156_, LevelHeightAccessor p_224157_, RandomState p_224158_) {
        return new NoiseColumn(p_224157_.getMinBuildHeight(), (BlockState[])this.settings.getLayers().stream().limit((long)p_224157_.getHeight()).map((p_204549_) -> {
