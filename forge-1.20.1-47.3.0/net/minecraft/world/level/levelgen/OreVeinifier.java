...
public final class OreVeinifier {
    ...
    protected static NoiseChunk.BlockStateFiller create(DensityFunction p_209668_, DensityFunction p_209669_, DensityFunction p_209670_, PositionalRandomFactory p_209671_) {
        BlockState $$4 = null;
        return (p_209666_) -> {
            double $$6 = p_209668_.compute(p_209666_);
            int $$7 = p_209666_.blockY();
            VeinType $$8 = $$6 > 0.0 ? net.minecraft.world.level.levelgen.OreVeinifier.VeinType.COPPER : net.minecraft.world.level.levelgen.OreVeinifier.VeinType.IRON;
            double $$9 = Math.abs($$6);
            int $$10 = $$8.maxY - $$7;
            int $$11 = $$7 - $$8.minY;
            if ($$11 >= 0 && $$10 >= 0) {
                ...
                if ($$9 + $$13 < 0.4000000059604645) {
                    return $$4;
                } else {
                    RandomSource $$14 = p_209671_.at(p_209666_.blockX(), $$7, p_209666_.blockZ());
                    if ($$14.nextFloat() > 0.7F) {
                        return $$4;
                    } else if (p_209669_.compute(p_209666_) >= 0.0) {
                        return $$4;
                    } else {
                        double $$15 = Mth.clampedMap($$9, 0.4000000059604645, 0.6000000238418579, 0.10000000149011612, 0.30000001192092896);
                        if ((double)$$14.nextFloat() < $$15 && p_209670_.compute(p_209666_) > -0.30000001192092896) {
