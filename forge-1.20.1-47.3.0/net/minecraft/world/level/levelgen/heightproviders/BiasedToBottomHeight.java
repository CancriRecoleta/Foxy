...
public class BiasedToBottomHeight extends HeightProvider {
    ...
    public int sample(RandomSource p_226297_, WorldGenerationContext p_226298_) {
        int $$2 = this.minInclusive.resolveY(p_226298_);
        int $$3 = this.maxInclusive.resolveY(p_226298_);
        if ($$3 - $$2 - this.inner + 1 <= 0) {
            LOGGER.warn("Empty height range: {}", this);
            return $$2;
        } else {
            int $$4 = p_226297_.nextInt($$3 - $$2 - this.inner + 1);
            return p_226297_.nextInt($$4 + this.inner) + $$2;
        }
    }
