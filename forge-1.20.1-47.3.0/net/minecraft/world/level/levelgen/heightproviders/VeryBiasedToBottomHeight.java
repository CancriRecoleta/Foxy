...
public class VeryBiasedToBottomHeight extends HeightProvider {
    ...
    public int sample(RandomSource p_226311_, WorldGenerationContext p_226312_) {
        int $$2 = this.minInclusive.resolveY(p_226312_);
        int $$3 = this.maxInclusive.resolveY(p_226312_);
        if ($$3 - $$2 - this.inner + 1 <= 0) {
            LOGGER.warn("Empty height range: {}", this);
            return $$2;
        } else {
            int $$4 = Mth.nextInt(p_226311_, $$2 + this.inner, $$3);
            int $$5 = Mth.nextInt(p_226311_, $$2, $$4 - 1);
            return Mth.nextInt(p_226311_, $$2, $$5 - 1 + this.inner);
        }
    }
