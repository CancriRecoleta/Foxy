...
public class BlendedNoise implements DensityFunction.SimpleFunction {
    ...
    private static final MapCodec<BlendedNoise> DATA_CODEC = RecordCodecBuilder.mapCodec((p_230486_) -> {
        ...
        }), Codec.doubleRange(1.0, 8.0).fieldOf("smear_scale_multiplier").forGetter((p_230488_) -> {
    ...
    public double compute(DensityFunction.FunctionContext p_210621_) {
        double $$1 = (double)p_210621_.blockX() * this.xzMultiplier;
        double $$2 = (double)p_210621_.blockY() * this.yMultiplier;
        double $$3 = (double)p_210621_.blockZ() * this.xzMultiplier;
        ...
        for(int $$19 = 0; $$19 < 16; ++$$19) {
            ...
            ImprovedNoise $$25;
            if (!$$17) {
                $$25 = this.minLimitNoise.getOctaveNoise($$19);
                if ($$25 != null) {
                    $$9 += $$25.noise($$20, $$21, $$22, $$23, $$2 * $$13) / $$13;
                }
            }

            if (!$$18) {
                $$25 = this.maxLimitNoise.getOctaveNoise($$19);
                if ($$25 != null) {
