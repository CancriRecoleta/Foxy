...
public class GeodeCrackSettings {
    public static final Codec<GeodeCrackSettings> CODEC = RecordCodecBuilder.create((p_158334_) -> {
        return p_158334_.group(GeodeConfiguration.CHANCE_RANGE.fieldOf("generate_crack_chance").orElse(1.0).forGetter((p_158340_) -> {
            return p_158340_.generateCrackChance;
        }), Codec.doubleRange(0.0, 5.0).fieldOf("base_crack_size").orElse(2.0).forGetter((p_158338_) -> {
