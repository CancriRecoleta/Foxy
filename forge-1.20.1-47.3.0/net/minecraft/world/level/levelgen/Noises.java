...
public class Noises {
    ...
    public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> p_256362_, PositionalRandomFactory p_256306_, ResourceKey<NormalNoise.NoiseParameters> p_256639_) {
        Holder<NormalNoise.NoiseParameters> $$3 = p_256362_.getOrThrow(p_256639_);
        return NormalNoise.create(p_256306_.fromHashOf(((ResourceKey)$$3.unwrapKey().orElseThrow()).location()), (NormalNoise.NoiseParameters)$$3.value());
    }
}
