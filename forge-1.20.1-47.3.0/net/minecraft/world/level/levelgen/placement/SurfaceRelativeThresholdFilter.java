...
public class SurfaceRelativeThresholdFilter extends PlacementFilter {
    public static final Codec<SurfaceRelativeThresholdFilter> CODEC = RecordCodecBuilder.create((p_191929_) -> {
        return p_191929_.group(Types.CODEC.fieldOf("heightmap").forGetter((p_191944_) -> {
            return p_191944_.heightmap;
        }), Codec.INT.optionalFieldOf("min_inclusive", Integer.MIN_VALUE).forGetter((p_191942_) -> {
            return p_191942_.minInclusive;
        }), Codec.INT.optionalFieldOf("max_inclusive", Integer.MAX_VALUE).forGetter((p_191939_) -> {
    ...
    protected boolean shouldPlace(PlacementContext p_226407_, RandomSource p_226408_, BlockPos p_226409_) {
        long $$3 = (long)p_226407_.getHeight(this.heightmap, p_226409_.getX(), p_226409_.getZ());
        long $$4 = $$3 + (long)this.minInclusive;
        long $$5 = $$3 + (long)this.maxInclusive;
        return $$4 <= (long)p_226409_.getY() && (long)p_226409_.getY() <= $$5;
    }
