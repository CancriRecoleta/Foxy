...
public class BiomeFilter extends PlacementFilter {
    ...
    protected boolean shouldPlace(PlacementContext p_226317_, RandomSource p_226318_, BlockPos p_226319_) {
        PlacedFeature $$3 = (PlacedFeature)p_226317_.topFeature().orElseThrow(() -> {
        ...
        Holder<Biome> $$4 = p_226317_.getLevel().getBiome(p_226319_);
        return p_226317_.generator().getBiomeGenerationSettings($$4).hasFeature($$3);
    }
