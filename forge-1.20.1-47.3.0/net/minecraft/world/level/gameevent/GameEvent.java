...
public class GameEvent {
    ...
    private static GameEvent register(String p_157825_, int p_157826_) {
        return (GameEvent)Registry.register(BuiltInRegistries.GAME_EVENT, (String)p_157825_, new GameEvent(p_157825_, p_157826_));
    }
    ...
    public static final class ListenerInfo implements Comparable<ListenerInfo> {
        ...
        public ListenerInfo(GameEvent p_251490_, Vec3 p_249118_, Context p_251196_, GameEventListener p_251701_, Vec3 p_248854_) {
        ...
        public int compareTo(ListenerInfo p_249631_) {
    ...
    public static record Context(@Nullable Entity sourceEntity, @Nullable BlockState affectedState) {
        ...
        public static Context of(@Nullable Entity p_223718_) {
            return new Context(p_223718_, (BlockState)null);
        }

        public static Context of(@Nullable BlockState p_223723_) {
            return new Context((Entity)null, p_223723_);
        }

        public static Context of(@Nullable Entity p_223720_, @Nullable BlockState p_223721_) {
