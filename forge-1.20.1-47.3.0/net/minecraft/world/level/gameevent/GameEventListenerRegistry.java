...
public interface GameEventListenerRegistry {
    GameEventListenerRegistry NOOP = new GameEventListenerRegistry() {
        ...
        public boolean visitInRangeListeners(GameEvent p_251260_, Vec3 p_249086_, GameEvent.Context p_249012_, ListenerVisitor p_252106_) {
            return false;
        }
    };
    ...
    boolean visitInRangeListeners(GameEvent var1, Vec3 var2, GameEvent.Context var3, ListenerVisitor var4);
