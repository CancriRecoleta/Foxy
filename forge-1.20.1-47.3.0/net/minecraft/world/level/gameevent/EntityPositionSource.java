...
public class EntityPositionSource implements PositionSource {
    ...
    public Optional<Vec3> getPosition(Level p_157733_) {
        ...
        return this.entityOrUuidOrId.left().map((p_223676_) -> {
            return p_223676_.position().add(0.0, (double)this.yOffset, 0.0);
        });
    }

    private void resolveEntity(Level p_223678_) {
        ((Optional)this.entityOrUuidOrId.map(Optional::of, (p_223657_) -> {
            Function var10001 = (p_223660_) -> {
                Entity var10000;
                if (p_223678_ instanceof ServerLevel $$2) {
                    var10000 = $$2.getEntity(p_223660_);
                } else {
                    var10000 = null;
                }
            ...
            Objects.requireNonNull(p_223678_);
            return Optional.ofNullable((Entity)p_223657_.map(var10001, p_223678_::getEntity));
        })).ifPresent((p_223654_) -> {
    ...
    private UUID getUuid() {
        return (UUID)this.entityOrUuidOrId.map(Entity::getUUID, (p_223680_) -> {
            return (UUID)p_223680_.map(Function.identity(), (p_223668_) -> {
    ...
    int getId() {
        return (Integer)this.entityOrUuidOrId.map(Entity::getId, (p_223662_) -> {
            return (Integer)p_223662_.map((p_223670_) -> {
