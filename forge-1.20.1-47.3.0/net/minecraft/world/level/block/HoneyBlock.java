...
public class HoneyBlock extends HalfTransparentBlock {
    ...
    private boolean isSlidingDown(BlockPos p_54008_, Entity p_54009_) {
        if (p_54009_.onGround()) {
            ...
            double $$2 = Math.abs((double)p_54008_.getX() + 0.5 - p_54009_.getX());
            double $$3 = Math.abs((double)p_54008_.getZ() + 0.5 - p_54009_.getZ());
            double $$4 = 0.4375 + (double)(p_54009_.getBbWidth() / 2.0F);
    ...
    private void doSlideMovement(Entity p_54020_) {
        Vec3 $$1 = p_54020_.getDeltaMovement();
        if ($$1.y < -0.13) {
            double $$2 = -0.05 / $$1.y;
            p_54020_.setDeltaMovement(new Vec3($$1.x * $$2, -0.05, $$1.z * $$2));
        } else {
            p_54020_.setDeltaMovement(new Vec3($$1.x, -0.05, $$1.z));
        }
    ...
    private static void showParticles(Entity p_53989_, int p_53990_) {
        if (p_53989_.level().isClientSide) {
            ...
            for(int $$3 = 0; $$3 < p_53990_; ++$$3) {
                p_53989_.level().addParticle(new BlockParticleOption(ParticleTypes.BLOCK, $$2), p_53989_.getX(), p_53989_.getY(), p_53989_.getZ(), 0.0, 0.0, 0.0);
            }
