...
public class FlowerBlock extends BushBlock implements SuspiciousEffectHolder {
    ...
    public FlowerBlock(MobEffect p_53512_, int p_53513_, BlockBehaviour.Properties p_53514_) {
        ...
        this.suspiciousStewEffectSupplier = ForgeRegistries.MOB_EFFECTS.getDelegateOrThrow((Object)p_53512_);
    }
    ...
    public MobEffect getSuspiciousEffect() {
        return (MobEffect)this.suspiciousStewEffectSupplier.get();
    }

    public int getEffectDuration() {
        return this.suspiciousStewEffect == null && !((MobEffect)this.suspiciousStewEffectSupplier.get()).isInstantenous() ? this.effectDuration * 20 : this.effectDuration;
    }
}
