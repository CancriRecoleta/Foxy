...
public enum Mirror implements StringRepresentable {
    ...
    public int mirror(int p_54844_, int p_54845_) {
        ...
        switch (this) {
            case FRONT_BACK -> return (p_54845_ - $$3) % p_54845_;
            case LEFT_RIGHT -> return ($$2 - $$3 + p_54845_) % p_54845_;
            default -> return p_54844_;
        }
    }
    ...
    public Direction mirror(Direction p_54849_) {
        if (this == FRONT_BACK && p_54849_.getAxis() == Axis.X) {
            return p_54849_.getOpposite();
        } else {
            return this == LEFT_RIGHT && p_54849_.getAxis() == Axis.Z ? p_54849_.getOpposite() : p_54849_;
        }
    }
