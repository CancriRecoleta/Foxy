...
public class PistonStructureResolver {
    ...
    public PistonStructureResolver(Level p_60418_, BlockPos p_60419_, Direction p_60420_, boolean p_60421_) {
        ...
        if (p_60421_) {
            ...
            this.startPos = p_60419_.relative((Direction)p_60420_, 2);
        }
    ...
    private boolean addBlockLine(BlockPos p_60434_, Direction p_60435_) {
        ...
        if (this.level.isEmptyBlock(p_60434_)) {
            return true;
            ...
            if (i + this.toPush.size() > 12) {
                ...
                int j1;
                for(j1 = i - 1; j1 >= 0; --j1) {
                    this.toPush.add(p_60434_.relative(this.pushDirection.getOpposite(), j1));
                    ++l;
                }
                ...
                while(true) {
                    ...
                    if (j > -1) {
                        ...
                        for(int k = 0; k <= j + l; ++k) {
                            BlockPos blockpos2 = (BlockPos)this.toPush.get(k);
