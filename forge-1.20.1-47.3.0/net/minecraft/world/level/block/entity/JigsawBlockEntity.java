...
public class JigsawBlockEntity extends BlockEntity {
    ...
    public JigsawBlockEntity(BlockPos p_155605_, BlockState p_155606_) {
        ...
        this.joint = net.minecraft.world.level.block.entity.JigsawBlockEntity.JointType.ROLLABLE;
    ...
    public void load(CompoundTag p_155608_) {
        ...
        this.joint = (JointType)net.minecraft.world.level.block.entity.JigsawBlockEntity.JointType.byName(p_155608_.getString("joint")).orElseGet(() -> {
            return JigsawBlock.getFrontFacing(this.getBlockState()).getAxis().isHorizontal() ? net.minecraft.world.level.block.entity.JigsawBlockEntity.JointType.ALIGNED : net.minecraft.world.level.block.entity.JigsawBlockEntity.JointType.ROLLABLE;
        });
    }
