...
public class SignBlockEntity extends BlockEntity {
    ...
    public boolean isFacingFrontText(Player p_277382_) {
        ...
        if ($$2 instanceof SignBlock signblock) {
            ...
            float f1 = (float)(Mth.atan2(d1, d0) * 57.2957763671875) - 90.0F;
    ...
    protected void saveAdditional(CompoundTag p_187515_) {
        ...
        var10000.resultOrPartial(var10001::error).ifPresent((p_277417_) -> {
            p_187515_.put("front_text", p_277417_);
        });
        var10000 = SignText.DIRECT_CODEC.encodeStart(NbtOps.INSTANCE, this.backText);
        var10001 = LOGGER;
        Objects.requireNonNull(var10001);
        var10000.resultOrPartial(var10001::error).ifPresent((p_277389_) -> {
    ...
    public void load(CompoundTag p_155716_) {
        ...
        if (p_155716_.contains("front_text")) {
            var10000 = SignText.DIRECT_CODEC.parse(NbtOps.INSTANCE, p_155716_.getCompound("front_text"));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var10000.resultOrPartial(var10001::error).ifPresent((p_278212_) -> {
                this.frontText = this.loadLines(p_278212_);
            });
        }

        if (p_155716_.contains("back_text")) {
            var10000 = SignText.DIRECT_CODEC.parse(NbtOps.INSTANCE, p_155716_.getCompound("back_text"));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var10000.resultOrPartial(var10001::error).ifPresent((p_278213_) -> {
    ...
    private Component loadLine(Component p_278307_) {
        ...
        if (level instanceof ServerLevel serverlevel) {
            try {
                return ComponentUtils.updateForEntity(createCommandSourceStack((Player)null, serverlevel, this.worldPosition), (Component)p_278307_, (Entity)null, 0);
    ...
    public boolean updateText(UnaryOperator<SignText> p_277877_, boolean p_277426_) {
        ...
        return this.setText((SignText)p_277877_.apply(signtext), p_277426_);
    }
    ...
    private SignText setMessages(Player p_277396_, List<FilteredText> p_277744_, SignText p_277359_) {
        for(int i = 0; i < p_277744_.size(); ++i) {
            FilteredText filteredtext = (FilteredText)p_277744_.get(i);
    ...
    public boolean executeClickCommandsIfPresent(Player p_279304_, Level p_279201_, BlockPos p_278282_, boolean p_278254_) {
        boolean flag = false;
        Component[] var6 = this.getText(p_278254_).getMessages(p_279304_.isTextFilteringEnabled());
