...
public abstract class BlockEntity extends CapabilityProvider<BlockEntity> implements IForgeBlockEntity {
    ...
    public void load(CompoundTag p_155245_) {
        if (p_155245_.contains("ForgeData")) {
            this.customPersistentData = p_155245_.getCompound("ForgeData");
        }

        if (this.getCapabilities() != null && p_155245_.contains("ForgeCaps")) {
            this.deserializeCaps(p_155245_.getCompound("ForgeCaps"));
        }
    ...
    protected void saveAdditional(CompoundTag p_187471_) {
        if (this.customPersistentData != null) {
            p_187471_.put("ForgeData", this.customPersistentData.copy());
        }

        if (this.getCapabilities() != null) {
            p_187471_.put("ForgeCaps", this.serializeCaps());
        }
    ...
    public static BlockEntity loadStatic(BlockPos p_155242_, BlockState p_155243_, CompoundTag p_155244_) {
        ...
        if (resourcelocation == null) {
            ...
            return (BlockEntity)BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(resourcelocation).map((p_155240_) -> {
                try {
