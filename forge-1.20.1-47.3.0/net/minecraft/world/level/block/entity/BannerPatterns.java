...
public class BannerPatterns {
    ...
    public static BannerPattern bootstrap(Registry<BannerPattern> p_222755_) {
        Registry.register(p_222755_, (ResourceKey)BASE, new BannerPattern("b"));
        Registry.register(p_222755_, (ResourceKey)SQUARE_BOTTOM_LEFT, new BannerPattern("bl"));
        Registry.register(p_222755_, (ResourceKey)SQUARE_BOTTOM_RIGHT, new BannerPattern("br"));
        Registry.register(p_222755_, (ResourceKey)SQUARE_TOP_LEFT, new BannerPattern("tl"));
        Registry.register(p_222755_, (ResourceKey)SQUARE_TOP_RIGHT, new BannerPattern("tr"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_BOTTOM, new BannerPattern("bs"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_TOP, new BannerPattern("ts"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_LEFT, new BannerPattern("ls"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_RIGHT, new BannerPattern("rs"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_CENTER, new BannerPattern("cs"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_MIDDLE, new BannerPattern("ms"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_DOWNRIGHT, new BannerPattern("drs"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_DOWNLEFT, new BannerPattern("dls"));
        Registry.register(p_222755_, (ResourceKey)STRIPE_SMALL, new BannerPattern("ss"));
        Registry.register(p_222755_, (ResourceKey)CROSS, new BannerPattern("cr"));
        Registry.register(p_222755_, (ResourceKey)STRAIGHT_CROSS, new BannerPattern("sc"));
        Registry.register(p_222755_, (ResourceKey)TRIANGLE_BOTTOM, new BannerPattern("bt"));
        Registry.register(p_222755_, (ResourceKey)TRIANGLE_TOP, new BannerPattern("tt"));
        Registry.register(p_222755_, (ResourceKey)TRIANGLES_BOTTOM, new BannerPattern("bts"));
        Registry.register(p_222755_, (ResourceKey)TRIANGLES_TOP, new BannerPattern("tts"));
        Registry.register(p_222755_, (ResourceKey)DIAGONAL_LEFT, new BannerPattern("ld"));
        Registry.register(p_222755_, (ResourceKey)DIAGONAL_RIGHT, new BannerPattern("rd"));
        Registry.register(p_222755_, (ResourceKey)DIAGONAL_LEFT_MIRROR, new BannerPattern("lud"));
        Registry.register(p_222755_, (ResourceKey)DIAGONAL_RIGHT_MIRROR, new BannerPattern("rud"));
        Registry.register(p_222755_, (ResourceKey)CIRCLE_MIDDLE, new BannerPattern("mc"));
        Registry.register(p_222755_, (ResourceKey)RHOMBUS_MIDDLE, new BannerPattern("mr"));
        Registry.register(p_222755_, (ResourceKey)HALF_VERTICAL, new BannerPattern("vh"));
        Registry.register(p_222755_, (ResourceKey)HALF_HORIZONTAL, new BannerPattern("hh"));
        Registry.register(p_222755_, (ResourceKey)HALF_VERTICAL_MIRROR, new BannerPattern("vhr"));
        Registry.register(p_222755_, (ResourceKey)HALF_HORIZONTAL_MIRROR, new BannerPattern("hhb"));
        Registry.register(p_222755_, (ResourceKey)BORDER, new BannerPattern("bo"));
        Registry.register(p_222755_, (ResourceKey)CURLY_BORDER, new BannerPattern("cbo"));
        Registry.register(p_222755_, (ResourceKey)GRADIENT, new BannerPattern("gra"));
        Registry.register(p_222755_, (ResourceKey)GRADIENT_UP, new BannerPattern("gru"));
        Registry.register(p_222755_, (ResourceKey)BRICKS, new BannerPattern("bri"));
        Registry.register(p_222755_, (ResourceKey)GLOBE, new BannerPattern("glb"));
        Registry.register(p_222755_, (ResourceKey)CREEPER, new BannerPattern("cre"));
        Registry.register(p_222755_, (ResourceKey)SKULL, new BannerPattern("sku"));
        Registry.register(p_222755_, (ResourceKey)FLOWER, new BannerPattern("flo"));
        Registry.register(p_222755_, (ResourceKey)MOJANG, new BannerPattern("moj"));
        return (BannerPattern)Registry.register(p_222755_, (ResourceKey)PIGLIN, new BannerPattern("pig"));
    }
}
