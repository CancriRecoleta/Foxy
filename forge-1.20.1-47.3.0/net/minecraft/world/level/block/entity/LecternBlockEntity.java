...
public class LecternBlockEntity extends BlockEntity implements Clearable, MenuProvider {
    ...
    private CommandSourceStack createCommandSourceStack(@Nullable Player p_59535_) {
        ...
        if (p_59535_ == null) {
            $$3 = "Lectern";
            $$4 = Component.literal("Lectern");
        } else {
            $$3 = p_59535_.getName().getString();
            $$4 = p_59535_.getDisplayName();
        }

        Vec3 $$5 = Vec3.atCenterOf(this.worldPosition);
        return new CommandSourceStack(CommandSource.NULL, $$5, Vec2.ZERO, (ServerLevel)this.level, 2, $$3, (Component)$$4, this.level.getServer(), p_59535_);
    }
