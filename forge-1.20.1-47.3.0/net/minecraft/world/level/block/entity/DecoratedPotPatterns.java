...
public class DecoratedPotPatterns {
    ...
    public static ResourceKey<String> getResourceKey(Item p_273094_) {
        return (ResourceKey)ITEM_TO_POT_TEXTURE.get(p_273094_);
    }

    public static String bootstrap(Registry<String> p_273479_) {
        Registry.register(p_273479_, (ResourceKey)BRICK, "decorated_pot_side");
        Registry.register(p_273479_, (ResourceKey)ANGLER, "angler_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)ARCHER, "archer_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)ARMS_UP, "arms_up_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)BLADE, "blade_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)BREWER, "brewer_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)BURN, "burn_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)DANGER, "danger_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)EXPLORER, "explorer_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)FRIEND, "friend_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)HEART, "heart_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)HEARTBREAK, "heartbreak_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)HOWL, "howl_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)MINER, "miner_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)MOURNER, "mourner_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)PLENTY, "plenty_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)PRIZE, "prize_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)SHEAF, "sheaf_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)SHELTER, "shelter_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)SKULL, "skull_pottery_pattern");
        Registry.register(p_273479_, (ResourceKey)SNORT, "snort_pottery_pattern");
        return (String)Registry.register(p_273479_, (ResourceKey)BASE, "decorated_pot_base");
    }
