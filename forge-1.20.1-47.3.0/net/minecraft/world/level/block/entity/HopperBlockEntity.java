...
public class HopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
    ...
    private static boolean tryMoveItems(Level p_155579_, BlockPos p_155580_, BlockState p_155581_, HopperBlockEntity p_155582_, BooleanSupplier p_155583_) {
        if (p_155579_.isClientSide) {
            ...
            if (!p_155582_.isOnCooldown() && (Boolean)p_155581_.getValue(HopperBlock.ENABLED)) {
                boolean flag = false;
    ...
    private static boolean ejectItems(Level p_155563_, BlockPos p_155564_, BlockState p_155565_, HopperBlockEntity p_155566_) {
        if (VanillaInventoryCodeHooks.insertHook(p_155566_)) {
            return true;
        } else {
            ...
            if (container == null) {
                ...
                Direction direction = ((Direction)p_155565_.getValue(HopperBlock.FACING)).getOpposite();
    ...
    public static boolean suckInItems(Level p_155553_, Hopper p_155554_) {
        ...
        if (ret != null) {
            ...
            if (container != null) {
                ...
                Iterator var4 = getItemsAtAndAbove(p_155553_, p_155554_).iterator();
                ...
                do {
                    ...
                    itementity = (ItemEntity)var4.next();
                } while(!addItem(p_155554_, itementity));
    ...
    private static Container getAttachedContainer(Level p_155593_, BlockPos p_155594_, BlockState p_155595_) {
        Direction direction = (Direction)p_155595_.getValue(HopperBlock.FACING);
    ...
    public static List<ItemEntity> getItemsAtAndAbove(Level p_155590_, Hopper p_155591_) {
        return (List)p_155591_.getSuckShape().toAabbs().stream().flatMap((p_155558_) -> {
            return p_155590_.getEntitiesOfClass(ItemEntity.class, p_155558_.move(p_155591_.getLevelX() - 0.5, p_155591_.getLevelY() - 0.5, p_155591_.getLevelZ() - 0.5), EntitySelector.ENTITY_STILL_ALIVE).stream();
    ...
    private static Container getContainerAt(Level p_59348_, double p_59349_, double p_59350_, double p_59351_) {
        ...
        if (container == null) {
            List<Entity> list = p_59348_.getEntities((Entity)null, new AABB(p_59349_ - 0.5, p_59350_ - 0.5, p_59351_ - 0.5, p_59349_ + 0.5, p_59350_ + 0.5, p_59351_ + 0.5), EntitySelector.CONTAINER_ENTITY_SELECTOR);
            if (!list.isEmpty()) {
