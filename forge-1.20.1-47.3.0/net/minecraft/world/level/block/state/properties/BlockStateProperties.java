...
public class BlockStateProperties {
    ...
    static {
        HORIZONTAL_AXIS = EnumProperty.create("axis", Direction.Axis.class, (Enum[])(Axis.X, Axis.Z));
        ...
        FACING_HOPPER = DirectionProperty.create("facing", (p_61456_) -> {
            return p_61456_ != Direction.UP;
        });
        HORIZONTAL_FACING = DirectionProperty.create("facing", (Predicate)Plane.HORIZONTAL);
        ...
        RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, (p_61454_) -> {
