...
public class WaterlilyBlock extends BushBlock {
    ...
    protected boolean mayPlaceOn(BlockState p_58174_, BlockGetter p_58175_, BlockPos p_58176_) {
        FluidState $$3 = p_58175_.getFluidState(p_58176_);
        FluidState $$4 = p_58175_.getFluidState(p_58176_.above());
        return ($$3.getType() == Fluids.WATER || p_58174_.getBlock() instanceof IceBlock) && $$4.getType() == Fluids.EMPTY;
    }
}
