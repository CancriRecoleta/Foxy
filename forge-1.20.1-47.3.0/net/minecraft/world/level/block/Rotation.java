...
public enum Rotation implements StringRepresentable {
    ...
    public Direction rotate(Direction p_55955_) {
        if (p_55955_.getAxis() == Axis.Y) {
            ...
            switch (this) {
                case CLOCKWISE_90 -> return p_55955_.getClockWise();
                case CLOCKWISE_180 -> return p_55955_.getOpposite();
                case COUNTERCLOCKWISE_90 -> return p_55955_.getCounterClockWise();
                default -> return p_55955_;
            }
        }
    }
    ...
    public int rotate(int p_55950_, int p_55951_) {
        switch (this) {
            case CLOCKWISE_90 -> return (p_55950_ + p_55951_ / 4) % p_55951_;
            case CLOCKWISE_180 -> return (p_55950_ + p_55951_ / 2) % p_55951_;
            case COUNTERCLOCKWISE_90 -> return (p_55950_ + p_55951_ * 3 / 4) % p_55951_;
            default -> return p_55950_;
        }
    }

    public static Rotation getRandom(RandomSource p_221991_) {
        return (Rotation)Util.getRandom((Object[])values(), p_221991_);
    }

    public static List<Rotation> getShuffled(RandomSource p_221993_) {
        return Util.shuffledCopy((Object[])values(), p_221993_);
    }
