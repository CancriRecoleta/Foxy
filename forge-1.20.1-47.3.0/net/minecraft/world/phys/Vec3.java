...
public class Vec3 implements Position {
    ...
    public static Vec3 fromRGB24(int p_82502_) {
        double $$1 = (double)(p_82502_ >> 16 & 255) / 255.0;
        double $$2 = (double)(p_82502_ >> 8 & 255) / 255.0;
        double $$3 = (double)(p_82502_ & 255) / 255.0;
    ...
    public double distanceTo(Vec3 p_82555_) {
        double $$1 = p_82555_.x - this.x;
        double $$2 = p_82555_.y - this.y;
        double $$3 = p_82555_.z - this.z;
        return Math.sqrt($$1 * $$1 + $$2 * $$2 + $$3 * $$3);
    }

    public double distanceToSqr(Vec3 p_82558_) {
        double $$1 = p_82558_.x - this.x;
        double $$2 = p_82558_.y - this.y;
        double $$3 = p_82558_.z - this.z;
        return $$1 * $$1 + $$2 * $$2 + $$3 * $$3;
    }

    public double distanceToSqr(double p_82532_, double p_82533_, double p_82534_) {
        double $$3 = p_82532_ - this.x;
        double $$4 = p_82533_ - this.y;
        double $$5 = p_82534_ - this.z;
        return $$3 * $$3 + $$4 * $$4 + $$5 * $$5;
    }
    ...
    public Vec3 xRot(float p_82497_) {
        float $$1 = Mth.cos(p_82497_);
        float $$2 = Mth.sin(p_82497_);
        double $$3 = this.x;
    ...
    public Vec3 yRot(float p_82525_) {
        float $$1 = Mth.cos(p_82525_);
        float $$2 = Mth.sin(p_82525_);
    ...
    public Vec3 zRot(float p_82536_) {
        float $$1 = Mth.cos(p_82536_);
        float $$2 = Mth.sin(p_82536_);
    ...
    public static Vec3 directionFromRotation(float p_82499_, float p_82500_) {
        float $$2 = Mth.cos(-p_82500_ * 0.017453292F - 3.1415927F);
        float $$3 = Mth.sin(-p_82500_ * 0.017453292F - 3.1415927F);
        float $$4 = -Mth.cos(-p_82499_ * 0.017453292F);
        float $$5 = Mth.sin(-p_82499_ * 0.017453292F);
        return new Vec3((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
    }

    public Vec3 align(EnumSet<Direction.Axis> p_82518_) {
        double $$1 = p_82518_.contains(Axis.X) ? (double)Mth.floor(this.x) : this.x;
        double $$2 = p_82518_.contains(Axis.Y) ? (double)Mth.floor(this.y) : this.y;
        double $$3 = p_82518_.contains(Axis.Z) ? (double)Mth.floor(this.z) : this.z;
        return new Vec3($$1, $$2, $$3);
    }
    ...
    public Vec3 with(Direction.Axis p_193104_, double p_193105_) {
        double $$2 = p_193104_ == Axis.X ? p_193105_ : this.x;
        double $$3 = p_193104_ == Axis.Y ? p_193105_ : this.y;
        double $$4 = p_193104_ == Axis.Z ? p_193105_ : this.z;
        return new Vec3($$2, $$3, $$4);
    }

    public Vec3 relative(Direction p_231076_, double p_231077_) {
        Vec3i $$2 = p_231076_.getNormal();
        return new Vec3(this.x + p_231077_ * (double)$$2.getX(), this.y + p_231077_ * (double)$$2.getY(), this.z + p_231077_ * (double)$$2.getZ());
    }
    ...
    static {
        CODEC = Codec.DOUBLE.listOf().comapFlatMap((p_231079_) -> {
            return Util.fixedSize((List)p_231079_, 3).map((p_231081_) -> {
                return new Vec3((Double)p_231081_.get(0), (Double)p_231081_.get(1), (Double)p_231081_.get(2));
            });
        }, (p_231083_) -> {
