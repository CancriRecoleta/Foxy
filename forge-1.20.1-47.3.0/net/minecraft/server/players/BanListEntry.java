...
public abstract class BanListEntry<T> extends StoredUserEntry<T> {
    ...
    protected BanListEntry(T p_10950_, JsonObject p_10951_) {
        ...
        Date $$4;
        try {
            $$4 = p_10951_.has("created") ? DATE_FORMAT.parse(p_10951_.get("created").getAsString()) : new Date();
        ...
        Date $$7;
        try {
            $$7 = p_10951_.has("expires") ? DATE_FORMAT.parse(p_10951_.get("expires").getAsString()) : null;
