...
public class PlayerAdvancements {
    ...
    public void stopListening() {
        ...
        while(var1.hasNext()) {
            CriterionTrigger<?> criteriontrigger = (CriterionTrigger)var1.next();
    ...
    private void registerListeners(ServerAdvancementManager p_135995_) {
        Iterator var2 = p_135995_.getAllAdvancements().iterator();
    ...
    private void checkForAutomaticTriggers(ServerAdvancementManager p_136003_) {
        Iterator var2 = p_136003_.getAllAdvancements().iterator();
            ...
            try {
                ...
                try {
                    ...
                    map.entrySet().stream().sorted(Entry.comparingByValue()).forEach((p_265663_) -> {
                        Advancement advancement = p_136007_.getAdvancement((ResourceLocation)p_265663_.getKey());
                        if (advancement == null) {
                            LOGGER.warn("Ignored advancement '{}' in progress file {} - it doesn't exist anymore?", p_265663_.getKey(), this.playerSavePath);
                        } else {
                            this.startProgress(advancement, (AdvancementProgress)p_265663_.getValue());
    ...
    public boolean award(Advancement p_135989_, String p_135990_) {
        if (this.player instanceof FakePlayer) {
            ...
            if (advancementprogress.grantProgress(p_135990_)) {
                ...
                flag = true;
                ForgeEventFactory.onAdvancementProgressedEvent(this.player, p_135989_, advancementprogress, p_135990_, ProgressType.GRANT);
                if (!flag1 && advancementprogress.isDone()) {
                    ...
                    ForgeEventFactory.onAdvancementEarnedEvent(this.player, p_135989_);
                }
            }
    ...
    public boolean revoke(Advancement p_135999_, String p_136000_) {
        ...
        if (advancementprogress.revokeProgress(p_136000_)) {
            ...
            flag = true;
            ForgeEventFactory.onAdvancementProgressedEvent(this.player, p_135999_, advancementprogress, p_136000_, ProgressType.REVOKE);
        }
    ...
    private void registerListeners(Advancement p_136005_) {
        ...
        if (!advancementprogress.isDone()) {
            Iterator var3 = p_136005_.getCriteria().entrySet().iterator();
                ...
                if (criterionprogress != null && !criterionprogress.isDone()) {
                    ...
                    if (criteriontriggerinstance != null) {
                        ...
                        if (criteriontrigger != null) {
                            criteriontrigger.addPlayerListener(this, new CriterionTrigger.Listener(criteriontriggerinstance, p_136005_, (String)entry.getKey()));
                        }
                    }
                }
            }
    ...
    private void unregisterListeners(Advancement p_136009_) {
        ...
        Iterator var3 = p_136009_.getCriteria().entrySet().iterator();
        ...
        while(true) {
            ...
            if (criteriontriggerinstance != null) {
                CriterionTrigger<CriterionTriggerInstance> criteriontrigger = CriteriaTriggers.getCriterion(criteriontriggerinstance.getCriterion());
                if (criteriontrigger != null) {
                    criteriontrigger.removePlayerListener(this, new CriterionTrigger.Listener(criteriontriggerinstance, p_136009_, (String)entry.getKey()));
                }
            }
        }
    }
    ...
    public void flushDirty(ServerPlayer p_135993_) {
        if (this.isFirstPacket || !this.rootsToUpdate.isEmpty() || !this.progressChanged.isEmpty()) {
            ...
            while(var5.hasNext()) {
                ...
                this.updateTreeVisibility(advancement1, set, set1);
            }
            ...
            while(var5.hasNext()) {
                ...
                if (this.visible.contains(advancement1)) {
                    map.put(advancement1.getId(), (AdvancementProgress)this.progress.get(advancement1));
                }
            }
    ...
    public AdvancementProgress getOrStartProgress(Advancement p_135997_) {
        AdvancementProgress advancementprogress = (AdvancementProgress)this.progress.get(p_135997_);
