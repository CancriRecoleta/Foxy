    ...
    public void run() {
        while(this.server.isRunning()) {
            ...
            if (k > this.maxTickTime) {
                ...
                Error error = new Error(String.format(Locale.ENGLISH, "ServerHangWatchdog detected that a single server tick took %.2f seconds (should be max 0.05)", (float)k / 1000.0F));
                ...
                crashreportcategory.setDetail("Threads", (Object)stringbuilder);
                ...
                crashreportcategory1.setDetail("Level stats", () -> {
                    return (String)Streams.stream(this.server.getAllLevels()).map((p_288758_) -> {
                        ResourceKey var10000 = p_288758_.dimension();
                        return "" + var10000 + ": " + p_288758_.getWatchdogStats();
