...
public abstract class DistanceManager {
    ...
    protected DistanceManager(Executor p_140774_, Executor p_140775_) {
        Objects.requireNonNull(p_140775_);
    ...
    void addTicket(long p_140785_, Ticket<?> p_140786_) {
        ...
        if (p_140786_.isForceTicks()) {
            SortedArraySet<Ticket<?>> tickets = (SortedArraySet)this.forcedTickets.computeIfAbsent(p_140785_, (e) -> {
    ...
    void removeTicket(long p_140819_, Ticket<?> p_140820_) {
        ...
        if (p_140820_.isForceTicks()) {
            SortedArraySet<Ticket<?>> tickets = (SortedArraySet)this.forcedTickets.get(p_140819_);
            if (tickets != null) {
    ...
    private SortedArraySet<Ticket<?>> getTickets(long p_140858_) {
        return (SortedArraySet)this.tickets.computeIfAbsent(p_140858_, (p_183923_) -> {
            return SortedArraySet.create(4);
        });
    }
    ...
    public void addPlayer(SectionPos p_140803_, ServerPlayer p_140804_) {
        ...
        ((ObjectSet)this.playersPerChunk.computeIfAbsent(i, (p_183921_) -> {
    ...
    protected String getTicketDebugString(long p_140839_) {
        SortedArraySet<Ticket<?>> sortedarrayset = (SortedArraySet)this.tickets.get(p_140839_);
    ...
    public boolean shouldForceTicks(long chunkPos) {
        SortedArraySet<Ticket<?>> tickets = (SortedArraySet)this.forcedTickets.get(chunkPos);
    ...
    private void dumpTickets(String p_143208_) {
        try {
            ...
            try {
                ...
                while(var3.hasNext()) {
                    Long2ObjectMap.Entry<SortedArraySet<Ticket<?>>> entry = (Long2ObjectMap.Entry)var3.next();
                    ...
                    while(var6.hasNext()) {
                        ...
                        fileoutputstream.write(("" + var10001 + "\t" + chunkpos.z + "\t" + ticket.getType() + "\t" + ticket.getTicketLevel() + "\t\n").getBytes(StandardCharsets.UTF_8));
                    }
                }
    ...
    class ChunkTicketTracker extends ChunkTracker {
        ...
        protected int getLevelFromSource(long p_140883_) {
            SortedArraySet<Ticket<?>> sortedarrayset = (SortedArraySet)DistanceManager.this.tickets.get(p_140883_);
    ...
    class FixedPlayerDistanceChunkTracker extends ChunkTracker {
        ...
        private boolean havePlayer(long p_140903_) {
            ObjectSet<ServerPlayer> objectset = (ObjectSet)DistanceManager.this.playersPerChunk.get(p_140903_);
