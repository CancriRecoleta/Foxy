...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
    ...
    public ChunkMap(ServerLevel p_214836_, LevelStorageSource.LevelStorageAccess p_214837_, DataFixer p_214838_, StructureTemplateManager p_214839_, Executor p_214840_, BlockableEventLoop<Runnable> p_214841_, LightChunkGetter p_214842_, ChunkGenerator p_214843_, ChunkProgressListener p_214844_, ChunkStatusUpdateListener p_214845_, Supplier<DimensionDataStorage> p_214846_, int p_214847_, boolean p_214848_) {
        ...
        if (p_214843_ instanceof NoiseBasedChunkGenerator noisebasedchunkgenerator) {
            this.randomState = RandomState.create((NoiseGeneratorSettings)((NoiseGeneratorSettings)noisebasedchunkgenerator.generatorSettings().value()), (HolderGetter)registryaccess.lookupOrThrow(Registries.NOISE), i);
        } else {
            this.randomState = RandomState.create((NoiseGeneratorSettings)NoiseGeneratorSettings.dummy(), (HolderGetter)registryaccess.lookupOrThrow(Registries.NOISE), i);
        }
        ...
        Objects.requireNonNull(p_214841_);
    ...
    private CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> getChunkRangeFuture(ChunkHolder p_281446_, int p_282030_, IntFunction<ChunkStatus> p_282923_) {
        if (p_282030_ == 0) {
            ChunkStatus chunkstatus1 = (ChunkStatus)p_282923_.apply(0);
            ...
            for(int k = -p_282030_; k <= p_282030_; ++k) {
                for(int l = -p_282030_; l <= p_282030_; ++l) {
                    ...
                    ChunkStatus chunkstatus = (ChunkStatus)p_282923_.apply(i1);
            ...
            CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture2 = completablefuture1.thenApply((p_183730_) -> {
                ...
                for(Iterator var7 = p_183730_.iterator(); var7.hasNext(); ++k1) {
                    final Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure> either = (Either)var7.next();
                    if (either == null) {
                    ...
                    if (!optional.isPresent()) {
                        ...
                        return Either.right(new ChunkHolder.ChunkLoadingFailure() {
                            public String toString() {
                                ChunkPos var10000 = new ChunkPos(p_183727_ + l1 % (p_183728_ * 2 + 1), p_183729_ + l1 / (p_183728_ * 2 + 1));
            ...
            Iterator var21 = list1.iterator();

            while(var21.hasNext()) {
                ChunkHolder chunkholder1 = (ChunkHolder)var21.next();
    ...
    public ReportedException debugFuturesAndCreateReportedException(IllegalStateException p_203752_, String p_203753_) {
        ...
        Consumer<ChunkHolder> consumer = (p_203756_) -> {
            p_203756_.getAllFutures().forEach((p_203760_) -> {
                ...
                CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = (CompletableFuture)p_203760_.getSecond();
                if (completablefuture != null && completablefuture.isDone() && completablefuture.join() == null) {
                    stringbuilder.append(p_203756_.getPos()).append(" - status: ").append(chunkstatus).append(" future: ").append(completablefuture).append(System.lineSeparator());
                }
        ...
        crashreportcategory.setDetail("Details", (Object)p_203753_);
    ...
    ChunkHolder updateChunkScheduling(long p_140177_, int p_140178_, @Nullable ChunkHolder p_140179_, int p_140180_) {
        if (!ChunkLevel.isLoaded(p_140180_) && !ChunkLevel.isLoaded(p_140178_)) {
            ...
            ForgeEventFactory.fireChunkTicketLevelUpdated(this.level, p_140177_, p_140180_, p_140178_, p_140179_);
            return p_140179_;
        }
    }
    ...
    private void processUnloads(BooleanSupplier p_140354_) {
        ...
        int k;
        for(k = 0; longiterator.hasNext() && (p_140354_.getAsBoolean() || k < 200 || this.toDrop.size() > 2000); longiterator.remove()) {
        ...
        k = Math.max(0, this.unloadQueue.size() - 2000);

        Runnable runnable;
        while((p_140354_.getAsBoolean() || k > 0) && (runnable = (Runnable)this.unloadQueue.poll()) != null) {
            --k;
            runnable.run();
        }
    ...
    private void scheduleUnload(long p_140182_, ChunkHolder p_140183_) {
        ...
        completablefuture.thenAcceptAsync(var10001, var10002::add).whenComplete((p_202996_, p_202997_) -> {
            if (p_202997_ != null) {
    ...
    public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> schedule(ChunkHolder p_140293_, ChunkStatus p_140294_) {
        ...
        if (p_140294_ == ChunkStatus.EMPTY) {
            ...
            if (!p_140294_.hasLoadDependencies()) {
                Optional<ChunkAccess> optional = ((Either)p_140293_.getOrScheduleFuture(p_140294_.getParent(), this).getNow(ChunkHolder.UNLOADED_CHUNK)).left();
                if (optional.isPresent() && ((ChunkAccess)optional.get()).getStatus().isOrAfter(p_140294_)) {
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkLoad(ChunkPos p_140418_) {
        return this.readChunk(p_140418_).thenApply((p_214925_) -> {
            ...
            if (p_269770_.isPresent()) {
                ChunkAccess chunkaccess = ChunkSerializer.read(this.level, this.poiManager, p_140418_, (CompoundTag)p_269770_.get());
    ...
    private byte markPosition(ChunkPos p_140230_, ChunkStatus.ChunkType p_140231_) {
        return this.chunkTypeCache.put(p_140230_.toLong(), (byte)(p_140231_ == ChunkType.PROTOCHUNK ? -1 : 1));
    }
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkGeneration(ChunkHolder p_140361_, ChunkStatus p_140362_) {
        ...
        return completablefuture.thenComposeAsync((p_214873_) -> {
            return (CompletionStage)p_214873_.map((p_280971_) -> {
                try {
        ...
        return completablefuture.thenApplyAsync((p_287363_) -> {
            ...
            return !chunkstatus.isOrAfter(ChunkStatus.FULL) ? ChunkHolder.UNLOADED_CHUNK : p_287363_.mapLeft((p_214856_) -> {
                ...
                if (this.entitiesInLevel.add(chunkpos.toLong())) {
                    ...
                    try {
                        p_140384_.currentlyLoading = levelchunk;
                        ...
                        p_140384_.currentlyLoading = null;
                    }
                }
            ...
            long var10002 = p_140384_.getPos().toLong();
            Objects.requireNonNull(p_140384_);
            var10000.tell(ChunkTaskPriorityQueueSorter.message(p_214951_, var10002, p_140384_::getTicketLevel));
        });
    }
    ...
    private boolean saveChunkIfNeeded(ChunkHolder p_198875_) {
        if (!p_198875_.wasAccessibleSinceLastSave()) {
            ...
            ChunkAccess chunkaccess = (ChunkAccess)p_198875_.getChunkToSave().getNow((ChunkAccess)null);
    ...
    private boolean save(ChunkAccess p_140259_) {
        ...
        if (!p_140259_.isUnsaved()) {
            ...
            try {
                ...
                MinecraftForge.EVENT_BUS.post(new ChunkDataEvent.Save(p_140259_, (LevelAccessor)(p_140259_.getWorldForge() != null ? p_140259_.getWorldForge() : this.level), compoundtag));
    ...
    private boolean isExistingChunkFull(ChunkPos p_140426_) {
        ...
        if (b0 != 0) {
            ...
            try {
                compoundtag = (CompoundTag)((Optional)this.readChunk(p_140426_).join()).orElse((CompoundTag)null);
                if (compoundtag == null) {
    ...
    protected void updateChunkTracking(ServerPlayer p_183755_, ChunkPos p_183756_, MutableObject<ClientboundLevelChunkWithLightPacket> p_183757_, boolean p_183758_, boolean p_183759_) {
        if (p_183755_.level() == this.level) {
            ...
            if (!p_183759_ && p_183758_) {
                ...
                ForgeEventFactory.fireChunkUnWatch(p_183755_, p_183756_, this.level);
            }
        }
    ...
    void dumpChunks(Writer p_140275_) throws IOException {
        ...
        while(var4.hasNext()) {
            Long2ObjectMap.Entry<ChunkHolder> entry = (Long2ObjectMap.Entry)var4.next();
    ...
    private static String printFuture(CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> p_140279_) {
        try {
            Either<LevelChunk, ChunkHolder.ChunkLoadingFailure> either = (Either)p_140279_.getNow((Either)null);
            return either != null ? (String)either.map((p_214897_) -> {
                return "done";
            }, (p_214850_) -> {
                return "unloaded";
            }) : "not completed";
        } catch (CompletionException var2) {
            CompletionException completionexception = var2;
    ...
    boolean anyPlayerCloseEnoughForSpawning(ChunkPos p_183880_) {
        ...
        if (!this.distanceManager.hasPlayersNearby(i)) {
            ...
            Iterator var4 = this.playerMap.getPlayers(i).iterator();
            ...
            do {
                ...
                serverplayer = (ServerPlayer)var4.next();
            } while(!this.playerIsCloseEnoughForSpawning(serverplayer, p_183880_));
    ...
    public List<ServerPlayer> getPlayersCloseForSpawning(ChunkPos p_183889_) {
        ...
        if (!this.distanceManager.hasPlayersNearby(i)) {
            ...
            Iterator var5 = this.playerMap.getPlayers(i).iterator();
    ...
    void updatePlayerStatus(ServerPlayer p_140193_, boolean p_140194_) {
        ...
        if (p_140194_) {
            ...
            if (!flag) {
                this.distanceManager.addPlayer(SectionPos.of((EntityAccess)p_140193_), p_140193_);
            }
        } else {
    ...
    private SectionPos updatePlayerPos(ServerPlayer p_140374_) {
        SectionPos sectionpos = SectionPos.of((EntityAccess)p_140374_);
    ...
    public void move(ServerPlayer p_140185_) {
        ...
        SectionPos sectionpos1 = SectionPos.of((EntityAccess)p_140185_);
        ...
        if (Math.abs(k - j2) <= i1 * 2 && Math.abs(l - k2) <= i1 * 2) {
            ...
            boolean flag7;
            boolean flag8;
            for(l2 = k - i1; l2 <= k + i1; ++l2) {
                for(j3 = l - i1; j3 <= l + i1; ++j3) {
                    if (isChunkInRange(l2, j3, k, l, this.viewDistance)) {
                        flag7 = true;
                        flag8 = false;
                        this.updateChunkTracking(p_140185_, new ChunkPos(l2, j3), new MutableObject(), true, false);
                    }
                }
            }

            for(l2 = j2 - i1; l2 <= j2 + i1; ++l2) {
                for(j3 = k2 - i1; j3 <= k2 + i1; ++j3) {
    ...
    public List<ServerPlayer> getPlayers(ChunkPos p_183801_, boolean p_183802_) {
        ...
        while(true) {
            ...
            } while((!p_183802_ || !isChunkOnRangeBorder(p_183801_.x, p_183801_.z, sectionpos.x(), sectionpos.z(), this.viewDistance)) && (p_183802_ || !isChunkInRange(p_183801_.x, p_183801_.z, sectionpos.x(), sectionpos.z(), this.viewDistance)));
    ...
    protected void addEntity(Entity p_140200_) {
        if (!(p_140200_ instanceof PartEntity)) {
            ...
            if (i != 0) {
                ...
                if (p_140200_ instanceof ServerPlayer) {
                    ...
                    while(var7.hasNext()) {
                        TrackedEntity chunkmap$trackedentity1 = (TrackedEntity)var7.next();
    ...
    protected void removeEntity(Entity p_140332_) {
        ...
        TrackedEntity chunkmap$trackedentity1 = (TrackedEntity)this.entityMap.remove(p_140332_.getId());
    ...
    protected void tick() {
        ...
        while(var3.hasNext()) {
            ...
            SectionPos sectionpos = chunkmap$trackedentity1.lastSectionPos;
            SectionPos sectionpos1 = SectionPos.of((EntityAccess)chunkmap$trackedentity1.entity);
            boolean flag = !Objects.equals(sectionpos, sectionpos1);
            if (flag) {
                chunkmap$trackedentity1.updatePlayers(list1);
                Entity entity = chunkmap$trackedentity1.entity;
                if (entity instanceof ServerPlayer) {
                    list.add((ServerPlayer)entity);
                }

                chunkmap$trackedentity1.lastSectionPos = sectionpos1;
            }

            if (flag || this.distanceManager.inEntityTickingRange(sectionpos1.chunk().toLong())) {
                chunkmap$trackedentity1.serverEntity.sendChanges();
            }
        }
    ...
    public void resendBiomesForChunks(List<ChunkAccess> p_275577_) {
        ...
        Iterator var3 = p_275577_.iterator();
        ...
        while(var3.hasNext()) {
            ...
            Iterator var9 = this.getPlayers(chunkpos, false).iterator();

            while(var9.hasNext()) {
                ServerPlayer serverplayer = (ServerPlayer)var9.next();
                ((List)map.computeIfAbsent(serverplayer, (p_274834_) -> {
    ...
    private void playerLoadedChunk(ServerPlayer p_183761_, MutableObject<ClientboundLevelChunkWithLightPacket> p_183762_, LevelChunk p_183763_) {
        ...
        p_183761_.trackChunk(p_183763_.getPos(), (Packet)p_183762_.getValue());
        ...
        while(var6.hasNext()) {
            TrackedEntity chunkmap$trackedentity = (TrackedEntity)var6.next();
        ...
        ForgeEventFactory.fireChunkWatch(p_183761_, p_183763_, this.level);
    }
    ...
    class TrackedEntity {
        ...
        public TrackedEntity(Entity p_140478_, int p_140479_, int p_140480_, boolean p_140481_) {
            ...
            this.lastSectionPos = SectionPos.of((EntityAccess)p_140478_);
        }
        ...
        public void updatePlayers(List<ServerPlayer> p_140488_) {
            Iterator var2 = p_140488_.iterator();
