...
public class BossBarCommands {
    ...
    public static final SuggestionProvider<CommandSourceStack> SUGGEST_BOSS_BAR = (p_136587_, p_136588_) -> {
        return SharedSuggestionProvider.suggestResource((Iterable)((CommandSourceStack)p_136587_.getSource()).getServer().getCustomBossEvents().getIds(), p_136588_);
    };
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_136583_) {
        p_136583_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("bossbar").requires((p_136627_) -> {
            ...
            return createBar((CommandSourceStack)p_136693_.getSource(), ResourceLocationArgument.getId(p_136693_, "id"), ComponentArgument.getComponent(p_136693_, "name"));
            ...
            return removeBar((CommandSourceStack)p_136691_.getSource(), getBossBar(p_136691_));
        })))).then(Commands.literal("list").executes((p_136689_) -> {
            return listBars((CommandSourceStack)p_136689_.getSource());
            ...
            return setName((CommandSourceStack)p_136687_.getSource(), getBossBar(p_136687_), ComponentArgument.getComponent(p_136687_, "name"));
        })))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("color").then(Commands.literal("pink").executes((p_136685_) -> {
            return setColor((CommandSourceStack)p_136685_.getSource(), getBossBar(p_136685_), BossBarColor.PINK);
        }))).then(Commands.literal("blue").executes((p_136683_) -> {
            return setColor((CommandSourceStack)p_136683_.getSource(), getBossBar(p_136683_), BossBarColor.BLUE);
        }))).then(Commands.literal("red").executes((p_136681_) -> {
            return setColor((CommandSourceStack)p_136681_.getSource(), getBossBar(p_136681_), BossBarColor.RED);
        }))).then(Commands.literal("green").executes((p_136679_) -> {
            return setColor((CommandSourceStack)p_136679_.getSource(), getBossBar(p_136679_), BossBarColor.GREEN);
        }))).then(Commands.literal("yellow").executes((p_136677_) -> {
            return setColor((CommandSourceStack)p_136677_.getSource(), getBossBar(p_136677_), BossBarColor.YELLOW);
        }))).then(Commands.literal("purple").executes((p_136675_) -> {
            return setColor((CommandSourceStack)p_136675_.getSource(), getBossBar(p_136675_), BossBarColor.PURPLE);
        }))).then(Commands.literal("white").executes((p_136673_) -> {
            return setColor((CommandSourceStack)p_136673_.getSource(), getBossBar(p_136673_), BossBarColor.WHITE);
        })))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("style").then(Commands.literal("progress").executes((p_136671_) -> {
            return setStyle((CommandSourceStack)p_136671_.getSource(), getBossBar(p_136671_), BossBarOverlay.PROGRESS);
        }))).then(Commands.literal("notched_6").executes((p_136669_) -> {
            return setStyle((CommandSourceStack)p_136669_.getSource(), getBossBar(p_136669_), BossBarOverlay.NOTCHED_6);
        }))).then(Commands.literal("notched_10").executes((p_136667_) -> {
            return setStyle((CommandSourceStack)p_136667_.getSource(), getBossBar(p_136667_), BossBarOverlay.NOTCHED_10);
        }))).then(Commands.literal("notched_12").executes((p_136665_) -> {
            return setStyle((CommandSourceStack)p_136665_.getSource(), getBossBar(p_136665_), BossBarOverlay.NOTCHED_12);
        }))).then(Commands.literal("notched_20").executes((p_136663_) -> {
            return setStyle((CommandSourceStack)p_136663_.getSource(), getBossBar(p_136663_), BossBarOverlay.NOTCHED_20);
        })))).then(Commands.literal("value").then(Commands.argument("value", IntegerArgumentType.integer(0)).executes((p_136661_) -> {
            return setValue((CommandSourceStack)p_136661_.getSource(), getBossBar(p_136661_), IntegerArgumentType.getInteger(p_136661_, "value"));
        })))).then(Commands.literal("max").then(Commands.argument("max", IntegerArgumentType.integer(1)).executes((p_136659_) -> {
            return setMax((CommandSourceStack)p_136659_.getSource(), getBossBar(p_136659_), IntegerArgumentType.getInteger(p_136659_, "max"));
        })))).then(Commands.literal("visible").then(Commands.argument("visible", BoolArgumentType.bool()).executes((p_136657_) -> {
            return setVisible((CommandSourceStack)p_136657_.getSource(), getBossBar(p_136657_), BoolArgumentType.getBool(p_136657_, "visible"));
        })))).then(((LiteralArgumentBuilder)Commands.literal("players").executes((p_136655_) -> {
            return setPlayers((CommandSourceStack)p_136655_.getSource(), getBossBar(p_136655_), Collections.emptyList());
        })).then(Commands.argument("targets", EntityArgument.players()).executes((p_136653_) -> {
            return setPlayers((CommandSourceStack)p_136653_.getSource(), getBossBar(p_136653_), EntityArgument.getOptionalPlayers(p_136653_, "targets"));
        })))))).then(Commands.literal("get").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR).then(Commands.literal("value").executes((p_136648_) -> {
            return getValue((CommandSourceStack)p_136648_.getSource(), getBossBar(p_136648_));
        }))).then(Commands.literal("max").executes((p_136643_) -> {
            return getMax((CommandSourceStack)p_136643_.getSource(), getBossBar(p_136643_));
        }))).then(Commands.literal("visible").executes((p_136638_) -> {
            return getVisible((CommandSourceStack)p_136638_.getSource(), getBossBar(p_136638_));
        }))).then(Commands.literal("players").executes((p_136625_) -> {
            return getPlayers((CommandSourceStack)p_136625_.getSource(), getBossBar(p_136625_));
        })))));
    }
    ...
    private static int setName(CommandSourceStack p_136615_, CustomBossEvent p_136616_, Component p_136617_) throws CommandSyntaxException {
        Component $$3 = ComponentUtils.updateForEntity(p_136615_, (Component)p_136617_, (Entity)null, 0);
        if (p_136616_.getName().equals($$3)) {
    ...
    private static int setPlayers(CommandSourceStack p_136611_, CustomBossEvent p_136612_, Collection<ServerPlayer> p_136613_) throws CommandSyntaxException {
        boolean $$3 = p_136612_.setPlayers(p_136613_);
        if (!$$3) {
    ...
    private static int listBars(CommandSourceStack p_136590_) {
        Collection<CustomBossEvent> $$1 = p_136590_.getServer().getCustomBossEvents().getEvents();
        if ($$1.isEmpty()) {
            ...
            p_136590_.sendSuccess(() -> {
                return Component.translatable("commands.bossbar.list.bars.some", $$1.size(), ComponentUtils.formatList($$1, CustomBossEvent::getDisplayName));
            }, false);
        }
    ...
    private static int createBar(CommandSourceStack p_136592_, ResourceLocation p_136593_, Component p_136594_) throws CommandSyntaxException {
        ...
        if ($$3.get(p_136593_) != null) {
            ...
            CustomBossEvent $$4 = $$3.create(p_136593_, ComponentUtils.updateForEntity(p_136592_, (Component)p_136594_, (Entity)null, 0));
            p_136592_.sendSuccess(() -> {
                return Component.translatable("commands.bossbar.create.success", $$4.getDisplayName());
            }, true);
    ...
    private static int removeBar(CommandSourceStack p_136650_, CustomBossEvent p_136651_) {
        CustomBossEvents $$2 = p_136650_.getServer().getCustomBossEvents();
    ...
    public static CustomBossEvent getBossBar(CommandContext<CommandSourceStack> p_136585_) throws CommandSyntaxException {
        ResourceLocation $$1 = ResourceLocationArgument.getId(p_136585_, "id");
        CustomBossEvent $$2 = ((CommandSourceStack)p_136585_.getSource()).getServer().getCustomBossEvents().get($$1);
        if ($$2 == null) {
