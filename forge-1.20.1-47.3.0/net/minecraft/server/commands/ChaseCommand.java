...
public class ChaseCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_196078_) {
        p_196078_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("chase").then(((LiteralArgumentBuilder)Commands.literal("follow").then(((RequiredArgumentBuilder)Commands.argument("host", StringArgumentType.string()).executes((p_196104_) -> {
            return follow((CommandSourceStack)p_196104_.getSource(), StringArgumentType.getString(p_196104_, "host"), 10000);
        })).then(Commands.argument("port", IntegerArgumentType.integer(1, 65535)).executes((p_196102_) -> {
            return follow((CommandSourceStack)p_196102_.getSource(), StringArgumentType.getString(p_196102_, "host"), IntegerArgumentType.getInteger(p_196102_, "port"));
        })))).executes((p_196100_) -> {
            return follow((CommandSourceStack)p_196100_.getSource(), "localhost", 10000);
        }))).then(((LiteralArgumentBuilder)Commands.literal("lead").then(((RequiredArgumentBuilder)Commands.argument("bind_address", StringArgumentType.string()).executes((p_196098_) -> {
            return lead((CommandSourceStack)p_196098_.getSource(), StringArgumentType.getString(p_196098_, "bind_address"), 10000);
        })).then(Commands.argument("port", IntegerArgumentType.integer(1024, 65535)).executes((p_196096_) -> {
            return lead((CommandSourceStack)p_196096_.getSource(), StringArgumentType.getString(p_196096_, "bind_address"), IntegerArgumentType.getInteger(p_196096_, "port"));
        })))).executes((p_196088_) -> {
            return lead((CommandSourceStack)p_196088_.getSource(), "0.0.0.0", 10000);
        }))).then(Commands.literal("stop").executes((p_196080_) -> {
            return stop((CommandSourceStack)p_196080_.getSource());
        })));
    }
