...
public class ReturnCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_282091_) {
        p_282091_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("return").requires((p_281281_) -> {
            return p_281281_.hasPermission(2);
        })).then(Commands.argument("value", IntegerArgumentType.integer()).executes((p_281464_) -> {
            return setReturn((CommandSourceStack)p_281464_.getSource(), IntegerArgumentType.getInteger(p_281464_, "value"));
        })));
    }
