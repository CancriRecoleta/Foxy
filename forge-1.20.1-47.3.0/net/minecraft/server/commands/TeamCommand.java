...
public class TeamCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_138878_) {
        p_138878_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("team").requires((p_183713_) -> {
            return p_183713_.hasPermission(2);
        })).then(((LiteralArgumentBuilder)Commands.literal("list").executes((p_183711_) -> {
            return listTeams((CommandSourceStack)p_183711_.getSource());
        })).then(Commands.argument("team", TeamArgument.team()).executes((p_138876_) -> {
            return listMembers((CommandSourceStack)p_138876_.getSource(), TeamArgument.getTeam(p_138876_, "team"));
        })))).then(Commands.literal("add").then(((RequiredArgumentBuilder)Commands.argument("team", StringArgumentType.word()).executes((p_138995_) -> {
            return createTeam((CommandSourceStack)p_138995_.getSource(), StringArgumentType.getString(p_138995_, "team"));
        })).then(Commands.argument("displayName", ComponentArgument.textComponent()).executes((p_138993_) -> {
            return createTeam((CommandSourceStack)p_138993_.getSource(), StringArgumentType.getString(p_138993_, "team"), ComponentArgument.getComponent(p_138993_, "displayName"));
        }))))).then(Commands.literal("remove").then(Commands.argument("team", TeamArgument.team()).executes((p_138991_) -> {
            return deleteTeam((CommandSourceStack)p_138991_.getSource(), TeamArgument.getTeam(p_138991_, "team"));
        })))).then(Commands.literal("empty").then(Commands.argument("team", TeamArgument.team()).executes((p_138989_) -> {
            return emptyTeam((CommandSourceStack)p_138989_.getSource(), TeamArgument.getTeam(p_138989_, "team"));
        })))).then(Commands.literal("join").then(((RequiredArgumentBuilder)Commands.argument("team", TeamArgument.team()).executes((p_138987_) -> {
            return joinTeam((CommandSourceStack)p_138987_.getSource(), TeamArgument.getTeam(p_138987_, "team"), Collections.singleton(((CommandSourceStack)p_138987_.getSource()).getEntityOrException().getScoreboardName()));
            ...
            return joinTeam((CommandSourceStack)p_138985_.getSource(), TeamArgument.getTeam(p_138985_, "team"), ScoreHolderArgument.getNamesWithDefaultWildcard(p_138985_, "members"));
            ...
            return leaveTeam((CommandSourceStack)p_138983_.getSource(), ScoreHolderArgument.getNamesWithDefaultWildcard(p_138983_, "members"));
            ...
            return setDisplayName((CommandSourceStack)p_138981_.getSource(), TeamArgument.getTeam(p_138981_, "team"), ComponentArgument.getComponent(p_138981_, "displayName"));
        })))).then(Commands.literal("color").then(Commands.argument("value", ColorArgument.color()).executes((p_138979_) -> {
            return setColor((CommandSourceStack)p_138979_.getSource(), TeamArgument.getTeam(p_138979_, "team"), ColorArgument.getColor(p_138979_, "value"));
        })))).then(Commands.literal("friendlyFire").then(Commands.argument("allowed", BoolArgumentType.bool()).executes((p_138977_) -> {
            return setFriendlyFire((CommandSourceStack)p_138977_.getSource(), TeamArgument.getTeam(p_138977_, "team"), BoolArgumentType.getBool(p_138977_, "allowed"));
        })))).then(Commands.literal("seeFriendlyInvisibles").then(Commands.argument("allowed", BoolArgumentType.bool()).executes((p_138975_) -> {
            return setFriendlySight((CommandSourceStack)p_138975_.getSource(), TeamArgument.getTeam(p_138975_, "team"), BoolArgumentType.getBool(p_138975_, "allowed"));
        })))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("nametagVisibility").then(Commands.literal("never").executes((p_138973_) -> {
            return setNametagVisibility((CommandSourceStack)p_138973_.getSource(), TeamArgument.getTeam(p_138973_, "team"), Visibility.NEVER);
        }))).then(Commands.literal("hideForOtherTeams").executes((p_138971_) -> {
            return setNametagVisibility((CommandSourceStack)p_138971_.getSource(), TeamArgument.getTeam(p_138971_, "team"), Visibility.HIDE_FOR_OTHER_TEAMS);
        }))).then(Commands.literal("hideForOwnTeam").executes((p_138969_) -> {
            return setNametagVisibility((CommandSourceStack)p_138969_.getSource(), TeamArgument.getTeam(p_138969_, "team"), Visibility.HIDE_FOR_OWN_TEAM);
        }))).then(Commands.literal("always").executes((p_138967_) -> {
            return setNametagVisibility((CommandSourceStack)p_138967_.getSource(), TeamArgument.getTeam(p_138967_, "team"), Visibility.ALWAYS);
        })))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("deathMessageVisibility").then(Commands.literal("never").executes((p_138965_) -> {
            return setDeathMessageVisibility((CommandSourceStack)p_138965_.getSource(), TeamArgument.getTeam(p_138965_, "team"), Visibility.NEVER);
        }))).then(Commands.literal("hideForOtherTeams").executes((p_138963_) -> {
            return setDeathMessageVisibility((CommandSourceStack)p_138963_.getSource(), TeamArgument.getTeam(p_138963_, "team"), Visibility.HIDE_FOR_OTHER_TEAMS);
        }))).then(Commands.literal("hideForOwnTeam").executes((p_138961_) -> {
            return setDeathMessageVisibility((CommandSourceStack)p_138961_.getSource(), TeamArgument.getTeam(p_138961_, "team"), Visibility.HIDE_FOR_OWN_TEAM);
        }))).then(Commands.literal("always").executes((p_138959_) -> {
            return setDeathMessageVisibility((CommandSourceStack)p_138959_.getSource(), TeamArgument.getTeam(p_138959_, "team"), Visibility.ALWAYS);
        })))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("collisionRule").then(Commands.literal("never").executes((p_138957_) -> {
            return setCollision((CommandSourceStack)p_138957_.getSource(), TeamArgument.getTeam(p_138957_, "team"), CollisionRule.NEVER);
        }))).then(Commands.literal("pushOwnTeam").executes((p_138955_) -> {
            return setCollision((CommandSourceStack)p_138955_.getSource(), TeamArgument.getTeam(p_138955_, "team"), CollisionRule.PUSH_OWN_TEAM);
        }))).then(Commands.literal("pushOtherTeams").executes((p_138953_) -> {
            return setCollision((CommandSourceStack)p_138953_.getSource(), TeamArgument.getTeam(p_138953_, "team"), CollisionRule.PUSH_OTHER_TEAMS);
        }))).then(Commands.literal("always").executes((p_138951_) -> {
            return setCollision((CommandSourceStack)p_138951_.getSource(), TeamArgument.getTeam(p_138951_, "team"), CollisionRule.ALWAYS);
        })))).then(Commands.literal("prefix").then(Commands.argument("prefix", ComponentArgument.textComponent()).executes((p_138942_) -> {
            return setPrefix((CommandSourceStack)p_138942_.getSource(), TeamArgument.getTeam(p_138942_, "team"), ComponentArgument.getComponent(p_138942_, "prefix"));
        })))).then(Commands.literal("suffix").then(Commands.argument("suffix", ComponentArgument.textComponent()).executes((p_138923_) -> {
            return setSuffix((CommandSourceStack)p_138923_.getSource(), TeamArgument.getTeam(p_138923_, "team"), ComponentArgument.getComponent(p_138923_, "suffix"));
        }))))));
    }

    private static int leaveTeam(CommandSourceStack p_138918_, Collection<String> p_138919_) {
        Scoreboard $$2 = p_138918_.getServer().getScoreboard();
        Iterator var3 = p_138919_.iterator();
    ...
    private static int joinTeam(CommandSourceStack p_138895_, PlayerTeam p_138896_, Collection<String> p_138897_) {
        Scoreboard $$3 = p_138895_.getServer().getScoreboard();
        Iterator var4 = p_138897_.iterator();

        while(var4.hasNext()) {
            String $$4 = (String)var4.next();
            $$3.addPlayerToTeam($$4, p_138896_);
        }
    ...
    private static int emptyTeam(CommandSourceStack p_138884_, PlayerTeam p_138885_) throws CommandSyntaxException {
        Scoreboard $$2 = p_138884_.getServer().getScoreboard();
        Collection<String> $$3 = Lists.newArrayList(p_138885_.getPlayers());
        if ($$3.isEmpty()) {
            ...
            while(var4.hasNext()) {
                String $$4 = (String)var4.next();
                $$2.removePlayerFromTeam($$4, p_138885_);
            }

            p_138884_.sendSuccess(() -> {
                return Component.translatable("commands.team.empty.success", $$3.size(), p_138885_.getFormattedDisplayName());
            }, true);
            return $$3.size();
        }
    }
    ...
    private static int deleteTeam(CommandSourceStack p_138927_, PlayerTeam p_138928_) {
        Scoreboard $$2 = p_138927_.getServer().getScoreboard();
        $$2.removePlayerTeam(p_138928_);
    ...
    private static int createTeam(CommandSourceStack p_138914_, String p_138915_, Component p_138916_) throws CommandSyntaxException {
        Scoreboard $$3 = p_138914_.getServer().getScoreboard();
        if ($$3.getPlayerTeam(p_138915_) != null) {
            throw ERROR_TEAM_ALREADY_EXISTS.create();
        } else {
            PlayerTeam $$4 = $$3.addPlayerTeam(p_138915_);
            $$4.setDisplayName(p_138916_);
            p_138914_.sendSuccess(() -> {
                return Component.translatable("commands.team.add.success", $$4.getFormattedDisplayName());
            }, true);
    ...
    private static int listMembers(CommandSourceStack p_138944_, PlayerTeam p_138945_) {
        Collection<String> $$2 = p_138945_.getPlayers();
        if ($$2.isEmpty()) {
            ...
            p_138944_.sendSuccess(() -> {
                return Component.translatable("commands.team.list.members.success", p_138945_.getFormattedDisplayName(), $$2.size(), ComponentUtils.formatList($$2));
            }, false);
        }
    ...
    private static int listTeams(CommandSourceStack p_138882_) {
        Collection<PlayerTeam> $$1 = p_138882_.getServer().getScoreboard().getPlayerTeams();
        if ($$1.isEmpty()) {
            ...
            p_138882_.sendSuccess(() -> {
                return Component.translatable("commands.team.list.teams.success", $$1.size(), ComponentUtils.formatList($$1, PlayerTeam::getFormattedDisplayName));
            }, false);
        }
