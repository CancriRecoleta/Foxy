...
public class SaveAllCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> p_138272_) {
        p_138272_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("save-all").requires((p_138276_) -> {
            return p_138276_.hasPermission(4);
        })).executes((p_138281_) -> {
            return saveAll((CommandSourceStack)p_138281_.getSource(), false);
        })).then(Commands.literal("flush").executes((p_138274_) -> {
            return saveAll((CommandSourceStack)p_138274_.getSource(), true);
        })));
    }
    ...
    private static int saveAll(CommandSourceStack p_138278_, boolean p_138279_) throws CommandSyntaxException {
        ...
        MinecraftServer $$2 = p_138278_.getServer();
        boolean $$3 = $$2.saveEverything(true, p_138279_, true);
        if (!$$3) {
