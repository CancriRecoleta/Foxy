...
public class Vec3i implements Comparable<Vec3i> {
    ...
    public Vec3i relative(Direction p_175592_) {
        return this.relative((Direction)p_175592_, 1);
    }
    ...
    public Vec3i relative(Direction.Axis p_175590_, int p_175591_) {
        if (p_175591_ == 0) {
            ...
            int $$2 = p_175590_ == Axis.X ? p_175591_ : 0;
            int $$3 = p_175590_ == Axis.Y ? p_175591_ : 0;
            int $$4 = p_175590_ == Axis.Z ? p_175591_ : 0;
    ...
    public double distToCenterSqr(double p_203199_, double p_203200_, double p_203201_) {
        double $$3 = (double)this.getX() + 0.5 - p_203199_;
        double $$4 = (double)this.getY() + 0.5 - p_203200_;
        double $$5 = (double)this.getZ() + 0.5 - p_203201_;
        return $$3 * $$3 + $$4 * $$4 + $$5 * $$5;
    }

    public double distToLowCornerSqr(double p_203203_, double p_203204_, double p_203205_) {
        double $$3 = (double)this.getX() - p_203203_;
        double $$4 = (double)this.getY() - p_203204_;
        double $$5 = (double)this.getZ() - p_203205_;
        return $$3 * $$3 + $$4 * $$4 + $$5 * $$5;
    }

    public int distManhattan(Vec3i p_123334_) {
        float $$1 = (float)Math.abs(p_123334_.getX() - this.getX());
        float $$2 = (float)Math.abs(p_123334_.getY() - this.getY());
        float $$3 = (float)Math.abs(p_123334_.getZ() - this.getZ());
        return (int)($$1 + $$2 + $$3);
    }
    ...
    static {
        CODEC = Codec.INT_STREAM.comapFlatMap((p_123318_) -> {
            return Util.fixedSize((IntStream)p_123318_, 3).map((p_175586_) -> {
                return new Vec3i(p_175586_[0], p_175586_[1], p_175586_[2]);
            });
        }, (p_123313_) -> {
            return IntStream.of(new int[]{p_123313_.getX(), p_123313_.getY(), p_123313_.getZ()});
        });
