...
public class ParticleTypes {
    ...
    private static SimpleParticleType register(String p_123825_, boolean p_123826_) {
        return (SimpleParticleType)Registry.register(BuiltInRegistries.PARTICLE_TYPE, (String)p_123825_, new SimpleParticleType(p_123826_));
    }
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(String p_235906_, boolean p_235907_, ParticleOptions.Deserializer<T> p_235908_, final Function<ParticleType<T>, Codec<T>> p_235909_) {
        return (ParticleType)Registry.register(BuiltInRegistries.PARTICLE_TYPE, (String)p_235906_, new ParticleType<T>(p_235907_, p_235908_) {
    ...
    static {
        ...
        DUST = register("dust", false, DustParticleOptions.DESERIALIZER, (p_123819_) -> {
            return DustParticleOptions.CODEC;
        });
        DUST_COLOR_TRANSITION = register("dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, (p_175841_) -> {
        ...
        SCULK_CHARGE = register("sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, (p_175839_) -> {
        ...
        VIBRATION = register("vibration", true, VibrationParticleOption.DESERIALIZER, (p_235911_) -> {
        ...
        SHRIEK = register("shriek", false, ShriekParticleOption.DESERIALIZER, (p_235904_) -> {
