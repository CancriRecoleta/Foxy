...
public enum FrontAndTop implements StringRepresentable {
    ...
    private static final Int2ObjectMap<FrontAndTop> LOOKUP_TOP_FRONT = (Int2ObjectMap)Util.make(new Int2ObjectOpenHashMap(values().length), (p_175377_) -> {
        FrontAndTop[] var1 = values();
        int var2 = var1.length;

        for(int var3 = 0; var3 < var2; ++var3) {
            FrontAndTop $$1 = var1[var3];
