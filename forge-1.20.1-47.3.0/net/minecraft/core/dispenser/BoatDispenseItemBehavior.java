...
public class BoatDispenseItemBehavior extends DefaultDispenseItemBehavior {
    ...
    public ItemStack execute(BlockSource p_123375_, ItemStack p_123376_) {
        Direction direction = (Direction)p_123375_.getBlockState().getValue(DispenserBlock.FACING);
        ...
        Boat boat = this.isChestBoat ? new ChestBoat(level, d0, d1, d2) : new Boat(level, d0, d1, d2);
