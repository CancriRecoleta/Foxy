...
public class RegistrySynchronization {
    private static final Map<ResourceKey<? extends Registry<?>>, NetworkedRegistryData<?>> NETWORKABLE_REGISTRIES = (Map)Util.make(() -> {
        ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, NetworkedRegistryData<?>> builder = ImmutableMap.builder();
    ...
    private static <E> void put(ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, NetworkedRegistryData<?>> p_251643_, ResourceKey<? extends Registry<E>> p_249195_, Codec<E> p_249212_) {
        p_251643_.put(p_249195_, new NetworkedRegistryData(p_249195_, p_249212_));
    }
    ...
    private static <E> DataResult<? extends Codec<E>> getNetworkCodec(ResourceKey<? extends Registry<E>> p_252190_) {
        return (DataResult)Optional.ofNullable((NetworkedRegistryData)NETWORKABLE_REGISTRIES.get(p_252190_)).map((p_250582_) -> {
            return p_250582_.networkCodec();
    ...
    private static <K extends ResourceKey<? extends Registry<?>>, V extends Registry<?>> Codec<RegistryAccess> captureMap(UnboundedMapCodec<K, V> p_249934_) {
        return p_249934_.xmap(RegistryAccess.ImmutableRegistryAccess::new, (p_251578_) -> {
            return (Map)ownedNetworkableRegistries(p_251578_).collect(ImmutableMap.toImmutableMap((p_250395_) -> {
                return p_250395_.key();
            }, (p_248951_) -> {
                return p_248951_.value();
            }));
        });
    }
    ...
    public static record NetworkedRegistryData<E>(ResourceKey<? extends Registry<E>> key, Codec<E> networkCodec) {
        public NetworkedRegistryData(ResourceKey<? extends Registry<E>> key, Codec<E> networkCodec) {
            this.key = key;
