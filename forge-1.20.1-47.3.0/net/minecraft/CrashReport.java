...
public class CrashReport {
    ...
    public void getDetails(StringBuilder p_127520_) {
        ...
        if (this.uncategorizedStackTrace != null && this.uncategorizedStackTrace.length > 0) {
            ...
            p_127520_.append(CrashReportAnalyser.appendSuspectedMods(this.exception, this.uncategorizedStackTrace));
            p_127520_.append("Stacktrace:");
            p_127520_.append(CrashReportExtender.generateEnhancedStackTrace(this.uncategorizedStackTrace));
        }

        Iterator var2 = this.details.iterator();

        while(var2.hasNext()) {
            CrashReportCategory crashreportcategory = (CrashReportCategory)var2.next();
    ...
    public String getExceptionMessage() {
        ...
        if (((Throwable)throwable).getMessage() == null) {
            ...
            ((Throwable)throwable).setStackTrace(this.exception.getStackTrace());
        }
