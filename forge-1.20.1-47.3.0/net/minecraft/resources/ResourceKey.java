...
public class ResourceKey<T> implements Comparable<ResourceKey<?>> {
    ...
    private static <T> ResourceKey<T> create(ResourceLocation p_135791_, ResourceLocation p_135792_) {
        return (ResourceKey)VALUES.computeIfAbsent(new InternKey(p_135791_, p_135792_), (p_258225_) -> {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return this.location.equals(((ResourceKey)o).location) && this.registryName.equals(((ResourceKey)o).registryName);
        } else {
            return false;
        }
    }
