...
public enum ChatFormatting implements StringRepresentable {
    ...
    private static final Map<String, ChatFormatting> FORMATTING_BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap((p_126660_) -> {
