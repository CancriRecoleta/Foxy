...
public class CompoundTag implements Tag {
    ...
    public int sizeInBytes() {
        ...
        Map.Entry entry;
        for(Iterator var2 = this.tags.entrySet().iterator(); var2.hasNext(); i += ((Tag)entry.getValue()).sizeInBytes()) {
    ...
    public Tag put(String p_128366_, Tag p_128367_) {
        if (p_128367_ == null) {
            ...
            return (Tag)this.tags.put(p_128366_, p_128367_);
        }
    }
    ...
    public Tag get(String p_128424_) {
        return (Tag)this.tags.get(p_128424_);
    }

    public byte getTagType(String p_128436_) {
        Tag tag = (Tag)this.tags.get(p_128436_);
    ...
    public String getString(String p_128462_) {
        try {
            if (this.contains(p_128462_, 8)) {
                return ((Tag)this.tags.get(p_128462_)).getAsString();
            }
        } catch (ClassCastException var3) {
        }
    ...
    private CrashReport createReport(String p_128373_, TagType<?> p_128374_, ClassCastException p_128375_) {
        ...
        crashreportcategory.setDetail("Tag type found", () -> {
            return ((Tag)this.tags.get(p_128373_)).getType().getName();
        });
        Objects.requireNonNull(p_128374_);
        crashreportcategory.setDetail("Tag type expected", p_128374_::getName);
        crashreportcategory.setDetail("Tag name", (Object)p_128373_);
        return crashreport;
    }
    ...
    static Tag readNamedTagData(TagType<?> p_128414_, String p_128415_, DataInput p_128416_, int p_128417_, NbtAccounter p_128418_) {
        try {
            ...
            crashreportcategory.setDetail("Tag name", (Object)p_128415_);
            crashreportcategory.setDetail("Tag type", (Object)p_128414_.getName());
            throw new ReportedException(crashreport);
        }
    }

    public CompoundTag merge(CompoundTag p_128392_) {
        Iterator var2 = p_128392_.tags.keySet().iterator();

        while(var2.hasNext()) {
            String s = (String)var2.next();
            Tag tag = (Tag)p_128392_.tags.get(s);
            if (tag.getId() == 10) {
        ...
        while(var2.hasNext()) {
            ...
            switch (streamtagvisitor$entryresult) {
                ...
                case SKIP:
                    break;
                default:
                    streamtagvisitor$entryresult = p_197442_.visitEntry(tagtype, (String)entry.getKey());
                    switch (streamtagvisitor$entryresult) {
                        case HALT:
                            return ValueResult.HALT;
                        case BREAK:
                        ...
                        default:
                            ...
                            switch (streamtagvisitor$valueresult) {
                                ...
                                case BREAK -> return p_197442_.visitContainerEnd();
                            }
                    }
            }
        }
    ...
    static {
        CODEC = Codec.PASSTHROUGH.comapFlatMap((p_274781_) -> {
            Tag tag = (Tag)p_274781_.convert(NbtOps.INSTANCE).getValue();
