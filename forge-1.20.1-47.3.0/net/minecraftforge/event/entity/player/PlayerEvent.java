...
public class PlayerEvent extends LivingEvent {
    ...
    public static class ItemSmeltedEvent extends PlayerEvent {
        private final @NotNull ItemStack smelting;
        ...
        public @NotNull ItemStack getSmelting() {
            return this.smelting;
        }
    }

    public static class ItemCraftedEvent extends PlayerEvent {
        private final @NotNull ItemStack crafting;
        ...
        public @NotNull ItemStack getCrafting() {
    ...
    public static class SaveToFile extends PlayerEvent {
        ...
        public File getPlayerFile(String suffix) {
            if ("dat".equals(suffix)) {
                ...
                File var10002 = this.getPlayerDirectory();
                String var10003 = this.getPlayerUUID();
                return new File(var10002, var10003 + "." + suffix);
            }
        }
