...
public class ProjectileImpactEvent extends EntityEvent {
    ...
    public ProjectileImpactEvent(Projectile projectile, HitResult ray) {
        super(projectile);
        this.result = net.minecraftforge.event.entity.ProjectileImpactEvent.ImpactResult.DEFAULT;
        this.ray = ray;
    ...
    public void setImpactResult(@NotNull @NotNull ImpactResult newResult) {
        this.result = (ImpactResult)Objects.requireNonNull(newResult, "ImpactResult cannot be null");
    }
