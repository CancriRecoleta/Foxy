...
public interface ITagManager<V> extends Iterable<ITag<V>> {
    @NotNull ITag<V> getTag(@NotNull TagKey<V> var1);

    @NotNull Optional<IReverseTag<V>> getReverseTag(@NotNull V var1);
    ...
    @NotNull TagKey<V> createTagKey(@NotNull ResourceLocation var1);

    @NotNull TagKey<V> createOptionalTagKey(@NotNull ResourceLocation var1, @NotNull Set<? extends Supplier<V>> var2);
