...
public class ForgeRegistries {
    ...
    private static void init() {
        net.minecraftforge.registries.ForgeRegistries.Keys.init();
        GameData.init();
        Bootstrap.bootStrap();
        Tags.init();
    }
    ...
    static {
        init();
        BLOCKS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.BLOCKS);
        FLUIDS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.FLUIDS);
        ITEMS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.ITEMS);
        MOB_EFFECTS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.MOB_EFFECTS);
        SOUND_EVENTS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.SOUND_EVENTS);
        POTIONS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.POTIONS);
        ENCHANTMENTS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.ENCHANTMENTS);
        ENTITY_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.ENTITY_TYPES);
        BLOCK_ENTITY_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.BLOCK_ENTITY_TYPES);
        PARTICLE_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.PARTICLE_TYPES);
        MENU_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.MENU_TYPES);
        PAINTING_VARIANTS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.PAINTING_VARIANTS);
        RECIPE_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.RECIPE_TYPES);
        RECIPE_SERIALIZERS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.RECIPE_SERIALIZERS);
        ATTRIBUTES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.ATTRIBUTES);
        STAT_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.STAT_TYPES);
        COMMAND_ARGUMENT_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.COMMAND_ARGUMENT_TYPES);
        VILLAGER_PROFESSIONS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.VILLAGER_PROFESSIONS);
        POI_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.POI_TYPES);
        MEMORY_MODULE_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.MEMORY_MODULE_TYPES);
        SENSOR_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.SENSOR_TYPES);
        SCHEDULES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.SCHEDULES);
        ACTIVITIES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.ACTIVITIES);
        WORLD_CARVERS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.WORLD_CARVERS);
        FEATURES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.FEATURES);
        CHUNK_STATUS = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.CHUNK_STATUS);
        BLOCK_STATE_PROVIDER_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.BLOCK_STATE_PROVIDER_TYPES);
        FOLIAGE_PLACER_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.FOLIAGE_PLACER_TYPES);
        TREE_DECORATOR_TYPES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.TREE_DECORATOR_TYPES);
        BIOMES = RegistryManager.ACTIVE.getRegistry(net.minecraftforge.registries.ForgeRegistries.Keys.BIOMES);
        DEFERRED_ENTITY_DATA_SERIALIZERS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.ENTITY_DATA_SERIALIZERS, net.minecraftforge.registries.ForgeRegistries.Keys.ENTITY_DATA_SERIALIZERS.location().getNamespace());
        ENTITY_DATA_SERIALIZERS = DEFERRED_ENTITY_DATA_SERIALIZERS.makeRegistry(GameData::getDataSerializersRegistryBuilder);
        DEFERRED_GLOBAL_LOOT_MODIFIER_SERIALIZERS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, net.minecraftforge.registries.ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS.location().getNamespace());
        ...
        DEFERRED_BIOME_MODIFIER_SERIALIZERS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, net.minecraftforge.registries.ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS.location().getNamespace());
        ...
        DEFERRED_STRUCTURE_MODIFIER_SERIALIZERS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.STRUCTURE_MODIFIER_SERIALIZERS, net.minecraftforge.registries.ForgeRegistries.Keys.STRUCTURE_MODIFIER_SERIALIZERS.location().getNamespace());
        ...
        DEFERRED_FLUID_TYPES = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.FLUID_TYPES, net.minecraftforge.registries.ForgeRegistries.Keys.FLUID_TYPES.location().getNamespace());
        FLUID_TYPES = DEFERRED_FLUID_TYPES.makeRegistry(GameData::getFluidTypeRegistryBuilder);
        DEFERRED_HOLDER_SET_TYPES = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.HOLDER_SET_TYPES, "forge");
        HOLDER_SET_TYPES = DEFERRED_HOLDER_SET_TYPES.makeRegistry(GameData::makeUnsavedAndUnsynced);
        DEFERRED_DISPLAY_CONTEXTS = DeferredRegister.create(net.minecraftforge.registries.ForgeRegistries.Keys.DISPLAY_CONTEXTS, "forge");
