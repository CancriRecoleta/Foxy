...
public class ForgeLoadingOverlay extends LoadingOverlay {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        bufferbuilder.vertex((double)wleft, (double)wbottom, 0.0).uv(0.0F, 0.0F).color(1.0F, 1.0F, 1.0F, fade).endVertex();
        bufferbuilder.vertex((double)wright, (double)wbottom, 0.0).uv(1.0F, 0.0F).color(1.0F, 1.0F, 1.0F, fade).endVertex();
        bufferbuilder.vertex((double)wright, (double)wtop, 0.0).uv(1.0F, 1.0F).color(1.0F, 1.0F, 1.0F, fade).endVertex();
        bufferbuilder.vertex((double)wleft, (double)wtop, 0.0).uv(0.0F, 1.0F).color(1.0F, 1.0F, 1.0F, fade).endVertex();
