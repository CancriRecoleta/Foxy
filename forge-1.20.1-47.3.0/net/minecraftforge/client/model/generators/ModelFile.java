...
public abstract class ModelFile {
    ...
    public static class ExistingModelFile extends ModelFile {
        ...
        protected boolean exists() {
            return this.getUncheckedLocation().getPath().contains(".") ? this.existingHelper.exists(this.getUncheckedLocation(), (ExistingFileHelper.IResourceType)ModelProvider.MODEL_WITH_EXTENSION) : this.existingHelper.exists(this.getUncheckedLocation(), (ExistingFileHelper.IResourceType)ModelProvider.MODEL);
        }
    }
