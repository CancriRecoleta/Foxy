...
public abstract class QuadLighter {
    ...
    public final void process(VertexConsumer consumer, PoseStack.Pose pose, BakedQuad quad, int overlay) {
        ...
        for(i = 0; i < 4; ++i) {
            ...
            this.normals[i][0] = (byte)(packedNormal & 255);
            this.normals[i][1] = (byte)(packedNormal >> 8 & 255);
            this.normals[i][2] = (byte)(packedNormal >> 16 & 255);
        ...
        for(i = 0; i < 4; ++i) {
            ...
            this.lightmap[i] = Math.max(v & '\uffff', newLightmap & '\uffff') | Math.max(v >> 16 & '\uffff', newLightmap >> 16 & '\uffff') << 16;
        }
    ...
    private float[] getColorFast(int tintIndex) {
        if (tintIndex != this.cachedTintIndex) {
            ...
            this.cachedTintColor[0] = (float)(packedColor >> 16 & 255) / 255.0F;
            this.cachedTintColor[1] = (float)(packedColor >> 8 & 255) / 255.0F;
            this.cachedTintColor[2] = (float)(packedColor & 255) / 255.0F;
        }
