...
public class SeparateTransformsModel implements IUnbakedGeometry<SeparateTransformsModel> {
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation) {
        return new Baked(context.useAmbientOcclusion(), context.isGui3d(), context.useBlockLight(), (TextureAtlasSprite)spriteGetter.apply(context.getMaterial("particle")), overrides, this.baseModel.bake(baker, this.baseModel, spriteGetter, modelState, modelLocation, context.useBlockLight()), ImmutableMap.copyOf(Maps.transformValues(this.perspectives, (value) -> {
    ...
    public void resolveParents(Function<ResourceLocation, UnbakedModel> modelGetter, IGeometryBakingContext context) {
        ...
        this.perspectives.values().forEach((model) -> {
    ...
    public static final class Loader implements IGeometryLoader<SeparateTransformsModel> {
        ...
        public SeparateTransformsModel read(JsonObject jsonObject, JsonDeserializationContext deserializationContext) {
            ...
            ItemDisplayContext[] var6 = ItemDisplayContext.values();
            int var7 = var6.length;

            for(int var8 = 0; var8 < var7; ++var8) {
                ItemDisplayContext transform = var6[var8];
