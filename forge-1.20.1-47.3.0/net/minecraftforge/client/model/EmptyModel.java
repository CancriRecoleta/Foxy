...
public class EmptyModel extends SimpleUnbakedGeometry<EmptyModel> {
    ...
    public static final IGeometryLoader<EmptyModel> LOADER = (json, ctx) -> {
        return INSTANCE;
    };
    ...
    private static class Baked extends SimpleBakedModel {
        ...
        static {
            MISSING_TEXTURE = new Material(TextureAtlas.LOCATION_BLOCKS, MissingTextureAtlasSprite.getLocation());
        }
    }
}
