...
public interface IClientFluidTypeExtensions {
    ...
    static IClientFluidTypeExtensions of(FluidType type) {
        Object var2 = type.getRenderPropertiesInternal();
        IClientFluidTypeExtensions var10000;
        if (var2 instanceof IClientFluidTypeExtensions props) {
            var10000 = props;
        } else {
            var10000 = DEFAULT;
        }
    ...
    default @Nullable ResourceLocation getOverlayTexture() {
        return null;
    }

    default @Nullable ResourceLocation getRenderOverlayTexture(Minecraft mc) {
        return null;
    }
    ...
    default @NotNull Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
