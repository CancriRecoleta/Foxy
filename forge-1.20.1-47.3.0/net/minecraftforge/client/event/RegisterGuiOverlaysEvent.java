...
public class RegisterGuiOverlaysEvent extends Event implements IModBusEvent {
    ...
    public void registerBelowAll(@NotNull String id, @NotNull IGuiOverlay overlay) {
        this.register(net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.BEFORE, (ResourceLocation)null, id, overlay);
    }

    public void registerBelow(@NotNull ResourceLocation other, @NotNull String id, @NotNull IGuiOverlay overlay) {
        this.register(net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.BEFORE, other, id, overlay);
    }

    public void registerAbove(@NotNull ResourceLocation other, @NotNull String id, @NotNull IGuiOverlay overlay) {
        this.register(net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.AFTER, other, id, overlay);
    }

    public void registerAboveAll(@NotNull String id, @NotNull IGuiOverlay overlay) {
        this.register(net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.AFTER, (ResourceLocation)null, id, overlay);
    }

    private void register(@NotNull @NotNull Ordering ordering, @Nullable ResourceLocation other, @NotNull String id, @NotNull IGuiOverlay overlay) {
        ...
        int insertPosition;
        if (other == null) {
            insertPosition = ordering == net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.BEFORE ? 0 : this.overlays.size();
        } else {
            ...
            insertPosition = otherIndex + (ordering == net.minecraftforge.client.event.RegisterGuiOverlaysEvent.Ordering.BEFORE ? 0 : 1);
        }
