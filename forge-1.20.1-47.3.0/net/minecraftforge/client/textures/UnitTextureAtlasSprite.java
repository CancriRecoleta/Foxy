...
public class UnitTextureAtlasSprite extends TextureAtlasSprite {
    ...
    private UnitTextureAtlasSprite() {
        super(LOCATION, new SpriteContents(LOCATION, new FrameSize(1, 1), new NativeImage(1, 1, false), AnimationMetadataSection.EMPTY, (ForgeTextureMetadata)null), 1, 1, 0, 0);
    }
