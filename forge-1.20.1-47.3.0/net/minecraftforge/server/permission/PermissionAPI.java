...
public final class PermissionAPI {
    ...
    public static @Nullable ResourceLocation getActivePermissionHandler() {
    ...
    public static void initializePermissionAPI() {
        ...
        if (callerClass != ServerLifecycleHooks.class) {
            ...
            try {
                ResourceLocation selectedPermissionHandler = new ResourceLocation((String)ForgeConfig.SERVER.permissionHandler.get());
                ...
                ResourceLocationException e = var6;
