...
public class FluidStack {
    ...
    public FluidStack(Fluid fluid, int amount) {
        if (fluid == null) {
            ...
            this.fluidDelegate = ForgeRegistries.FLUIDS.getDelegateOrThrow((Object)fluid);
            this.amount = amount;
            this.updateEmpty();
        }
    }
    ...
    static {
        ...
        CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(BuiltInRegistries.FLUID.byNameCodec().fieldOf("FluidName").forGetter(FluidStack::getFluid), Codec.INT.fieldOf("Amount").forGetter(FluidStack::getAmount), CompoundTag.CODEC.optionalFieldOf("Tag").forGetter((stack) -> {
