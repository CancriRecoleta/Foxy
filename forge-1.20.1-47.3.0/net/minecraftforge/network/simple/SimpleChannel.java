...
public class SimpleChannel {
    ...
    public <M> MessageBuilder<M> messageBuilder(Class<M> type, int id) {
        return net.minecraftforge.network.simple.SimpleChannel.MessageBuilder.forType(this, type, id, (NetworkDirection)null);
    }

    public <M> MessageBuilder<M> messageBuilder(Class<M> type, int id, NetworkDirection direction) {
        return net.minecraftforge.network.simple.SimpleChannel.MessageBuilder.forType(this, type, id, direction);
    }
