...
public class DualStackUtils {
    ...
    public static boolean checkIPv6(String hostAddress) {
        Optional<InetSocketAddress> hostAddr = ServerNameResolver.DEFAULT.resolveAddress(ServerAddress.parseString(hostAddress)).map(ResolvedServerAddress::asInetSocketAddress);
