...
public enum NetworkDirection {
    PLAY_TO_SERVER(NetworkEvent.ClientCustomPayloadEvent::new, LogicalSide.CLIENT, ServerboundCustomPayloadPacket.class, 1, (d, i, n) -> {
        return new ServerboundCustomPayloadPacket(n, d);
    }),
    PLAY_TO_CLIENT(NetworkEvent.ServerCustomPayloadEvent::new, LogicalSide.SERVER, ClientboundCustomPayloadPacket.class, 0, (d, i, n) -> {
        return new ClientboundCustomPayloadPacket(n, d);
    }),
    LOGIN_TO_SERVER(NetworkEvent.ClientCustomPayloadLoginEvent::new, LogicalSide.CLIENT, ServerboundCustomQueryPacket.class, 3, (d, i, n) -> {
        return new ServerboundCustomQueryPacket(i, d);
    }),
    LOGIN_TO_CLIENT(NetworkEvent.ServerCustomPayloadLoginEvent::new, LogicalSide.SERVER, ClientboundCustomQueryPacket.class, 2, (d, i, n) -> {
        return new ClientboundCustomQueryPacket(i, n, d);
    });
    ...
    private static final Reference2ReferenceArrayMap<Class<? extends Packet>, NetworkDirection> packetLookup = (Reference2ReferenceArrayMap)Stream.of(values()).collect(Collectors.toMap(NetworkDirection::getPacketClass, Function.identity(), (m1, m2) -> {
        return m1;
    }, Reference2ReferenceArrayMap::new));

    private NetworkDirection(BiFunction eventSupplier, LogicalSide logicalSide, Class clazz, int i, Factory factory) {
