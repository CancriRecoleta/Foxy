        ...
        if (entity.getClass().equals(ItemEntity.class)) {
            ...
            if (item.hasCustomEntity(stack)) {
                ...
                if (newEntity != null) {
                    ...
                    BlockableEventLoop<? super TickTask> executor = (BlockableEventLoop)LogicalSidedProvider.WORKQUEUE.get(event.getLevel().isClientSide ? LogicalSide.CLIENT : LogicalSide.SERVER);
