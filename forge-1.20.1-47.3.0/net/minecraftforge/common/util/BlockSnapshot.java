...
public class BlockSnapshot {
    ...
    private @Nullable WeakReference<LevelAccessor> level;
    ...
    private static @Nullable CompoundTag getBlockEntityTag(@Nullable BlockEntity te) {
    ...
    public String toString() {
        if (this.toString == null) {
            ResourceLocation var10001 = this.dim.location();
            this.toString = "BlockSnapshot[World:" + var10001 + ",Pos: " + this.pos + ",State: " + this.block + ",Flags: " + this.flags + ",NBT: " + (this.nbt == null ? "null" : this.nbt.toString()) + "]";
        }
